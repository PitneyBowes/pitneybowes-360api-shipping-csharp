...
**PickupSummary** | [**List&lt;SchedulePickupDHLEXPRequestPickupSummaryInner&gt;**](SchedulePickupDHLEXPRequestPickupSummaryInner.md) | An array of the pickup details, including the number of packages, total weight, and carrier service information and package details. | [optional] 
...
**ShipmentIds** | **List&lt;string&gt;** | List of shipment IDs for which pickup needs to be scheduled. | [optional] 
