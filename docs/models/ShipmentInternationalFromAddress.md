# com.pitneybowes.api360.Model.ShipmentInternationalFromAddress
...
**Email** | **string** | This must be sender&#39;s valid email. Email is required if the customer is using GoFor Carrier. This field is required for RMG b2b shipment. | [optional] 
