# com.pitneybowes.api360.Model.ShipmentDomesticToAddress
...
**Company** | **string** | The name of the company, in case if the receiver address is not residential. Required for B2B shipments when using the RMG carrier. &lt;br /&gt; &#x60;Max length &#x3D; 30&#x60;. | [optional] 
