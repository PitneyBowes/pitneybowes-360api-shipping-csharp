...
namespace com.pitneybowes.api360.Api
{
    ...
    public sealed partial class ElectronicTradeDocumentApi : IElectronicTradeDocumentApi
    {
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        UploadETDApiResponse apiResponseLocalVar;

                        switch ((int)httpResponseMessageLocalVar.StatusCode) {
                            default: {
                                string responseContentLocalVar = await httpResponseMessageLocalVar.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                                apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/api/v1/importUrl", requestedAtLocalVar, _jsonSerializerOptions);
        ...
        public partial class UploadETDApiResponse : com.pitneybowes.api360.Client.ApiResponse, IUploadETDApiResponse
        {
            ...
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out com.pitneybowes.api360.Model.UploadETD200Response? result)
            {
                result = null;
