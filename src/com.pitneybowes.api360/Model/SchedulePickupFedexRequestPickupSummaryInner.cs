...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    [DataContract(Name = "schedulePickupFedexRequest_pickupSummary_inner")]
    public partial class SchedulePickupFedexRequestPickupSummaryInner : IValidatableObject
    {
        ...
        protected SchedulePickupFedexRequestPickupSummaryInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SchedulePickupFedexRequestPickupSummaryInner" /> class.
        /// </summary>
        ...
        public SchedulePickupFedexRequestPickupSummaryInner(string serviceId = default(string), decimal packageCount = default(decimal), decimal totalWeight = default(decimal), string weightUnit = default(string))
        {
            // to ensure "serviceId" is required (not null)
            if (serviceId == null)
            {
                throw new ArgumentNullException("serviceId is a required property for SchedulePickupFedexRequestPickupSummaryInner and cannot be null");
            }
            ...
            if (weightUnit == null)
            {
                throw new ArgumentNullException("weightUnit is a required property for SchedulePickupFedexRequestPickupSummaryInner and cannot be null");
            }
