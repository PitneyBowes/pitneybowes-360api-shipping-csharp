...
{
    /// <summary>
    /// ShipmentDomesticCustomsCustomsItemsInner
    /// </summary>
    public partial class ShipmentDomesticCustomsCustomsItemsInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShipmentDomesticCustomsCustomsItemsInner" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public ShipmentDomesticCustomsCustomsItemsInner(string description, decimal quantity, decimal unitPrice, WeightUnitEnum weightUnit, decimal weight, Option<Object> hSTariffCode = default, Option<string> originCountryCode = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShipmentDomesticCustomsCustomsItemsInner {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="ShipmentDomesticCustomsCustomsItemsInner" />
    /// </summary>
    public class ShipmentDomesticCustomsCustomsItemsInnerJsonConverter : JsonConverter<ShipmentDomesticCustomsCustomsItemsInner>
    {
        /// <summary>
        /// Deserializes json to <see cref="ShipmentDomesticCustomsCustomsItemsInner" />
        /// </summary>
        ...
        public override ShipmentDomesticCustomsCustomsItemsInner Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<ShipmentDomesticCustomsCustomsItemsInner.WeightUnitEnum?> weightUnit = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "weightUnit":
                            ...
                            if (weightUnitRawValue != null)
                                weightUnit = new Option<ShipmentDomesticCustomsCustomsItemsInner.WeightUnitEnum?>(ShipmentDomesticCustomsCustomsItemsInner.WeightUnitEnumFromStringOrDefault(weightUnitRawValue));
                            break;
                        case "weight":
            ...
            if (!description.IsSet)
                throw new ArgumentException("Property is required for class ShipmentDomesticCustomsCustomsItemsInner.", nameof(description));

            if (!quantity.IsSet)
                throw new ArgumentException("Property is required for class ShipmentDomesticCustomsCustomsItemsInner.", nameof(quantity));

            if (!unitPrice.IsSet)
                throw new ArgumentException("Property is required for class ShipmentDomesticCustomsCustomsItemsInner.", nameof(unitPrice));

            if (!weightUnit.IsSet)
                throw new ArgumentException("Property is required for class ShipmentDomesticCustomsCustomsItemsInner.", nameof(weightUnit));

            if (!weight.IsSet)
                throw new ArgumentException("Property is required for class ShipmentDomesticCustomsCustomsItemsInner.", nameof(weight));

            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class ShipmentDomesticCustomsCustomsItemsInner.");

            if (quantity.IsSet && quantity.Value == null)
                throw new ArgumentNullException(nameof(quantity), "Property is not nullable for class ShipmentDomesticCustomsCustomsItemsInner.");

            if (unitPrice.IsSet && unitPrice.Value == null)
                throw new ArgumentNullException(nameof(unitPrice), "Property is not nullable for class ShipmentDomesticCustomsCustomsItemsInner.");

            if (weightUnit.IsSet && weightUnit.Value == null)
                throw new ArgumentNullException(nameof(weightUnit), "Property is not nullable for class ShipmentDomesticCustomsCustomsItemsInner.");

            if (weight.IsSet && weight.Value == null)
                throw new ArgumentNullException(nameof(weight), "Property is not nullable for class ShipmentDomesticCustomsCustomsItemsInner.");

            if (hSTariffCode.IsSet && hSTariffCode.Value == null)
                throw new ArgumentNullException(nameof(hSTariffCode), "Property is not nullable for class ShipmentDomesticCustomsCustomsItemsInner.");

            if (originCountryCode.IsSet && originCountryCode.Value == null)
                throw new ArgumentNullException(nameof(originCountryCode), "Property is not nullable for class ShipmentDomesticCustomsCustomsItemsInner.");

            return new ShipmentDomesticCustomsCustomsItemsInner(description.Value, quantity.Value.Value, unitPrice.Value.Value, weightUnit.Value.Value, weight.Value.Value, hSTariffCode, originCountryCode);
        }

        /// <summary>
        /// Serializes a <see cref="ShipmentDomesticCustomsCustomsItemsInner" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="shipmentDomesticCustomsCustomsItemsInner"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ShipmentDomesticCustomsCustomsItemsInner shipmentDomesticCustomsCustomsItemsInner, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, shipmentDomesticCustomsCustomsItemsInner, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ShipmentDomesticCustomsCustomsItemsInner" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="shipmentDomesticCustomsCustomsItemsInner"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ShipmentDomesticCustomsCustomsItemsInner shipmentDomesticCustomsCustomsItemsInner, JsonSerializerOptions jsonSerializerOptions)
        {
            if (shipmentDomesticCustomsCustomsItemsInner.Description == null)
                throw new ArgumentNullException(nameof(shipmentDomesticCustomsCustomsItemsInner.Description), "Property is required for class ShipmentDomesticCustomsCustomsItemsInner.");

            if (shipmentDomesticCustomsCustomsItemsInner.HSTariffCodeOption.IsSet && shipmentDomesticCustomsCustomsItemsInner.HSTariffCode == null)
                throw new ArgumentNullException(nameof(shipmentDomesticCustomsCustomsItemsInner.HSTariffCode), "Property is required for class ShipmentDomesticCustomsCustomsItemsInner.");

            if (shipmentDomesticCustomsCustomsItemsInner.OriginCountryCodeOption.IsSet && shipmentDomesticCustomsCustomsItemsInner.OriginCountryCode == null)
                throw new ArgumentNullException(nameof(shipmentDomesticCustomsCustomsItemsInner.OriginCountryCode), "Property is required for class ShipmentDomesticCustomsCustomsItemsInner.");

            writer.WriteString("description", shipmentDomesticCustomsCustomsItemsInner.Description);

            writer.WriteNumber("quantity", shipmentDomesticCustomsCustomsItemsInner.Quantity);

            writer.WriteNumber("unitPrice", shipmentDomesticCustomsCustomsItemsInner.UnitPrice);

            var weightUnitRawValue = ShipmentDomesticCustomsCustomsItemsInner.WeightUnitEnumToJsonValue(shipmentDomesticCustomsCustomsItemsInner.WeightUnit);
            writer.WriteString("weightUnit", weightUnitRawValue);
            writer.WriteNumber("weight", shipmentDomesticCustomsCustomsItemsInner.Weight);

            if (shipmentDomesticCustomsCustomsItemsInner.HSTariffCodeOption.IsSet)
            {
                writer.WritePropertyName("hSTariffCode");
                JsonSerializer.Serialize(writer, shipmentDomesticCustomsCustomsItemsInner.HSTariffCode, jsonSerializerOptions);
            }
            if (shipmentDomesticCustomsCustomsItemsInner.OriginCountryCodeOption.IsSet)
                writer.WriteString("originCountryCode", shipmentDomesticCustomsCustomsItemsInner.OriginCountryCode);
        }
    }
}
