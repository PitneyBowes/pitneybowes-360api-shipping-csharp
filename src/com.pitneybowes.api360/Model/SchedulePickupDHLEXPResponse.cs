...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    [DataContract(Name = "schedulePickupDHLEXPResponse")]
    public partial class SchedulePickupDHLEXPResponse : IValidatableObject
    {
        ...
        public SchedulePickupDHLEXPResponse(string packageLocation = default(string), string pickupConfirmationNumber = default(string), string pickupId = default(string), string carrier = default(string), string carrierAccountId = default(string), SchedulePickupDHLEXPResponsePickupAddress pickupAddress = default(SchedulePickupDHLEXPResponsePickupAddress), List<string> shipmentIds = default(List<string>), List<SchedulePickupDHLEXPResponsePickupSummaryInner> pickupSummary = default(List<SchedulePickupDHLEXPResponsePickupSummaryInner>), string additionalnotes = default(string), string reference = default(string), string pickupDateTime = default(string), decimal pickupTotalWeight = default(decimal), string pickupTotalWeightUnit = default(string), SchedulePickupDHLEXPResponsePickupOptions pickupOptions = default(SchedulePickupDHLEXPResponsePickupOptions))
        {
        ...
        public List<SchedulePickupDHLEXPResponsePickupSummaryInner> PickupSummary { get; set; }
        ...
        public SchedulePickupDHLEXPResponsePickupOptions PickupOptions { get; set; }
