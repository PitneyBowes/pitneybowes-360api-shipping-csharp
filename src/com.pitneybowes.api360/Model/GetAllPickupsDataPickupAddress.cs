...
{
    /// <summary>
    /// GetAllPickupsDataPickupAddress
    /// </summary>
    public partial class GetAllPickupsDataPickupAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAllPickupsDataPickupAddress" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public GetAllPickupsDataPickupAddress(Option<string> name = default, Option<string> addressLine1 = default, Option<string> cityTown = default, Option<string> stateProvince = default, Option<string> postalCode = default, Option<string> countryCode = default, Option<string> phone = default, Option<string> company = default, Option<string> email = default)
        {
            NameOption = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetAllPickupsDataPickupAddress {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="GetAllPickupsDataPickupAddress" />
    /// </summary>
    public class GetAllPickupsDataPickupAddressJsonConverter : JsonConverter<GetAllPickupsDataPickupAddress>
    {
        /// <summary>
        /// Deserializes json to <see cref="GetAllPickupsDataPickupAddress" />
        /// </summary>
        ...
        public override GetAllPickupsDataPickupAddress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class GetAllPickupsDataPickupAddress.");

            if (addressLine1.IsSet && addressLine1.Value == null)
                throw new ArgumentNullException(nameof(addressLine1), "Property is not nullable for class GetAllPickupsDataPickupAddress.");

            if (cityTown.IsSet && cityTown.Value == null)
                throw new ArgumentNullException(nameof(cityTown), "Property is not nullable for class GetAllPickupsDataPickupAddress.");

            if (stateProvince.IsSet && stateProvince.Value == null)
                throw new ArgumentNullException(nameof(stateProvince), "Property is not nullable for class GetAllPickupsDataPickupAddress.");

            if (postalCode.IsSet && postalCode.Value == null)
                throw new ArgumentNullException(nameof(postalCode), "Property is not nullable for class GetAllPickupsDataPickupAddress.");

            if (countryCode.IsSet && countryCode.Value == null)
                throw new ArgumentNullException(nameof(countryCode), "Property is not nullable for class GetAllPickupsDataPickupAddress.");

            if (phone.IsSet && phone.Value == null)
                throw new ArgumentNullException(nameof(phone), "Property is not nullable for class GetAllPickupsDataPickupAddress.");

            if (company.IsSet && company.Value == null)
                throw new ArgumentNullException(nameof(company), "Property is not nullable for class GetAllPickupsDataPickupAddress.");

            if (email.IsSet && email.Value == null)
                throw new ArgumentNullException(nameof(email), "Property is not nullable for class GetAllPickupsDataPickupAddress.");

            return new GetAllPickupsDataPickupAddress(name, addressLine1, cityTown, stateProvince, postalCode, countryCode, phone, company, email);
        }

        /// <summary>
        /// Serializes a <see cref="GetAllPickupsDataPickupAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getAllPickupsDataPickupAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GetAllPickupsDataPickupAddress getAllPickupsDataPickupAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, getAllPickupsDataPickupAddress, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GetAllPickupsDataPickupAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getAllPickupsDataPickupAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, GetAllPickupsDataPickupAddress getAllPickupsDataPickupAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            if (getAllPickupsDataPickupAddress.NameOption.IsSet && getAllPickupsDataPickupAddress.Name == null)
                throw new ArgumentNullException(nameof(getAllPickupsDataPickupAddress.Name), "Property is required for class GetAllPickupsDataPickupAddress.");

            if (getAllPickupsDataPickupAddress.AddressLine1Option.IsSet && getAllPickupsDataPickupAddress.AddressLine1 == null)
                throw new ArgumentNullException(nameof(getAllPickupsDataPickupAddress.AddressLine1), "Property is required for class GetAllPickupsDataPickupAddress.");

            if (getAllPickupsDataPickupAddress.CityTownOption.IsSet && getAllPickupsDataPickupAddress.CityTown == null)
                throw new ArgumentNullException(nameof(getAllPickupsDataPickupAddress.CityTown), "Property is required for class GetAllPickupsDataPickupAddress.");

            if (getAllPickupsDataPickupAddress.StateProvinceOption.IsSet && getAllPickupsDataPickupAddress.StateProvince == null)
                throw new ArgumentNullException(nameof(getAllPickupsDataPickupAddress.StateProvince), "Property is required for class GetAllPickupsDataPickupAddress.");

            if (getAllPickupsDataPickupAddress.PostalCodeOption.IsSet && getAllPickupsDataPickupAddress.PostalCode == null)
                throw new ArgumentNullException(nameof(getAllPickupsDataPickupAddress.PostalCode), "Property is required for class GetAllPickupsDataPickupAddress.");

            if (getAllPickupsDataPickupAddress.CountryCodeOption.IsSet && getAllPickupsDataPickupAddress.CountryCode == null)
                throw new ArgumentNullException(nameof(getAllPickupsDataPickupAddress.CountryCode), "Property is required for class GetAllPickupsDataPickupAddress.");

            if (getAllPickupsDataPickupAddress.PhoneOption.IsSet && getAllPickupsDataPickupAddress.Phone == null)
                throw new ArgumentNullException(nameof(getAllPickupsDataPickupAddress.Phone), "Property is required for class GetAllPickupsDataPickupAddress.");

            if (getAllPickupsDataPickupAddress.CompanyOption.IsSet && getAllPickupsDataPickupAddress.Company == null)
                throw new ArgumentNullException(nameof(getAllPickupsDataPickupAddress.Company), "Property is required for class GetAllPickupsDataPickupAddress.");

            if (getAllPickupsDataPickupAddress.EmailOption.IsSet && getAllPickupsDataPickupAddress.Email == null)
                throw new ArgumentNullException(nameof(getAllPickupsDataPickupAddress.Email), "Property is required for class GetAllPickupsDataPickupAddress.");

            if (getAllPickupsDataPickupAddress.NameOption.IsSet)
                writer.WriteString("name", getAllPickupsDataPickupAddress.Name);

            if (getAllPickupsDataPickupAddress.AddressLine1Option.IsSet)
                writer.WriteString("addressLine1", getAllPickupsDataPickupAddress.AddressLine1);

            if (getAllPickupsDataPickupAddress.CityTownOption.IsSet)
                writer.WriteString("cityTown", getAllPickupsDataPickupAddress.CityTown);

            if (getAllPickupsDataPickupAddress.StateProvinceOption.IsSet)
                writer.WriteString("stateProvince", getAllPickupsDataPickupAddress.StateProvince);

            if (getAllPickupsDataPickupAddress.PostalCodeOption.IsSet)
                writer.WriteString("postalCode", getAllPickupsDataPickupAddress.PostalCode);

            if (getAllPickupsDataPickupAddress.CountryCodeOption.IsSet)
                writer.WriteString("countryCode", getAllPickupsDataPickupAddress.CountryCode);

            if (getAllPickupsDataPickupAddress.PhoneOption.IsSet)
                writer.WriteString("phone", getAllPickupsDataPickupAddress.Phone);

            if (getAllPickupsDataPickupAddress.CompanyOption.IsSet)
                writer.WriteString("company", getAllPickupsDataPickupAddress.Company);

            if (getAllPickupsDataPickupAddress.EmailOption.IsSet)
                writer.WriteString("email", getAllPickupsDataPickupAddress.Email);
        }
    }
}
