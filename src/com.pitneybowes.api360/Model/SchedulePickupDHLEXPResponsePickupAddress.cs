...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    [DataContract(Name = "schedulePickupDHLEXPResponse_pickupAddress")]
    public partial class SchedulePickupDHLEXPResponsePickupAddress : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="name">Name of the person, It should not contain special character or numeric value.</param>
        /// <param name="addressLine1">Address line1 of the pickup address.</param>
        /// <param name="cityTown">City of the pickup address.</param>
        /// <param name="stateProvince">State province of the pickup address.</param>
        /// <param name="postalCode">Postal Code of the pickup address.</param>
        ...
        /// <param name="countryCode">ISO-2 characters country code.</param>
        ...
        public SchedulePickupDHLEXPResponsePickupAddress(string name = default(string), string addressLine1 = default(string), string cityTown = default(string), string stateProvince = default(string), string postalCode = default(string), bool residential = default(bool), string countryCode = default(string), string phone = default(string), string company = default(string), string email = default(string))
        {
            this.Name = name;
