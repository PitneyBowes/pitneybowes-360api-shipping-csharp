...
{
    /// <summary>
    /// Dimensions of packages to be picked up.
    /// </summary>
    public partial class PickupAvailabilityRequestPickupSummaryInnerPackageDetailsInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PickupAvailabilityRequestPickupSummaryInnerPackageDetailsInner" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PickupAvailabilityRequestPickupSummaryInnerPackageDetailsInner {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="PickupAvailabilityRequestPickupSummaryInnerPackageDetailsInner" />
    /// </summary>
    public class PickupAvailabilityRequestPickupSummaryInnerPackageDetailsInnerJsonConverter : JsonConverter<PickupAvailabilityRequestPickupSummaryInnerPackageDetailsInner>
    {
        /// <summary>
        /// Deserializes json to <see cref="PickupAvailabilityRequestPickupSummaryInnerPackageDetailsInner" />
        /// </summary>
        ...
        public override PickupAvailabilityRequestPickupSummaryInnerPackageDetailsInner Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (height.IsSet && height.Value == null)
                throw new ArgumentNullException(nameof(height), "Property is not nullable for class PickupAvailabilityRequestPickupSummaryInnerPackageDetailsInner.");

            if (length.IsSet && length.Value == null)
                throw new ArgumentNullException(nameof(length), "Property is not nullable for class PickupAvailabilityRequestPickupSummaryInnerPackageDetailsInner.");
        ...
        /// <summary>
        /// Serializes a <see cref="PickupAvailabilityRequestPickupSummaryInnerPackageDetailsInner" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="pickupAvailabilityRequestPickupSummaryInnerPackageDetailsInner"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, PickupAvailabilityRequestPickupSummaryInnerPackageDetailsInner pickupAvailabilityRequestPickupSummaryInnerPackageDetailsInner, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, pickupAvailabilityRequestPickupSummaryInnerPackageDetailsInner, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="PickupAvailabilityRequestPickupSummaryInnerPackageDetailsInner" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="pickupAvailabilityRequestPickupSummaryInnerPackageDetailsInner"></param>
        /// <param name="jsonSerializerOptions"></param>
        ...
        public void WriteProperties(Utf8JsonWriter writer, PickupAvailabilityRequestPickupSummaryInnerPackageDetailsInner pickupAvailabilityRequestPickupSummaryInnerPackageDetailsInner, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (pickupAvailabilityRequestPickupSummaryInnerPackageDetailsInner.HeightOption.IsSet)
                writer.WriteNumber("height", pickupAvailabilityRequestPickupSummaryInnerPackageDetailsInner.HeightOption.Value!.Value);

            if (pickupAvailabilityRequestPickupSummaryInnerPackageDetailsInner.LengthOption.IsSet)
                writer.WriteNumber("length", pickupAvailabilityRequestPickupSummaryInnerPackageDetailsInner.LengthOption.Value!.Value);
