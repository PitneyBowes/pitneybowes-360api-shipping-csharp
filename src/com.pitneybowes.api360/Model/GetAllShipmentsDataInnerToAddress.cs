...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    public partial class GetAllShipmentsDataInnerToAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAllShipmentsDataInnerToAddress" /> class.
        /// </summary>
        ...
        /* <example>sender1@yopmail.com</example> */
    ...
    /// <summary>
    /// A Json converter for type <see cref="GetAllShipmentsDataInnerToAddress" />
    /// </summary>
    public class GetAllShipmentsDataInnerToAddressJsonConverter : JsonConverter<GetAllShipmentsDataInnerToAddress>
    {
        /// <summary>
        /// Deserializes json to <see cref="GetAllShipmentsDataInnerToAddress" />
        /// </summary>
        ...
        public override GetAllShipmentsDataInnerToAddress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (addressLine1.IsSet && addressLine1.Value == null)
                throw new ArgumentNullException(nameof(addressLine1), "Property is not nullable for class GetAllShipmentsDataInnerToAddress.");

            if (addressLine2.IsSet && addressLine2.Value == null)
                throw new ArgumentNullException(nameof(addressLine2), "Property is not nullable for class GetAllShipmentsDataInnerToAddress.");

            if (addressLine3.IsSet && addressLine3.Value == null)
                throw new ArgumentNullException(nameof(addressLine3), "Property is not nullable for class GetAllShipmentsDataInnerToAddress.");

            if (cityTown.IsSet && cityTown.Value == null)
                throw new ArgumentNullException(nameof(cityTown), "Property is not nullable for class GetAllShipmentsDataInnerToAddress.");

            if (company.IsSet && company.Value == null)
                throw new ArgumentNullException(nameof(company), "Property is not nullable for class GetAllShipmentsDataInnerToAddress.");

            if (countryCode.IsSet && countryCode.Value == null)
                throw new ArgumentNullException(nameof(countryCode), "Property is not nullable for class GetAllShipmentsDataInnerToAddress.");

            if (email.IsSet && email.Value == null)
                throw new ArgumentNullException(nameof(email), "Property is not nullable for class GetAllShipmentsDataInnerToAddress.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class GetAllShipmentsDataInnerToAddress.");

            if (phone.IsSet && phone.Value == null)
                throw new ArgumentNullException(nameof(phone), "Property is not nullable for class GetAllShipmentsDataInnerToAddress.");

            if (postalCode.IsSet && postalCode.Value == null)
                throw new ArgumentNullException(nameof(postalCode), "Property is not nullable for class GetAllShipmentsDataInnerToAddress.");

            if (residential.IsSet && residential.Value == null)
                throw new ArgumentNullException(nameof(residential), "Property is not nullable for class GetAllShipmentsDataInnerToAddress.");

            if (stateProvince.IsSet && stateProvince.Value == null)
                throw new ArgumentNullException(nameof(stateProvince), "Property is not nullable for class GetAllShipmentsDataInnerToAddress.");

            return new GetAllShipmentsDataInnerToAddress(addressLine1, addressLine2, addressLine3, cityTown, company, countryCode, email, name, phone, postalCode, residential, stateProvince);
        }

        /// <summary>
        /// Serializes a <see cref="GetAllShipmentsDataInnerToAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getAllShipmentsDataInnerToAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GetAllShipmentsDataInnerToAddress getAllShipmentsDataInnerToAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, getAllShipmentsDataInnerToAddress, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GetAllShipmentsDataInnerToAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getAllShipmentsDataInnerToAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, GetAllShipmentsDataInnerToAddress getAllShipmentsDataInnerToAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            if (getAllShipmentsDataInnerToAddress.AddressLine1Option.IsSet && getAllShipmentsDataInnerToAddress.AddressLine1 == null)
                throw new ArgumentNullException(nameof(getAllShipmentsDataInnerToAddress.AddressLine1), "Property is required for class GetAllShipmentsDataInnerToAddress.");

            if (getAllShipmentsDataInnerToAddress.AddressLine2Option.IsSet && getAllShipmentsDataInnerToAddress.AddressLine2 == null)
                throw new ArgumentNullException(nameof(getAllShipmentsDataInnerToAddress.AddressLine2), "Property is required for class GetAllShipmentsDataInnerToAddress.");

            if (getAllShipmentsDataInnerToAddress.AddressLine3Option.IsSet && getAllShipmentsDataInnerToAddress.AddressLine3 == null)
                throw new ArgumentNullException(nameof(getAllShipmentsDataInnerToAddress.AddressLine3), "Property is required for class GetAllShipmentsDataInnerToAddress.");

            if (getAllShipmentsDataInnerToAddress.CityTownOption.IsSet && getAllShipmentsDataInnerToAddress.CityTown == null)
                throw new ArgumentNullException(nameof(getAllShipmentsDataInnerToAddress.CityTown), "Property is required for class GetAllShipmentsDataInnerToAddress.");

            if (getAllShipmentsDataInnerToAddress.CompanyOption.IsSet && getAllShipmentsDataInnerToAddress.Company == null)
                throw new ArgumentNullException(nameof(getAllShipmentsDataInnerToAddress.Company), "Property is required for class GetAllShipmentsDataInnerToAddress.");

            if (getAllShipmentsDataInnerToAddress.CountryCodeOption.IsSet && getAllShipmentsDataInnerToAddress.CountryCode == null)
                throw new ArgumentNullException(nameof(getAllShipmentsDataInnerToAddress.CountryCode), "Property is required for class GetAllShipmentsDataInnerToAddress.");

            if (getAllShipmentsDataInnerToAddress.EmailOption.IsSet && getAllShipmentsDataInnerToAddress.Email == null)
                throw new ArgumentNullException(nameof(getAllShipmentsDataInnerToAddress.Email), "Property is required for class GetAllShipmentsDataInnerToAddress.");

            if (getAllShipmentsDataInnerToAddress.NameOption.IsSet && getAllShipmentsDataInnerToAddress.Name == null)
                throw new ArgumentNullException(nameof(getAllShipmentsDataInnerToAddress.Name), "Property is required for class GetAllShipmentsDataInnerToAddress.");

            if (getAllShipmentsDataInnerToAddress.PhoneOption.IsSet && getAllShipmentsDataInnerToAddress.Phone == null)
                throw new ArgumentNullException(nameof(getAllShipmentsDataInnerToAddress.Phone), "Property is required for class GetAllShipmentsDataInnerToAddress.");

            if (getAllShipmentsDataInnerToAddress.PostalCodeOption.IsSet && getAllShipmentsDataInnerToAddress.PostalCode == null)
                throw new ArgumentNullException(nameof(getAllShipmentsDataInnerToAddress.PostalCode), "Property is required for class GetAllShipmentsDataInnerToAddress.");

            if (getAllShipmentsDataInnerToAddress.StateProvinceOption.IsSet && getAllShipmentsDataInnerToAddress.StateProvince == null)
                throw new ArgumentNullException(nameof(getAllShipmentsDataInnerToAddress.StateProvince), "Property is required for class GetAllShipmentsDataInnerToAddress.");

            if (getAllShipmentsDataInnerToAddress.AddressLine1Option.IsSet)
                writer.WriteString("addressLine1", getAllShipmentsDataInnerToAddress.AddressLine1);

            if (getAllShipmentsDataInnerToAddress.AddressLine2Option.IsSet)
                writer.WriteString("addressLine2", getAllShipmentsDataInnerToAddress.AddressLine2);

            if (getAllShipmentsDataInnerToAddress.AddressLine3Option.IsSet)
                writer.WriteString("addressLine3", getAllShipmentsDataInnerToAddress.AddressLine3);

            if (getAllShipmentsDataInnerToAddress.CityTownOption.IsSet)
                writer.WriteString("cityTown", getAllShipmentsDataInnerToAddress.CityTown);

            if (getAllShipmentsDataInnerToAddress.CompanyOption.IsSet)
                writer.WriteString("company", getAllShipmentsDataInnerToAddress.Company);

            if (getAllShipmentsDataInnerToAddress.CountryCodeOption.IsSet)
                writer.WriteString("countryCode", getAllShipmentsDataInnerToAddress.CountryCode);

            if (getAllShipmentsDataInnerToAddress.EmailOption.IsSet)
                writer.WriteString("email", getAllShipmentsDataInnerToAddress.Email);

            if (getAllShipmentsDataInnerToAddress.NameOption.IsSet)
                writer.WriteString("name", getAllShipmentsDataInnerToAddress.Name);

            if (getAllShipmentsDataInnerToAddress.PhoneOption.IsSet)
                writer.WriteString("phone", getAllShipmentsDataInnerToAddress.Phone);

            if (getAllShipmentsDataInnerToAddress.PostalCodeOption.IsSet)
                writer.WriteString("postalCode", getAllShipmentsDataInnerToAddress.PostalCode);

            if (getAllShipmentsDataInnerToAddress.ResidentialOption.IsSet)
                writer.WriteBoolean("residential", getAllShipmentsDataInnerToAddress.ResidentialOption.Value!.Value);

            if (getAllShipmentsDataInnerToAddress.StateProvinceOption.IsSet)
                writer.WriteString("stateProvince", getAllShipmentsDataInnerToAddress.StateProvince);
        }
    }
}
