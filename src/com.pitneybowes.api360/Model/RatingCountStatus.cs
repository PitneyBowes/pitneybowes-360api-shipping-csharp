...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RatingCountStatus")]
    public partial class RatingCountStatus : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RatingCountStatus" /> class.
        /// </summary>
        /// <param name="success">The number of shipments that have been successfully processed for Ratings..</param>
        /// <param name="failed">The number of shipments which failed processing at Rating due to some scenarios like unsupported extra services or incompatible special services combined for a shipment..</param>
        /// <param name="pending">The number of shipments which are pending and in-queue to be processed..</param>
        public RatingCountStatus(decimal success = default(decimal), decimal failed = default(decimal), decimal pending = default(decimal))
        {
        ...
        /// </summary>
        /// <value>The number of shipments which failed processing at Rating due to some scenarios like unsupported extra services or incompatible special services combined for a shipment.</value>
        /// <example>10</example>
