...
namespace com.pitneybowes.api360.Model
{
    ...
    public partial class ShipmentDomesticByRuleset : IValidatableObject
    {
        ...
        [JsonConstructor]
        public ShipmentDomesticByRuleset(FromAddressV2 fromAddress, ToAddressV2 toAddress, string parcelType, LabelSizeEnum labelSize, LabelTypeEnum labelType, LabelFormatEnum labelFormat, Option<SoldToAddressV2> soldToAddress = default, Option<List<AdditionalAddressesInner>> additionalAddresses = default, Option<ShipmentDomesticByRulesetAltReturnAddress> altReturnAddress = default, Option<ParcelV2> parcel = default, Option<RateShopByEnum?> rateShopBy = default, Option<ShipmentDomesticByRulesetByRuleSet> byRuleSet = default, Option<ShipmentDomesticByRulesetShipmentOptions> shipmentOptions = default, Option<List<CarrierPaymentsInner>> carrierPayments = default, Option<ShipmentDomesticByCarrierDocTab> docTab = default, Option<MilitaryMailShipmentsRequestV2DeliveryConfirmation> deliveryConfirmation = default, Option<MilitaryMailShipmentsRequestV2Handling> handling = default, Option<MilitaryMailShipmentsRequestV2Insurance> insurance = default, Option<ReferenceV2> references = default, Option<List<ShipmentDomesticByCustomCarrierCodeMetadataInner>> metadata = default, Option<ContentTypeEnum?> contentType = default, Option<string> printerAliasName = default, Option<DateTime?> dateOfShipment = default, Option<ShipmentDomesticByRulesetDeliveryOption> deliveryOption = default)
        {
        ...
        public ShipmentDomesticByRulesetAltReturnAddress AltReturnAddress { get { return this.AltReturnAddressOption; } set { this.AltReturnAddressOption = new Option<ShipmentDomesticByRulesetAltReturnAddress>(value); } }
        ...
        public ShipmentDomesticByRulesetByRuleSet ByRuleSet { get { return this.ByRuleSetOption; } set { this.ByRuleSetOption = new Option<ShipmentDomesticByRulesetByRuleSet>(value); } }
        ...
        public ShipmentDomesticByRulesetShipmentOptions ShipmentOptions { get { return this.ShipmentOptionsOption; } set { this.ShipmentOptionsOption = new Option<ShipmentDomesticByRulesetShipmentOptions>(value); } }
        ...
        public ShipmentDomesticByRulesetDeliveryOption DeliveryOption { get { return this.DeliveryOptionOption; } set { this.DeliveryOptionOption = new Option<ShipmentDomesticByRulesetDeliveryOption>(value); } }
