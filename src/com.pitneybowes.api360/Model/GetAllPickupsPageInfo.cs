...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    public partial class GetAllPickupsPageInfo : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAllPickupsPageInfo" /> class.
        /// </summary>
        /// <param name="total">Total number of records for pickups.</param>
        /// <param name="pages">Total number of pages available.</param>
        /// <param name="page">Current page number.</param>
        [JsonConstructor]
        public GetAllPickupsPageInfo(Option<int?> total = default, Option<int?> pages = default, Option<int?> page = default)
        {
            TotalOption = total;
            PagesOption = pages;
            PageOption = page;
        ...
        /// </summary>
        /// <value>Total number of records for pickups.</value>
        /* <example>78</example> */
    ...
    /// <summary>
    /// A Json converter for type <see cref="GetAllPickupsPageInfo" />
    /// </summary>
    public class GetAllPickupsPageInfoJsonConverter : JsonConverter<GetAllPickupsPageInfo>
    {
        /// <summary>
        /// Deserializes json to <see cref="GetAllPickupsPageInfo" />
        /// </summary>
        ...
        public override GetAllPickupsPageInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (total.IsSet && total.Value == null)
                throw new ArgumentNullException(nameof(total), "Property is not nullable for class GetAllPickupsPageInfo.");

            if (pages.IsSet && pages.Value == null)
                throw new ArgumentNullException(nameof(pages), "Property is not nullable for class GetAllPickupsPageInfo.");

            if (page.IsSet && page.Value == null)
                throw new ArgumentNullException(nameof(page), "Property is not nullable for class GetAllPickupsPageInfo.");

            return new GetAllPickupsPageInfo(total, pages, page);
        }

        /// <summary>
        /// Serializes a <see cref="GetAllPickupsPageInfo" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getAllPickupsPageInfo"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GetAllPickupsPageInfo getAllPickupsPageInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, getAllPickupsPageInfo, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GetAllPickupsPageInfo" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getAllPickupsPageInfo"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, GetAllPickupsPageInfo getAllPickupsPageInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            if (getAllPickupsPageInfo.TotalOption.IsSet)
                writer.WriteNumber("total", getAllPickupsPageInfo.TotalOption.Value.Value);

            if (getAllPickupsPageInfo.PagesOption.IsSet)
                writer.WriteNumber("pages", getAllPickupsPageInfo.PagesOption.Value.Value);

            if (getAllPickupsPageInfo.PageOption.IsSet)
                writer.WriteNumber("page", getAllPickupsPageInfo.PageOption.Value.Value);
        }
    }
}
