...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    [DataContract(Name = "rateShopResponse_rates_inner")]
    public partial class RateShopResponseRatesInner : IValidatableObject
    {
        ...
        /// <param name="parcelId">It indicates parcelId chosen in the request.</param>
        ...
        /// <param name="surcharges"> Additional fees or surcharges for the shipment. Each object in the array defines a surcharge and fee..</param>
        ...
        public RateShopResponseRatesInner(decimal baseCharge = default(decimal), string carrier = default(string), string carrierAccount = default(string), RateShopResponseRatesInnerDeliveryCommitment deliveryCommitment = default(RateShopResponseRatesInnerDeliveryCommitment), string currencyCode = default(string), string parcelType = default(string), string parcelId = default(string), string rateTypeId = default(string), string serviceId = default(string), List<RateShopResponseRatesInnerSurchargesInner> surcharges = default(List<RateShopResponseRatesInnerSurchargesInner>), decimal totalCarrierCharge = default(decimal))
        {
        ...
        /// </summary>
        /// <value>It indicates parcelId chosen in the request</value>
        /// <example>FRE</example>
        ...
        /// </summary>
        /// <value> Additional fees or surcharges for the shipment. Each object in the array defines a surcharge and fee.</value>
        /// <example>[{&quot;fee&quot;:5.85,&quot;name&quot;:&quot;RESIDENTIAL&quot;},{&quot;fee&quot;:4.66,&quot;name&quot;:&quot;FUEL&quot;}]</example>
        [DataMember(Name = "surcharges", EmitDefaultValue = false)]
        public List<RateShopResponseRatesInnerSurchargesInner> Surcharges { get; set; }
