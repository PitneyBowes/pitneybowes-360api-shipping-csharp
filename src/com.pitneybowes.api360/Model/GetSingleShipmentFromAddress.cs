...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    public partial class GetSingleShipmentFromAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetSingleShipmentFromAddress" /> class.
        /// </summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="GetSingleShipmentFromAddress" />
    /// </summary>
    public class GetSingleShipmentFromAddressJsonConverter : JsonConverter<GetSingleShipmentFromAddress>
    {
        /// <summary>
        /// Deserializes json to <see cref="GetSingleShipmentFromAddress" />
        /// </summary>
        ...
        public override GetSingleShipmentFromAddress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (addressLine1.IsSet && addressLine1.Value == null)
                throw new ArgumentNullException(nameof(addressLine1), "Property is not nullable for class GetSingleShipmentFromAddress.");

            if (addressLine2.IsSet && addressLine2.Value == null)
                throw new ArgumentNullException(nameof(addressLine2), "Property is not nullable for class GetSingleShipmentFromAddress.");

            if (addressLine3.IsSet && addressLine3.Value == null)
                throw new ArgumentNullException(nameof(addressLine3), "Property is not nullable for class GetSingleShipmentFromAddress.");

            if (cityTown.IsSet && cityTown.Value == null)
                throw new ArgumentNullException(nameof(cityTown), "Property is not nullable for class GetSingleShipmentFromAddress.");

            if (company.IsSet && company.Value == null)
                throw new ArgumentNullException(nameof(company), "Property is not nullable for class GetSingleShipmentFromAddress.");

            if (countryCode.IsSet && countryCode.Value == null)
                throw new ArgumentNullException(nameof(countryCode), "Property is not nullable for class GetSingleShipmentFromAddress.");

            if (email.IsSet && email.Value == null)
                throw new ArgumentNullException(nameof(email), "Property is not nullable for class GetSingleShipmentFromAddress.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class GetSingleShipmentFromAddress.");

            if (phone.IsSet && phone.Value == null)
                throw new ArgumentNullException(nameof(phone), "Property is not nullable for class GetSingleShipmentFromAddress.");

            if (postalCode.IsSet && postalCode.Value == null)
                throw new ArgumentNullException(nameof(postalCode), "Property is not nullable for class GetSingleShipmentFromAddress.");

            if (residential.IsSet && residential.Value == null)
                throw new ArgumentNullException(nameof(residential), "Property is not nullable for class GetSingleShipmentFromAddress.");

            if (stateProvince.IsSet && stateProvince.Value == null)
                throw new ArgumentNullException(nameof(stateProvince), "Property is not nullable for class GetSingleShipmentFromAddress.");

            return new GetSingleShipmentFromAddress(addressLine1, addressLine2, addressLine3, cityTown, company, countryCode, email, name, phone, postalCode, residential, stateProvince);
        }

        /// <summary>
        /// Serializes a <see cref="GetSingleShipmentFromAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getSingleShipmentFromAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GetSingleShipmentFromAddress getSingleShipmentFromAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, getSingleShipmentFromAddress, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GetSingleShipmentFromAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getSingleShipmentFromAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, GetSingleShipmentFromAddress getSingleShipmentFromAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            if (getSingleShipmentFromAddress.AddressLine1Option.IsSet && getSingleShipmentFromAddress.AddressLine1 == null)
                throw new ArgumentNullException(nameof(getSingleShipmentFromAddress.AddressLine1), "Property is required for class GetSingleShipmentFromAddress.");

            if (getSingleShipmentFromAddress.AddressLine2Option.IsSet && getSingleShipmentFromAddress.AddressLine2 == null)
                throw new ArgumentNullException(nameof(getSingleShipmentFromAddress.AddressLine2), "Property is required for class GetSingleShipmentFromAddress.");

            if (getSingleShipmentFromAddress.AddressLine3Option.IsSet && getSingleShipmentFromAddress.AddressLine3 == null)
                throw new ArgumentNullException(nameof(getSingleShipmentFromAddress.AddressLine3), "Property is required for class GetSingleShipmentFromAddress.");

            if (getSingleShipmentFromAddress.CityTownOption.IsSet && getSingleShipmentFromAddress.CityTown == null)
                throw new ArgumentNullException(nameof(getSingleShipmentFromAddress.CityTown), "Property is required for class GetSingleShipmentFromAddress.");

            if (getSingleShipmentFromAddress.CompanyOption.IsSet && getSingleShipmentFromAddress.Company == null)
                throw new ArgumentNullException(nameof(getSingleShipmentFromAddress.Company), "Property is required for class GetSingleShipmentFromAddress.");

            if (getSingleShipmentFromAddress.CountryCodeOption.IsSet && getSingleShipmentFromAddress.CountryCode == null)
                throw new ArgumentNullException(nameof(getSingleShipmentFromAddress.CountryCode), "Property is required for class GetSingleShipmentFromAddress.");

            if (getSingleShipmentFromAddress.EmailOption.IsSet && getSingleShipmentFromAddress.Email == null)
                throw new ArgumentNullException(nameof(getSingleShipmentFromAddress.Email), "Property is required for class GetSingleShipmentFromAddress.");

            if (getSingleShipmentFromAddress.NameOption.IsSet && getSingleShipmentFromAddress.Name == null)
                throw new ArgumentNullException(nameof(getSingleShipmentFromAddress.Name), "Property is required for class GetSingleShipmentFromAddress.");

            if (getSingleShipmentFromAddress.PhoneOption.IsSet && getSingleShipmentFromAddress.Phone == null)
                throw new ArgumentNullException(nameof(getSingleShipmentFromAddress.Phone), "Property is required for class GetSingleShipmentFromAddress.");

            if (getSingleShipmentFromAddress.PostalCodeOption.IsSet && getSingleShipmentFromAddress.PostalCode == null)
                throw new ArgumentNullException(nameof(getSingleShipmentFromAddress.PostalCode), "Property is required for class GetSingleShipmentFromAddress.");

            if (getSingleShipmentFromAddress.StateProvinceOption.IsSet && getSingleShipmentFromAddress.StateProvince == null)
                throw new ArgumentNullException(nameof(getSingleShipmentFromAddress.StateProvince), "Property is required for class GetSingleShipmentFromAddress.");

            if (getSingleShipmentFromAddress.AddressLine1Option.IsSet)
                writer.WriteString("addressLine1", getSingleShipmentFromAddress.AddressLine1);

            if (getSingleShipmentFromAddress.AddressLine2Option.IsSet)
                writer.WriteString("addressLine2", getSingleShipmentFromAddress.AddressLine2);

            if (getSingleShipmentFromAddress.AddressLine3Option.IsSet)
                writer.WriteString("addressLine3", getSingleShipmentFromAddress.AddressLine3);

            if (getSingleShipmentFromAddress.CityTownOption.IsSet)
                writer.WriteString("cityTown", getSingleShipmentFromAddress.CityTown);

            if (getSingleShipmentFromAddress.CompanyOption.IsSet)
                writer.WriteString("company", getSingleShipmentFromAddress.Company);

            if (getSingleShipmentFromAddress.CountryCodeOption.IsSet)
                writer.WriteString("countryCode", getSingleShipmentFromAddress.CountryCode);

            if (getSingleShipmentFromAddress.EmailOption.IsSet)
                writer.WriteString("email", getSingleShipmentFromAddress.Email);

            if (getSingleShipmentFromAddress.NameOption.IsSet)
                writer.WriteString("name", getSingleShipmentFromAddress.Name);

            if (getSingleShipmentFromAddress.PhoneOption.IsSet)
                writer.WriteString("phone", getSingleShipmentFromAddress.Phone);

            if (getSingleShipmentFromAddress.PostalCodeOption.IsSet)
                writer.WriteString("postalCode", getSingleShipmentFromAddress.PostalCode);

            if (getSingleShipmentFromAddress.ResidentialOption.IsSet)
                writer.WriteBoolean("residential", getSingleShipmentFromAddress.ResidentialOption.Value!.Value);

            if (getSingleShipmentFromAddress.StateProvinceOption.IsSet)
                writer.WriteString("stateProvince", getSingleShipmentFromAddress.StateProvince);
        }
    }
}
