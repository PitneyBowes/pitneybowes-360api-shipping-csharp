...
{
    /// <summary>
    /// MilitaryMailShipmentResponseV2ShipmentOptions
    /// </summary>
    public partial class MilitaryMailShipmentResponseV2ShipmentOptions : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MilitaryMailShipmentResponseV2ShipmentOptions" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public MilitaryMailShipmentResponseV2ShipmentOptions(Option<bool?> addToManifest = default, Option<string?> printCustomMessage = default, Option<ReceiptOptionEnum?> receiptOption = default, Option<string?> printDepartment = default, Option<string?> printInvoiceNumber = default, Option<string?> printPONumber = default, Option<string?> shipperId = default, Option<bool?> minimalAddressValidation = default, Option<string?> billingWeight = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MilitaryMailShipmentResponseV2ShipmentOptions {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="MilitaryMailShipmentResponseV2ShipmentOptions" />
    /// </summary>
    public class MilitaryMailShipmentResponseV2ShipmentOptionsJsonConverter : JsonConverter<MilitaryMailShipmentResponseV2ShipmentOptions>
    {
        /// <summary>
        /// Deserializes json to <see cref="MilitaryMailShipmentResponseV2ShipmentOptions" />
        /// </summary>
        ...
        public override MilitaryMailShipmentResponseV2ShipmentOptions Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<MilitaryMailShipmentResponseV2ShipmentOptions.ReceiptOptionEnum?> receiptOption = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "receiptOption":
                            ...
                            if (receiptOptionRawValue != null)
                                receiptOption = new Option<MilitaryMailShipmentResponseV2ShipmentOptions.ReceiptOptionEnum?>(MilitaryMailShipmentResponseV2ShipmentOptions.ReceiptOptionEnumFromStringOrDefault(receiptOptionRawValue));
                            break;
            ...
            if (addToManifest.IsSet && addToManifest.Value == null)
                throw new ArgumentNullException(nameof(addToManifest), "Property is not nullable for class MilitaryMailShipmentResponseV2ShipmentOptions.");

            if (printCustomMessage.IsSet && printCustomMessage.Value == null)
                throw new ArgumentNullException(nameof(printCustomMessage), "Property is not nullable for class MilitaryMailShipmentResponseV2ShipmentOptions.");

            if (receiptOption.IsSet && receiptOption.Value == null)
                throw new ArgumentNullException(nameof(receiptOption), "Property is not nullable for class MilitaryMailShipmentResponseV2ShipmentOptions.");

            if (printDepartment.IsSet && printDepartment.Value == null)
                throw new ArgumentNullException(nameof(printDepartment), "Property is not nullable for class MilitaryMailShipmentResponseV2ShipmentOptions.");

            if (printInvoiceNumber.IsSet && printInvoiceNumber.Value == null)
                throw new ArgumentNullException(nameof(printInvoiceNumber), "Property is not nullable for class MilitaryMailShipmentResponseV2ShipmentOptions.");

            if (printPONumber.IsSet && printPONumber.Value == null)
                throw new ArgumentNullException(nameof(printPONumber), "Property is not nullable for class MilitaryMailShipmentResponseV2ShipmentOptions.");

            if (shipperId.IsSet && shipperId.Value == null)
                throw new ArgumentNullException(nameof(shipperId), "Property is not nullable for class MilitaryMailShipmentResponseV2ShipmentOptions.");

            if (minimalAddressValidation.IsSet && minimalAddressValidation.Value == null)
                throw new ArgumentNullException(nameof(minimalAddressValidation), "Property is not nullable for class MilitaryMailShipmentResponseV2ShipmentOptions.");

            if (billingWeight.IsSet && billingWeight.Value == null)
                throw new ArgumentNullException(nameof(billingWeight), "Property is not nullable for class MilitaryMailShipmentResponseV2ShipmentOptions.");

            return new MilitaryMailShipmentResponseV2ShipmentOptions(addToManifest, printCustomMessage, receiptOption, printDepartment, printInvoiceNumber, printPONumber, shipperId, minimalAddressValidation, billingWeight);
        }

        /// <summary>
        /// Serializes a <see cref="MilitaryMailShipmentResponseV2ShipmentOptions" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="militaryMailShipmentResponseV2ShipmentOptions"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, MilitaryMailShipmentResponseV2ShipmentOptions militaryMailShipmentResponseV2ShipmentOptions, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, militaryMailShipmentResponseV2ShipmentOptions, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="MilitaryMailShipmentResponseV2ShipmentOptions" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="militaryMailShipmentResponseV2ShipmentOptions"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, MilitaryMailShipmentResponseV2ShipmentOptions militaryMailShipmentResponseV2ShipmentOptions, JsonSerializerOptions jsonSerializerOptions)
        {
            if (militaryMailShipmentResponseV2ShipmentOptions.PrintCustomMessageOption.IsSet && militaryMailShipmentResponseV2ShipmentOptions.PrintCustomMessage == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentResponseV2ShipmentOptions.PrintCustomMessage), "Property is required for class MilitaryMailShipmentResponseV2ShipmentOptions.");

            if (militaryMailShipmentResponseV2ShipmentOptions.PrintDepartmentOption.IsSet && militaryMailShipmentResponseV2ShipmentOptions.PrintDepartment == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentResponseV2ShipmentOptions.PrintDepartment), "Property is required for class MilitaryMailShipmentResponseV2ShipmentOptions.");

            if (militaryMailShipmentResponseV2ShipmentOptions.PrintInvoiceNumberOption.IsSet && militaryMailShipmentResponseV2ShipmentOptions.PrintInvoiceNumber == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentResponseV2ShipmentOptions.PrintInvoiceNumber), "Property is required for class MilitaryMailShipmentResponseV2ShipmentOptions.");

            if (militaryMailShipmentResponseV2ShipmentOptions.PrintPONumberOption.IsSet && militaryMailShipmentResponseV2ShipmentOptions.PrintPONumber == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentResponseV2ShipmentOptions.PrintPONumber), "Property is required for class MilitaryMailShipmentResponseV2ShipmentOptions.");

            if (militaryMailShipmentResponseV2ShipmentOptions.ShipperIdOption.IsSet && militaryMailShipmentResponseV2ShipmentOptions.ShipperId == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentResponseV2ShipmentOptions.ShipperId), "Property is required for class MilitaryMailShipmentResponseV2ShipmentOptions.");

            if (militaryMailShipmentResponseV2ShipmentOptions.BillingWeightOption.IsSet && militaryMailShipmentResponseV2ShipmentOptions.BillingWeight == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentResponseV2ShipmentOptions.BillingWeight), "Property is required for class MilitaryMailShipmentResponseV2ShipmentOptions.");

            if (militaryMailShipmentResponseV2ShipmentOptions.AddToManifestOption.IsSet)
                writer.WriteBoolean("addToManifest", militaryMailShipmentResponseV2ShipmentOptions.AddToManifestOption.Value!.Value);

            if (militaryMailShipmentResponseV2ShipmentOptions.PrintCustomMessageOption.IsSet)
                writer.WriteString("printCustomMessage", militaryMailShipmentResponseV2ShipmentOptions.PrintCustomMessage);

            var receiptOptionRawValue = MilitaryMailShipmentResponseV2ShipmentOptions.ReceiptOptionEnumToJsonValue(militaryMailShipmentResponseV2ShipmentOptions.ReceiptOptionOption.Value!.Value);
            writer.WriteString("receiptOption", receiptOptionRawValue);
            if (militaryMailShipmentResponseV2ShipmentOptions.PrintDepartmentOption.IsSet)
                writer.WriteString("printDepartment", militaryMailShipmentResponseV2ShipmentOptions.PrintDepartment);

            if (militaryMailShipmentResponseV2ShipmentOptions.PrintInvoiceNumberOption.IsSet)
                writer.WriteString("printInvoiceNumber", militaryMailShipmentResponseV2ShipmentOptions.PrintInvoiceNumber);

            if (militaryMailShipmentResponseV2ShipmentOptions.PrintPONumberOption.IsSet)
                writer.WriteString("printPONumber", militaryMailShipmentResponseV2ShipmentOptions.PrintPONumber);

            if (militaryMailShipmentResponseV2ShipmentOptions.ShipperIdOption.IsSet)
                writer.WriteString("shipperId", militaryMailShipmentResponseV2ShipmentOptions.ShipperId);

            if (militaryMailShipmentResponseV2ShipmentOptions.MinimalAddressValidationOption.IsSet)
                writer.WriteBoolean("minimalAddressValidation", militaryMailShipmentResponseV2ShipmentOptions.MinimalAddressValidationOption.Value!.Value);

            if (militaryMailShipmentResponseV2ShipmentOptions.BillingWeightOption.IsSet)
                writer.WriteString("billingWeight", militaryMailShipmentResponseV2ShipmentOptions.BillingWeight);
        }
    }
}
