...
namespace com.pitneybowes.api360.Model
{
    ...
    public partial class MilitaryMailShipmentResponseV2ShipmentOptions : IValidatableObject
    {
        ...
        [JsonConstructor]
        public MilitaryMailShipmentResponseV2ShipmentOptions(Option<bool?> addToManifest = default, Option<string?> printCustomMessage = default, Option<string?> receiptOption = default, Option<string?> printDepartment = default, Option<string?> printInvoiceNumber = default, Option<string?> printPONumber = default, Option<string?> shipperId = default, Option<bool?> minimalAddressValidation = default, Option<string?> billingWeight = default)
        {
    ...
    public class MilitaryMailShipmentResponseV2ShipmentOptionsJsonConverter : JsonConverter<MilitaryMailShipmentResponseV2ShipmentOptions>
    {
        ...
        public void WriteProperties(Utf8JsonWriter writer, MilitaryMailShipmentResponseV2ShipmentOptions militaryMailShipmentResponseV2ShipmentOptions, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (militaryMailShipmentResponseV2ShipmentOptions.ReceiptOptionOption.IsSet && militaryMailShipmentResponseV2ShipmentOptions.ReceiptOption == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentResponseV2ShipmentOptions.ReceiptOption), "Property is required for class MilitaryMailShipmentResponseV2ShipmentOptions.");
            ...
            if (militaryMailShipmentResponseV2ShipmentOptions.ReceiptOptionOption.IsSet)
                writer.WriteString("receiptOption", militaryMailShipmentResponseV2ShipmentOptions.ReceiptOption);
