...
{
    /// <summary>
    /// MilitaryMailShipmentsCustomsCustomsItemsInner
    /// </summary>
    public partial class MilitaryMailShipmentsCustomsCustomsItemsInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MilitaryMailShipmentsCustomsCustomsItemsInner" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public MilitaryMailShipmentsCustomsCustomsItemsInner(string description, decimal quantity, decimal unitPrice, WeightUnitEnum weightUnit, decimal weight, Option<Object> hSTariffCode = default, Option<string> originCountryCode = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MilitaryMailShipmentsCustomsCustomsItemsInner {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="MilitaryMailShipmentsCustomsCustomsItemsInner" />
    /// </summary>
    public class MilitaryMailShipmentsCustomsCustomsItemsInnerJsonConverter : JsonConverter<MilitaryMailShipmentsCustomsCustomsItemsInner>
    {
        /// <summary>
        /// Deserializes json to <see cref="MilitaryMailShipmentsCustomsCustomsItemsInner" />
        /// </summary>
        ...
        public override MilitaryMailShipmentsCustomsCustomsItemsInner Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<MilitaryMailShipmentsCustomsCustomsItemsInner.WeightUnitEnum?> weightUnit = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "weightUnit":
                            ...
                            if (weightUnitRawValue != null)
                                weightUnit = new Option<MilitaryMailShipmentsCustomsCustomsItemsInner.WeightUnitEnum?>(MilitaryMailShipmentsCustomsCustomsItemsInner.WeightUnitEnumFromStringOrDefault(weightUnitRawValue));
                            break;
                        case "weight":
            ...
            if (!description.IsSet)
                throw new ArgumentException("Property is required for class MilitaryMailShipmentsCustomsCustomsItemsInner.", nameof(description));

            if (!quantity.IsSet)
                throw new ArgumentException("Property is required for class MilitaryMailShipmentsCustomsCustomsItemsInner.", nameof(quantity));

            if (!unitPrice.IsSet)
                throw new ArgumentException("Property is required for class MilitaryMailShipmentsCustomsCustomsItemsInner.", nameof(unitPrice));

            if (!weightUnit.IsSet)
                throw new ArgumentException("Property is required for class MilitaryMailShipmentsCustomsCustomsItemsInner.", nameof(weightUnit));

            if (!weight.IsSet)
                throw new ArgumentException("Property is required for class MilitaryMailShipmentsCustomsCustomsItemsInner.", nameof(weight));

            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class MilitaryMailShipmentsCustomsCustomsItemsInner.");

            if (quantity.IsSet && quantity.Value == null)
                throw new ArgumentNullException(nameof(quantity), "Property is not nullable for class MilitaryMailShipmentsCustomsCustomsItemsInner.");

            if (unitPrice.IsSet && unitPrice.Value == null)
                throw new ArgumentNullException(nameof(unitPrice), "Property is not nullable for class MilitaryMailShipmentsCustomsCustomsItemsInner.");

            if (weightUnit.IsSet && weightUnit.Value == null)
                throw new ArgumentNullException(nameof(weightUnit), "Property is not nullable for class MilitaryMailShipmentsCustomsCustomsItemsInner.");

            if (weight.IsSet && weight.Value == null)
                throw new ArgumentNullException(nameof(weight), "Property is not nullable for class MilitaryMailShipmentsCustomsCustomsItemsInner.");

            if (hSTariffCode.IsSet && hSTariffCode.Value == null)
                throw new ArgumentNullException(nameof(hSTariffCode), "Property is not nullable for class MilitaryMailShipmentsCustomsCustomsItemsInner.");

            if (originCountryCode.IsSet && originCountryCode.Value == null)
                throw new ArgumentNullException(nameof(originCountryCode), "Property is not nullable for class MilitaryMailShipmentsCustomsCustomsItemsInner.");

            return new MilitaryMailShipmentsCustomsCustomsItemsInner(description.Value, quantity.Value.Value, unitPrice.Value.Value, weightUnit.Value.Value, weight.Value.Value, hSTariffCode, originCountryCode);
        }

        /// <summary>
        /// Serializes a <see cref="MilitaryMailShipmentsCustomsCustomsItemsInner" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="militaryMailShipmentsCustomsCustomsItemsInner"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, MilitaryMailShipmentsCustomsCustomsItemsInner militaryMailShipmentsCustomsCustomsItemsInner, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, militaryMailShipmentsCustomsCustomsItemsInner, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="MilitaryMailShipmentsCustomsCustomsItemsInner" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="militaryMailShipmentsCustomsCustomsItemsInner"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, MilitaryMailShipmentsCustomsCustomsItemsInner militaryMailShipmentsCustomsCustomsItemsInner, JsonSerializerOptions jsonSerializerOptions)
        {
            if (militaryMailShipmentsCustomsCustomsItemsInner.Description == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentsCustomsCustomsItemsInner.Description), "Property is required for class MilitaryMailShipmentsCustomsCustomsItemsInner.");

            if (militaryMailShipmentsCustomsCustomsItemsInner.HSTariffCodeOption.IsSet && militaryMailShipmentsCustomsCustomsItemsInner.HSTariffCode == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentsCustomsCustomsItemsInner.HSTariffCode), "Property is required for class MilitaryMailShipmentsCustomsCustomsItemsInner.");

            if (militaryMailShipmentsCustomsCustomsItemsInner.OriginCountryCodeOption.IsSet && militaryMailShipmentsCustomsCustomsItemsInner.OriginCountryCode == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentsCustomsCustomsItemsInner.OriginCountryCode), "Property is required for class MilitaryMailShipmentsCustomsCustomsItemsInner.");

            writer.WriteString("description", militaryMailShipmentsCustomsCustomsItemsInner.Description);

            writer.WriteNumber("quantity", militaryMailShipmentsCustomsCustomsItemsInner.Quantity);

            writer.WriteNumber("unitPrice", militaryMailShipmentsCustomsCustomsItemsInner.UnitPrice);

            var weightUnitRawValue = MilitaryMailShipmentsCustomsCustomsItemsInner.WeightUnitEnumToJsonValue(militaryMailShipmentsCustomsCustomsItemsInner.WeightUnit);
            writer.WriteString("weightUnit", weightUnitRawValue);
            writer.WriteNumber("weight", militaryMailShipmentsCustomsCustomsItemsInner.Weight);

            if (militaryMailShipmentsCustomsCustomsItemsInner.HSTariffCodeOption.IsSet)
            {
                writer.WritePropertyName("hSTariffCode");
                JsonSerializer.Serialize(writer, militaryMailShipmentsCustomsCustomsItemsInner.HSTariffCode, jsonSerializerOptions);
            }
            if (militaryMailShipmentsCustomsCustomsItemsInner.OriginCountryCodeOption.IsSet)
                writer.WriteString("originCountryCode", militaryMailShipmentsCustomsCustomsItemsInner.OriginCountryCode);
        }
    }
}
