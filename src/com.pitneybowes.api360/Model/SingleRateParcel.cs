...
namespace com.pitneybowes.api360.Model
{
    ...
    public partial class SingleRateParcel : IValidatableObject
    {
        ...
        [JsonConstructor]
        public SingleRateParcel(int length, int width, int height, DimUnitEnum dimUnit, WeightUnitEnum weightUnit, decimal weight)
        {
            Length = length;
            Width = width;
            Height = height;
    ...
    /// <summary>
    /// A Json converter for type <see cref="SingleRateParcel" />
    /// </summary>
    public class SingleRateParcelJsonConverter : JsonConverter<SingleRateParcel>
    {
        /// <summary>
        /// Deserializes json to <see cref="SingleRateParcel" />
        /// </summary>
        ...
        public override SingleRateParcel Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<SingleRateParcel.DimUnitEnum?> dimUnit = default;
            Option<SingleRateParcel.WeightUnitEnum?> weightUnit = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "dimUnit":
                            ...
                            if (dimUnitRawValue != null)
                                dimUnit = new Option<SingleRateParcel.DimUnitEnum?>(SingleRateParcel.DimUnitEnumFromStringOrDefault(dimUnitRawValue));
                            break;
                        case "weightUnit":
                            string? weightUnitRawValue = utf8JsonReader.GetString();
                            if (weightUnitRawValue != null)
                                weightUnit = new Option<SingleRateParcel.WeightUnitEnum?>(SingleRateParcel.WeightUnitEnumFromStringOrDefault(weightUnitRawValue));
                            break;
                        case "weight":
            ...
            if (!length.IsSet)
                throw new ArgumentException("Property is required for class SingleRateParcel.", nameof(length));

            if (!width.IsSet)
                throw new ArgumentException("Property is required for class SingleRateParcel.", nameof(width));

            if (!height.IsSet)
                throw new ArgumentException("Property is required for class SingleRateParcel.", nameof(height));

            if (!dimUnit.IsSet)
                throw new ArgumentException("Property is required for class SingleRateParcel.", nameof(dimUnit));

            if (!weightUnit.IsSet)
                throw new ArgumentException("Property is required for class SingleRateParcel.", nameof(weightUnit));

            if (!weight.IsSet)
                throw new ArgumentException("Property is required for class SingleRateParcel.", nameof(weight));

            if (length.IsSet && length.Value == null)
                throw new ArgumentNullException(nameof(length), "Property is not nullable for class SingleRateParcel.");

            if (width.IsSet && width.Value == null)
                throw new ArgumentNullException(nameof(width), "Property is not nullable for class SingleRateParcel.");

            if (height.IsSet && height.Value == null)
                throw new ArgumentNullException(nameof(height), "Property is not nullable for class SingleRateParcel.");

            if (dimUnit.IsSet && dimUnit.Value == null)
                throw new ArgumentNullException(nameof(dimUnit), "Property is not nullable for class SingleRateParcel.");

            if (weightUnit.IsSet && weightUnit.Value == null)
                throw new ArgumentNullException(nameof(weightUnit), "Property is not nullable for class SingleRateParcel.");

            if (weight.IsSet && weight.Value == null)
                throw new ArgumentNullException(nameof(weight), "Property is not nullable for class SingleRateParcel.");

            return new SingleRateParcel(length.Value!.Value!, width.Value!.Value!, height.Value!.Value!, dimUnit.Value!.Value!, weightUnit.Value!.Value!, weight.Value!.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="SingleRateParcel" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="singleRateParcel"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, SingleRateParcel singleRateParcel, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, singleRateParcel, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="SingleRateParcel" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="singleRateParcel"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, SingleRateParcel singleRateParcel, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteNumber("length", singleRateParcel.Length);

            writer.WriteNumber("width", singleRateParcel.Width);

            writer.WriteNumber("height", singleRateParcel.Height);

            var dimUnitRawValue = SingleRateParcel.DimUnitEnumToJsonValue(singleRateParcel.DimUnit);
            writer.WriteString("dimUnit", dimUnitRawValue);
            var weightUnitRawValue = SingleRateParcel.WeightUnitEnumToJsonValue(singleRateParcel.WeightUnit);
            writer.WriteString("weightUnit", weightUnitRawValue);
            writer.WriteNumber("weight", singleRateParcel.Weight);
        }
    }
}
