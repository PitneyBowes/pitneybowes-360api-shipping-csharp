...
namespace com.pitneybowes.api360.Model
{
    ...
    /// <summary>
    /// A Json converter for type <see cref="ShipmentInternationalCustomsCustomsInfo" />
    /// </summary>
    public class ShipmentInternationalCustomsCustomsInfoJsonConverter : JsonConverter<ShipmentInternationalCustomsCustomsInfo>
    {
        /// <summary>
        /// Deserializes json to <see cref="ShipmentInternationalCustomsCustomsInfo" />
        /// </summary>
        ...
        public override ShipmentInternationalCustomsCustomsInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<ShipmentInternationalCustomsCustomsInfo.ReasonForExportEnum?> reasonForExport = default;
            ...
            Option<ShipmentInternationalCustomsCustomsInfo.TermsOfSaleEnum?> termsOfSale = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "reasonForExport":
                            ...
                            if (reasonForExportRawValue != null)
                                reasonForExport = new Option<ShipmentInternationalCustomsCustomsInfo.ReasonForExportEnum?>(ShipmentInternationalCustomsCustomsInfo.ReasonForExportEnumFromStringOrDefault(reasonForExportRawValue));
                            break;
                        ...
                        case "termsOfSale":
                            ...
                            if (termsOfSaleRawValue != null)
                                termsOfSale = new Option<ShipmentInternationalCustomsCustomsInfo.TermsOfSaleEnum?>(ShipmentInternationalCustomsCustomsInfo.TermsOfSaleEnumFromStringOrDefault(termsOfSaleRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            if (!reasonForExport.IsSet)
                throw new ArgumentException("Property is required for class ShipmentInternationalCustomsCustomsInfo.", nameof(reasonForExport));

            if (!customsDeclaredValue.IsSet)
                throw new ArgumentException("Property is required for class ShipmentInternationalCustomsCustomsInfo.", nameof(customsDeclaredValue));

            if (!currencyCode.IsSet)
                throw new ArgumentException("Property is required for class ShipmentInternationalCustomsCustomsInfo.", nameof(currencyCode));

            if (reasonForExport.IsSet && reasonForExport.Value == null)
                throw new ArgumentNullException(nameof(reasonForExport), "Property is not nullable for class ShipmentInternationalCustomsCustomsInfo.");

            if (customsDeclaredValue.IsSet && customsDeclaredValue.Value == null)
                throw new ArgumentNullException(nameof(customsDeclaredValue), "Property is not nullable for class ShipmentInternationalCustomsCustomsInfo.");

            if (currencyCode.IsSet && currencyCode.Value == null)
                throw new ArgumentNullException(nameof(currencyCode), "Property is not nullable for class ShipmentInternationalCustomsCustomsInfo.");

            if (eELPFC.IsSet && eELPFC.Value == null)
                throw new ArgumentNullException(nameof(eELPFC), "Property is not nullable for class ShipmentInternationalCustomsCustomsInfo.");

            if (certificateNumber.IsSet && certificateNumber.Value == null)
                throw new ArgumentNullException(nameof(certificateNumber), "Property is not nullable for class ShipmentInternationalCustomsCustomsInfo.");

            if (comments.IsSet && comments.Value == null)
                throw new ArgumentNullException(nameof(comments), "Property is not nullable for class ShipmentInternationalCustomsCustomsInfo.");

            if (fromCustomsReference.IsSet && fromCustomsReference.Value == null)
                throw new ArgumentNullException(nameof(fromCustomsReference), "Property is not nullable for class ShipmentInternationalCustomsCustomsInfo.");

            if (importerCustomsReference.IsSet && importerCustomsReference.Value == null)
                throw new ArgumentNullException(nameof(importerCustomsReference), "Property is not nullable for class ShipmentInternationalCustomsCustomsInfo.");

            if (invoiceNumber.IsSet && invoiceNumber.Value == null)
                throw new ArgumentNullException(nameof(invoiceNumber), "Property is not nullable for class ShipmentInternationalCustomsCustomsInfo.");

            if (licenseNumber.IsSet && licenseNumber.Value == null)
                throw new ArgumentNullException(nameof(licenseNumber), "Property is not nullable for class ShipmentInternationalCustomsCustomsInfo.");

            if (sdrValue.IsSet && sdrValue.Value == null)
                throw new ArgumentNullException(nameof(sdrValue), "Property is not nullable for class ShipmentInternationalCustomsCustomsInfo.");

            if (termsOfSale.IsSet && termsOfSale.Value == null)
                throw new ArgumentNullException(nameof(termsOfSale), "Property is not nullable for class ShipmentInternationalCustomsCustomsInfo.");

            return new ShipmentInternationalCustomsCustomsInfo(reasonForExport.Value.Value, customsDeclaredValue.Value.Value, currencyCode.Value, eELPFC, certificateNumber, comments, fromCustomsReference, importerCustomsReference, invoiceNumber, licenseNumber, sdrValue, termsOfSale);
        }

        /// <summary>
        /// Serializes a <see cref="ShipmentInternationalCustomsCustomsInfo" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="shipmentInternationalCustomsCustomsInfo"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ShipmentInternationalCustomsCustomsInfo shipmentInternationalCustomsCustomsInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, shipmentInternationalCustomsCustomsInfo, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ShipmentInternationalCustomsCustomsInfo" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="shipmentInternationalCustomsCustomsInfo"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ShipmentInternationalCustomsCustomsInfo shipmentInternationalCustomsCustomsInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            if (shipmentInternationalCustomsCustomsInfo.CurrencyCode == null)
                throw new ArgumentNullException(nameof(shipmentInternationalCustomsCustomsInfo.CurrencyCode), "Property is required for class ShipmentInternationalCustomsCustomsInfo.");

            if (shipmentInternationalCustomsCustomsInfo.EELPFCOption.IsSet && shipmentInternationalCustomsCustomsInfo.EELPFC == null)
                throw new ArgumentNullException(nameof(shipmentInternationalCustomsCustomsInfo.EELPFC), "Property is required for class ShipmentInternationalCustomsCustomsInfo.");

            if (shipmentInternationalCustomsCustomsInfo.CertificateNumberOption.IsSet && shipmentInternationalCustomsCustomsInfo.CertificateNumber == null)
                throw new ArgumentNullException(nameof(shipmentInternationalCustomsCustomsInfo.CertificateNumber), "Property is required for class ShipmentInternationalCustomsCustomsInfo.");

            if (shipmentInternationalCustomsCustomsInfo.CommentsOption.IsSet && shipmentInternationalCustomsCustomsInfo.Comments == null)
                throw new ArgumentNullException(nameof(shipmentInternationalCustomsCustomsInfo.Comments), "Property is required for class ShipmentInternationalCustomsCustomsInfo.");

            if (shipmentInternationalCustomsCustomsInfo.FromCustomsReferenceOption.IsSet && shipmentInternationalCustomsCustomsInfo.FromCustomsReference == null)
                throw new ArgumentNullException(nameof(shipmentInternationalCustomsCustomsInfo.FromCustomsReference), "Property is required for class ShipmentInternationalCustomsCustomsInfo.");

            if (shipmentInternationalCustomsCustomsInfo.ImporterCustomsReferenceOption.IsSet && shipmentInternationalCustomsCustomsInfo.ImporterCustomsReference == null)
                throw new ArgumentNullException(nameof(shipmentInternationalCustomsCustomsInfo.ImporterCustomsReference), "Property is required for class ShipmentInternationalCustomsCustomsInfo.");

            if (shipmentInternationalCustomsCustomsInfo.InvoiceNumberOption.IsSet && shipmentInternationalCustomsCustomsInfo.InvoiceNumber == null)
                throw new ArgumentNullException(nameof(shipmentInternationalCustomsCustomsInfo.InvoiceNumber), "Property is required for class ShipmentInternationalCustomsCustomsInfo.");

            if (shipmentInternationalCustomsCustomsInfo.LicenseNumberOption.IsSet && shipmentInternationalCustomsCustomsInfo.LicenseNumber == null)
                throw new ArgumentNullException(nameof(shipmentInternationalCustomsCustomsInfo.LicenseNumber), "Property is required for class ShipmentInternationalCustomsCustomsInfo.");

            var reasonForExportRawValue = ShipmentInternationalCustomsCustomsInfo.ReasonForExportEnumToJsonValue(shipmentInternationalCustomsCustomsInfo.ReasonForExport);
            writer.WriteString("reasonForExport", reasonForExportRawValue);
            writer.WriteNumber("customsDeclaredValue", shipmentInternationalCustomsCustomsInfo.CustomsDeclaredValue);

            writer.WriteString("currencyCode", shipmentInternationalCustomsCustomsInfo.CurrencyCode);

            if (shipmentInternationalCustomsCustomsInfo.EELPFCOption.IsSet)
                writer.WriteString("EELPFC", shipmentInternationalCustomsCustomsInfo.EELPFC);

            if (shipmentInternationalCustomsCustomsInfo.CertificateNumberOption.IsSet)
                writer.WriteString("certificateNumber", shipmentInternationalCustomsCustomsInfo.CertificateNumber);

            if (shipmentInternationalCustomsCustomsInfo.CommentsOption.IsSet)
                writer.WriteString("comments", shipmentInternationalCustomsCustomsInfo.Comments);

            if (shipmentInternationalCustomsCustomsInfo.FromCustomsReferenceOption.IsSet)
                writer.WriteString("fromCustomsReference", shipmentInternationalCustomsCustomsInfo.FromCustomsReference);

            if (shipmentInternationalCustomsCustomsInfo.ImporterCustomsReferenceOption.IsSet)
                writer.WriteString("importerCustomsReference", shipmentInternationalCustomsCustomsInfo.ImporterCustomsReference);

            if (shipmentInternationalCustomsCustomsInfo.InvoiceNumberOption.IsSet)
                writer.WriteString("invoiceNumber", shipmentInternationalCustomsCustomsInfo.InvoiceNumber);

            if (shipmentInternationalCustomsCustomsInfo.LicenseNumberOption.IsSet)
                writer.WriteString("licenseNumber", shipmentInternationalCustomsCustomsInfo.LicenseNumber);

            if (shipmentInternationalCustomsCustomsInfo.SdrValueOption.IsSet)
                writer.WriteNumber("sdrValue", shipmentInternationalCustomsCustomsInfo.SdrValueOption.Value.Value);

            var termsOfSaleRawValue = ShipmentInternationalCustomsCustomsInfo.TermsOfSaleEnumToJsonValue(shipmentInternationalCustomsCustomsInfo.TermsOfSaleOption.Value.Value);
