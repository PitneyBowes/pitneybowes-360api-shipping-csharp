...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MultipieceDomesticShipmentRequest_fromAddress")]
    public partial class MultipieceDomesticShipmentRequestFromAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MultipieceDomesticShipmentRequestFromAddress" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MultipieceDomesticShipmentRequestFromAddress() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MultipieceDomesticShipmentRequestFromAddress" /> class.
        /// </summary>
        ...
        /// <param name="countryCode">This indicates the two-character ISO code of the source country from the ISO country list. (required).</param>
        /// <param name="name">Name of the sender to which this address points..</param>
        /// <param name="phone">This is sender&#39;s phone number. Enter the digits with or without spaces or hyphens. The maximum characters for Phone number is 10 digits. .</param>
        ...
        public MultipieceDomesticShipmentRequestFromAddress(string addressLine1 = default(string), string addressLine2 = default(string), string addressLine3 = default(string), string cityTown = default(string), string countryCode = default(string), string name = default(string), string phone = default(string), string postalCode = default(string), string stateProvince = default(string))
        {
            // to ensure "addressLine1" is required (not null)
            if (addressLine1 == null)
            {
                throw new ArgumentNullException("addressLine1 is a required property for MultipieceDomesticShipmentRequestFromAddress and cannot be null");
            }
            this.AddressLine1 = addressLine1;
            // to ensure "countryCode" is required (not null)
            if (countryCode == null)
            {
                throw new ArgumentNullException("countryCode is a required property for MultipieceDomesticShipmentRequestFromAddress and cannot be null");
            }
            this.CountryCode = countryCode;
            // to ensure "postalCode" is required (not null)
            if (postalCode == null)
            {
                throw new ArgumentNullException("postalCode is a required property for MultipieceDomesticShipmentRequestFromAddress and cannot be null");
            }
            this.PostalCode = postalCode;
            // to ensure "stateProvince" is required (not null)
            if (stateProvince == null)
            {
                throw new ArgumentNullException("stateProvince is a required property for MultipieceDomesticShipmentRequestFromAddress and cannot be null");
            }
        ...
        /// </summary>
        /// <value>This is sender&#39;s phone number. Enter the digits with or without spaces or hyphens. The maximum characters for Phone number is 10 digits. </value>
