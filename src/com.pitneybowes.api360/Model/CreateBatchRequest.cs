...
namespace com.pitneybowes.api360.Model
{
    ...
    /// CreateBatchRequest
    /// </summary>
    [DataContract(Name = "CreateBatchRequest")]
    public partial class CreateBatchRequest : IValidatableObject
    {
        ...
        protected CreateBatchRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateBatchRequest" /> class.
        /// </summary>
        /// <param name="name">Name of the Batch which consists of multiple shipments (shipments in bulk)..</param>
        ...
        /// <param name="serviceId">A unique identifier given to the carrier-specific service. This varies as per carrier selection. (required).</param>
        ...
        public CreateBatchRequest(string name = default(string), string groupName = default(string), SizeEnum size = default(SizeEnum), TypeEnum type = default(TypeEnum), FormatEnum? format = default(FormatEnum?), string carrierAccountId = default(string), string serviceId = default(string), string parcelType = default(string), List<SpecialServiceBatch> specialServices = default(List<SpecialServiceBatch>))
        {
            this.Size = size;
            this.Type = type;
            ...
            {
                throw new ArgumentNullException("carrierAccountId is a required property for CreateBatchRequest and cannot be null");
            }
            this.CarrierAccountId = carrierAccountId;
            // to ensure "serviceId" is required (not null)
            if (serviceId == null)
            {
                throw new ArgumentNullException("serviceId is a required property for CreateBatchRequest and cannot be null");
            }
            this.ServiceId = serviceId;
            // to ensure "parcelType" is required (not null)
            if (parcelType == null)
            {
                throw new ArgumentNullException("parcelType is a required property for CreateBatchRequest and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Name of the Batch which consists of multiple shipments (shipments in bulk).</value>
        ...
        /// </summary>
        /// <value>A unique identifier given to the carrier-specific service. This varies as per carrier selection.</value>
        ...
        public List<SpecialServiceBatch> SpecialServices { get; set; }
