...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    [DataContract(Name = "singleRate_fromAddress")]
    public partial class SingleRateFromAddress : IValidatableObject
    {
        ...
        protected SingleRateFromAddress() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SingleRateFromAddress" /> class.
        /// </summary>
        ...
        public SingleRateFromAddress(string addressLine1 = default(string), string addressLine2 = default(string), string addressLine3 = default(string), string cityTown = default(string), string company = default(string), string countryCode = default(string), string email = default(string), string name = default(string), string phone = default(string), string postalCode = default(string), string stateProvince = default(string), bool residential = default(bool))
        {
            // to ensure "addressLine1" is required (not null)
            if (addressLine1 == null)
            {
                throw new ArgumentNullException("addressLine1 is a required property for SingleRateFromAddress and cannot be null");
            }
            this.AddressLine1 = addressLine1;
            // to ensure "countryCode" is required (not null)
            if (countryCode == null)
            {
                throw new ArgumentNullException("countryCode is a required property for SingleRateFromAddress and cannot be null");
            }
            this.CountryCode = countryCode;
            // to ensure "postalCode" is required (not null)
            if (postalCode == null)
            {
                throw new ArgumentNullException("postalCode is a required property for SingleRateFromAddress and cannot be null");
            }
