...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    public partial class SingleRateFromAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SingleRateFromAddress" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public SingleRateFromAddress(string addressLine1, string countryCode, string postalCode, Option<string> addressLine2 = default, Option<string> addressLine3 = default, Option<string> cityTown = default, Option<string> company = default, Option<string> email = default, Option<string> name = default, Option<string> phone = default, Option<string> inductionPostalCode = default, Option<string> stateProvince = default, Option<bool?> residential = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="SingleRateFromAddress" />
    /// </summary>
    public class SingleRateFromAddressJsonConverter : JsonConverter<SingleRateFromAddress>
    {
        /// <summary>
        /// Deserializes json to <see cref="SingleRateFromAddress" />
        /// </summary>
        ...
        public override SingleRateFromAddress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!addressLine1.IsSet)
                throw new ArgumentException("Property is required for class SingleRateFromAddress.", nameof(addressLine1));

            if (!countryCode.IsSet)
                throw new ArgumentException("Property is required for class SingleRateFromAddress.", nameof(countryCode));

            if (!postalCode.IsSet)
                throw new ArgumentException("Property is required for class SingleRateFromAddress.", nameof(postalCode));

            if (addressLine1.IsSet && addressLine1.Value == null)
                throw new ArgumentNullException(nameof(addressLine1), "Property is not nullable for class SingleRateFromAddress.");

            if (countryCode.IsSet && countryCode.Value == null)
                throw new ArgumentNullException(nameof(countryCode), "Property is not nullable for class SingleRateFromAddress.");

            if (postalCode.IsSet && postalCode.Value == null)
                throw new ArgumentNullException(nameof(postalCode), "Property is not nullable for class SingleRateFromAddress.");

            if (addressLine2.IsSet && addressLine2.Value == null)
                throw new ArgumentNullException(nameof(addressLine2), "Property is not nullable for class SingleRateFromAddress.");

            if (addressLine3.IsSet && addressLine3.Value == null)
                throw new ArgumentNullException(nameof(addressLine3), "Property is not nullable for class SingleRateFromAddress.");

            if (cityTown.IsSet && cityTown.Value == null)
                throw new ArgumentNullException(nameof(cityTown), "Property is not nullable for class SingleRateFromAddress.");

            if (company.IsSet && company.Value == null)
                throw new ArgumentNullException(nameof(company), "Property is not nullable for class SingleRateFromAddress.");

            if (email.IsSet && email.Value == null)
                throw new ArgumentNullException(nameof(email), "Property is not nullable for class SingleRateFromAddress.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class SingleRateFromAddress.");

            if (phone.IsSet && phone.Value == null)
                throw new ArgumentNullException(nameof(phone), "Property is not nullable for class SingleRateFromAddress.");

            if (inductionPostalCode.IsSet && inductionPostalCode.Value == null)
                throw new ArgumentNullException(nameof(inductionPostalCode), "Property is not nullable for class SingleRateFromAddress.");

            if (stateProvince.IsSet && stateProvince.Value == null)
                throw new ArgumentNullException(nameof(stateProvince), "Property is not nullable for class SingleRateFromAddress.");

            if (residential.IsSet && residential.Value == null)
                throw new ArgumentNullException(nameof(residential), "Property is not nullable for class SingleRateFromAddress.");

            return new SingleRateFromAddress(addressLine1.Value, countryCode.Value, postalCode.Value, addressLine2, addressLine3, cityTown, company, email, name, phone, inductionPostalCode, stateProvince, residential);
        }

        /// <summary>
        /// Serializes a <see cref="SingleRateFromAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="singleRateFromAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, SingleRateFromAddress singleRateFromAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, singleRateFromAddress, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="SingleRateFromAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="singleRateFromAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, SingleRateFromAddress singleRateFromAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            if (singleRateFromAddress.AddressLine1 == null)
                throw new ArgumentNullException(nameof(singleRateFromAddress.AddressLine1), "Property is required for class SingleRateFromAddress.");

            if (singleRateFromAddress.CountryCode == null)
                throw new ArgumentNullException(nameof(singleRateFromAddress.CountryCode), "Property is required for class SingleRateFromAddress.");

            if (singleRateFromAddress.PostalCode == null)
                throw new ArgumentNullException(nameof(singleRateFromAddress.PostalCode), "Property is required for class SingleRateFromAddress.");

            if (singleRateFromAddress.AddressLine2Option.IsSet && singleRateFromAddress.AddressLine2 == null)
                throw new ArgumentNullException(nameof(singleRateFromAddress.AddressLine2), "Property is required for class SingleRateFromAddress.");

            if (singleRateFromAddress.AddressLine3Option.IsSet && singleRateFromAddress.AddressLine3 == null)
                throw new ArgumentNullException(nameof(singleRateFromAddress.AddressLine3), "Property is required for class SingleRateFromAddress.");

            if (singleRateFromAddress.CityTownOption.IsSet && singleRateFromAddress.CityTown == null)
                throw new ArgumentNullException(nameof(singleRateFromAddress.CityTown), "Property is required for class SingleRateFromAddress.");

            if (singleRateFromAddress.CompanyOption.IsSet && singleRateFromAddress.Company == null)
                throw new ArgumentNullException(nameof(singleRateFromAddress.Company), "Property is required for class SingleRateFromAddress.");

            if (singleRateFromAddress.EmailOption.IsSet && singleRateFromAddress.Email == null)
                throw new ArgumentNullException(nameof(singleRateFromAddress.Email), "Property is required for class SingleRateFromAddress.");

            if (singleRateFromAddress.NameOption.IsSet && singleRateFromAddress.Name == null)
                throw new ArgumentNullException(nameof(singleRateFromAddress.Name), "Property is required for class SingleRateFromAddress.");

            if (singleRateFromAddress.PhoneOption.IsSet && singleRateFromAddress.Phone == null)
                throw new ArgumentNullException(nameof(singleRateFromAddress.Phone), "Property is required for class SingleRateFromAddress.");

            if (singleRateFromAddress.InductionPostalCodeOption.IsSet && singleRateFromAddress.InductionPostalCode == null)
                throw new ArgumentNullException(nameof(singleRateFromAddress.InductionPostalCode), "Property is required for class SingleRateFromAddress.");

            if (singleRateFromAddress.StateProvinceOption.IsSet && singleRateFromAddress.StateProvince == null)
                throw new ArgumentNullException(nameof(singleRateFromAddress.StateProvince), "Property is required for class SingleRateFromAddress.");

            writer.WriteString("addressLine1", singleRateFromAddress.AddressLine1);

            writer.WriteString("countryCode", singleRateFromAddress.CountryCode);

            writer.WriteString("postalCode", singleRateFromAddress.PostalCode);

            if (singleRateFromAddress.AddressLine2Option.IsSet)
                writer.WriteString("addressLine2", singleRateFromAddress.AddressLine2);

            if (singleRateFromAddress.AddressLine3Option.IsSet)
                writer.WriteString("addressLine3", singleRateFromAddress.AddressLine3);

            if (singleRateFromAddress.CityTownOption.IsSet)
                writer.WriteString("cityTown", singleRateFromAddress.CityTown);

            if (singleRateFromAddress.CompanyOption.IsSet)
                writer.WriteString("company", singleRateFromAddress.Company);

            if (singleRateFromAddress.EmailOption.IsSet)
                writer.WriteString("email", singleRateFromAddress.Email);

            if (singleRateFromAddress.NameOption.IsSet)
                writer.WriteString("name", singleRateFromAddress.Name);

            if (singleRateFromAddress.PhoneOption.IsSet)
                writer.WriteString("phone", singleRateFromAddress.Phone);

            if (singleRateFromAddress.InductionPostalCodeOption.IsSet)
                writer.WriteString("inductionPostalCode", singleRateFromAddress.InductionPostalCode);

            if (singleRateFromAddress.StateProvinceOption.IsSet)
                writer.WriteString("stateProvince", singleRateFromAddress.StateProvince);

            if (singleRateFromAddress.ResidentialOption.IsSet)
                writer.WriteBoolean("residential", singleRateFromAddress.ResidentialOption.Value.Value);
        }
    }
}
