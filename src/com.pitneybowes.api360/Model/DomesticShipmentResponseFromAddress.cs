...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    [DataContract(Name = "domesticShipmentResponse_fromAddress")]
    public partial class DomesticShipmentResponseFromAddress : IValidatableObject
    {
        ...
        public DomesticShipmentResponseFromAddress(string addressLine1 = default(string), string addressLine2 = default(string), string addressLine3 = default(string), string cityTown = default(string), string company = default(string), string countryCode = default(string), string email = default(string), string name = default(string), string phone = default(string), string postalCode = default(string), bool residential = default(bool), string stateProvince = default(string), string inductionPostalCode = default(string))
        {
