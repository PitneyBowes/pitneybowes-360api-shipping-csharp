...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    public partial class DomesticShipmentResponseFromAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DomesticShipmentResponseFromAddress" /> class.
        /// </summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="DomesticShipmentResponseFromAddress" />
    /// </summary>
    public class DomesticShipmentResponseFromAddressJsonConverter : JsonConverter<DomesticShipmentResponseFromAddress>
    {
        /// <summary>
        /// Deserializes json to <see cref="DomesticShipmentResponseFromAddress" />
        /// </summary>
        ...
        public override DomesticShipmentResponseFromAddress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (addressLine1.IsSet && addressLine1.Value == null)
                throw new ArgumentNullException(nameof(addressLine1), "Property is not nullable for class DomesticShipmentResponseFromAddress.");

            if (addressLine2.IsSet && addressLine2.Value == null)
                throw new ArgumentNullException(nameof(addressLine2), "Property is not nullable for class DomesticShipmentResponseFromAddress.");

            if (addressLine3.IsSet && addressLine3.Value == null)
                throw new ArgumentNullException(nameof(addressLine3), "Property is not nullable for class DomesticShipmentResponseFromAddress.");

            if (cityTown.IsSet && cityTown.Value == null)
                throw new ArgumentNullException(nameof(cityTown), "Property is not nullable for class DomesticShipmentResponseFromAddress.");

            if (company.IsSet && company.Value == null)
                throw new ArgumentNullException(nameof(company), "Property is not nullable for class DomesticShipmentResponseFromAddress.");

            if (countryCode.IsSet && countryCode.Value == null)
                throw new ArgumentNullException(nameof(countryCode), "Property is not nullable for class DomesticShipmentResponseFromAddress.");

            if (email.IsSet && email.Value == null)
                throw new ArgumentNullException(nameof(email), "Property is not nullable for class DomesticShipmentResponseFromAddress.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class DomesticShipmentResponseFromAddress.");

            if (phone.IsSet && phone.Value == null)
                throw new ArgumentNullException(nameof(phone), "Property is not nullable for class DomesticShipmentResponseFromAddress.");

            if (postalCode.IsSet && postalCode.Value == null)
                throw new ArgumentNullException(nameof(postalCode), "Property is not nullable for class DomesticShipmentResponseFromAddress.");

            if (residential.IsSet && residential.Value == null)
                throw new ArgumentNullException(nameof(residential), "Property is not nullable for class DomesticShipmentResponseFromAddress.");

            if (stateProvince.IsSet && stateProvince.Value == null)
                throw new ArgumentNullException(nameof(stateProvince), "Property is not nullable for class DomesticShipmentResponseFromAddress.");

            if (inductionPostalCode.IsSet && inductionPostalCode.Value == null)
                throw new ArgumentNullException(nameof(inductionPostalCode), "Property is not nullable for class DomesticShipmentResponseFromAddress.");

            return new DomesticShipmentResponseFromAddress(addressLine1, addressLine2, addressLine3, cityTown, company, countryCode, email, name, phone, postalCode, residential, stateProvince, inductionPostalCode);
        }

        /// <summary>
        /// Serializes a <see cref="DomesticShipmentResponseFromAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="domesticShipmentResponseFromAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, DomesticShipmentResponseFromAddress domesticShipmentResponseFromAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, domesticShipmentResponseFromAddress, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="DomesticShipmentResponseFromAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="domesticShipmentResponseFromAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, DomesticShipmentResponseFromAddress domesticShipmentResponseFromAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            if (domesticShipmentResponseFromAddress.AddressLine1Option.IsSet && domesticShipmentResponseFromAddress.AddressLine1 == null)
                throw new ArgumentNullException(nameof(domesticShipmentResponseFromAddress.AddressLine1), "Property is required for class DomesticShipmentResponseFromAddress.");

            if (domesticShipmentResponseFromAddress.AddressLine2Option.IsSet && domesticShipmentResponseFromAddress.AddressLine2 == null)
                throw new ArgumentNullException(nameof(domesticShipmentResponseFromAddress.AddressLine2), "Property is required for class DomesticShipmentResponseFromAddress.");

            if (domesticShipmentResponseFromAddress.AddressLine3Option.IsSet && domesticShipmentResponseFromAddress.AddressLine3 == null)
                throw new ArgumentNullException(nameof(domesticShipmentResponseFromAddress.AddressLine3), "Property is required for class DomesticShipmentResponseFromAddress.");

            if (domesticShipmentResponseFromAddress.CityTownOption.IsSet && domesticShipmentResponseFromAddress.CityTown == null)
                throw new ArgumentNullException(nameof(domesticShipmentResponseFromAddress.CityTown), "Property is required for class DomesticShipmentResponseFromAddress.");

            if (domesticShipmentResponseFromAddress.CompanyOption.IsSet && domesticShipmentResponseFromAddress.Company == null)
                throw new ArgumentNullException(nameof(domesticShipmentResponseFromAddress.Company), "Property is required for class DomesticShipmentResponseFromAddress.");

            if (domesticShipmentResponseFromAddress.CountryCodeOption.IsSet && domesticShipmentResponseFromAddress.CountryCode == null)
                throw new ArgumentNullException(nameof(domesticShipmentResponseFromAddress.CountryCode), "Property is required for class DomesticShipmentResponseFromAddress.");

            if (domesticShipmentResponseFromAddress.EmailOption.IsSet && domesticShipmentResponseFromAddress.Email == null)
                throw new ArgumentNullException(nameof(domesticShipmentResponseFromAddress.Email), "Property is required for class DomesticShipmentResponseFromAddress.");

            if (domesticShipmentResponseFromAddress.NameOption.IsSet && domesticShipmentResponseFromAddress.Name == null)
                throw new ArgumentNullException(nameof(domesticShipmentResponseFromAddress.Name), "Property is required for class DomesticShipmentResponseFromAddress.");

            if (domesticShipmentResponseFromAddress.PhoneOption.IsSet && domesticShipmentResponseFromAddress.Phone == null)
                throw new ArgumentNullException(nameof(domesticShipmentResponseFromAddress.Phone), "Property is required for class DomesticShipmentResponseFromAddress.");

            if (domesticShipmentResponseFromAddress.PostalCodeOption.IsSet && domesticShipmentResponseFromAddress.PostalCode == null)
                throw new ArgumentNullException(nameof(domesticShipmentResponseFromAddress.PostalCode), "Property is required for class DomesticShipmentResponseFromAddress.");

            if (domesticShipmentResponseFromAddress.StateProvinceOption.IsSet && domesticShipmentResponseFromAddress.StateProvince == null)
                throw new ArgumentNullException(nameof(domesticShipmentResponseFromAddress.StateProvince), "Property is required for class DomesticShipmentResponseFromAddress.");

            if (domesticShipmentResponseFromAddress.InductionPostalCodeOption.IsSet && domesticShipmentResponseFromAddress.InductionPostalCode == null)
                throw new ArgumentNullException(nameof(domesticShipmentResponseFromAddress.InductionPostalCode), "Property is required for class DomesticShipmentResponseFromAddress.");

            if (domesticShipmentResponseFromAddress.AddressLine1Option.IsSet)
                writer.WriteString("addressLine1", domesticShipmentResponseFromAddress.AddressLine1);

            if (domesticShipmentResponseFromAddress.AddressLine2Option.IsSet)
                writer.WriteString("addressLine2", domesticShipmentResponseFromAddress.AddressLine2);

            if (domesticShipmentResponseFromAddress.AddressLine3Option.IsSet)
                writer.WriteString("addressLine3", domesticShipmentResponseFromAddress.AddressLine3);

            if (domesticShipmentResponseFromAddress.CityTownOption.IsSet)
                writer.WriteString("cityTown", domesticShipmentResponseFromAddress.CityTown);

            if (domesticShipmentResponseFromAddress.CompanyOption.IsSet)
                writer.WriteString("company", domesticShipmentResponseFromAddress.Company);

            if (domesticShipmentResponseFromAddress.CountryCodeOption.IsSet)
                writer.WriteString("countryCode", domesticShipmentResponseFromAddress.CountryCode);

            if (domesticShipmentResponseFromAddress.EmailOption.IsSet)
                writer.WriteString("email", domesticShipmentResponseFromAddress.Email);

            if (domesticShipmentResponseFromAddress.NameOption.IsSet)
                writer.WriteString("name", domesticShipmentResponseFromAddress.Name);

            if (domesticShipmentResponseFromAddress.PhoneOption.IsSet)
                writer.WriteString("phone", domesticShipmentResponseFromAddress.Phone);

            if (domesticShipmentResponseFromAddress.PostalCodeOption.IsSet)
                writer.WriteString("postalCode", domesticShipmentResponseFromAddress.PostalCode);

            if (domesticShipmentResponseFromAddress.ResidentialOption.IsSet)
                writer.WriteBoolean("residential", domesticShipmentResponseFromAddress.ResidentialOption.Value.Value);

            if (domesticShipmentResponseFromAddress.StateProvinceOption.IsSet)
                writer.WriteString("stateProvince", domesticShipmentResponseFromAddress.StateProvince);

            if (domesticShipmentResponseFromAddress.InductionPostalCodeOption.IsSet)
                writer.WriteString("inductionPostalCode", domesticShipmentResponseFromAddress.InductionPostalCode);
        }
    }
}
