...
namespace com.pitneybowes.api360.Model
{
    ...
    /// RateShopbyRategroup
    /// </summary>
    public partial class RateShopbyRategroup : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RateShopbyRategroup" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public RateShopbyRategroup(FromAddressV2 fromAddress, ToAddressV2 toAddress, RateShopbyCarrierParcel parcel, string parcelType, RateShopByEnum rateShopBy, ShipmentDomesticByRateGroupByRateGroup byRateGroup, Option<RateShopbyCarrierDeliveryOption> deliveryOption = default)
        {
        ...
        public ShipmentDomesticByRateGroupByRateGroup ByRateGroup { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RateShopbyRategroup {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="RateShopbyRategroup" />
    /// </summary>
    public class RateShopbyRategroupJsonConverter : JsonConverter<RateShopbyRategroup>
    {
        /// <summary>
        /// Deserializes json to <see cref="RateShopbyRategroup" />
        /// </summary>
        ...
        public override RateShopbyRategroup Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<RateShopbyRategroup.RateShopByEnum?> rateShopBy = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "rateShopBy":
                            ...
                            if (rateShopByRawValue != null)
                                rateShopBy = new Option<RateShopbyRategroup.RateShopByEnum?>(RateShopbyRategroup.RateShopByEnumFromStringOrDefault(rateShopByRawValue));
                            break;
                        case "byRateGroup":
            ...
            if (!fromAddress.IsSet)
                throw new ArgumentException("Property is required for class RateShopbyRategroup.", nameof(fromAddress));

            if (!toAddress.IsSet)
                throw new ArgumentException("Property is required for class RateShopbyRategroup.", nameof(toAddress));

            if (!parcel.IsSet)
                throw new ArgumentException("Property is required for class RateShopbyRategroup.", nameof(parcel));

            if (!parcelType.IsSet)
                throw new ArgumentException("Property is required for class RateShopbyRategroup.", nameof(parcelType));

            if (!rateShopBy.IsSet)
                throw new ArgumentException("Property is required for class RateShopbyRategroup.", nameof(rateShopBy));

            if (!byRateGroup.IsSet)
                throw new ArgumentException("Property is required for class RateShopbyRategroup.", nameof(byRateGroup));

            if (fromAddress.IsSet && fromAddress.Value == null)
                throw new ArgumentNullException(nameof(fromAddress), "Property is not nullable for class RateShopbyRategroup.");

            if (toAddress.IsSet && toAddress.Value == null)
                throw new ArgumentNullException(nameof(toAddress), "Property is not nullable for class RateShopbyRategroup.");

            if (parcel.IsSet && parcel.Value == null)
                throw new ArgumentNullException(nameof(parcel), "Property is not nullable for class RateShopbyRategroup.");

            if (parcelType.IsSet && parcelType.Value == null)
                throw new ArgumentNullException(nameof(parcelType), "Property is not nullable for class RateShopbyRategroup.");

            if (rateShopBy.IsSet && rateShopBy.Value == null)
                throw new ArgumentNullException(nameof(rateShopBy), "Property is not nullable for class RateShopbyRategroup.");

            if (byRateGroup.IsSet && byRateGroup.Value == null)
                throw new ArgumentNullException(nameof(byRateGroup), "Property is not nullable for class RateShopbyRategroup.");

            if (deliveryOption.IsSet && deliveryOption.Value == null)
                throw new ArgumentNullException(nameof(deliveryOption), "Property is not nullable for class RateShopbyRategroup.");

            return new RateShopbyRategroup(fromAddress.Value, toAddress.Value, parcel.Value, parcelType.Value, rateShopBy.Value.Value, byRateGroup.Value, deliveryOption);
        }

        /// <summary>
        /// Serializes a <see cref="RateShopbyRategroup" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="rateShopbyRategroup"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, RateShopbyRategroup rateShopbyRategroup, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, rateShopbyRategroup, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="RateShopbyRategroup" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="rateShopbyRategroup"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, RateShopbyRategroup rateShopbyRategroup, JsonSerializerOptions jsonSerializerOptions)
        {
            if (rateShopbyRategroup.FromAddress == null)
                throw new ArgumentNullException(nameof(rateShopbyRategroup.FromAddress), "Property is required for class RateShopbyRategroup.");

            if (rateShopbyRategroup.ToAddress == null)
                throw new ArgumentNullException(nameof(rateShopbyRategroup.ToAddress), "Property is required for class RateShopbyRategroup.");

            if (rateShopbyRategroup.Parcel == null)
                throw new ArgumentNullException(nameof(rateShopbyRategroup.Parcel), "Property is required for class RateShopbyRategroup.");

            if (rateShopbyRategroup.ParcelType == null)
                throw new ArgumentNullException(nameof(rateShopbyRategroup.ParcelType), "Property is required for class RateShopbyRategroup.");

            if (rateShopbyRategroup.ByRateGroup == null)
                throw new ArgumentNullException(nameof(rateShopbyRategroup.ByRateGroup), "Property is required for class RateShopbyRategroup.");

            if (rateShopbyRategroup.DeliveryOptionOption.IsSet && rateShopbyRategroup.DeliveryOption == null)
                throw new ArgumentNullException(nameof(rateShopbyRategroup.DeliveryOption), "Property is required for class RateShopbyRategroup.");

            writer.WritePropertyName("fromAddress");
            JsonSerializer.Serialize(writer, rateShopbyRategroup.FromAddress, jsonSerializerOptions);
            writer.WritePropertyName("toAddress");
            JsonSerializer.Serialize(writer, rateShopbyRategroup.ToAddress, jsonSerializerOptions);
            writer.WritePropertyName("parcel");
            JsonSerializer.Serialize(writer, rateShopbyRategroup.Parcel, jsonSerializerOptions);
            writer.WriteString("parcelType", rateShopbyRategroup.ParcelType);

            var rateShopByRawValue = RateShopbyRategroup.RateShopByEnumToJsonValue(rateShopbyRategroup.RateShopBy);
            writer.WriteString("rateShopBy", rateShopByRawValue);
            writer.WritePropertyName("byRateGroup");
            JsonSerializer.Serialize(writer, rateShopbyRategroup.ByRateGroup, jsonSerializerOptions);
            if (rateShopbyRategroup.DeliveryOptionOption.IsSet)
            {
                writer.WritePropertyName("deliveryOption");
                JsonSerializer.Serialize(writer, rateShopbyRategroup.DeliveryOption, jsonSerializerOptions);
            }
        }
    }
}
