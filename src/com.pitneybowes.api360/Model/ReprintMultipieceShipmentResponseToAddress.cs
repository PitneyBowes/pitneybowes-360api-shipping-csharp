...
{
    /// <summary>
    /// ReprintMultipieceShipmentResponseToAddress
    /// </summary>
    public partial class ReprintMultipieceShipmentResponseToAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReprintMultipieceShipmentResponseToAddress" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public ReprintMultipieceShipmentResponseToAddress(string addressLine1, string countryCode, string postalCode, string stateProvince, Option<string> addressLine2 = default, Option<string> addressLine3 = default, Option<string> cityTown = default, Option<string> name = default, Option<string> phone = default, Option<string> company = default, Option<string> email = default, Option<bool?> residential = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReprintMultipieceShipmentResponseToAddress {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="ReprintMultipieceShipmentResponseToAddress" />
    /// </summary>
    public class ReprintMultipieceShipmentResponseToAddressJsonConverter : JsonConverter<ReprintMultipieceShipmentResponseToAddress>
    {
        /// <summary>
        /// Deserializes json to <see cref="ReprintMultipieceShipmentResponseToAddress" />
        /// </summary>
        ...
        public override ReprintMultipieceShipmentResponseToAddress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!addressLine1.IsSet)
                throw new ArgumentException("Property is required for class ReprintMultipieceShipmentResponseToAddress.", nameof(addressLine1));

            if (!countryCode.IsSet)
                throw new ArgumentException("Property is required for class ReprintMultipieceShipmentResponseToAddress.", nameof(countryCode));

            if (!postalCode.IsSet)
                throw new ArgumentException("Property is required for class ReprintMultipieceShipmentResponseToAddress.", nameof(postalCode));

            if (!stateProvince.IsSet)
                throw new ArgumentException("Property is required for class ReprintMultipieceShipmentResponseToAddress.", nameof(stateProvince));

            if (addressLine1.IsSet && addressLine1.Value == null)
                throw new ArgumentNullException(nameof(addressLine1), "Property is not nullable for class ReprintMultipieceShipmentResponseToAddress.");

            if (countryCode.IsSet && countryCode.Value == null)
                throw new ArgumentNullException(nameof(countryCode), "Property is not nullable for class ReprintMultipieceShipmentResponseToAddress.");

            if (postalCode.IsSet && postalCode.Value == null)
                throw new ArgumentNullException(nameof(postalCode), "Property is not nullable for class ReprintMultipieceShipmentResponseToAddress.");

            if (stateProvince.IsSet && stateProvince.Value == null)
                throw new ArgumentNullException(nameof(stateProvince), "Property is not nullable for class ReprintMultipieceShipmentResponseToAddress.");

            if (addressLine2.IsSet && addressLine2.Value == null)
                throw new ArgumentNullException(nameof(addressLine2), "Property is not nullable for class ReprintMultipieceShipmentResponseToAddress.");

            if (addressLine3.IsSet && addressLine3.Value == null)
                throw new ArgumentNullException(nameof(addressLine3), "Property is not nullable for class ReprintMultipieceShipmentResponseToAddress.");

            if (cityTown.IsSet && cityTown.Value == null)
                throw new ArgumentNullException(nameof(cityTown), "Property is not nullable for class ReprintMultipieceShipmentResponseToAddress.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class ReprintMultipieceShipmentResponseToAddress.");

            if (phone.IsSet && phone.Value == null)
                throw new ArgumentNullException(nameof(phone), "Property is not nullable for class ReprintMultipieceShipmentResponseToAddress.");

            if (company.IsSet && company.Value == null)
                throw new ArgumentNullException(nameof(company), "Property is not nullable for class ReprintMultipieceShipmentResponseToAddress.");

            if (email.IsSet && email.Value == null)
                throw new ArgumentNullException(nameof(email), "Property is not nullable for class ReprintMultipieceShipmentResponseToAddress.");

            if (residential.IsSet && residential.Value == null)
                throw new ArgumentNullException(nameof(residential), "Property is not nullable for class ReprintMultipieceShipmentResponseToAddress.");

            return new ReprintMultipieceShipmentResponseToAddress(addressLine1.Value, countryCode.Value, postalCode.Value, stateProvince.Value, addressLine2, addressLine3, cityTown, name, phone, company, email, residential);
        }

        /// <summary>
        /// Serializes a <see cref="ReprintMultipieceShipmentResponseToAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="reprintMultipieceShipmentResponseToAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ReprintMultipieceShipmentResponseToAddress reprintMultipieceShipmentResponseToAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, reprintMultipieceShipmentResponseToAddress, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ReprintMultipieceShipmentResponseToAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="reprintMultipieceShipmentResponseToAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ReprintMultipieceShipmentResponseToAddress reprintMultipieceShipmentResponseToAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            if (reprintMultipieceShipmentResponseToAddress.AddressLine1 == null)
                throw new ArgumentNullException(nameof(reprintMultipieceShipmentResponseToAddress.AddressLine1), "Property is required for class ReprintMultipieceShipmentResponseToAddress.");

            if (reprintMultipieceShipmentResponseToAddress.CountryCode == null)
                throw new ArgumentNullException(nameof(reprintMultipieceShipmentResponseToAddress.CountryCode), "Property is required for class ReprintMultipieceShipmentResponseToAddress.");

            if (reprintMultipieceShipmentResponseToAddress.PostalCode == null)
                throw new ArgumentNullException(nameof(reprintMultipieceShipmentResponseToAddress.PostalCode), "Property is required for class ReprintMultipieceShipmentResponseToAddress.");

            if (reprintMultipieceShipmentResponseToAddress.StateProvince == null)
                throw new ArgumentNullException(nameof(reprintMultipieceShipmentResponseToAddress.StateProvince), "Property is required for class ReprintMultipieceShipmentResponseToAddress.");

            if (reprintMultipieceShipmentResponseToAddress.AddressLine2Option.IsSet && reprintMultipieceShipmentResponseToAddress.AddressLine2 == null)
                throw new ArgumentNullException(nameof(reprintMultipieceShipmentResponseToAddress.AddressLine2), "Property is required for class ReprintMultipieceShipmentResponseToAddress.");

            if (reprintMultipieceShipmentResponseToAddress.AddressLine3Option.IsSet && reprintMultipieceShipmentResponseToAddress.AddressLine3 == null)
                throw new ArgumentNullException(nameof(reprintMultipieceShipmentResponseToAddress.AddressLine3), "Property is required for class ReprintMultipieceShipmentResponseToAddress.");

            if (reprintMultipieceShipmentResponseToAddress.CityTownOption.IsSet && reprintMultipieceShipmentResponseToAddress.CityTown == null)
                throw new ArgumentNullException(nameof(reprintMultipieceShipmentResponseToAddress.CityTown), "Property is required for class ReprintMultipieceShipmentResponseToAddress.");

            if (reprintMultipieceShipmentResponseToAddress.NameOption.IsSet && reprintMultipieceShipmentResponseToAddress.Name == null)
                throw new ArgumentNullException(nameof(reprintMultipieceShipmentResponseToAddress.Name), "Property is required for class ReprintMultipieceShipmentResponseToAddress.");

            if (reprintMultipieceShipmentResponseToAddress.PhoneOption.IsSet && reprintMultipieceShipmentResponseToAddress.Phone == null)
                throw new ArgumentNullException(nameof(reprintMultipieceShipmentResponseToAddress.Phone), "Property is required for class ReprintMultipieceShipmentResponseToAddress.");

            if (reprintMultipieceShipmentResponseToAddress.CompanyOption.IsSet && reprintMultipieceShipmentResponseToAddress.Company == null)
                throw new ArgumentNullException(nameof(reprintMultipieceShipmentResponseToAddress.Company), "Property is required for class ReprintMultipieceShipmentResponseToAddress.");

            if (reprintMultipieceShipmentResponseToAddress.EmailOption.IsSet && reprintMultipieceShipmentResponseToAddress.Email == null)
                throw new ArgumentNullException(nameof(reprintMultipieceShipmentResponseToAddress.Email), "Property is required for class ReprintMultipieceShipmentResponseToAddress.");

            writer.WriteString("addressLine1", reprintMultipieceShipmentResponseToAddress.AddressLine1);

            writer.WriteString("countryCode", reprintMultipieceShipmentResponseToAddress.CountryCode);

            writer.WriteString("postalCode", reprintMultipieceShipmentResponseToAddress.PostalCode);

            writer.WriteString("stateProvince", reprintMultipieceShipmentResponseToAddress.StateProvince);

            if (reprintMultipieceShipmentResponseToAddress.AddressLine2Option.IsSet)
                writer.WriteString("addressLine2", reprintMultipieceShipmentResponseToAddress.AddressLine2);

            if (reprintMultipieceShipmentResponseToAddress.AddressLine3Option.IsSet)
                writer.WriteString("addressLine3", reprintMultipieceShipmentResponseToAddress.AddressLine3);

            if (reprintMultipieceShipmentResponseToAddress.CityTownOption.IsSet)
                writer.WriteString("cityTown", reprintMultipieceShipmentResponseToAddress.CityTown);

            if (reprintMultipieceShipmentResponseToAddress.NameOption.IsSet)
                writer.WriteString("name", reprintMultipieceShipmentResponseToAddress.Name);

            if (reprintMultipieceShipmentResponseToAddress.PhoneOption.IsSet)
                writer.WriteString("phone", reprintMultipieceShipmentResponseToAddress.Phone);

            if (reprintMultipieceShipmentResponseToAddress.CompanyOption.IsSet)
                writer.WriteString("company", reprintMultipieceShipmentResponseToAddress.Company);

            if (reprintMultipieceShipmentResponseToAddress.EmailOption.IsSet)
                writer.WriteString("email", reprintMultipieceShipmentResponseToAddress.Email);

            if (reprintMultipieceShipmentResponseToAddress.ResidentialOption.IsSet)
                writer.WriteBoolean("residential", reprintMultipieceShipmentResponseToAddress.ResidentialOption.Value.Value);
        }
    }
}
