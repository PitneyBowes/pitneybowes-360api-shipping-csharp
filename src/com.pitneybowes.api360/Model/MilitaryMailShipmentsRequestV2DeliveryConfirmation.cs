...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    public partial class MilitaryMailShipmentsRequestV2DeliveryConfirmation : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MilitaryMailShipmentsRequestV2DeliveryConfirmation" /> class.
        /// </summary>
        /// <param name="type">The delivery confirmation Type.</param>
        [JsonConstructor]
        public MilitaryMailShipmentsRequestV2DeliveryConfirmation(Option<TypeEnum?> type = default)
        {
            TypeOption = type;
            OnCreated();
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MilitaryMailShipmentsRequestV2DeliveryConfirmation {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="MilitaryMailShipmentsRequestV2DeliveryConfirmation" />
    /// </summary>
    public class MilitaryMailShipmentsRequestV2DeliveryConfirmationJsonConverter : JsonConverter<MilitaryMailShipmentsRequestV2DeliveryConfirmation>
    {
        /// <summary>
        /// Deserializes json to <see cref="MilitaryMailShipmentsRequestV2DeliveryConfirmation" />
        /// </summary>
        ...
        public override MilitaryMailShipmentsRequestV2DeliveryConfirmation Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<MilitaryMailShipmentsRequestV2DeliveryConfirmation.TypeEnum?> type = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "type":
                            ...
                            if (typeRawValue != null)
                                type = new Option<MilitaryMailShipmentsRequestV2DeliveryConfirmation.TypeEnum?>(MilitaryMailShipmentsRequestV2DeliveryConfirmation.TypeEnumFromStringOrDefault(typeRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class MilitaryMailShipmentsRequestV2DeliveryConfirmation.");

            return new MilitaryMailShipmentsRequestV2DeliveryConfirmation(type);
        }

        /// <summary>
        /// Serializes a <see cref="MilitaryMailShipmentsRequestV2DeliveryConfirmation" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="militaryMailShipmentsRequestV2DeliveryConfirmation"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, MilitaryMailShipmentsRequestV2DeliveryConfirmation militaryMailShipmentsRequestV2DeliveryConfirmation, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, militaryMailShipmentsRequestV2DeliveryConfirmation, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="MilitaryMailShipmentsRequestV2DeliveryConfirmation" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="militaryMailShipmentsRequestV2DeliveryConfirmation"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, MilitaryMailShipmentsRequestV2DeliveryConfirmation militaryMailShipmentsRequestV2DeliveryConfirmation, JsonSerializerOptions jsonSerializerOptions)
        {
            var typeRawValue = MilitaryMailShipmentsRequestV2DeliveryConfirmation.TypeEnumToJsonValue(militaryMailShipmentsRequestV2DeliveryConfirmation.TypeOption.Value!.Value);
