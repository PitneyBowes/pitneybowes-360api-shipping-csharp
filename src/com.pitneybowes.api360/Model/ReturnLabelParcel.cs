...
namespace com.pitneybowes.api360.Model
{
    ...
    /// ReturnLabelParcel
    /// </summary>
    public partial class ReturnLabelParcel : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReturnLabelParcel" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public ReturnLabelParcel(int length, int width, int height, DimUnitEnum dimUnit, WeightUnitEnum weightUnit, decimal weight)
        {
            Length = length;
            Width = width;
            Height = height;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReturnLabelParcel {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="ReturnLabelParcel" />
    /// </summary>
    public class ReturnLabelParcelJsonConverter : JsonConverter<ReturnLabelParcel>
    {
        /// <summary>
        /// Deserializes json to <see cref="ReturnLabelParcel" />
        /// </summary>
        ...
        public override ReturnLabelParcel Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<ReturnLabelParcel.DimUnitEnum?> dimUnit = default;
            Option<ReturnLabelParcel.WeightUnitEnum?> weightUnit = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "dimUnit":
                            ...
                            if (dimUnitRawValue != null)
                                dimUnit = new Option<ReturnLabelParcel.DimUnitEnum?>(ReturnLabelParcel.DimUnitEnumFromStringOrDefault(dimUnitRawValue));
                            break;
                        case "weightUnit":
                            string? weightUnitRawValue = utf8JsonReader.GetString();
                            if (weightUnitRawValue != null)
                                weightUnit = new Option<ReturnLabelParcel.WeightUnitEnum?>(ReturnLabelParcel.WeightUnitEnumFromStringOrDefault(weightUnitRawValue));
                            break;
                        case "weight":
            ...
            if (!length.IsSet)
                throw new ArgumentException("Property is required for class ReturnLabelParcel.", nameof(length));

            if (!width.IsSet)
                throw new ArgumentException("Property is required for class ReturnLabelParcel.", nameof(width));

            if (!height.IsSet)
                throw new ArgumentException("Property is required for class ReturnLabelParcel.", nameof(height));

            if (!dimUnit.IsSet)
                throw new ArgumentException("Property is required for class ReturnLabelParcel.", nameof(dimUnit));

            if (!weightUnit.IsSet)
                throw new ArgumentException("Property is required for class ReturnLabelParcel.", nameof(weightUnit));

            if (!weight.IsSet)
                throw new ArgumentException("Property is required for class ReturnLabelParcel.", nameof(weight));

            if (length.IsSet && length.Value == null)
                throw new ArgumentNullException(nameof(length), "Property is not nullable for class ReturnLabelParcel.");

            if (width.IsSet && width.Value == null)
                throw new ArgumentNullException(nameof(width), "Property is not nullable for class ReturnLabelParcel.");

            if (height.IsSet && height.Value == null)
                throw new ArgumentNullException(nameof(height), "Property is not nullable for class ReturnLabelParcel.");

            if (dimUnit.IsSet && dimUnit.Value == null)
                throw new ArgumentNullException(nameof(dimUnit), "Property is not nullable for class ReturnLabelParcel.");

            if (weightUnit.IsSet && weightUnit.Value == null)
                throw new ArgumentNullException(nameof(weightUnit), "Property is not nullable for class ReturnLabelParcel.");

            if (weight.IsSet && weight.Value == null)
                throw new ArgumentNullException(nameof(weight), "Property is not nullable for class ReturnLabelParcel.");

            return new ReturnLabelParcel(length.Value!.Value!, width.Value!.Value!, height.Value!.Value!, dimUnit.Value!.Value!, weightUnit.Value!.Value!, weight.Value!.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="ReturnLabelParcel" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="returnLabelParcel"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ReturnLabelParcel returnLabelParcel, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, returnLabelParcel, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ReturnLabelParcel" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="returnLabelParcel"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ReturnLabelParcel returnLabelParcel, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteNumber("length", returnLabelParcel.Length);

            writer.WriteNumber("width", returnLabelParcel.Width);

            writer.WriteNumber("height", returnLabelParcel.Height);

            var dimUnitRawValue = ReturnLabelParcel.DimUnitEnumToJsonValue(returnLabelParcel.DimUnit);
            writer.WriteString("dimUnit", dimUnitRawValue);
            var weightUnitRawValue = ReturnLabelParcel.WeightUnitEnumToJsonValue(returnLabelParcel.WeightUnit);
            writer.WriteString("weightUnit", weightUnitRawValue);
            writer.WriteNumber("weight", returnLabelParcel.Weight);
        }
    }
}
