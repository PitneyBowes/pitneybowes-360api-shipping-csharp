...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    public partial class GetAllShipmentsDataInnerFromAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAllShipmentsDataInnerFromAddress" /> class.
        /// </summary>
        ...
        /* <example>rec1@yopmail.com</example> */
    ...
    /// <summary>
    /// A Json converter for type <see cref="GetAllShipmentsDataInnerFromAddress" />
    /// </summary>
    public class GetAllShipmentsDataInnerFromAddressJsonConverter : JsonConverter<GetAllShipmentsDataInnerFromAddress>
    {
        /// <summary>
        /// Deserializes json to <see cref="GetAllShipmentsDataInnerFromAddress" />
        /// </summary>
        ...
        public override GetAllShipmentsDataInnerFromAddress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (addressLine1.IsSet && addressLine1.Value == null)
                throw new ArgumentNullException(nameof(addressLine1), "Property is not nullable for class GetAllShipmentsDataInnerFromAddress.");

            if (addressLine2.IsSet && addressLine2.Value == null)
                throw new ArgumentNullException(nameof(addressLine2), "Property is not nullable for class GetAllShipmentsDataInnerFromAddress.");

            if (addressLine3.IsSet && addressLine3.Value == null)
                throw new ArgumentNullException(nameof(addressLine3), "Property is not nullable for class GetAllShipmentsDataInnerFromAddress.");

            if (cityTown.IsSet && cityTown.Value == null)
                throw new ArgumentNullException(nameof(cityTown), "Property is not nullable for class GetAllShipmentsDataInnerFromAddress.");

            if (company.IsSet && company.Value == null)
                throw new ArgumentNullException(nameof(company), "Property is not nullable for class GetAllShipmentsDataInnerFromAddress.");

            if (countryCode.IsSet && countryCode.Value == null)
                throw new ArgumentNullException(nameof(countryCode), "Property is not nullable for class GetAllShipmentsDataInnerFromAddress.");

            if (email.IsSet && email.Value == null)
                throw new ArgumentNullException(nameof(email), "Property is not nullable for class GetAllShipmentsDataInnerFromAddress.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class GetAllShipmentsDataInnerFromAddress.");

            if (phone.IsSet && phone.Value == null)
                throw new ArgumentNullException(nameof(phone), "Property is not nullable for class GetAllShipmentsDataInnerFromAddress.");

            if (postalCode.IsSet && postalCode.Value == null)
                throw new ArgumentNullException(nameof(postalCode), "Property is not nullable for class GetAllShipmentsDataInnerFromAddress.");

            if (residential.IsSet && residential.Value == null)
                throw new ArgumentNullException(nameof(residential), "Property is not nullable for class GetAllShipmentsDataInnerFromAddress.");

            if (stateProvince.IsSet && stateProvince.Value == null)
                throw new ArgumentNullException(nameof(stateProvince), "Property is not nullable for class GetAllShipmentsDataInnerFromAddress.");

            return new GetAllShipmentsDataInnerFromAddress(addressLine1, addressLine2, addressLine3, cityTown, company, countryCode, email, name, phone, postalCode, residential, stateProvince);
        }

        /// <summary>
        /// Serializes a <see cref="GetAllShipmentsDataInnerFromAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getAllShipmentsDataInnerFromAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GetAllShipmentsDataInnerFromAddress getAllShipmentsDataInnerFromAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, getAllShipmentsDataInnerFromAddress, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GetAllShipmentsDataInnerFromAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getAllShipmentsDataInnerFromAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, GetAllShipmentsDataInnerFromAddress getAllShipmentsDataInnerFromAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            if (getAllShipmentsDataInnerFromAddress.AddressLine1Option.IsSet && getAllShipmentsDataInnerFromAddress.AddressLine1 == null)
                throw new ArgumentNullException(nameof(getAllShipmentsDataInnerFromAddress.AddressLine1), "Property is required for class GetAllShipmentsDataInnerFromAddress.");

            if (getAllShipmentsDataInnerFromAddress.AddressLine2Option.IsSet && getAllShipmentsDataInnerFromAddress.AddressLine2 == null)
                throw new ArgumentNullException(nameof(getAllShipmentsDataInnerFromAddress.AddressLine2), "Property is required for class GetAllShipmentsDataInnerFromAddress.");

            if (getAllShipmentsDataInnerFromAddress.AddressLine3Option.IsSet && getAllShipmentsDataInnerFromAddress.AddressLine3 == null)
                throw new ArgumentNullException(nameof(getAllShipmentsDataInnerFromAddress.AddressLine3), "Property is required for class GetAllShipmentsDataInnerFromAddress.");

            if (getAllShipmentsDataInnerFromAddress.CityTownOption.IsSet && getAllShipmentsDataInnerFromAddress.CityTown == null)
                throw new ArgumentNullException(nameof(getAllShipmentsDataInnerFromAddress.CityTown), "Property is required for class GetAllShipmentsDataInnerFromAddress.");

            if (getAllShipmentsDataInnerFromAddress.CompanyOption.IsSet && getAllShipmentsDataInnerFromAddress.Company == null)
                throw new ArgumentNullException(nameof(getAllShipmentsDataInnerFromAddress.Company), "Property is required for class GetAllShipmentsDataInnerFromAddress.");

            if (getAllShipmentsDataInnerFromAddress.CountryCodeOption.IsSet && getAllShipmentsDataInnerFromAddress.CountryCode == null)
                throw new ArgumentNullException(nameof(getAllShipmentsDataInnerFromAddress.CountryCode), "Property is required for class GetAllShipmentsDataInnerFromAddress.");

            if (getAllShipmentsDataInnerFromAddress.EmailOption.IsSet && getAllShipmentsDataInnerFromAddress.Email == null)
                throw new ArgumentNullException(nameof(getAllShipmentsDataInnerFromAddress.Email), "Property is required for class GetAllShipmentsDataInnerFromAddress.");

            if (getAllShipmentsDataInnerFromAddress.NameOption.IsSet && getAllShipmentsDataInnerFromAddress.Name == null)
                throw new ArgumentNullException(nameof(getAllShipmentsDataInnerFromAddress.Name), "Property is required for class GetAllShipmentsDataInnerFromAddress.");

            if (getAllShipmentsDataInnerFromAddress.PhoneOption.IsSet && getAllShipmentsDataInnerFromAddress.Phone == null)
                throw new ArgumentNullException(nameof(getAllShipmentsDataInnerFromAddress.Phone), "Property is required for class GetAllShipmentsDataInnerFromAddress.");

            if (getAllShipmentsDataInnerFromAddress.PostalCodeOption.IsSet && getAllShipmentsDataInnerFromAddress.PostalCode == null)
                throw new ArgumentNullException(nameof(getAllShipmentsDataInnerFromAddress.PostalCode), "Property is required for class GetAllShipmentsDataInnerFromAddress.");

            if (getAllShipmentsDataInnerFromAddress.StateProvinceOption.IsSet && getAllShipmentsDataInnerFromAddress.StateProvince == null)
                throw new ArgumentNullException(nameof(getAllShipmentsDataInnerFromAddress.StateProvince), "Property is required for class GetAllShipmentsDataInnerFromAddress.");

            if (getAllShipmentsDataInnerFromAddress.AddressLine1Option.IsSet)
                writer.WriteString("addressLine1", getAllShipmentsDataInnerFromAddress.AddressLine1);

            if (getAllShipmentsDataInnerFromAddress.AddressLine2Option.IsSet)
                writer.WriteString("addressLine2", getAllShipmentsDataInnerFromAddress.AddressLine2);

            if (getAllShipmentsDataInnerFromAddress.AddressLine3Option.IsSet)
                writer.WriteString("addressLine3", getAllShipmentsDataInnerFromAddress.AddressLine3);

            if (getAllShipmentsDataInnerFromAddress.CityTownOption.IsSet)
                writer.WriteString("cityTown", getAllShipmentsDataInnerFromAddress.CityTown);

            if (getAllShipmentsDataInnerFromAddress.CompanyOption.IsSet)
                writer.WriteString("company", getAllShipmentsDataInnerFromAddress.Company);

            if (getAllShipmentsDataInnerFromAddress.CountryCodeOption.IsSet)
                writer.WriteString("countryCode", getAllShipmentsDataInnerFromAddress.CountryCode);

            if (getAllShipmentsDataInnerFromAddress.EmailOption.IsSet)
                writer.WriteString("email", getAllShipmentsDataInnerFromAddress.Email);

            if (getAllShipmentsDataInnerFromAddress.NameOption.IsSet)
                writer.WriteString("name", getAllShipmentsDataInnerFromAddress.Name);

            if (getAllShipmentsDataInnerFromAddress.PhoneOption.IsSet)
                writer.WriteString("phone", getAllShipmentsDataInnerFromAddress.Phone);

            if (getAllShipmentsDataInnerFromAddress.PostalCodeOption.IsSet)
                writer.WriteString("postalCode", getAllShipmentsDataInnerFromAddress.PostalCode);

            if (getAllShipmentsDataInnerFromAddress.ResidentialOption.IsSet)
                writer.WriteBoolean("residential", getAllShipmentsDataInnerFromAddress.ResidentialOption.Value!.Value);

            if (getAllShipmentsDataInnerFromAddress.StateProvinceOption.IsSet)
                writer.WriteString("stateProvince", getAllShipmentsDataInnerFromAddress.StateProvince);
        }
    }
}
