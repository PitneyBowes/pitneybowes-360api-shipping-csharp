...
{
    /// <summary>
    /// SchedulePickupUSPSRequestPickupOptions
    /// </summary>
    public partial class SchedulePickupUSPSRequestPickupOptions : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SchedulePickupUSPSRequestPickupOptions" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public SchedulePickupUSPSRequestPickupOptions(Option<DateTime?> pickupStartDateTime = default, Option<DateTime?> pickupEndDateTime = default, Option<int?> overweight = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SchedulePickupUSPSRequestPickupOptions {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="SchedulePickupUSPSRequestPickupOptions" />
    /// </summary>
    public class SchedulePickupUSPSRequestPickupOptionsJsonConverter : JsonConverter<SchedulePickupUSPSRequestPickupOptions>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="SchedulePickupUSPSRequestPickupOptions" />
        /// </summary>
        ...
        public override SchedulePickupUSPSRequestPickupOptions Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (pickupStartDateTime.IsSet && pickupStartDateTime.Value == null)
                throw new ArgumentNullException(nameof(pickupStartDateTime), "Property is not nullable for class SchedulePickupUSPSRequestPickupOptions.");

            if (pickupEndDateTime.IsSet && pickupEndDateTime.Value == null)
                throw new ArgumentNullException(nameof(pickupEndDateTime), "Property is not nullable for class SchedulePickupUSPSRequestPickupOptions.");

            if (overweight.IsSet && overweight.Value == null)
                throw new ArgumentNullException(nameof(overweight), "Property is not nullable for class SchedulePickupUSPSRequestPickupOptions.");

            return new SchedulePickupUSPSRequestPickupOptions(pickupStartDateTime, pickupEndDateTime, overweight);
        }

        /// <summary>
        /// Serializes a <see cref="SchedulePickupUSPSRequestPickupOptions" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="schedulePickupUSPSRequestPickupOptions"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, SchedulePickupUSPSRequestPickupOptions schedulePickupUSPSRequestPickupOptions, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, schedulePickupUSPSRequestPickupOptions, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="SchedulePickupUSPSRequestPickupOptions" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="schedulePickupUSPSRequestPickupOptions"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, SchedulePickupUSPSRequestPickupOptions schedulePickupUSPSRequestPickupOptions, JsonSerializerOptions jsonSerializerOptions)
        {
            if (schedulePickupUSPSRequestPickupOptions.PickupStartDateTimeOption.IsSet)
                writer.WriteString("pickupStartDateTime", schedulePickupUSPSRequestPickupOptions.PickupStartDateTimeOption.Value!.Value.ToString(PickupStartDateTimeFormat));

            if (schedulePickupUSPSRequestPickupOptions.PickupEndDateTimeOption.IsSet)
                writer.WriteString("pickupEndDateTime", schedulePickupUSPSRequestPickupOptions.PickupEndDateTimeOption.Value!.Value.ToString(PickupEndDateTimeFormat));

            if (schedulePickupUSPSRequestPickupOptions.OverweightOption.IsSet)
                writer.WriteNumber("overweight", schedulePickupUSPSRequestPickupOptions.OverweightOption.Value!.Value);
        }
    }
}
