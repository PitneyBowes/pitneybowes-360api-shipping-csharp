...
{
    /// <summary>
    /// ErrCoversheetRequestShipmentOptions
    /// </summary>
    public partial class ErrCoversheetRequestShipmentOptions : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ErrCoversheetRequestShipmentOptions" /> class.
        /// </summary>
        /// <param name="printCustomMessage">A custom message printed on the coversheet. You can pass either print custom message or reference1 under shippingReference. If both are supplied, they will be concatenated.</param>
        ...
        [JsonConstructor]
        public ErrCoversheetRequestShipmentOptions(Option<string?> printCustomMessage = default, Option<bool?> addToManifest = default)
        {
        ...
        /// </summary>
        /// <value>A custom message printed on the coversheet. You can pass either print custom message or reference1 under shippingReference. If both are supplied, they will be concatenated.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ErrCoversheetRequestShipmentOptions {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="ErrCoversheetRequestShipmentOptions" />
    /// </summary>
    public class ErrCoversheetRequestShipmentOptionsJsonConverter : JsonConverter<ErrCoversheetRequestShipmentOptions>
    {
        /// <summary>
        /// Deserializes json to <see cref="ErrCoversheetRequestShipmentOptions" />
        /// </summary>
        ...
        public override ErrCoversheetRequestShipmentOptions Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (printCustomMessage.IsSet && printCustomMessage.Value == null)
                throw new ArgumentNullException(nameof(printCustomMessage), "Property is not nullable for class ErrCoversheetRequestShipmentOptions.");

            if (addToManifest.IsSet && addToManifest.Value == null)
                throw new ArgumentNullException(nameof(addToManifest), "Property is not nullable for class ErrCoversheetRequestShipmentOptions.");

            return new ErrCoversheetRequestShipmentOptions(printCustomMessage, addToManifest);
        }

        /// <summary>
        /// Serializes a <see cref="ErrCoversheetRequestShipmentOptions" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="errCoversheetRequestShipmentOptions"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ErrCoversheetRequestShipmentOptions errCoversheetRequestShipmentOptions, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, errCoversheetRequestShipmentOptions, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ErrCoversheetRequestShipmentOptions" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="errCoversheetRequestShipmentOptions"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ErrCoversheetRequestShipmentOptions errCoversheetRequestShipmentOptions, JsonSerializerOptions jsonSerializerOptions)
        {
            if (errCoversheetRequestShipmentOptions.PrintCustomMessageOption.IsSet && errCoversheetRequestShipmentOptions.PrintCustomMessage == null)
                throw new ArgumentNullException(nameof(errCoversheetRequestShipmentOptions.PrintCustomMessage), "Property is required for class ErrCoversheetRequestShipmentOptions.");

            if (errCoversheetRequestShipmentOptions.PrintCustomMessageOption.IsSet)
                writer.WriteString("printCustomMessage", errCoversheetRequestShipmentOptions.PrintCustomMessage);

            if (errCoversheetRequestShipmentOptions.AddToManifestOption.IsSet)
                writer.WriteBoolean("addToManifest", errCoversheetRequestShipmentOptions.AddToManifestOption.Value!.Value);
        }
    }
}
