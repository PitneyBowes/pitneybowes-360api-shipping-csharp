...
namespace com.pitneybowes.api360.Model
{
    ...
    /// MilitaryMailAddress
    /// </summary>
    public partial class MilitaryMailAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MilitaryMailAddress" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public MilitaryMailAddress(Option<string> addressLine1 = default, Option<string> addressLine2 = default, Option<string> addressLine3 = default, Option<string> cityTown = default, Option<string> countryCode = default, Option<string> name = default, Option<string> phone = default, Option<string> company = default, Option<string> email = default, Option<string> postalCode = default, Option<string> stateProvince = default, Option<bool?> residential = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MilitaryMailAddress {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="MilitaryMailAddress" />
    /// </summary>
    public class MilitaryMailAddressJsonConverter : JsonConverter<MilitaryMailAddress>
    {
        /// <summary>
        /// Deserializes json to <see cref="MilitaryMailAddress" />
        /// </summary>
        ...
        public override MilitaryMailAddress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (addressLine1.IsSet && addressLine1.Value == null)
                throw new ArgumentNullException(nameof(addressLine1), "Property is not nullable for class MilitaryMailAddress.");

            if (addressLine2.IsSet && addressLine2.Value == null)
                throw new ArgumentNullException(nameof(addressLine2), "Property is not nullable for class MilitaryMailAddress.");

            if (addressLine3.IsSet && addressLine3.Value == null)
                throw new ArgumentNullException(nameof(addressLine3), "Property is not nullable for class MilitaryMailAddress.");

            if (cityTown.IsSet && cityTown.Value == null)
                throw new ArgumentNullException(nameof(cityTown), "Property is not nullable for class MilitaryMailAddress.");

            if (countryCode.IsSet && countryCode.Value == null)
                throw new ArgumentNullException(nameof(countryCode), "Property is not nullable for class MilitaryMailAddress.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class MilitaryMailAddress.");

            if (phone.IsSet && phone.Value == null)
                throw new ArgumentNullException(nameof(phone), "Property is not nullable for class MilitaryMailAddress.");

            if (company.IsSet && company.Value == null)
                throw new ArgumentNullException(nameof(company), "Property is not nullable for class MilitaryMailAddress.");

            if (email.IsSet && email.Value == null)
                throw new ArgumentNullException(nameof(email), "Property is not nullable for class MilitaryMailAddress.");

            if (postalCode.IsSet && postalCode.Value == null)
                throw new ArgumentNullException(nameof(postalCode), "Property is not nullable for class MilitaryMailAddress.");

            if (stateProvince.IsSet && stateProvince.Value == null)
                throw new ArgumentNullException(nameof(stateProvince), "Property is not nullable for class MilitaryMailAddress.");

            if (residential.IsSet && residential.Value == null)
                throw new ArgumentNullException(nameof(residential), "Property is not nullable for class MilitaryMailAddress.");

            return new MilitaryMailAddress(addressLine1, addressLine2, addressLine3, cityTown, countryCode, name, phone, company, email, postalCode, stateProvince, residential);
        }

        /// <summary>
        /// Serializes a <see cref="MilitaryMailAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="militaryMailAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, MilitaryMailAddress militaryMailAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, militaryMailAddress, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="MilitaryMailAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="militaryMailAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, MilitaryMailAddress militaryMailAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            if (militaryMailAddress.AddressLine1Option.IsSet && militaryMailAddress.AddressLine1 == null)
                throw new ArgumentNullException(nameof(militaryMailAddress.AddressLine1), "Property is required for class MilitaryMailAddress.");

            if (militaryMailAddress.AddressLine2Option.IsSet && militaryMailAddress.AddressLine2 == null)
                throw new ArgumentNullException(nameof(militaryMailAddress.AddressLine2), "Property is required for class MilitaryMailAddress.");

            if (militaryMailAddress.AddressLine3Option.IsSet && militaryMailAddress.AddressLine3 == null)
                throw new ArgumentNullException(nameof(militaryMailAddress.AddressLine3), "Property is required for class MilitaryMailAddress.");

            if (militaryMailAddress.CityTownOption.IsSet && militaryMailAddress.CityTown == null)
                throw new ArgumentNullException(nameof(militaryMailAddress.CityTown), "Property is required for class MilitaryMailAddress.");

            if (militaryMailAddress.CountryCodeOption.IsSet && militaryMailAddress.CountryCode == null)
                throw new ArgumentNullException(nameof(militaryMailAddress.CountryCode), "Property is required for class MilitaryMailAddress.");

            if (militaryMailAddress.NameOption.IsSet && militaryMailAddress.Name == null)
                throw new ArgumentNullException(nameof(militaryMailAddress.Name), "Property is required for class MilitaryMailAddress.");

            if (militaryMailAddress.PhoneOption.IsSet && militaryMailAddress.Phone == null)
                throw new ArgumentNullException(nameof(militaryMailAddress.Phone), "Property is required for class MilitaryMailAddress.");

            if (militaryMailAddress.CompanyOption.IsSet && militaryMailAddress.Company == null)
                throw new ArgumentNullException(nameof(militaryMailAddress.Company), "Property is required for class MilitaryMailAddress.");

            if (militaryMailAddress.EmailOption.IsSet && militaryMailAddress.Email == null)
                throw new ArgumentNullException(nameof(militaryMailAddress.Email), "Property is required for class MilitaryMailAddress.");

            if (militaryMailAddress.PostalCodeOption.IsSet && militaryMailAddress.PostalCode == null)
                throw new ArgumentNullException(nameof(militaryMailAddress.PostalCode), "Property is required for class MilitaryMailAddress.");

            if (militaryMailAddress.StateProvinceOption.IsSet && militaryMailAddress.StateProvince == null)
                throw new ArgumentNullException(nameof(militaryMailAddress.StateProvince), "Property is required for class MilitaryMailAddress.");

            if (militaryMailAddress.AddressLine1Option.IsSet)
                writer.WriteString("addressLine1", militaryMailAddress.AddressLine1);

            if (militaryMailAddress.AddressLine2Option.IsSet)
                writer.WriteString("addressLine2", militaryMailAddress.AddressLine2);

            if (militaryMailAddress.AddressLine3Option.IsSet)
                writer.WriteString("addressLine3", militaryMailAddress.AddressLine3);

            if (militaryMailAddress.CityTownOption.IsSet)
                writer.WriteString("cityTown", militaryMailAddress.CityTown);

            if (militaryMailAddress.CountryCodeOption.IsSet)
                writer.WriteString("countryCode", militaryMailAddress.CountryCode);

            if (militaryMailAddress.NameOption.IsSet)
                writer.WriteString("name", militaryMailAddress.Name);

            if (militaryMailAddress.PhoneOption.IsSet)
                writer.WriteString("phone", militaryMailAddress.Phone);

            if (militaryMailAddress.CompanyOption.IsSet)
                writer.WriteString("company", militaryMailAddress.Company);

            if (militaryMailAddress.EmailOption.IsSet)
                writer.WriteString("email", militaryMailAddress.Email);

            if (militaryMailAddress.PostalCodeOption.IsSet)
                writer.WriteString("postalCode", militaryMailAddress.PostalCode);

            if (militaryMailAddress.StateProvinceOption.IsSet)
                writer.WriteString("stateProvince", militaryMailAddress.StateProvince);

            if (militaryMailAddress.ResidentialOption.IsSet)
                writer.WriteBoolean("residential", militaryMailAddress.ResidentialOption.Value.Value);
        }
    }
}
