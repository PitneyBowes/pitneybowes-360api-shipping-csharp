...
namespace com.pitneybowes.api360.Model
{
    ...
    public partial class Shipment : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="Shipment" /> class.
        /// </summary>
        /// <param name="externalId">The external ID of the shipment. User can provide any custom value to it for its own reference.</param>
        ...
        /// <param name="dateOfShipment">Current Shipment date.</param>
        ...
        public Shipment(string externalId = default(string), MultipieceDomesticShipmentRequestFromAddress fromAddress = default(MultipieceDomesticShipmentRequestFromAddress), ShipmentDomesticParcel parcel = default(ShipmentDomesticParcel), string carrierAccountId = default(string), string parcelType = default(string), string serviceId = default(string), string dateOfShipment = default(string), List<SpecialService> specialServices = default(List<SpecialService>), ShipmentOptions shipmentOptions = default(ShipmentOptions), List<ShipmentMetadataInner> metadata = default(List<ShipmentMetadataInner>), ShipmentToAddress toAddress = default(ShipmentToAddress))
        {
            ...
            if (parcel == null)
            {
                throw new ArgumentNullException("parcel is a required property for Shipment and cannot be null");
            }
            this.Parcel = parcel;
            // to ensure "carrierAccountId" is required (not null)
            if (carrierAccountId == null)
            {
                throw new ArgumentNullException("carrierAccountId is a required property for Shipment and cannot be null");
            }
            this.CarrierAccountId = carrierAccountId;
            // to ensure "parcelType" is required (not null)
            if (parcelType == null)
            {
                throw new ArgumentNullException("parcelType is a required property for Shipment and cannot be null");
            }
            this.ParcelType = parcelType;
            // to ensure "serviceId" is required (not null)
            if (serviceId == null)
            {
                throw new ArgumentNullException("serviceId is a required property for Shipment and cannot be null");
            }
            this.ServiceId = serviceId;
            // to ensure "toAddress" is required (not null)
            if (toAddress == null)
            {
                throw new ArgumentNullException("toAddress is a required property for Shipment and cannot be null");
            }
        ...
        /// </summary>
        /// <value>The external ID of the shipment. User can provide any custom value to it for its own reference</value>
        ...
        /// </summary>
        /// <value>Current Shipment date</value>
        ...
        public List<ShipmentMetadataInner> Metadata { get; set; }

        /// <summary>
        /// Gets or Sets ToAddress
        /// </summary>
        [DataMember(Name = "toAddress", IsRequired = true, EmitDefaultValue = true)]
        public ShipmentToAddress ToAddress { get; set; }
