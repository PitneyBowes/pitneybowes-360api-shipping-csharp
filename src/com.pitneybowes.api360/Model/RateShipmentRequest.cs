    ...
    public class RateShipmentRequestJsonConverter : JsonConverter<RateShipmentRequest>
    {
        ...
        public override void Write(Utf8JsonWriter writer, RateShipmentRequest rateShipmentRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (rateShipmentRequest.RateShopbyCarrier != null)
                JsonSerializer.Serialize(writer, rateShipmentRequest.RateShopbyCarrier, jsonSerializerOptions);
            else if (rateShipmentRequest.RateShopbyRuleset != null)
                JsonSerializer.Serialize(writer, rateShipmentRequest.RateShopbyRuleset, jsonSerializerOptions);
            else if (rateShipmentRequest.RateShopbyRategroup != null)
                JsonSerializer.Serialize(writer, rateShipmentRequest.RateShopbyRategroup, jsonSerializerOptions);
        }
