...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    public partial class MultipieceShipmentRequestAltReturnAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MultipieceShipmentRequestAltReturnAddress" /> class.
        /// </summary>
        ...
        /* <example>29 Waterview Dr</example> */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MultipieceShipmentRequestAltReturnAddress {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="MultipieceShipmentRequestAltReturnAddress" />
    /// </summary>
    public class MultipieceShipmentRequestAltReturnAddressJsonConverter : JsonConverter<MultipieceShipmentRequestAltReturnAddress>
    {
        /// <summary>
        /// Deserializes json to <see cref="MultipieceShipmentRequestAltReturnAddress" />
        /// </summary>
        ...
        public override MultipieceShipmentRequestAltReturnAddress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (addressLine1.IsSet && addressLine1.Value == null)
                throw new ArgumentNullException(nameof(addressLine1), "Property is not nullable for class MultipieceShipmentRequestAltReturnAddress.");

            if (addressLine2.IsSet && addressLine2.Value == null)
                throw new ArgumentNullException(nameof(addressLine2), "Property is not nullable for class MultipieceShipmentRequestAltReturnAddress.");

            if (addressLine3.IsSet && addressLine3.Value == null)
                throw new ArgumentNullException(nameof(addressLine3), "Property is not nullable for class MultipieceShipmentRequestAltReturnAddress.");

            if (company.IsSet && company.Value == null)
                throw new ArgumentNullException(nameof(company), "Property is not nullable for class MultipieceShipmentRequestAltReturnAddress.");

            if (email.IsSet && email.Value == null)
                throw new ArgumentNullException(nameof(email), "Property is not nullable for class MultipieceShipmentRequestAltReturnAddress.");

            if (residential.IsSet && residential.Value == null)
                throw new ArgumentNullException(nameof(residential), "Property is not nullable for class MultipieceShipmentRequestAltReturnAddress.");

            if (cityTown.IsSet && cityTown.Value == null)
                throw new ArgumentNullException(nameof(cityTown), "Property is not nullable for class MultipieceShipmentRequestAltReturnAddress.");

            if (countryCode.IsSet && countryCode.Value == null)
                throw new ArgumentNullException(nameof(countryCode), "Property is not nullable for class MultipieceShipmentRequestAltReturnAddress.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class MultipieceShipmentRequestAltReturnAddress.");

            if (phone.IsSet && phone.Value == null)
                throw new ArgumentNullException(nameof(phone), "Property is not nullable for class MultipieceShipmentRequestAltReturnAddress.");

            if (postalCode.IsSet && postalCode.Value == null)
                throw new ArgumentNullException(nameof(postalCode), "Property is not nullable for class MultipieceShipmentRequestAltReturnAddress.");

            if (stateProvince.IsSet && stateProvince.Value == null)
                throw new ArgumentNullException(nameof(stateProvince), "Property is not nullable for class MultipieceShipmentRequestAltReturnAddress.");

            return new MultipieceShipmentRequestAltReturnAddress(addressLine1, addressLine2, addressLine3, company, email, residential, cityTown, countryCode, name, phone, postalCode, stateProvince);
        }

        /// <summary>
        /// Serializes a <see cref="MultipieceShipmentRequestAltReturnAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="multipieceShipmentRequestAltReturnAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, MultipieceShipmentRequestAltReturnAddress multipieceShipmentRequestAltReturnAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, multipieceShipmentRequestAltReturnAddress, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="MultipieceShipmentRequestAltReturnAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="multipieceShipmentRequestAltReturnAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, MultipieceShipmentRequestAltReturnAddress multipieceShipmentRequestAltReturnAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            if (multipieceShipmentRequestAltReturnAddress.AddressLine1Option.IsSet && multipieceShipmentRequestAltReturnAddress.AddressLine1 == null)
                throw new ArgumentNullException(nameof(multipieceShipmentRequestAltReturnAddress.AddressLine1), "Property is required for class MultipieceShipmentRequestAltReturnAddress.");

            if (multipieceShipmentRequestAltReturnAddress.AddressLine2Option.IsSet && multipieceShipmentRequestAltReturnAddress.AddressLine2 == null)
                throw new ArgumentNullException(nameof(multipieceShipmentRequestAltReturnAddress.AddressLine2), "Property is required for class MultipieceShipmentRequestAltReturnAddress.");

            if (multipieceShipmentRequestAltReturnAddress.AddressLine3Option.IsSet && multipieceShipmentRequestAltReturnAddress.AddressLine3 == null)
                throw new ArgumentNullException(nameof(multipieceShipmentRequestAltReturnAddress.AddressLine3), "Property is required for class MultipieceShipmentRequestAltReturnAddress.");

            if (multipieceShipmentRequestAltReturnAddress.CompanyOption.IsSet && multipieceShipmentRequestAltReturnAddress.Company == null)
                throw new ArgumentNullException(nameof(multipieceShipmentRequestAltReturnAddress.Company), "Property is required for class MultipieceShipmentRequestAltReturnAddress.");

            if (multipieceShipmentRequestAltReturnAddress.EmailOption.IsSet && multipieceShipmentRequestAltReturnAddress.Email == null)
                throw new ArgumentNullException(nameof(multipieceShipmentRequestAltReturnAddress.Email), "Property is required for class MultipieceShipmentRequestAltReturnAddress.");

            if (multipieceShipmentRequestAltReturnAddress.CityTownOption.IsSet && multipieceShipmentRequestAltReturnAddress.CityTown == null)
                throw new ArgumentNullException(nameof(multipieceShipmentRequestAltReturnAddress.CityTown), "Property is required for class MultipieceShipmentRequestAltReturnAddress.");

            if (multipieceShipmentRequestAltReturnAddress.CountryCodeOption.IsSet && multipieceShipmentRequestAltReturnAddress.CountryCode == null)
                throw new ArgumentNullException(nameof(multipieceShipmentRequestAltReturnAddress.CountryCode), "Property is required for class MultipieceShipmentRequestAltReturnAddress.");

            if (multipieceShipmentRequestAltReturnAddress.NameOption.IsSet && multipieceShipmentRequestAltReturnAddress.Name == null)
                throw new ArgumentNullException(nameof(multipieceShipmentRequestAltReturnAddress.Name), "Property is required for class MultipieceShipmentRequestAltReturnAddress.");

            if (multipieceShipmentRequestAltReturnAddress.PhoneOption.IsSet && multipieceShipmentRequestAltReturnAddress.Phone == null)
                throw new ArgumentNullException(nameof(multipieceShipmentRequestAltReturnAddress.Phone), "Property is required for class MultipieceShipmentRequestAltReturnAddress.");

            if (multipieceShipmentRequestAltReturnAddress.PostalCodeOption.IsSet && multipieceShipmentRequestAltReturnAddress.PostalCode == null)
                throw new ArgumentNullException(nameof(multipieceShipmentRequestAltReturnAddress.PostalCode), "Property is required for class MultipieceShipmentRequestAltReturnAddress.");

            if (multipieceShipmentRequestAltReturnAddress.StateProvinceOption.IsSet && multipieceShipmentRequestAltReturnAddress.StateProvince == null)
                throw new ArgumentNullException(nameof(multipieceShipmentRequestAltReturnAddress.StateProvince), "Property is required for class MultipieceShipmentRequestAltReturnAddress.");

            if (multipieceShipmentRequestAltReturnAddress.AddressLine1Option.IsSet)
                writer.WriteString("addressLine1", multipieceShipmentRequestAltReturnAddress.AddressLine1);

            if (multipieceShipmentRequestAltReturnAddress.AddressLine2Option.IsSet)
                writer.WriteString("addressLine2", multipieceShipmentRequestAltReturnAddress.AddressLine2);

            if (multipieceShipmentRequestAltReturnAddress.AddressLine3Option.IsSet)
                writer.WriteString("addressLine3", multipieceShipmentRequestAltReturnAddress.AddressLine3);

            if (multipieceShipmentRequestAltReturnAddress.CompanyOption.IsSet)
                writer.WriteString("company", multipieceShipmentRequestAltReturnAddress.Company);

            if (multipieceShipmentRequestAltReturnAddress.EmailOption.IsSet)
                writer.WriteString("email", multipieceShipmentRequestAltReturnAddress.Email);

            if (multipieceShipmentRequestAltReturnAddress.ResidentialOption.IsSet)
                writer.WriteBoolean("residential", multipieceShipmentRequestAltReturnAddress.ResidentialOption.Value.Value);

            if (multipieceShipmentRequestAltReturnAddress.CityTownOption.IsSet)
                writer.WriteString("cityTown", multipieceShipmentRequestAltReturnAddress.CityTown);

            if (multipieceShipmentRequestAltReturnAddress.CountryCodeOption.IsSet)
                writer.WriteString("countryCode", multipieceShipmentRequestAltReturnAddress.CountryCode);

            if (multipieceShipmentRequestAltReturnAddress.NameOption.IsSet)
                writer.WriteString("name", multipieceShipmentRequestAltReturnAddress.Name);

            if (multipieceShipmentRequestAltReturnAddress.PhoneOption.IsSet)
                writer.WriteString("phone", multipieceShipmentRequestAltReturnAddress.Phone);

            if (multipieceShipmentRequestAltReturnAddress.PostalCodeOption.IsSet)
                writer.WriteString("postalCode", multipieceShipmentRequestAltReturnAddress.PostalCode);

            if (multipieceShipmentRequestAltReturnAddress.StateProvinceOption.IsSet)
                writer.WriteString("stateProvince", multipieceShipmentRequestAltReturnAddress.StateProvince);
        }
    }
}
