...
{
    /// <summary>
    /// MultipieceShipmentResponseToAddress
    /// </summary>
    public partial class MultipieceShipmentResponseToAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MultipieceShipmentResponseToAddress" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public MultipieceShipmentResponseToAddress(string addressLine1, string countryCode, string postalCode, string stateProvince, Option<string?> addressLine2 = default, Option<string?> addressLine3 = default, Option<string?> cityTown = default, Option<string?> name = default, Option<string?> phone = default, Option<string?> company = default, Option<string?> email = default, Option<bool?> residential = default)
        {
        ...
        /* <example>recipient@yopmail.com</example> */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MultipieceShipmentResponseToAddress {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="MultipieceShipmentResponseToAddress" />
    /// </summary>
    public class MultipieceShipmentResponseToAddressJsonConverter : JsonConverter<MultipieceShipmentResponseToAddress>
    {
        /// <summary>
        /// Deserializes json to <see cref="MultipieceShipmentResponseToAddress" />
        /// </summary>
        ...
        public override MultipieceShipmentResponseToAddress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!addressLine1.IsSet)
                throw new ArgumentException("Property is required for class MultipieceShipmentResponseToAddress.", nameof(addressLine1));

            if (!countryCode.IsSet)
                throw new ArgumentException("Property is required for class MultipieceShipmentResponseToAddress.", nameof(countryCode));

            if (!postalCode.IsSet)
                throw new ArgumentException("Property is required for class MultipieceShipmentResponseToAddress.", nameof(postalCode));

            if (!stateProvince.IsSet)
                throw new ArgumentException("Property is required for class MultipieceShipmentResponseToAddress.", nameof(stateProvince));

            if (addressLine1.IsSet && addressLine1.Value == null)
                throw new ArgumentNullException(nameof(addressLine1), "Property is not nullable for class MultipieceShipmentResponseToAddress.");

            if (countryCode.IsSet && countryCode.Value == null)
                throw new ArgumentNullException(nameof(countryCode), "Property is not nullable for class MultipieceShipmentResponseToAddress.");

            if (postalCode.IsSet && postalCode.Value == null)
                throw new ArgumentNullException(nameof(postalCode), "Property is not nullable for class MultipieceShipmentResponseToAddress.");

            if (stateProvince.IsSet && stateProvince.Value == null)
                throw new ArgumentNullException(nameof(stateProvince), "Property is not nullable for class MultipieceShipmentResponseToAddress.");

            if (addressLine2.IsSet && addressLine2.Value == null)
                throw new ArgumentNullException(nameof(addressLine2), "Property is not nullable for class MultipieceShipmentResponseToAddress.");

            if (addressLine3.IsSet && addressLine3.Value == null)
                throw new ArgumentNullException(nameof(addressLine3), "Property is not nullable for class MultipieceShipmentResponseToAddress.");

            if (cityTown.IsSet && cityTown.Value == null)
                throw new ArgumentNullException(nameof(cityTown), "Property is not nullable for class MultipieceShipmentResponseToAddress.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class MultipieceShipmentResponseToAddress.");

            if (phone.IsSet && phone.Value == null)
                throw new ArgumentNullException(nameof(phone), "Property is not nullable for class MultipieceShipmentResponseToAddress.");

            if (company.IsSet && company.Value == null)
                throw new ArgumentNullException(nameof(company), "Property is not nullable for class MultipieceShipmentResponseToAddress.");

            if (email.IsSet && email.Value == null)
                throw new ArgumentNullException(nameof(email), "Property is not nullable for class MultipieceShipmentResponseToAddress.");

            if (residential.IsSet && residential.Value == null)
                throw new ArgumentNullException(nameof(residential), "Property is not nullable for class MultipieceShipmentResponseToAddress.");

            return new MultipieceShipmentResponseToAddress(addressLine1.Value!, countryCode.Value!, postalCode.Value!, stateProvince.Value!, addressLine2, addressLine3, cityTown, name, phone, company, email, residential);
        }

        /// <summary>
        /// Serializes a <see cref="MultipieceShipmentResponseToAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="multipieceShipmentResponseToAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, MultipieceShipmentResponseToAddress multipieceShipmentResponseToAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, multipieceShipmentResponseToAddress, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="MultipieceShipmentResponseToAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="multipieceShipmentResponseToAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, MultipieceShipmentResponseToAddress multipieceShipmentResponseToAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            if (multipieceShipmentResponseToAddress.AddressLine1 == null)
                throw new ArgumentNullException(nameof(multipieceShipmentResponseToAddress.AddressLine1), "Property is required for class MultipieceShipmentResponseToAddress.");

            if (multipieceShipmentResponseToAddress.CountryCode == null)
                throw new ArgumentNullException(nameof(multipieceShipmentResponseToAddress.CountryCode), "Property is required for class MultipieceShipmentResponseToAddress.");

            if (multipieceShipmentResponseToAddress.PostalCode == null)
                throw new ArgumentNullException(nameof(multipieceShipmentResponseToAddress.PostalCode), "Property is required for class MultipieceShipmentResponseToAddress.");

            if (multipieceShipmentResponseToAddress.StateProvince == null)
                throw new ArgumentNullException(nameof(multipieceShipmentResponseToAddress.StateProvince), "Property is required for class MultipieceShipmentResponseToAddress.");

            if (multipieceShipmentResponseToAddress.AddressLine2Option.IsSet && multipieceShipmentResponseToAddress.AddressLine2 == null)
                throw new ArgumentNullException(nameof(multipieceShipmentResponseToAddress.AddressLine2), "Property is required for class MultipieceShipmentResponseToAddress.");

            if (multipieceShipmentResponseToAddress.AddressLine3Option.IsSet && multipieceShipmentResponseToAddress.AddressLine3 == null)
                throw new ArgumentNullException(nameof(multipieceShipmentResponseToAddress.AddressLine3), "Property is required for class MultipieceShipmentResponseToAddress.");

            if (multipieceShipmentResponseToAddress.CityTownOption.IsSet && multipieceShipmentResponseToAddress.CityTown == null)
                throw new ArgumentNullException(nameof(multipieceShipmentResponseToAddress.CityTown), "Property is required for class MultipieceShipmentResponseToAddress.");

            if (multipieceShipmentResponseToAddress.NameOption.IsSet && multipieceShipmentResponseToAddress.Name == null)
                throw new ArgumentNullException(nameof(multipieceShipmentResponseToAddress.Name), "Property is required for class MultipieceShipmentResponseToAddress.");

            if (multipieceShipmentResponseToAddress.PhoneOption.IsSet && multipieceShipmentResponseToAddress.Phone == null)
                throw new ArgumentNullException(nameof(multipieceShipmentResponseToAddress.Phone), "Property is required for class MultipieceShipmentResponseToAddress.");

            if (multipieceShipmentResponseToAddress.CompanyOption.IsSet && multipieceShipmentResponseToAddress.Company == null)
                throw new ArgumentNullException(nameof(multipieceShipmentResponseToAddress.Company), "Property is required for class MultipieceShipmentResponseToAddress.");

            if (multipieceShipmentResponseToAddress.EmailOption.IsSet && multipieceShipmentResponseToAddress.Email == null)
                throw new ArgumentNullException(nameof(multipieceShipmentResponseToAddress.Email), "Property is required for class MultipieceShipmentResponseToAddress.");

            writer.WriteString("addressLine1", multipieceShipmentResponseToAddress.AddressLine1);

            writer.WriteString("countryCode", multipieceShipmentResponseToAddress.CountryCode);

            writer.WriteString("postalCode", multipieceShipmentResponseToAddress.PostalCode);

            writer.WriteString("stateProvince", multipieceShipmentResponseToAddress.StateProvince);

            if (multipieceShipmentResponseToAddress.AddressLine2Option.IsSet)
                writer.WriteString("addressLine2", multipieceShipmentResponseToAddress.AddressLine2);

            if (multipieceShipmentResponseToAddress.AddressLine3Option.IsSet)
                writer.WriteString("addressLine3", multipieceShipmentResponseToAddress.AddressLine3);

            if (multipieceShipmentResponseToAddress.CityTownOption.IsSet)
                writer.WriteString("cityTown", multipieceShipmentResponseToAddress.CityTown);

            if (multipieceShipmentResponseToAddress.NameOption.IsSet)
                writer.WriteString("name", multipieceShipmentResponseToAddress.Name);

            if (multipieceShipmentResponseToAddress.PhoneOption.IsSet)
                writer.WriteString("phone", multipieceShipmentResponseToAddress.Phone);

            if (multipieceShipmentResponseToAddress.CompanyOption.IsSet)
                writer.WriteString("company", multipieceShipmentResponseToAddress.Company);

            if (multipieceShipmentResponseToAddress.EmailOption.IsSet)
                writer.WriteString("email", multipieceShipmentResponseToAddress.Email);

            if (multipieceShipmentResponseToAddress.ResidentialOption.IsSet)
                writer.WriteBoolean("residential", multipieceShipmentResponseToAddress.ResidentialOption.Value!.Value);
        }
    }
}
