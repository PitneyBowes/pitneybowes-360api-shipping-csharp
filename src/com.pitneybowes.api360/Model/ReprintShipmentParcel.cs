...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    public partial class ReprintShipmentParcel : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReprintShipmentParcel" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public ReprintShipmentParcel(int length, int width, int height, DimUnitEnum dimUnit, WeightUnitEnum weightUnit, decimal weight)
        {
            Length = length;
            Width = width;
            Height = height;
    ...
    /// <summary>
    /// A Json converter for type <see cref="ReprintShipmentParcel" />
    /// </summary>
    public class ReprintShipmentParcelJsonConverter : JsonConverter<ReprintShipmentParcel>
    {
        /// <summary>
        /// Deserializes json to <see cref="ReprintShipmentParcel" />
        /// </summary>
        ...
        public override ReprintShipmentParcel Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<ReprintShipmentParcel.DimUnitEnum?> dimUnit = default;
            Option<ReprintShipmentParcel.WeightUnitEnum?> weightUnit = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "dimUnit":
                            ...
                            if (dimUnitRawValue != null)
                                dimUnit = new Option<ReprintShipmentParcel.DimUnitEnum?>(ReprintShipmentParcel.DimUnitEnumFromStringOrDefault(dimUnitRawValue));
                            break;
                        case "weightUnit":
                            string weightUnitRawValue = utf8JsonReader.GetString();
                            if (weightUnitRawValue != null)
                                weightUnit = new Option<ReprintShipmentParcel.WeightUnitEnum?>(ReprintShipmentParcel.WeightUnitEnumFromStringOrDefault(weightUnitRawValue));
                            break;
                        case "weight":
            ...
            if (!length.IsSet)
                throw new ArgumentException("Property is required for class ReprintShipmentParcel.", nameof(length));

            if (!width.IsSet)
                throw new ArgumentException("Property is required for class ReprintShipmentParcel.", nameof(width));

            if (!height.IsSet)
                throw new ArgumentException("Property is required for class ReprintShipmentParcel.", nameof(height));

            if (!dimUnit.IsSet)
                throw new ArgumentException("Property is required for class ReprintShipmentParcel.", nameof(dimUnit));

            if (!weightUnit.IsSet)
                throw new ArgumentException("Property is required for class ReprintShipmentParcel.", nameof(weightUnit));

            if (!weight.IsSet)
                throw new ArgumentException("Property is required for class ReprintShipmentParcel.", nameof(weight));

            if (length.IsSet && length.Value == null)
                throw new ArgumentNullException(nameof(length), "Property is not nullable for class ReprintShipmentParcel.");

            if (width.IsSet && width.Value == null)
                throw new ArgumentNullException(nameof(width), "Property is not nullable for class ReprintShipmentParcel.");

            if (height.IsSet && height.Value == null)
                throw new ArgumentNullException(nameof(height), "Property is not nullable for class ReprintShipmentParcel.");

            if (dimUnit.IsSet && dimUnit.Value == null)
                throw new ArgumentNullException(nameof(dimUnit), "Property is not nullable for class ReprintShipmentParcel.");

            if (weightUnit.IsSet && weightUnit.Value == null)
                throw new ArgumentNullException(nameof(weightUnit), "Property is not nullable for class ReprintShipmentParcel.");

            if (weight.IsSet && weight.Value == null)
                throw new ArgumentNullException(nameof(weight), "Property is not nullable for class ReprintShipmentParcel.");

            return new ReprintShipmentParcel(length.Value.Value, width.Value.Value, height.Value.Value, dimUnit.Value.Value, weightUnit.Value.Value, weight.Value.Value);
        }

        /// <summary>
        /// Serializes a <see cref="ReprintShipmentParcel" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="reprintShipmentParcel"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ReprintShipmentParcel reprintShipmentParcel, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, reprintShipmentParcel, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ReprintShipmentParcel" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="reprintShipmentParcel"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ReprintShipmentParcel reprintShipmentParcel, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteNumber("length", reprintShipmentParcel.Length);

            writer.WriteNumber("width", reprintShipmentParcel.Width);

            writer.WriteNumber("height", reprintShipmentParcel.Height);

            var dimUnitRawValue = ReprintShipmentParcel.DimUnitEnumToJsonValue(reprintShipmentParcel.DimUnit);
            writer.WriteString("dimUnit", dimUnitRawValue);
            var weightUnitRawValue = ReprintShipmentParcel.WeightUnitEnumToJsonValue(reprintShipmentParcel.WeightUnit);
            writer.WriteString("weightUnit", weightUnitRawValue);
            writer.WriteNumber("weight", reprintShipmentParcel.Weight);
        }
    }
}
