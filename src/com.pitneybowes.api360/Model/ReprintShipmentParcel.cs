...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    [DataContract(Name = "reprintShipment_parcel")]
    public partial class ReprintShipmentParcel : IValidatableObject
    {
        ...
        protected ReprintShipmentParcel() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ReprintShipmentParcel" /> class.
        /// </summary>
        ...
        /// <param name="weightUnit">WeightUnit is a standard for measuring the physical quantities of specified weight. &lt;br&gt; The valid values are:  &lt;br&gt;- OZ: Ounces &lt;br&gt;- GM: Grams &lt;br&gt;- LB: Pounds &lt;br&gt;- KG: Kilograms For USPS shipments, set this to OZ. (required).</param>
        /// <param name="weight">Weight is the measure of how heavy an object is. (required).</param>
        public ReprintShipmentParcel(decimal height = default(decimal), decimal length = default(decimal), decimal width = default(decimal), DimUnitEnum dimUnit = default(DimUnitEnum), WeightUnitEnum weightUnit = default(WeightUnitEnum), decimal weight = default(decimal))
        {
            this.Height = height;
            this.Length = length;
            this.Width = width;
