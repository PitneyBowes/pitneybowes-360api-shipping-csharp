...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    public partial class ShipmentDomesticByCarrierCustomsCustomsInfo : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShipmentDomesticByCarrierCustomsCustomsInfo" /> class.
        /// </summary>
        /// <param name="reasonForExport">Reason for exporting the items.</param>
        ...
        [JsonConstructor]
        public ShipmentDomesticByCarrierCustomsCustomsInfo(ReasonForExportEnum reasonForExport, string currencyCode, decimal customsDeclaredValue, Option<string> comments = default, Option<string> invoiceNumber = default, Option<string> importerCustomsReference = default, Option<float?> sdrValue = default, Option<string> eELPFC = default, Option<string> fromCustomsReference = default, Option<string> licenseNumber = default, Option<string> certificateNumber = default, Option<TermsOfSaleEnum?> termsOfSale = default)
        {
        ...
        /// </summary>
        /// <value>Reason for exporting the items.</value>
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<float?> SdrValueOption { get; private set; }
        ...
        public float? SdrValue { get { return this.SdrValueOption; } set { this.SdrValueOption = new Option<float?>(value); } }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShipmentDomesticByCarrierCustomsCustomsInfo {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="ShipmentDomesticByCarrierCustomsCustomsInfo" />
    /// </summary>
    public class ShipmentDomesticByCarrierCustomsCustomsInfoJsonConverter : JsonConverter<ShipmentDomesticByCarrierCustomsCustomsInfo>
    {
        /// <summary>
        /// Deserializes json to <see cref="ShipmentDomesticByCarrierCustomsCustomsInfo" />
        /// </summary>
        ...
        public override ShipmentDomesticByCarrierCustomsCustomsInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<ShipmentDomesticByCarrierCustomsCustomsInfo.ReasonForExportEnum?> reasonForExport = default;
            ...
            Option<ShipmentDomesticByCarrierCustomsCustomsInfo.TermsOfSaleEnum?> termsOfSale = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "reasonForExport":
                            ...
                            if (reasonForExportRawValue != null)
                                reasonForExport = new Option<ShipmentDomesticByCarrierCustomsCustomsInfo.ReasonForExportEnum?>(ShipmentDomesticByCarrierCustomsCustomsInfo.ReasonForExportEnumFromStringOrDefault(reasonForExportRawValue));
                            break;
                        case "currencyCode":
                        ...
                        case "importerCustomsReference":
                            ...
                            break;
                        case "sdrValue":
                            sdrValue = new Option<float?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (float?)null : (float)utf8JsonReader.GetDouble());
                            break;
                        case "EELPFC":
                        ...
                        case "termsOfSale":
                            ...
                            if (termsOfSaleRawValue != null)
                                termsOfSale = new Option<ShipmentDomesticByCarrierCustomsCustomsInfo.TermsOfSaleEnum?>(ShipmentDomesticByCarrierCustomsCustomsInfo.TermsOfSaleEnumFromStringOrDefault(termsOfSaleRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            if (!reasonForExport.IsSet)
                throw new ArgumentException("Property is required for class ShipmentDomesticByCarrierCustomsCustomsInfo.", nameof(reasonForExport));

            if (!currencyCode.IsSet)
                throw new ArgumentException("Property is required for class ShipmentDomesticByCarrierCustomsCustomsInfo.", nameof(currencyCode));

            if (!customsDeclaredValue.IsSet)
                throw new ArgumentException("Property is required for class ShipmentDomesticByCarrierCustomsCustomsInfo.", nameof(customsDeclaredValue));

            if (reasonForExport.IsSet && reasonForExport.Value == null)
                throw new ArgumentNullException(nameof(reasonForExport), "Property is not nullable for class ShipmentDomesticByCarrierCustomsCustomsInfo.");

            if (currencyCode.IsSet && currencyCode.Value == null)
                throw new ArgumentNullException(nameof(currencyCode), "Property is not nullable for class ShipmentDomesticByCarrierCustomsCustomsInfo.");

            if (customsDeclaredValue.IsSet && customsDeclaredValue.Value == null)
                throw new ArgumentNullException(nameof(customsDeclaredValue), "Property is not nullable for class ShipmentDomesticByCarrierCustomsCustomsInfo.");

            if (comments.IsSet && comments.Value == null)
                throw new ArgumentNullException(nameof(comments), "Property is not nullable for class ShipmentDomesticByCarrierCustomsCustomsInfo.");

            if (invoiceNumber.IsSet && invoiceNumber.Value == null)
                throw new ArgumentNullException(nameof(invoiceNumber), "Property is not nullable for class ShipmentDomesticByCarrierCustomsCustomsInfo.");

            if (importerCustomsReference.IsSet && importerCustomsReference.Value == null)
                throw new ArgumentNullException(nameof(importerCustomsReference), "Property is not nullable for class ShipmentDomesticByCarrierCustomsCustomsInfo.");

            if (sdrValue.IsSet && sdrValue.Value == null)
                throw new ArgumentNullException(nameof(sdrValue), "Property is not nullable for class ShipmentDomesticByCarrierCustomsCustomsInfo.");

            if (eELPFC.IsSet && eELPFC.Value == null)
                throw new ArgumentNullException(nameof(eELPFC), "Property is not nullable for class ShipmentDomesticByCarrierCustomsCustomsInfo.");

            if (fromCustomsReference.IsSet && fromCustomsReference.Value == null)
                throw new ArgumentNullException(nameof(fromCustomsReference), "Property is not nullable for class ShipmentDomesticByCarrierCustomsCustomsInfo.");

            if (licenseNumber.IsSet && licenseNumber.Value == null)
                throw new ArgumentNullException(nameof(licenseNumber), "Property is not nullable for class ShipmentDomesticByCarrierCustomsCustomsInfo.");

            if (certificateNumber.IsSet && certificateNumber.Value == null)
                throw new ArgumentNullException(nameof(certificateNumber), "Property is not nullable for class ShipmentDomesticByCarrierCustomsCustomsInfo.");

            if (termsOfSale.IsSet && termsOfSale.Value == null)
                throw new ArgumentNullException(nameof(termsOfSale), "Property is not nullable for class ShipmentDomesticByCarrierCustomsCustomsInfo.");

            return new ShipmentDomesticByCarrierCustomsCustomsInfo(reasonForExport.Value.Value, currencyCode.Value, customsDeclaredValue.Value.Value, comments, invoiceNumber, importerCustomsReference, sdrValue, eELPFC, fromCustomsReference, licenseNumber, certificateNumber, termsOfSale);
        }

        /// <summary>
        /// Serializes a <see cref="ShipmentDomesticByCarrierCustomsCustomsInfo" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="shipmentDomesticByCarrierCustomsCustomsInfo"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ShipmentDomesticByCarrierCustomsCustomsInfo shipmentDomesticByCarrierCustomsCustomsInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, shipmentDomesticByCarrierCustomsCustomsInfo, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ShipmentDomesticByCarrierCustomsCustomsInfo" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="shipmentDomesticByCarrierCustomsCustomsInfo"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ShipmentDomesticByCarrierCustomsCustomsInfo shipmentDomesticByCarrierCustomsCustomsInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            if (shipmentDomesticByCarrierCustomsCustomsInfo.CurrencyCode == null)
                throw new ArgumentNullException(nameof(shipmentDomesticByCarrierCustomsCustomsInfo.CurrencyCode), "Property is required for class ShipmentDomesticByCarrierCustomsCustomsInfo.");

            if (shipmentDomesticByCarrierCustomsCustomsInfo.CommentsOption.IsSet && shipmentDomesticByCarrierCustomsCustomsInfo.Comments == null)
                throw new ArgumentNullException(nameof(shipmentDomesticByCarrierCustomsCustomsInfo.Comments), "Property is required for class ShipmentDomesticByCarrierCustomsCustomsInfo.");

            if (shipmentDomesticByCarrierCustomsCustomsInfo.InvoiceNumberOption.IsSet && shipmentDomesticByCarrierCustomsCustomsInfo.InvoiceNumber == null)
                throw new ArgumentNullException(nameof(shipmentDomesticByCarrierCustomsCustomsInfo.InvoiceNumber), "Property is required for class ShipmentDomesticByCarrierCustomsCustomsInfo.");

            if (shipmentDomesticByCarrierCustomsCustomsInfo.ImporterCustomsReferenceOption.IsSet && shipmentDomesticByCarrierCustomsCustomsInfo.ImporterCustomsReference == null)
                throw new ArgumentNullException(nameof(shipmentDomesticByCarrierCustomsCustomsInfo.ImporterCustomsReference), "Property is required for class ShipmentDomesticByCarrierCustomsCustomsInfo.");

            if (shipmentDomesticByCarrierCustomsCustomsInfo.EELPFCOption.IsSet && shipmentDomesticByCarrierCustomsCustomsInfo.EELPFC == null)
                throw new ArgumentNullException(nameof(shipmentDomesticByCarrierCustomsCustomsInfo.EELPFC), "Property is required for class ShipmentDomesticByCarrierCustomsCustomsInfo.");

            if (shipmentDomesticByCarrierCustomsCustomsInfo.FromCustomsReferenceOption.IsSet && shipmentDomesticByCarrierCustomsCustomsInfo.FromCustomsReference == null)
                throw new ArgumentNullException(nameof(shipmentDomesticByCarrierCustomsCustomsInfo.FromCustomsReference), "Property is required for class ShipmentDomesticByCarrierCustomsCustomsInfo.");

            if (shipmentDomesticByCarrierCustomsCustomsInfo.LicenseNumberOption.IsSet && shipmentDomesticByCarrierCustomsCustomsInfo.LicenseNumber == null)
                throw new ArgumentNullException(nameof(shipmentDomesticByCarrierCustomsCustomsInfo.LicenseNumber), "Property is required for class ShipmentDomesticByCarrierCustomsCustomsInfo.");

            if (shipmentDomesticByCarrierCustomsCustomsInfo.CertificateNumberOption.IsSet && shipmentDomesticByCarrierCustomsCustomsInfo.CertificateNumber == null)
                throw new ArgumentNullException(nameof(shipmentDomesticByCarrierCustomsCustomsInfo.CertificateNumber), "Property is required for class ShipmentDomesticByCarrierCustomsCustomsInfo.");

            var reasonForExportRawValue = ShipmentDomesticByCarrierCustomsCustomsInfo.ReasonForExportEnumToJsonValue(shipmentDomesticByCarrierCustomsCustomsInfo.ReasonForExport);
            writer.WriteString("reasonForExport", reasonForExportRawValue);
            writer.WriteString("currencyCode", shipmentDomesticByCarrierCustomsCustomsInfo.CurrencyCode);

            writer.WriteNumber("customsDeclaredValue", shipmentDomesticByCarrierCustomsCustomsInfo.CustomsDeclaredValue);

            if (shipmentDomesticByCarrierCustomsCustomsInfo.CommentsOption.IsSet)
                writer.WriteString("comments", shipmentDomesticByCarrierCustomsCustomsInfo.Comments);

            if (shipmentDomesticByCarrierCustomsCustomsInfo.InvoiceNumberOption.IsSet)
                writer.WriteString("invoiceNumber", shipmentDomesticByCarrierCustomsCustomsInfo.InvoiceNumber);

            if (shipmentDomesticByCarrierCustomsCustomsInfo.ImporterCustomsReferenceOption.IsSet)
                writer.WriteString("importerCustomsReference", shipmentDomesticByCarrierCustomsCustomsInfo.ImporterCustomsReference);

            if (shipmentDomesticByCarrierCustomsCustomsInfo.SdrValueOption.IsSet)
                writer.WriteNumber("sdrValue", shipmentDomesticByCarrierCustomsCustomsInfo.SdrValueOption.Value.Value);

            if (shipmentDomesticByCarrierCustomsCustomsInfo.EELPFCOption.IsSet)
                writer.WriteString("EELPFC", shipmentDomesticByCarrierCustomsCustomsInfo.EELPFC);

            if (shipmentDomesticByCarrierCustomsCustomsInfo.FromCustomsReferenceOption.IsSet)
                writer.WriteString("fromCustomsReference", shipmentDomesticByCarrierCustomsCustomsInfo.FromCustomsReference);

            if (shipmentDomesticByCarrierCustomsCustomsInfo.LicenseNumberOption.IsSet)
                writer.WriteString("licenseNumber", shipmentDomesticByCarrierCustomsCustomsInfo.LicenseNumber);

            if (shipmentDomesticByCarrierCustomsCustomsInfo.CertificateNumberOption.IsSet)
                writer.WriteString("certificateNumber", shipmentDomesticByCarrierCustomsCustomsInfo.CertificateNumber);

            var termsOfSaleRawValue = ShipmentDomesticByCarrierCustomsCustomsInfo.TermsOfSaleEnumToJsonValue(shipmentDomesticByCarrierCustomsCustomsInfo.TermsOfSaleOption.Value.Value);
