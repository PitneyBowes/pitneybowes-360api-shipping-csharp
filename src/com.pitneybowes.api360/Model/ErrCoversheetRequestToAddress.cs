...
{
    /// <summary>
    /// ErrCoversheetRequestToAddress
    /// </summary>
    public partial class ErrCoversheetRequestToAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ErrCoversheetRequestToAddress" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public ErrCoversheetRequestToAddress(Option<string> name = default, Option<string> addressLine1 = default, Option<string> addressLine2 = default, Option<string> addressLine3 = default, Option<string> cityTown = default, Option<string> stateProvince = default, Option<string> postalCode = default, Option<string> countryCode = default, Option<string> phone = default, Option<string> company = default, Option<string> email = default, Option<bool?> residential = default)
        {
            NameOption = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ErrCoversheetRequestToAddress {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="ErrCoversheetRequestToAddress" />
    /// </summary>
    public class ErrCoversheetRequestToAddressJsonConverter : JsonConverter<ErrCoversheetRequestToAddress>
    {
        /// <summary>
        /// Deserializes json to <see cref="ErrCoversheetRequestToAddress" />
        /// </summary>
        ...
        public override ErrCoversheetRequestToAddress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class ErrCoversheetRequestToAddress.");

            if (addressLine1.IsSet && addressLine1.Value == null)
                throw new ArgumentNullException(nameof(addressLine1), "Property is not nullable for class ErrCoversheetRequestToAddress.");

            if (addressLine2.IsSet && addressLine2.Value == null)
                throw new ArgumentNullException(nameof(addressLine2), "Property is not nullable for class ErrCoversheetRequestToAddress.");

            if (addressLine3.IsSet && addressLine3.Value == null)
                throw new ArgumentNullException(nameof(addressLine3), "Property is not nullable for class ErrCoversheetRequestToAddress.");

            if (cityTown.IsSet && cityTown.Value == null)
                throw new ArgumentNullException(nameof(cityTown), "Property is not nullable for class ErrCoversheetRequestToAddress.");

            if (stateProvince.IsSet && stateProvince.Value == null)
                throw new ArgumentNullException(nameof(stateProvince), "Property is not nullable for class ErrCoversheetRequestToAddress.");

            if (postalCode.IsSet && postalCode.Value == null)
                throw new ArgumentNullException(nameof(postalCode), "Property is not nullable for class ErrCoversheetRequestToAddress.");

            if (countryCode.IsSet && countryCode.Value == null)
                throw new ArgumentNullException(nameof(countryCode), "Property is not nullable for class ErrCoversheetRequestToAddress.");

            if (phone.IsSet && phone.Value == null)
                throw new ArgumentNullException(nameof(phone), "Property is not nullable for class ErrCoversheetRequestToAddress.");

            if (company.IsSet && company.Value == null)
                throw new ArgumentNullException(nameof(company), "Property is not nullable for class ErrCoversheetRequestToAddress.");

            if (email.IsSet && email.Value == null)
                throw new ArgumentNullException(nameof(email), "Property is not nullable for class ErrCoversheetRequestToAddress.");

            if (residential.IsSet && residential.Value == null)
                throw new ArgumentNullException(nameof(residential), "Property is not nullable for class ErrCoversheetRequestToAddress.");

            return new ErrCoversheetRequestToAddress(name, addressLine1, addressLine2, addressLine3, cityTown, stateProvince, postalCode, countryCode, phone, company, email, residential);
        }

        /// <summary>
        /// Serializes a <see cref="ErrCoversheetRequestToAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="errCoversheetRequestToAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ErrCoversheetRequestToAddress errCoversheetRequestToAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, errCoversheetRequestToAddress, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ErrCoversheetRequestToAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="errCoversheetRequestToAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ErrCoversheetRequestToAddress errCoversheetRequestToAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            if (errCoversheetRequestToAddress.NameOption.IsSet && errCoversheetRequestToAddress.Name == null)
                throw new ArgumentNullException(nameof(errCoversheetRequestToAddress.Name), "Property is required for class ErrCoversheetRequestToAddress.");

            if (errCoversheetRequestToAddress.AddressLine1Option.IsSet && errCoversheetRequestToAddress.AddressLine1 == null)
                throw new ArgumentNullException(nameof(errCoversheetRequestToAddress.AddressLine1), "Property is required for class ErrCoversheetRequestToAddress.");

            if (errCoversheetRequestToAddress.AddressLine2Option.IsSet && errCoversheetRequestToAddress.AddressLine2 == null)
                throw new ArgumentNullException(nameof(errCoversheetRequestToAddress.AddressLine2), "Property is required for class ErrCoversheetRequestToAddress.");

            if (errCoversheetRequestToAddress.AddressLine3Option.IsSet && errCoversheetRequestToAddress.AddressLine3 == null)
                throw new ArgumentNullException(nameof(errCoversheetRequestToAddress.AddressLine3), "Property is required for class ErrCoversheetRequestToAddress.");

            if (errCoversheetRequestToAddress.CityTownOption.IsSet && errCoversheetRequestToAddress.CityTown == null)
                throw new ArgumentNullException(nameof(errCoversheetRequestToAddress.CityTown), "Property is required for class ErrCoversheetRequestToAddress.");

            if (errCoversheetRequestToAddress.StateProvinceOption.IsSet && errCoversheetRequestToAddress.StateProvince == null)
                throw new ArgumentNullException(nameof(errCoversheetRequestToAddress.StateProvince), "Property is required for class ErrCoversheetRequestToAddress.");

            if (errCoversheetRequestToAddress.PostalCodeOption.IsSet && errCoversheetRequestToAddress.PostalCode == null)
                throw new ArgumentNullException(nameof(errCoversheetRequestToAddress.PostalCode), "Property is required for class ErrCoversheetRequestToAddress.");

            if (errCoversheetRequestToAddress.CountryCodeOption.IsSet && errCoversheetRequestToAddress.CountryCode == null)
                throw new ArgumentNullException(nameof(errCoversheetRequestToAddress.CountryCode), "Property is required for class ErrCoversheetRequestToAddress.");

            if (errCoversheetRequestToAddress.PhoneOption.IsSet && errCoversheetRequestToAddress.Phone == null)
                throw new ArgumentNullException(nameof(errCoversheetRequestToAddress.Phone), "Property is required for class ErrCoversheetRequestToAddress.");

            if (errCoversheetRequestToAddress.CompanyOption.IsSet && errCoversheetRequestToAddress.Company == null)
                throw new ArgumentNullException(nameof(errCoversheetRequestToAddress.Company), "Property is required for class ErrCoversheetRequestToAddress.");

            if (errCoversheetRequestToAddress.EmailOption.IsSet && errCoversheetRequestToAddress.Email == null)
                throw new ArgumentNullException(nameof(errCoversheetRequestToAddress.Email), "Property is required for class ErrCoversheetRequestToAddress.");

            if (errCoversheetRequestToAddress.NameOption.IsSet)
                writer.WriteString("name", errCoversheetRequestToAddress.Name);

            if (errCoversheetRequestToAddress.AddressLine1Option.IsSet)
                writer.WriteString("addressLine1", errCoversheetRequestToAddress.AddressLine1);

            if (errCoversheetRequestToAddress.AddressLine2Option.IsSet)
                writer.WriteString("addressLine2", errCoversheetRequestToAddress.AddressLine2);

            if (errCoversheetRequestToAddress.AddressLine3Option.IsSet)
                writer.WriteString("addressLine3", errCoversheetRequestToAddress.AddressLine3);

            if (errCoversheetRequestToAddress.CityTownOption.IsSet)
                writer.WriteString("cityTown", errCoversheetRequestToAddress.CityTown);

            if (errCoversheetRequestToAddress.StateProvinceOption.IsSet)
                writer.WriteString("stateProvince", errCoversheetRequestToAddress.StateProvince);

            if (errCoversheetRequestToAddress.PostalCodeOption.IsSet)
                writer.WriteString("postalCode", errCoversheetRequestToAddress.PostalCode);

            if (errCoversheetRequestToAddress.CountryCodeOption.IsSet)
                writer.WriteString("countryCode", errCoversheetRequestToAddress.CountryCode);

            if (errCoversheetRequestToAddress.PhoneOption.IsSet)
                writer.WriteString("phone", errCoversheetRequestToAddress.Phone);

            if (errCoversheetRequestToAddress.CompanyOption.IsSet)
                writer.WriteString("company", errCoversheetRequestToAddress.Company);

            if (errCoversheetRequestToAddress.EmailOption.IsSet)
                writer.WriteString("email", errCoversheetRequestToAddress.Email);

            if (errCoversheetRequestToAddress.ResidentialOption.IsSet)
                writer.WriteBoolean("residential", errCoversheetRequestToAddress.ResidentialOption.Value.Value);
        }
    }
}
