...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    public partial class GetSingleShipmentToAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetSingleShipmentToAddress" /> class.
        /// </summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="GetSingleShipmentToAddress" />
    /// </summary>
    public class GetSingleShipmentToAddressJsonConverter : JsonConverter<GetSingleShipmentToAddress>
    {
        /// <summary>
        /// Deserializes json to <see cref="GetSingleShipmentToAddress" />
        /// </summary>
        ...
        public override GetSingleShipmentToAddress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (addressLine1.IsSet && addressLine1.Value == null)
                throw new ArgumentNullException(nameof(addressLine1), "Property is not nullable for class GetSingleShipmentToAddress.");

            if (addressLine2.IsSet && addressLine2.Value == null)
                throw new ArgumentNullException(nameof(addressLine2), "Property is not nullable for class GetSingleShipmentToAddress.");

            if (addressLine3.IsSet && addressLine3.Value == null)
                throw new ArgumentNullException(nameof(addressLine3), "Property is not nullable for class GetSingleShipmentToAddress.");

            if (cityTown.IsSet && cityTown.Value == null)
                throw new ArgumentNullException(nameof(cityTown), "Property is not nullable for class GetSingleShipmentToAddress.");

            if (company.IsSet && company.Value == null)
                throw new ArgumentNullException(nameof(company), "Property is not nullable for class GetSingleShipmentToAddress.");

            if (countryCode.IsSet && countryCode.Value == null)
                throw new ArgumentNullException(nameof(countryCode), "Property is not nullable for class GetSingleShipmentToAddress.");

            if (email.IsSet && email.Value == null)
                throw new ArgumentNullException(nameof(email), "Property is not nullable for class GetSingleShipmentToAddress.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class GetSingleShipmentToAddress.");

            if (phone.IsSet && phone.Value == null)
                throw new ArgumentNullException(nameof(phone), "Property is not nullable for class GetSingleShipmentToAddress.");

            if (postalCode.IsSet && postalCode.Value == null)
                throw new ArgumentNullException(nameof(postalCode), "Property is not nullable for class GetSingleShipmentToAddress.");

            if (residential.IsSet && residential.Value == null)
                throw new ArgumentNullException(nameof(residential), "Property is not nullable for class GetSingleShipmentToAddress.");

            if (stateProvince.IsSet && stateProvince.Value == null)
                throw new ArgumentNullException(nameof(stateProvince), "Property is not nullable for class GetSingleShipmentToAddress.");

            return new GetSingleShipmentToAddress(addressLine1, addressLine2, addressLine3, cityTown, company, countryCode, email, name, phone, postalCode, residential, stateProvince);
        }

        /// <summary>
        /// Serializes a <see cref="GetSingleShipmentToAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getSingleShipmentToAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GetSingleShipmentToAddress getSingleShipmentToAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, getSingleShipmentToAddress, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GetSingleShipmentToAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getSingleShipmentToAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, GetSingleShipmentToAddress getSingleShipmentToAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            if (getSingleShipmentToAddress.AddressLine1Option.IsSet && getSingleShipmentToAddress.AddressLine1 == null)
                throw new ArgumentNullException(nameof(getSingleShipmentToAddress.AddressLine1), "Property is required for class GetSingleShipmentToAddress.");

            if (getSingleShipmentToAddress.AddressLine2Option.IsSet && getSingleShipmentToAddress.AddressLine2 == null)
                throw new ArgumentNullException(nameof(getSingleShipmentToAddress.AddressLine2), "Property is required for class GetSingleShipmentToAddress.");

            if (getSingleShipmentToAddress.AddressLine3Option.IsSet && getSingleShipmentToAddress.AddressLine3 == null)
                throw new ArgumentNullException(nameof(getSingleShipmentToAddress.AddressLine3), "Property is required for class GetSingleShipmentToAddress.");

            if (getSingleShipmentToAddress.CityTownOption.IsSet && getSingleShipmentToAddress.CityTown == null)
                throw new ArgumentNullException(nameof(getSingleShipmentToAddress.CityTown), "Property is required for class GetSingleShipmentToAddress.");

            if (getSingleShipmentToAddress.CompanyOption.IsSet && getSingleShipmentToAddress.Company == null)
                throw new ArgumentNullException(nameof(getSingleShipmentToAddress.Company), "Property is required for class GetSingleShipmentToAddress.");

            if (getSingleShipmentToAddress.CountryCodeOption.IsSet && getSingleShipmentToAddress.CountryCode == null)
                throw new ArgumentNullException(nameof(getSingleShipmentToAddress.CountryCode), "Property is required for class GetSingleShipmentToAddress.");

            if (getSingleShipmentToAddress.EmailOption.IsSet && getSingleShipmentToAddress.Email == null)
                throw new ArgumentNullException(nameof(getSingleShipmentToAddress.Email), "Property is required for class GetSingleShipmentToAddress.");

            if (getSingleShipmentToAddress.NameOption.IsSet && getSingleShipmentToAddress.Name == null)
                throw new ArgumentNullException(nameof(getSingleShipmentToAddress.Name), "Property is required for class GetSingleShipmentToAddress.");

            if (getSingleShipmentToAddress.PhoneOption.IsSet && getSingleShipmentToAddress.Phone == null)
                throw new ArgumentNullException(nameof(getSingleShipmentToAddress.Phone), "Property is required for class GetSingleShipmentToAddress.");

            if (getSingleShipmentToAddress.PostalCodeOption.IsSet && getSingleShipmentToAddress.PostalCode == null)
                throw new ArgumentNullException(nameof(getSingleShipmentToAddress.PostalCode), "Property is required for class GetSingleShipmentToAddress.");

            if (getSingleShipmentToAddress.StateProvinceOption.IsSet && getSingleShipmentToAddress.StateProvince == null)
                throw new ArgumentNullException(nameof(getSingleShipmentToAddress.StateProvince), "Property is required for class GetSingleShipmentToAddress.");

            if (getSingleShipmentToAddress.AddressLine1Option.IsSet)
                writer.WriteString("addressLine1", getSingleShipmentToAddress.AddressLine1);

            if (getSingleShipmentToAddress.AddressLine2Option.IsSet)
                writer.WriteString("addressLine2", getSingleShipmentToAddress.AddressLine2);

            if (getSingleShipmentToAddress.AddressLine3Option.IsSet)
                writer.WriteString("addressLine3", getSingleShipmentToAddress.AddressLine3);

            if (getSingleShipmentToAddress.CityTownOption.IsSet)
                writer.WriteString("cityTown", getSingleShipmentToAddress.CityTown);

            if (getSingleShipmentToAddress.CompanyOption.IsSet)
                writer.WriteString("company", getSingleShipmentToAddress.Company);

            if (getSingleShipmentToAddress.CountryCodeOption.IsSet)
                writer.WriteString("countryCode", getSingleShipmentToAddress.CountryCode);

            if (getSingleShipmentToAddress.EmailOption.IsSet)
                writer.WriteString("email", getSingleShipmentToAddress.Email);

            if (getSingleShipmentToAddress.NameOption.IsSet)
                writer.WriteString("name", getSingleShipmentToAddress.Name);

            if (getSingleShipmentToAddress.PhoneOption.IsSet)
                writer.WriteString("phone", getSingleShipmentToAddress.Phone);

            if (getSingleShipmentToAddress.PostalCodeOption.IsSet)
                writer.WriteString("postalCode", getSingleShipmentToAddress.PostalCode);

            if (getSingleShipmentToAddress.ResidentialOption.IsSet)
                writer.WriteBoolean("residential", getSingleShipmentToAddress.ResidentialOption.Value!.Value);

            if (getSingleShipmentToAddress.StateProvinceOption.IsSet)
                writer.WriteString("stateProvince", getSingleShipmentToAddress.StateProvince);
        }
    }
}
