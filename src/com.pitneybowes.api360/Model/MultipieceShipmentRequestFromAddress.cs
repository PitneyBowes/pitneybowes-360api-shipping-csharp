...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    public partial class MultipieceShipmentRequestFromAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MultipieceShipmentRequestFromAddress" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public MultipieceShipmentRequestFromAddress(string addressLine1, string countryCode, string postalCode, string stateProvince, Option<string?> addressLine2 = default, Option<string?> addressLine3 = default, Option<string?> cityTown = default, Option<string?> company = default, Option<string?> email = default, Option<string?> name = default, Option<string?> phone = default, Option<bool?> residential = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MultipieceShipmentRequestFromAddress {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="MultipieceShipmentRequestFromAddress" />
    /// </summary>
    public class MultipieceShipmentRequestFromAddressJsonConverter : JsonConverter<MultipieceShipmentRequestFromAddress>
    {
        /// <summary>
        /// Deserializes json to <see cref="MultipieceShipmentRequestFromAddress" />
        /// </summary>
        ...
        public override MultipieceShipmentRequestFromAddress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!addressLine1.IsSet)
                throw new ArgumentException("Property is required for class MultipieceShipmentRequestFromAddress.", nameof(addressLine1));

            if (!countryCode.IsSet)
                throw new ArgumentException("Property is required for class MultipieceShipmentRequestFromAddress.", nameof(countryCode));

            if (!postalCode.IsSet)
                throw new ArgumentException("Property is required for class MultipieceShipmentRequestFromAddress.", nameof(postalCode));

            if (!stateProvince.IsSet)
                throw new ArgumentException("Property is required for class MultipieceShipmentRequestFromAddress.", nameof(stateProvince));

            if (addressLine1.IsSet && addressLine1.Value == null)
                throw new ArgumentNullException(nameof(addressLine1), "Property is not nullable for class MultipieceShipmentRequestFromAddress.");

            if (countryCode.IsSet && countryCode.Value == null)
                throw new ArgumentNullException(nameof(countryCode), "Property is not nullable for class MultipieceShipmentRequestFromAddress.");

            if (postalCode.IsSet && postalCode.Value == null)
                throw new ArgumentNullException(nameof(postalCode), "Property is not nullable for class MultipieceShipmentRequestFromAddress.");

            if (stateProvince.IsSet && stateProvince.Value == null)
                throw new ArgumentNullException(nameof(stateProvince), "Property is not nullable for class MultipieceShipmentRequestFromAddress.");

            if (addressLine2.IsSet && addressLine2.Value == null)
                throw new ArgumentNullException(nameof(addressLine2), "Property is not nullable for class MultipieceShipmentRequestFromAddress.");

            if (addressLine3.IsSet && addressLine3.Value == null)
                throw new ArgumentNullException(nameof(addressLine3), "Property is not nullable for class MultipieceShipmentRequestFromAddress.");

            if (cityTown.IsSet && cityTown.Value == null)
                throw new ArgumentNullException(nameof(cityTown), "Property is not nullable for class MultipieceShipmentRequestFromAddress.");

            if (company.IsSet && company.Value == null)
                throw new ArgumentNullException(nameof(company), "Property is not nullable for class MultipieceShipmentRequestFromAddress.");

            if (email.IsSet && email.Value == null)
                throw new ArgumentNullException(nameof(email), "Property is not nullable for class MultipieceShipmentRequestFromAddress.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class MultipieceShipmentRequestFromAddress.");

            if (phone.IsSet && phone.Value == null)
                throw new ArgumentNullException(nameof(phone), "Property is not nullable for class MultipieceShipmentRequestFromAddress.");

            if (residential.IsSet && residential.Value == null)
                throw new ArgumentNullException(nameof(residential), "Property is not nullable for class MultipieceShipmentRequestFromAddress.");

            return new MultipieceShipmentRequestFromAddress(addressLine1.Value!, countryCode.Value!, postalCode.Value!, stateProvince.Value!, addressLine2, addressLine3, cityTown, company, email, name, phone, residential);
        }

        /// <summary>
        /// Serializes a <see cref="MultipieceShipmentRequestFromAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="multipieceShipmentRequestFromAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, MultipieceShipmentRequestFromAddress multipieceShipmentRequestFromAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, multipieceShipmentRequestFromAddress, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="MultipieceShipmentRequestFromAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="multipieceShipmentRequestFromAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, MultipieceShipmentRequestFromAddress multipieceShipmentRequestFromAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            if (multipieceShipmentRequestFromAddress.AddressLine1 == null)
                throw new ArgumentNullException(nameof(multipieceShipmentRequestFromAddress.AddressLine1), "Property is required for class MultipieceShipmentRequestFromAddress.");

            if (multipieceShipmentRequestFromAddress.CountryCode == null)
                throw new ArgumentNullException(nameof(multipieceShipmentRequestFromAddress.CountryCode), "Property is required for class MultipieceShipmentRequestFromAddress.");

            if (multipieceShipmentRequestFromAddress.PostalCode == null)
                throw new ArgumentNullException(nameof(multipieceShipmentRequestFromAddress.PostalCode), "Property is required for class MultipieceShipmentRequestFromAddress.");

            if (multipieceShipmentRequestFromAddress.StateProvince == null)
                throw new ArgumentNullException(nameof(multipieceShipmentRequestFromAddress.StateProvince), "Property is required for class MultipieceShipmentRequestFromAddress.");

            if (multipieceShipmentRequestFromAddress.AddressLine2Option.IsSet && multipieceShipmentRequestFromAddress.AddressLine2 == null)
                throw new ArgumentNullException(nameof(multipieceShipmentRequestFromAddress.AddressLine2), "Property is required for class MultipieceShipmentRequestFromAddress.");

            if (multipieceShipmentRequestFromAddress.AddressLine3Option.IsSet && multipieceShipmentRequestFromAddress.AddressLine3 == null)
                throw new ArgumentNullException(nameof(multipieceShipmentRequestFromAddress.AddressLine3), "Property is required for class MultipieceShipmentRequestFromAddress.");

            if (multipieceShipmentRequestFromAddress.CityTownOption.IsSet && multipieceShipmentRequestFromAddress.CityTown == null)
                throw new ArgumentNullException(nameof(multipieceShipmentRequestFromAddress.CityTown), "Property is required for class MultipieceShipmentRequestFromAddress.");

            if (multipieceShipmentRequestFromAddress.CompanyOption.IsSet && multipieceShipmentRequestFromAddress.Company == null)
                throw new ArgumentNullException(nameof(multipieceShipmentRequestFromAddress.Company), "Property is required for class MultipieceShipmentRequestFromAddress.");

            if (multipieceShipmentRequestFromAddress.EmailOption.IsSet && multipieceShipmentRequestFromAddress.Email == null)
                throw new ArgumentNullException(nameof(multipieceShipmentRequestFromAddress.Email), "Property is required for class MultipieceShipmentRequestFromAddress.");

            if (multipieceShipmentRequestFromAddress.NameOption.IsSet && multipieceShipmentRequestFromAddress.Name == null)
                throw new ArgumentNullException(nameof(multipieceShipmentRequestFromAddress.Name), "Property is required for class MultipieceShipmentRequestFromAddress.");

            if (multipieceShipmentRequestFromAddress.PhoneOption.IsSet && multipieceShipmentRequestFromAddress.Phone == null)
                throw new ArgumentNullException(nameof(multipieceShipmentRequestFromAddress.Phone), "Property is required for class MultipieceShipmentRequestFromAddress.");

            writer.WriteString("addressLine1", multipieceShipmentRequestFromAddress.AddressLine1);

            writer.WriteString("countryCode", multipieceShipmentRequestFromAddress.CountryCode);

            writer.WriteString("postalCode", multipieceShipmentRequestFromAddress.PostalCode);

            writer.WriteString("stateProvince", multipieceShipmentRequestFromAddress.StateProvince);

            if (multipieceShipmentRequestFromAddress.AddressLine2Option.IsSet)
                writer.WriteString("addressLine2", multipieceShipmentRequestFromAddress.AddressLine2);

            if (multipieceShipmentRequestFromAddress.AddressLine3Option.IsSet)
                writer.WriteString("addressLine3", multipieceShipmentRequestFromAddress.AddressLine3);

            if (multipieceShipmentRequestFromAddress.CityTownOption.IsSet)
                writer.WriteString("cityTown", multipieceShipmentRequestFromAddress.CityTown);

            if (multipieceShipmentRequestFromAddress.CompanyOption.IsSet)
                writer.WriteString("company", multipieceShipmentRequestFromAddress.Company);

            if (multipieceShipmentRequestFromAddress.EmailOption.IsSet)
                writer.WriteString("email", multipieceShipmentRequestFromAddress.Email);

            if (multipieceShipmentRequestFromAddress.NameOption.IsSet)
                writer.WriteString("name", multipieceShipmentRequestFromAddress.Name);

            if (multipieceShipmentRequestFromAddress.PhoneOption.IsSet)
                writer.WriteString("phone", multipieceShipmentRequestFromAddress.Phone);

            if (multipieceShipmentRequestFromAddress.ResidentialOption.IsSet)
                writer.WriteBoolean("residential", multipieceShipmentRequestFromAddress.ResidentialOption.Value!.Value);
        }
    }
}
