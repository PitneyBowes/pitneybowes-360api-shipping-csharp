...
namespace com.pitneybowes.api360.Model
{
    ...
    /// SpecialService
    /// </summary>
    [DataContract(Name = "SpecialService")]
    public partial class SpecialService : IValidatableObject
    {
        ...
        /// <param name="specialserviceId">A unique identifier associate to the special service, which is to be applied. (required).</param>
        public SpecialService(List<Parameter> inputParameters = default(List<Parameter>), string specialserviceId = default(string))
        {
            // to ensure "specialserviceId" is required (not null)
            if (specialserviceId == null)
            {
                throw new ArgumentNullException("specialserviceId is a required property for SpecialService and cannot be null");
            }
