...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    [DataContract(Name = "shipmentDomesticByRateGroup")]
    public partial class ShipmentDomesticByRateGroup : IValidatableObject
    {
        ...
        protected ShipmentDomesticByRateGroup() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ShipmentDomesticByRateGroup" /> class.
        /// </summary>
        ...
        public ShipmentDomesticByRateGroup(FromAddressV2 fromAddress = default(FromAddressV2), ToAddressV2 toAddress = default(ToAddressV2), ParcelV2 parcel = default(ParcelV2), string parcelType = default(string), RateShopByEnum? rateShopBy = default(RateShopByEnum?), ShipmentDomesticByRateGroupByRateGroup byRateGroup = default(ShipmentDomesticByRateGroupByRateGroup), ShipmentDomesticByRateGroupShipmentOptions shipmentOptions = default(ShipmentDomesticByRateGroupShipmentOptions), ShipmentDomesticByCarrierDocTab docTab = default(ShipmentDomesticByCarrierDocTab), DeliveryConfirmationEnum? deliveryConfirmation = default(DeliveryConfirmationEnum?), HandlingEnum? handling = default(HandlingEnum?), InsuranceEnum? insurance = default(InsuranceEnum?), ReferenceV2 references = default(ReferenceV2), List<ShipmentDomesticByRateGroupMetadataInner> metadata = default(List<ShipmentDomesticByRateGroupMetadataInner>), LabelSizeEnum labelSize = default(LabelSizeEnum), LabelTypeEnum labelType = default(LabelTypeEnum), LabelFormatEnum labelFormat = default(LabelFormatEnum), string printerAliasName = default(string), DateOnly dateOfShipment = default(DateOnly), ShipmentDomesticByCarrierDeliveryOption deliveryOption = default(ShipmentDomesticByCarrierDeliveryOption))
        {
            // to ensure "fromAddress" is required (not null)
            if (fromAddress == null)
            {
                throw new ArgumentNullException("fromAddress is a required property for ShipmentDomesticByRateGroup and cannot be null");
            }
            this.FromAddress = fromAddress;
            // to ensure "toAddress" is required (not null)
            if (toAddress == null)
            {
                throw new ArgumentNullException("toAddress is a required property for ShipmentDomesticByRateGroup and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "byRateGroup", EmitDefaultValue = false)]
        ...
        public ShipmentDomesticByRateGroupShipmentOptions ShipmentOptions { get; set; }
        ...
        public List<ShipmentDomesticByRateGroupMetadataInner> Metadata { get; set; }
