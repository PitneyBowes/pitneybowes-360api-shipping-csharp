...
namespace com.pitneybowes.api360.Model
{
    ...
    public partial class ShipmentDomesticByRateGroup : IValidatableObject
    {
        ...
        [JsonConstructor]
        public ShipmentDomesticByRateGroup(FromAddressV2 fromAddress, ToAddressV2 toAddress, string parcelType, LabelSizeEnum labelSize, LabelTypeEnum labelType, LabelFormatEnum labelFormat, Option<SoldToAddressV2> soldToAddress = default, Option<List<AdditionalAddressesInner>> additionalAddresses = default, Option<ShipmentDomesticByRateGroupAltReturnAddress> altReturnAddress = default, Option<ParcelV2> parcel = default, Option<RateShopByEnum?> rateShopBy = default, Option<ShipmentDomesticByRateGroupByRateGroup> byRateGroup = default, Option<ShipmentDomesticByRateGroupShipmentOptions> shipmentOptions = default, Option<List<CarrierPaymentsInner>> carrierPayments = default, Option<ShipmentDomesticByCarrierDocTab> docTab = default, Option<MilitaryMailShipmentsRequestV2DeliveryConfirmation> deliveryConfirmation = default, Option<MilitaryMailShipmentsRequestV2Handling> handling = default, Option<MilitaryMailShipmentsRequestV2Insurance> insurance = default, Option<ReferenceV2> references = default, Option<List<ShipmentDomesticByCustomCarrierCodeMetadataInner>> metadata = default, Option<ContentTypeEnum?> contentType = default, Option<string> printerAliasName = default, Option<DateTime?> dateOfShipment = default, Option<ShipmentDomesticByRateGroupDeliveryOption> deliveryOption = default)
        {
        ...
        public RateShopByEnum? RateShopBy { get { return this.RateShopByOption; } set { this.RateShopByOption = new Option<RateShopByEnum?>(value); } }
        ...
        public ShipmentDomesticByRateGroupAltReturnAddress AltReturnAddress { get { return this.AltReturnAddressOption; } set { this.AltReturnAddressOption = new Option<ShipmentDomesticByRateGroupAltReturnAddress>(value); } }
        ...
        public ShipmentDomesticByRateGroupByRateGroup ByRateGroup { get { return this.ByRateGroupOption; } set { this.ByRateGroupOption = new Option<ShipmentDomesticByRateGroupByRateGroup>(value); } }
        ...
        public ShipmentDomesticByRateGroupShipmentOptions ShipmentOptions { get { return this.ShipmentOptionsOption; } set { this.ShipmentOptionsOption = new Option<ShipmentDomesticByRateGroupShipmentOptions>(value); } }
        ...
        public ShipmentDomesticByRateGroupDeliveryOption DeliveryOption { get { return this.DeliveryOptionOption; } set { this.DeliveryOptionOption = new Option<ShipmentDomesticByRateGroupDeliveryOption>(value); } }
