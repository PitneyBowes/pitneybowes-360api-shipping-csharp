...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    [DataContract(Name = "parcelTypes_inner_dimensionRules_inner_maxParcelDimensions")]
    public partial class ParcelTypesInnerDimensionRulesInnerMaxParcelDimensions : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ParcelTypesInnerDimensionRulesInnerMaxParcelDimensions" /> class.
        /// </summary>
        ...
        public ParcelTypesInnerDimensionRulesInnerMaxParcelDimensions(decimal height = default(decimal), decimal length = default(decimal), string unitOfMeasurement = default(string), decimal width = default(decimal))
        {
            this.Height = height;
            this.Length = length;
