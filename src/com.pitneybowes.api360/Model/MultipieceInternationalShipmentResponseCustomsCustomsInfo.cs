...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MultipieceInternationalShipmentResponse_customs_customsInfo")]
    public partial class MultipieceInternationalShipmentResponseCustomsCustomsInfo : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MultipieceInternationalShipmentResponseCustomsCustomsInfo" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MultipieceInternationalShipmentResponseCustomsCustomsInfo() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MultipieceInternationalShipmentResponseCustomsCustomsInfo" /> class.
        /// </summary>
        ...
        public MultipieceInternationalShipmentResponseCustomsCustomsInfo(ReasonForExportEnum reasonForExport = default(ReasonForExportEnum), decimal customsDeclaredValue = default(decimal), string currencyCode = default(string), string eELPFC = default(string), string certificateNumber = default(string), string comments = default(string), string fromCustomsReference = default(string), string importerCustomsReference = default(string), string invoiceNumber = default(string), string licenseNumber = default(string), decimal sdrValue = default(decimal))
        {
            ...
            {
                throw new ArgumentNullException("currencyCode is a required property for MultipieceInternationalShipmentResponseCustomsCustomsInfo and cannot be null");
            }
