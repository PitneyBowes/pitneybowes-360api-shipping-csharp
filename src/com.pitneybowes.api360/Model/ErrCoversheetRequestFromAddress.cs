...
{
    /// <summary>
    /// ErrCoversheetRequestFromAddress
    /// </summary>
    public partial class ErrCoversheetRequestFromAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ErrCoversheetRequestFromAddress" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public ErrCoversheetRequestFromAddress(Option<string> name = default, Option<string> addressLine1 = default, Option<string> addressLine2 = default, Option<string> addressLine3 = default, Option<string> cityTown = default, Option<string> stateProvince = default, Option<string> postalCode = default, Option<string> countryCode = default, Option<string> phone = default, Option<string> company = default, Option<string> email = default, Option<string> inductionPostalCode = default, Option<bool?> residential = default)
        {
            NameOption = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ErrCoversheetRequestFromAddress {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="ErrCoversheetRequestFromAddress" />
    /// </summary>
    public class ErrCoversheetRequestFromAddressJsonConverter : JsonConverter<ErrCoversheetRequestFromAddress>
    {
        /// <summary>
        /// Deserializes json to <see cref="ErrCoversheetRequestFromAddress" />
        /// </summary>
        ...
        public override ErrCoversheetRequestFromAddress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class ErrCoversheetRequestFromAddress.");

            if (addressLine1.IsSet && addressLine1.Value == null)
                throw new ArgumentNullException(nameof(addressLine1), "Property is not nullable for class ErrCoversheetRequestFromAddress.");

            if (addressLine2.IsSet && addressLine2.Value == null)
                throw new ArgumentNullException(nameof(addressLine2), "Property is not nullable for class ErrCoversheetRequestFromAddress.");

            if (addressLine3.IsSet && addressLine3.Value == null)
                throw new ArgumentNullException(nameof(addressLine3), "Property is not nullable for class ErrCoversheetRequestFromAddress.");

            if (cityTown.IsSet && cityTown.Value == null)
                throw new ArgumentNullException(nameof(cityTown), "Property is not nullable for class ErrCoversheetRequestFromAddress.");

            if (stateProvince.IsSet && stateProvince.Value == null)
                throw new ArgumentNullException(nameof(stateProvince), "Property is not nullable for class ErrCoversheetRequestFromAddress.");

            if (postalCode.IsSet && postalCode.Value == null)
                throw new ArgumentNullException(nameof(postalCode), "Property is not nullable for class ErrCoversheetRequestFromAddress.");

            if (countryCode.IsSet && countryCode.Value == null)
                throw new ArgumentNullException(nameof(countryCode), "Property is not nullable for class ErrCoversheetRequestFromAddress.");

            if (phone.IsSet && phone.Value == null)
                throw new ArgumentNullException(nameof(phone), "Property is not nullable for class ErrCoversheetRequestFromAddress.");

            if (company.IsSet && company.Value == null)
                throw new ArgumentNullException(nameof(company), "Property is not nullable for class ErrCoversheetRequestFromAddress.");

            if (email.IsSet && email.Value == null)
                throw new ArgumentNullException(nameof(email), "Property is not nullable for class ErrCoversheetRequestFromAddress.");

            if (inductionPostalCode.IsSet && inductionPostalCode.Value == null)
                throw new ArgumentNullException(nameof(inductionPostalCode), "Property is not nullable for class ErrCoversheetRequestFromAddress.");

            if (residential.IsSet && residential.Value == null)
                throw new ArgumentNullException(nameof(residential), "Property is not nullable for class ErrCoversheetRequestFromAddress.");

            return new ErrCoversheetRequestFromAddress(name, addressLine1, addressLine2, addressLine3, cityTown, stateProvince, postalCode, countryCode, phone, company, email, inductionPostalCode, residential);
        }

        /// <summary>
        /// Serializes a <see cref="ErrCoversheetRequestFromAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="errCoversheetRequestFromAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ErrCoversheetRequestFromAddress errCoversheetRequestFromAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, errCoversheetRequestFromAddress, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ErrCoversheetRequestFromAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="errCoversheetRequestFromAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ErrCoversheetRequestFromAddress errCoversheetRequestFromAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            if (errCoversheetRequestFromAddress.NameOption.IsSet && errCoversheetRequestFromAddress.Name == null)
                throw new ArgumentNullException(nameof(errCoversheetRequestFromAddress.Name), "Property is required for class ErrCoversheetRequestFromAddress.");

            if (errCoversheetRequestFromAddress.AddressLine1Option.IsSet && errCoversheetRequestFromAddress.AddressLine1 == null)
                throw new ArgumentNullException(nameof(errCoversheetRequestFromAddress.AddressLine1), "Property is required for class ErrCoversheetRequestFromAddress.");

            if (errCoversheetRequestFromAddress.AddressLine2Option.IsSet && errCoversheetRequestFromAddress.AddressLine2 == null)
                throw new ArgumentNullException(nameof(errCoversheetRequestFromAddress.AddressLine2), "Property is required for class ErrCoversheetRequestFromAddress.");

            if (errCoversheetRequestFromAddress.AddressLine3Option.IsSet && errCoversheetRequestFromAddress.AddressLine3 == null)
                throw new ArgumentNullException(nameof(errCoversheetRequestFromAddress.AddressLine3), "Property is required for class ErrCoversheetRequestFromAddress.");

            if (errCoversheetRequestFromAddress.CityTownOption.IsSet && errCoversheetRequestFromAddress.CityTown == null)
                throw new ArgumentNullException(nameof(errCoversheetRequestFromAddress.CityTown), "Property is required for class ErrCoversheetRequestFromAddress.");

            if (errCoversheetRequestFromAddress.StateProvinceOption.IsSet && errCoversheetRequestFromAddress.StateProvince == null)
                throw new ArgumentNullException(nameof(errCoversheetRequestFromAddress.StateProvince), "Property is required for class ErrCoversheetRequestFromAddress.");

            if (errCoversheetRequestFromAddress.PostalCodeOption.IsSet && errCoversheetRequestFromAddress.PostalCode == null)
                throw new ArgumentNullException(nameof(errCoversheetRequestFromAddress.PostalCode), "Property is required for class ErrCoversheetRequestFromAddress.");

            if (errCoversheetRequestFromAddress.CountryCodeOption.IsSet && errCoversheetRequestFromAddress.CountryCode == null)
                throw new ArgumentNullException(nameof(errCoversheetRequestFromAddress.CountryCode), "Property is required for class ErrCoversheetRequestFromAddress.");

            if (errCoversheetRequestFromAddress.PhoneOption.IsSet && errCoversheetRequestFromAddress.Phone == null)
                throw new ArgumentNullException(nameof(errCoversheetRequestFromAddress.Phone), "Property is required for class ErrCoversheetRequestFromAddress.");

            if (errCoversheetRequestFromAddress.CompanyOption.IsSet && errCoversheetRequestFromAddress.Company == null)
                throw new ArgumentNullException(nameof(errCoversheetRequestFromAddress.Company), "Property is required for class ErrCoversheetRequestFromAddress.");

            if (errCoversheetRequestFromAddress.EmailOption.IsSet && errCoversheetRequestFromAddress.Email == null)
                throw new ArgumentNullException(nameof(errCoversheetRequestFromAddress.Email), "Property is required for class ErrCoversheetRequestFromAddress.");

            if (errCoversheetRequestFromAddress.InductionPostalCodeOption.IsSet && errCoversheetRequestFromAddress.InductionPostalCode == null)
                throw new ArgumentNullException(nameof(errCoversheetRequestFromAddress.InductionPostalCode), "Property is required for class ErrCoversheetRequestFromAddress.");

            if (errCoversheetRequestFromAddress.NameOption.IsSet)
                writer.WriteString("name", errCoversheetRequestFromAddress.Name);

            if (errCoversheetRequestFromAddress.AddressLine1Option.IsSet)
                writer.WriteString("addressLine1", errCoversheetRequestFromAddress.AddressLine1);

            if (errCoversheetRequestFromAddress.AddressLine2Option.IsSet)
                writer.WriteString("addressLine2", errCoversheetRequestFromAddress.AddressLine2);

            if (errCoversheetRequestFromAddress.AddressLine3Option.IsSet)
                writer.WriteString("addressLine3", errCoversheetRequestFromAddress.AddressLine3);

            if (errCoversheetRequestFromAddress.CityTownOption.IsSet)
                writer.WriteString("cityTown", errCoversheetRequestFromAddress.CityTown);

            if (errCoversheetRequestFromAddress.StateProvinceOption.IsSet)
                writer.WriteString("stateProvince", errCoversheetRequestFromAddress.StateProvince);

            if (errCoversheetRequestFromAddress.PostalCodeOption.IsSet)
                writer.WriteString("postalCode", errCoversheetRequestFromAddress.PostalCode);

            if (errCoversheetRequestFromAddress.CountryCodeOption.IsSet)
                writer.WriteString("countryCode", errCoversheetRequestFromAddress.CountryCode);

            if (errCoversheetRequestFromAddress.PhoneOption.IsSet)
                writer.WriteString("phone", errCoversheetRequestFromAddress.Phone);

            if (errCoversheetRequestFromAddress.CompanyOption.IsSet)
                writer.WriteString("company", errCoversheetRequestFromAddress.Company);

            if (errCoversheetRequestFromAddress.EmailOption.IsSet)
                writer.WriteString("email", errCoversheetRequestFromAddress.Email);

            if (errCoversheetRequestFromAddress.InductionPostalCodeOption.IsSet)
                writer.WriteString("inductionPostalCode", errCoversheetRequestFromAddress.InductionPostalCode);

            if (errCoversheetRequestFromAddress.ResidentialOption.IsSet)
                writer.WriteBoolean("residential", errCoversheetRequestFromAddress.ResidentialOption.Value.Value);
        }
    }
}
