...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    public partial class ReturnLabelToAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReturnLabelToAddress" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public ReturnLabelToAddress(string addressLine1, Option<string> addressLine2 = default, Option<string> addressLine3 = default, Option<string> email = default, Option<string> cityTown = default, Option<string> countryCode = default, Option<string> name = default, Option<string> company = default, Option<string> phone = default, Option<string> postalCode = default, Option<string> stateProvince = default, Option<bool?> residential = default)
        {
        ...
        /* <example>762 Atlantic Ave</example> */
    ...
    /// <summary>
    /// A Json converter for type <see cref="ReturnLabelToAddress" />
    /// </summary>
    public class ReturnLabelToAddressJsonConverter : JsonConverter<ReturnLabelToAddress>
    {
        /// <summary>
        /// Deserializes json to <see cref="ReturnLabelToAddress" />
        /// </summary>
        ...
        public override ReturnLabelToAddress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!addressLine1.IsSet)
                throw new ArgumentException("Property is required for class ReturnLabelToAddress.", nameof(addressLine1));

            if (addressLine1.IsSet && addressLine1.Value == null)
                throw new ArgumentNullException(nameof(addressLine1), "Property is not nullable for class ReturnLabelToAddress.");

            if (addressLine2.IsSet && addressLine2.Value == null)
                throw new ArgumentNullException(nameof(addressLine2), "Property is not nullable for class ReturnLabelToAddress.");

            if (addressLine3.IsSet && addressLine3.Value == null)
                throw new ArgumentNullException(nameof(addressLine3), "Property is not nullable for class ReturnLabelToAddress.");

            if (email.IsSet && email.Value == null)
                throw new ArgumentNullException(nameof(email), "Property is not nullable for class ReturnLabelToAddress.");

            if (cityTown.IsSet && cityTown.Value == null)
                throw new ArgumentNullException(nameof(cityTown), "Property is not nullable for class ReturnLabelToAddress.");

            if (countryCode.IsSet && countryCode.Value == null)
                throw new ArgumentNullException(nameof(countryCode), "Property is not nullable for class ReturnLabelToAddress.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class ReturnLabelToAddress.");

            if (company.IsSet && company.Value == null)
                throw new ArgumentNullException(nameof(company), "Property is not nullable for class ReturnLabelToAddress.");

            if (phone.IsSet && phone.Value == null)
                throw new ArgumentNullException(nameof(phone), "Property is not nullable for class ReturnLabelToAddress.");

            if (postalCode.IsSet && postalCode.Value == null)
                throw new ArgumentNullException(nameof(postalCode), "Property is not nullable for class ReturnLabelToAddress.");

            if (stateProvince.IsSet && stateProvince.Value == null)
                throw new ArgumentNullException(nameof(stateProvince), "Property is not nullable for class ReturnLabelToAddress.");

            if (residential.IsSet && residential.Value == null)
                throw new ArgumentNullException(nameof(residential), "Property is not nullable for class ReturnLabelToAddress.");

            return new ReturnLabelToAddress(addressLine1.Value, addressLine2, addressLine3, email, cityTown, countryCode, name, company, phone, postalCode, stateProvince, residential);
        }

        /// <summary>
        /// Serializes a <see cref="ReturnLabelToAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="returnLabelToAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ReturnLabelToAddress returnLabelToAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, returnLabelToAddress, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ReturnLabelToAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="returnLabelToAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ReturnLabelToAddress returnLabelToAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            if (returnLabelToAddress.AddressLine1 == null)
                throw new ArgumentNullException(nameof(returnLabelToAddress.AddressLine1), "Property is required for class ReturnLabelToAddress.");

            if (returnLabelToAddress.AddressLine2Option.IsSet && returnLabelToAddress.AddressLine2 == null)
                throw new ArgumentNullException(nameof(returnLabelToAddress.AddressLine2), "Property is required for class ReturnLabelToAddress.");

            if (returnLabelToAddress.AddressLine3Option.IsSet && returnLabelToAddress.AddressLine3 == null)
                throw new ArgumentNullException(nameof(returnLabelToAddress.AddressLine3), "Property is required for class ReturnLabelToAddress.");

            if (returnLabelToAddress.EmailOption.IsSet && returnLabelToAddress.Email == null)
                throw new ArgumentNullException(nameof(returnLabelToAddress.Email), "Property is required for class ReturnLabelToAddress.");

            if (returnLabelToAddress.CityTownOption.IsSet && returnLabelToAddress.CityTown == null)
                throw new ArgumentNullException(nameof(returnLabelToAddress.CityTown), "Property is required for class ReturnLabelToAddress.");

            if (returnLabelToAddress.CountryCodeOption.IsSet && returnLabelToAddress.CountryCode == null)
                throw new ArgumentNullException(nameof(returnLabelToAddress.CountryCode), "Property is required for class ReturnLabelToAddress.");

            if (returnLabelToAddress.NameOption.IsSet && returnLabelToAddress.Name == null)
                throw new ArgumentNullException(nameof(returnLabelToAddress.Name), "Property is required for class ReturnLabelToAddress.");

            if (returnLabelToAddress.CompanyOption.IsSet && returnLabelToAddress.Company == null)
                throw new ArgumentNullException(nameof(returnLabelToAddress.Company), "Property is required for class ReturnLabelToAddress.");

            if (returnLabelToAddress.PhoneOption.IsSet && returnLabelToAddress.Phone == null)
                throw new ArgumentNullException(nameof(returnLabelToAddress.Phone), "Property is required for class ReturnLabelToAddress.");

            if (returnLabelToAddress.PostalCodeOption.IsSet && returnLabelToAddress.PostalCode == null)
                throw new ArgumentNullException(nameof(returnLabelToAddress.PostalCode), "Property is required for class ReturnLabelToAddress.");

            if (returnLabelToAddress.StateProvinceOption.IsSet && returnLabelToAddress.StateProvince == null)
                throw new ArgumentNullException(nameof(returnLabelToAddress.StateProvince), "Property is required for class ReturnLabelToAddress.");

            writer.WriteString("addressLine1", returnLabelToAddress.AddressLine1);

            if (returnLabelToAddress.AddressLine2Option.IsSet)
                writer.WriteString("addressLine2", returnLabelToAddress.AddressLine2);

            if (returnLabelToAddress.AddressLine3Option.IsSet)
                writer.WriteString("addressLine3", returnLabelToAddress.AddressLine3);

            if (returnLabelToAddress.EmailOption.IsSet)
                writer.WriteString("email", returnLabelToAddress.Email);

            if (returnLabelToAddress.CityTownOption.IsSet)
                writer.WriteString("cityTown", returnLabelToAddress.CityTown);

            if (returnLabelToAddress.CountryCodeOption.IsSet)
                writer.WriteString("countryCode", returnLabelToAddress.CountryCode);

            if (returnLabelToAddress.NameOption.IsSet)
                writer.WriteString("name", returnLabelToAddress.Name);

            if (returnLabelToAddress.CompanyOption.IsSet)
                writer.WriteString("company", returnLabelToAddress.Company);

            if (returnLabelToAddress.PhoneOption.IsSet)
                writer.WriteString("phone", returnLabelToAddress.Phone);

            if (returnLabelToAddress.PostalCodeOption.IsSet)
                writer.WriteString("postalCode", returnLabelToAddress.PostalCode);

            if (returnLabelToAddress.StateProvinceOption.IsSet)
                writer.WriteString("stateProvince", returnLabelToAddress.StateProvince);

            if (returnLabelToAddress.ResidentialOption.IsSet)
                writer.WriteBoolean("residential", returnLabelToAddress.ResidentialOption.Value.Value);
        }
    }
}
