...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    [DataContract(Name = "returnLabel_toAddress")]
    public partial class ReturnLabelToAddress : IValidatableObject
    {
        ...
        protected ReturnLabelToAddress() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ReturnLabelToAddress" /> class.
        /// </summary>
        ...
        public ReturnLabelToAddress(string addressLine1 = default(string), string email = default(string), string cityTown = default(string), string countryCode = default(string), string name = default(string), string company = default(string), string phone = default(string), string postalCode = default(string), string stateProvince = default(string))
        {
            // to ensure "addressLine1" is required (not null)
            if (addressLine1 == null)
            {
                throw new ArgumentNullException("addressLine1 is a required property for ReturnLabelToAddress and cannot be null");
            }
