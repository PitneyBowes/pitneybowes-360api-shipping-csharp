...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    public partial class InternationalShipmentResponseAltReturnAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InternationalShipmentResponseAltReturnAddress" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InternationalShipmentResponseAltReturnAddress {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="InternationalShipmentResponseAltReturnAddress" />
    /// </summary>
    public class InternationalShipmentResponseAltReturnAddressJsonConverter : JsonConverter<InternationalShipmentResponseAltReturnAddress>
    {
        /// <summary>
        /// Deserializes json to <see cref="InternationalShipmentResponseAltReturnAddress" />
        /// </summary>
        ...
        public override InternationalShipmentResponseAltReturnAddress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (addressLine1.IsSet && addressLine1.Value == null)
                throw new ArgumentNullException(nameof(addressLine1), "Property is not nullable for class InternationalShipmentResponseAltReturnAddress.");

            if (addressLine2.IsSet && addressLine2.Value == null)
                throw new ArgumentNullException(nameof(addressLine2), "Property is not nullable for class InternationalShipmentResponseAltReturnAddress.");

            if (addressLine3.IsSet && addressLine3.Value == null)
                throw new ArgumentNullException(nameof(addressLine3), "Property is not nullable for class InternationalShipmentResponseAltReturnAddress.");

            if (company.IsSet && company.Value == null)
                throw new ArgumentNullException(nameof(company), "Property is not nullable for class InternationalShipmentResponseAltReturnAddress.");

            if (email.IsSet && email.Value == null)
                throw new ArgumentNullException(nameof(email), "Property is not nullable for class InternationalShipmentResponseAltReturnAddress.");

            if (residential.IsSet && residential.Value == null)
                throw new ArgumentNullException(nameof(residential), "Property is not nullable for class InternationalShipmentResponseAltReturnAddress.");

            if (cityTown.IsSet && cityTown.Value == null)
                throw new ArgumentNullException(nameof(cityTown), "Property is not nullable for class InternationalShipmentResponseAltReturnAddress.");

            if (countryCode.IsSet && countryCode.Value == null)
                throw new ArgumentNullException(nameof(countryCode), "Property is not nullable for class InternationalShipmentResponseAltReturnAddress.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class InternationalShipmentResponseAltReturnAddress.");

            if (phone.IsSet && phone.Value == null)
                throw new ArgumentNullException(nameof(phone), "Property is not nullable for class InternationalShipmentResponseAltReturnAddress.");

            if (postalCode.IsSet && postalCode.Value == null)
                throw new ArgumentNullException(nameof(postalCode), "Property is not nullable for class InternationalShipmentResponseAltReturnAddress.");

            if (stateProvince.IsSet && stateProvince.Value == null)
                throw new ArgumentNullException(nameof(stateProvince), "Property is not nullable for class InternationalShipmentResponseAltReturnAddress.");

            return new InternationalShipmentResponseAltReturnAddress(addressLine1, addressLine2, addressLine3, company, email, residential, cityTown, countryCode, name, phone, postalCode, stateProvince);
        }

        /// <summary>
        /// Serializes a <see cref="InternationalShipmentResponseAltReturnAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="internationalShipmentResponseAltReturnAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, InternationalShipmentResponseAltReturnAddress internationalShipmentResponseAltReturnAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, internationalShipmentResponseAltReturnAddress, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="InternationalShipmentResponseAltReturnAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="internationalShipmentResponseAltReturnAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, InternationalShipmentResponseAltReturnAddress internationalShipmentResponseAltReturnAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            if (internationalShipmentResponseAltReturnAddress.AddressLine1Option.IsSet && internationalShipmentResponseAltReturnAddress.AddressLine1 == null)
                throw new ArgumentNullException(nameof(internationalShipmentResponseAltReturnAddress.AddressLine1), "Property is required for class InternationalShipmentResponseAltReturnAddress.");

            if (internationalShipmentResponseAltReturnAddress.AddressLine2Option.IsSet && internationalShipmentResponseAltReturnAddress.AddressLine2 == null)
                throw new ArgumentNullException(nameof(internationalShipmentResponseAltReturnAddress.AddressLine2), "Property is required for class InternationalShipmentResponseAltReturnAddress.");

            if (internationalShipmentResponseAltReturnAddress.AddressLine3Option.IsSet && internationalShipmentResponseAltReturnAddress.AddressLine3 == null)
                throw new ArgumentNullException(nameof(internationalShipmentResponseAltReturnAddress.AddressLine3), "Property is required for class InternationalShipmentResponseAltReturnAddress.");

            if (internationalShipmentResponseAltReturnAddress.CompanyOption.IsSet && internationalShipmentResponseAltReturnAddress.Company == null)
                throw new ArgumentNullException(nameof(internationalShipmentResponseAltReturnAddress.Company), "Property is required for class InternationalShipmentResponseAltReturnAddress.");

            if (internationalShipmentResponseAltReturnAddress.EmailOption.IsSet && internationalShipmentResponseAltReturnAddress.Email == null)
                throw new ArgumentNullException(nameof(internationalShipmentResponseAltReturnAddress.Email), "Property is required for class InternationalShipmentResponseAltReturnAddress.");

            if (internationalShipmentResponseAltReturnAddress.CityTownOption.IsSet && internationalShipmentResponseAltReturnAddress.CityTown == null)
                throw new ArgumentNullException(nameof(internationalShipmentResponseAltReturnAddress.CityTown), "Property is required for class InternationalShipmentResponseAltReturnAddress.");

            if (internationalShipmentResponseAltReturnAddress.CountryCodeOption.IsSet && internationalShipmentResponseAltReturnAddress.CountryCode == null)
                throw new ArgumentNullException(nameof(internationalShipmentResponseAltReturnAddress.CountryCode), "Property is required for class InternationalShipmentResponseAltReturnAddress.");

            if (internationalShipmentResponseAltReturnAddress.NameOption.IsSet && internationalShipmentResponseAltReturnAddress.Name == null)
                throw new ArgumentNullException(nameof(internationalShipmentResponseAltReturnAddress.Name), "Property is required for class InternationalShipmentResponseAltReturnAddress.");

            if (internationalShipmentResponseAltReturnAddress.PhoneOption.IsSet && internationalShipmentResponseAltReturnAddress.Phone == null)
                throw new ArgumentNullException(nameof(internationalShipmentResponseAltReturnAddress.Phone), "Property is required for class InternationalShipmentResponseAltReturnAddress.");

            if (internationalShipmentResponseAltReturnAddress.PostalCodeOption.IsSet && internationalShipmentResponseAltReturnAddress.PostalCode == null)
                throw new ArgumentNullException(nameof(internationalShipmentResponseAltReturnAddress.PostalCode), "Property is required for class InternationalShipmentResponseAltReturnAddress.");

            if (internationalShipmentResponseAltReturnAddress.StateProvinceOption.IsSet && internationalShipmentResponseAltReturnAddress.StateProvince == null)
                throw new ArgumentNullException(nameof(internationalShipmentResponseAltReturnAddress.StateProvince), "Property is required for class InternationalShipmentResponseAltReturnAddress.");

            if (internationalShipmentResponseAltReturnAddress.AddressLine1Option.IsSet)
                writer.WriteString("addressLine1", internationalShipmentResponseAltReturnAddress.AddressLine1);

            if (internationalShipmentResponseAltReturnAddress.AddressLine2Option.IsSet)
                writer.WriteString("addressLine2", internationalShipmentResponseAltReturnAddress.AddressLine2);

            if (internationalShipmentResponseAltReturnAddress.AddressLine3Option.IsSet)
                writer.WriteString("addressLine3", internationalShipmentResponseAltReturnAddress.AddressLine3);

            if (internationalShipmentResponseAltReturnAddress.CompanyOption.IsSet)
                writer.WriteString("company", internationalShipmentResponseAltReturnAddress.Company);

            if (internationalShipmentResponseAltReturnAddress.EmailOption.IsSet)
                writer.WriteString("email", internationalShipmentResponseAltReturnAddress.Email);

            if (internationalShipmentResponseAltReturnAddress.ResidentialOption.IsSet)
                writer.WriteBoolean("residential", internationalShipmentResponseAltReturnAddress.ResidentialOption.Value.Value);

            if (internationalShipmentResponseAltReturnAddress.CityTownOption.IsSet)
                writer.WriteString("cityTown", internationalShipmentResponseAltReturnAddress.CityTown);

            if (internationalShipmentResponseAltReturnAddress.CountryCodeOption.IsSet)
                writer.WriteString("countryCode", internationalShipmentResponseAltReturnAddress.CountryCode);

            if (internationalShipmentResponseAltReturnAddress.NameOption.IsSet)
                writer.WriteString("name", internationalShipmentResponseAltReturnAddress.Name);

            if (internationalShipmentResponseAltReturnAddress.PhoneOption.IsSet)
                writer.WriteString("phone", internationalShipmentResponseAltReturnAddress.Phone);

            if (internationalShipmentResponseAltReturnAddress.PostalCodeOption.IsSet)
                writer.WriteString("postalCode", internationalShipmentResponseAltReturnAddress.PostalCode);

            if (internationalShipmentResponseAltReturnAddress.StateProvinceOption.IsSet)
                writer.WriteString("stateProvince", internationalShipmentResponseAltReturnAddress.StateProvince);
        }
    }
}
