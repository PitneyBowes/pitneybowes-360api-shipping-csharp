...
{
    /// <summary>
    /// ReprintShipmentShipmentOptions
    /// </summary>
    public partial class ReprintShipmentShipmentOptions : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReprintShipmentShipmentOptions" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public ReprintShipmentShipmentOptions(Option<bool?> addToManifest = default, Option<string?> printCustomMessage = default, Option<ReceiptOptionEnum?> receiptOption = default, Option<string?> printDepartment = default, Option<string?> printInvoiceNumber = default, Option<string?> printPONumber = default, Option<string?> shipperId = default, Option<bool?> minimalAddressValidation = default, Option<string?> billingWeight = default, Option<string?> bookingConfirmationNumber = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReprintShipmentShipmentOptions {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="ReprintShipmentShipmentOptions" />
    /// </summary>
    public class ReprintShipmentShipmentOptionsJsonConverter : JsonConverter<ReprintShipmentShipmentOptions>
    {
        /// <summary>
        /// Deserializes json to <see cref="ReprintShipmentShipmentOptions" />
        /// </summary>
        ...
        public override ReprintShipmentShipmentOptions Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<ReprintShipmentShipmentOptions.ReceiptOptionEnum?> receiptOption = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "receiptOption":
                            ...
                            if (receiptOptionRawValue != null)
                                receiptOption = new Option<ReprintShipmentShipmentOptions.ReceiptOptionEnum?>(ReprintShipmentShipmentOptions.ReceiptOptionEnumFromStringOrDefault(receiptOptionRawValue));
                            break;
            ...
            if (addToManifest.IsSet && addToManifest.Value == null)
                throw new ArgumentNullException(nameof(addToManifest), "Property is not nullable for class ReprintShipmentShipmentOptions.");

            if (printCustomMessage.IsSet && printCustomMessage.Value == null)
                throw new ArgumentNullException(nameof(printCustomMessage), "Property is not nullable for class ReprintShipmentShipmentOptions.");

            if (receiptOption.IsSet && receiptOption.Value == null)
                throw new ArgumentNullException(nameof(receiptOption), "Property is not nullable for class ReprintShipmentShipmentOptions.");

            if (printDepartment.IsSet && printDepartment.Value == null)
                throw new ArgumentNullException(nameof(printDepartment), "Property is not nullable for class ReprintShipmentShipmentOptions.");

            if (printInvoiceNumber.IsSet && printInvoiceNumber.Value == null)
                throw new ArgumentNullException(nameof(printInvoiceNumber), "Property is not nullable for class ReprintShipmentShipmentOptions.");

            if (printPONumber.IsSet && printPONumber.Value == null)
                throw new ArgumentNullException(nameof(printPONumber), "Property is not nullable for class ReprintShipmentShipmentOptions.");

            if (shipperId.IsSet && shipperId.Value == null)
                throw new ArgumentNullException(nameof(shipperId), "Property is not nullable for class ReprintShipmentShipmentOptions.");

            if (minimalAddressValidation.IsSet && minimalAddressValidation.Value == null)
                throw new ArgumentNullException(nameof(minimalAddressValidation), "Property is not nullable for class ReprintShipmentShipmentOptions.");

            if (billingWeight.IsSet && billingWeight.Value == null)
                throw new ArgumentNullException(nameof(billingWeight), "Property is not nullable for class ReprintShipmentShipmentOptions.");

            if (bookingConfirmationNumber.IsSet && bookingConfirmationNumber.Value == null)
                throw new ArgumentNullException(nameof(bookingConfirmationNumber), "Property is not nullable for class ReprintShipmentShipmentOptions.");

            return new ReprintShipmentShipmentOptions(addToManifest, printCustomMessage, receiptOption, printDepartment, printInvoiceNumber, printPONumber, shipperId, minimalAddressValidation, billingWeight, bookingConfirmationNumber);
        }

        /// <summary>
        /// Serializes a <see cref="ReprintShipmentShipmentOptions" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="reprintShipmentShipmentOptions"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ReprintShipmentShipmentOptions reprintShipmentShipmentOptions, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, reprintShipmentShipmentOptions, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ReprintShipmentShipmentOptions" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="reprintShipmentShipmentOptions"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ReprintShipmentShipmentOptions reprintShipmentShipmentOptions, JsonSerializerOptions jsonSerializerOptions)
        {
            if (reprintShipmentShipmentOptions.PrintCustomMessageOption.IsSet && reprintShipmentShipmentOptions.PrintCustomMessage == null)
                throw new ArgumentNullException(nameof(reprintShipmentShipmentOptions.PrintCustomMessage), "Property is required for class ReprintShipmentShipmentOptions.");

            if (reprintShipmentShipmentOptions.PrintDepartmentOption.IsSet && reprintShipmentShipmentOptions.PrintDepartment == null)
                throw new ArgumentNullException(nameof(reprintShipmentShipmentOptions.PrintDepartment), "Property is required for class ReprintShipmentShipmentOptions.");

            if (reprintShipmentShipmentOptions.PrintInvoiceNumberOption.IsSet && reprintShipmentShipmentOptions.PrintInvoiceNumber == null)
                throw new ArgumentNullException(nameof(reprintShipmentShipmentOptions.PrintInvoiceNumber), "Property is required for class ReprintShipmentShipmentOptions.");

            if (reprintShipmentShipmentOptions.PrintPONumberOption.IsSet && reprintShipmentShipmentOptions.PrintPONumber == null)
                throw new ArgumentNullException(nameof(reprintShipmentShipmentOptions.PrintPONumber), "Property is required for class ReprintShipmentShipmentOptions.");

            if (reprintShipmentShipmentOptions.ShipperIdOption.IsSet && reprintShipmentShipmentOptions.ShipperId == null)
                throw new ArgumentNullException(nameof(reprintShipmentShipmentOptions.ShipperId), "Property is required for class ReprintShipmentShipmentOptions.");

            if (reprintShipmentShipmentOptions.BillingWeightOption.IsSet && reprintShipmentShipmentOptions.BillingWeight == null)
                throw new ArgumentNullException(nameof(reprintShipmentShipmentOptions.BillingWeight), "Property is required for class ReprintShipmentShipmentOptions.");

            if (reprintShipmentShipmentOptions.BookingConfirmationNumberOption.IsSet && reprintShipmentShipmentOptions.BookingConfirmationNumber == null)
                throw new ArgumentNullException(nameof(reprintShipmentShipmentOptions.BookingConfirmationNumber), "Property is required for class ReprintShipmentShipmentOptions.");

            if (reprintShipmentShipmentOptions.AddToManifestOption.IsSet)
                writer.WriteBoolean("addToManifest", reprintShipmentShipmentOptions.AddToManifestOption.Value!.Value);

            if (reprintShipmentShipmentOptions.PrintCustomMessageOption.IsSet)
                writer.WriteString("printCustomMessage", reprintShipmentShipmentOptions.PrintCustomMessage);

            var receiptOptionRawValue = ReprintShipmentShipmentOptions.ReceiptOptionEnumToJsonValue(reprintShipmentShipmentOptions.ReceiptOptionOption.Value!.Value);
            writer.WriteString("receiptOption", receiptOptionRawValue);
            if (reprintShipmentShipmentOptions.PrintDepartmentOption.IsSet)
                writer.WriteString("printDepartment", reprintShipmentShipmentOptions.PrintDepartment);

            if (reprintShipmentShipmentOptions.PrintInvoiceNumberOption.IsSet)
                writer.WriteString("printInvoiceNumber", reprintShipmentShipmentOptions.PrintInvoiceNumber);

            if (reprintShipmentShipmentOptions.PrintPONumberOption.IsSet)
                writer.WriteString("printPONumber", reprintShipmentShipmentOptions.PrintPONumber);

            if (reprintShipmentShipmentOptions.ShipperIdOption.IsSet)
                writer.WriteString("shipperId", reprintShipmentShipmentOptions.ShipperId);

            if (reprintShipmentShipmentOptions.MinimalAddressValidationOption.IsSet)
                writer.WriteBoolean("minimalAddressValidation", reprintShipmentShipmentOptions.MinimalAddressValidationOption.Value!.Value);

            if (reprintShipmentShipmentOptions.BillingWeightOption.IsSet)
                writer.WriteString("billingWeight", reprintShipmentShipmentOptions.BillingWeight);

            if (reprintShipmentShipmentOptions.BookingConfirmationNumberOption.IsSet)
                writer.WriteString("bookingConfirmationNumber", reprintShipmentShipmentOptions.BookingConfirmationNumber);
        }
    }
}
