...
namespace com.pitneybowes.api360.Model
{
    ...
    public partial class ReprintShipmentShipmentOptions : IValidatableObject
    {
        ...
        [JsonConstructor]
        public ReprintShipmentShipmentOptions(Option<bool?> addToManifest = default, Option<string?> printCustomMessage = default, Option<string?> receiptOption = default, Option<string?> printDepartment = default, Option<string?> printInvoiceNumber = default, Option<string?> printPONumber = default, Option<string?> shipperId = default, Option<bool?> minimalAddressValidation = default, Option<string?> billingWeight = default, Option<string?> bookingConfirmationNumber = default)
        {
    ...
    public class ReprintShipmentShipmentOptionsJsonConverter : JsonConverter<ReprintShipmentShipmentOptions>
    {
        ...
        public void WriteProperties(Utf8JsonWriter writer, ReprintShipmentShipmentOptions reprintShipmentShipmentOptions, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (reprintShipmentShipmentOptions.ReceiptOptionOption.IsSet && reprintShipmentShipmentOptions.ReceiptOption == null)
                throw new ArgumentNullException(nameof(reprintShipmentShipmentOptions.ReceiptOption), "Property is required for class ReprintShipmentShipmentOptions.");
            ...
            if (reprintShipmentShipmentOptions.ReceiptOptionOption.IsSet)
                writer.WriteString("receiptOption", reprintShipmentShipmentOptions.ReceiptOption);
