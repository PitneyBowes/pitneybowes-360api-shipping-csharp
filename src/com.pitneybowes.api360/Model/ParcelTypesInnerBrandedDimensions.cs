...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    [DataContract(Name = "parcelTypes_inner_brandedDimensions")]
    public partial class ParcelTypesInnerBrandedDimensions : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ParcelTypesInnerBrandedDimensions" /> class.
        /// </summary>
        /// <param name="girth">This is the measure around parcel by area or circumference..</param>
        /// <param name="height">Height is a part of Dimension objet where it helps determine a parcel’s girth..</param>
        /// <param name="length">Length is a part of Dimension objet having highest numeric value out of three required parameters (length, width, and height) of Dimension. It helps determine a parcel’s girth..</param>
        ...
        public ParcelTypesInnerBrandedDimensions(decimal girth = default(decimal), decimal height = default(decimal), decimal length = default(decimal), string unitOfMeasurement = default(string), decimal width = default(decimal))
        {
            this.Girth = girth;
            this.Height = height;
            this.Length = length;
        ...
        /// <example>0</example>
        [DataMember(Name = "girth", EmitDefaultValue = false)]
