...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    [DataContract(Name = "internationalShipmentResponse_rate")]
    public partial class InternationalShipmentResponseRate : IValidatableObject
    {
        ...
        public InternationalShipmentResponseRate(decimal baseCharge = default(decimal), string carrier = default(string), string currencyCode = default(string), string parcelType = default(string), string rateTypeId = default(string), string serviceId = default(string), List<InternationalShipmentResponseRateSpecialServicesInner> specialServices = default(List<InternationalShipmentResponseRateSpecialServicesInner>), decimal totalCarrierCharge = default(decimal))
        {
        ...
        public List<InternationalShipmentResponseRateSpecialServicesInner> SpecialServices { get; set; }
