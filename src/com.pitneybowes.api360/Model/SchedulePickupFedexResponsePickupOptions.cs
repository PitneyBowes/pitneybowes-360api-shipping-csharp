...
{
    /// <summary>
    /// SchedulePickupFedexResponsePickupOptions
    /// </summary>
    public partial class SchedulePickupFedexResponsePickupOptions : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SchedulePickupFedexResponsePickupOptions" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public SchedulePickupFedexResponsePickupOptions(Option<DateTime?> pickupStartDateTime = default, Option<DateTime?> pickupEndDateTime = default, Option<int?> overweight = default, Option<string?> carrierType = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SchedulePickupFedexResponsePickupOptions {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="SchedulePickupFedexResponsePickupOptions" />
    /// </summary>
    public class SchedulePickupFedexResponsePickupOptionsJsonConverter : JsonConverter<SchedulePickupFedexResponsePickupOptions>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="SchedulePickupFedexResponsePickupOptions" />
        /// </summary>
        ...
        public override SchedulePickupFedexResponsePickupOptions Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (pickupStartDateTime.IsSet && pickupStartDateTime.Value == null)
                throw new ArgumentNullException(nameof(pickupStartDateTime), "Property is not nullable for class SchedulePickupFedexResponsePickupOptions.");

            if (pickupEndDateTime.IsSet && pickupEndDateTime.Value == null)
                throw new ArgumentNullException(nameof(pickupEndDateTime), "Property is not nullable for class SchedulePickupFedexResponsePickupOptions.");

            if (overweight.IsSet && overweight.Value == null)
                throw new ArgumentNullException(nameof(overweight), "Property is not nullable for class SchedulePickupFedexResponsePickupOptions.");

            if (carrierType.IsSet && carrierType.Value == null)
                throw new ArgumentNullException(nameof(carrierType), "Property is not nullable for class SchedulePickupFedexResponsePickupOptions.");

            return new SchedulePickupFedexResponsePickupOptions(pickupStartDateTime, pickupEndDateTime, overweight, carrierType);
        }

        /// <summary>
        /// Serializes a <see cref="SchedulePickupFedexResponsePickupOptions" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="schedulePickupFedexResponsePickupOptions"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, SchedulePickupFedexResponsePickupOptions schedulePickupFedexResponsePickupOptions, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, schedulePickupFedexResponsePickupOptions, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="SchedulePickupFedexResponsePickupOptions" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="schedulePickupFedexResponsePickupOptions"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, SchedulePickupFedexResponsePickupOptions schedulePickupFedexResponsePickupOptions, JsonSerializerOptions jsonSerializerOptions)
        {
            if (schedulePickupFedexResponsePickupOptions.CarrierTypeOption.IsSet && schedulePickupFedexResponsePickupOptions.CarrierType == null)
                throw new ArgumentNullException(nameof(schedulePickupFedexResponsePickupOptions.CarrierType), "Property is required for class SchedulePickupFedexResponsePickupOptions.");

            if (schedulePickupFedexResponsePickupOptions.PickupStartDateTimeOption.IsSet)
                writer.WriteString("pickupStartDateTime", schedulePickupFedexResponsePickupOptions.PickupStartDateTimeOption.Value!.Value.ToString(PickupStartDateTimeFormat));

            if (schedulePickupFedexResponsePickupOptions.PickupEndDateTimeOption.IsSet)
                writer.WriteString("pickupEndDateTime", schedulePickupFedexResponsePickupOptions.PickupEndDateTimeOption.Value!.Value.ToString(PickupEndDateTimeFormat));

            if (schedulePickupFedexResponsePickupOptions.OverweightOption.IsSet)
                writer.WriteNumber("overweight", schedulePickupFedexResponsePickupOptions.OverweightOption.Value!.Value);

            if (schedulePickupFedexResponsePickupOptions.CarrierTypeOption.IsSet)
                writer.WriteString("carrierType", schedulePickupFedexResponsePickupOptions.CarrierType);
        }
    }
}
