...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    public partial class FromAddressV2Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FromAddressV2Response" /> class.
        /// </summary>
        ...
        /// <param name="email">This must be senders&#39;s valid email. Email is required if the customer is using GoFor Carrier. &lt;br /&gt; &#x60;Max length &#x3D; 30&#x60; </param>
        ...
        [JsonConstructor]
        public FromAddressV2Response(Option<string> name = default, Option<string> addressLine1 = default, Option<string> addressLine2 = default, Option<string> addressLine3 = default, Option<string> company = default, Option<string> email = default, Option<string> phone = default, Option<string> cityTown = default, Option<string> stateProvince = default, Option<string> postalCode = default, Option<string> inductionPostalCode = default, Option<string> countryCode = default, Option<bool?> residential = default)
        {
            NameOption = name;
        ...
        /// <summary>
        /// This must be senders&#39;s valid email. Email is required if the customer is using GoFor Carrier. &lt;br /&gt; &#x60;Max length &#x3D; 30&#x60; 
        /// </summary>
        /// <value>This must be senders&#39;s valid email. Email is required if the customer is using GoFor Carrier. &lt;br /&gt; &#x60;Max length &#x3D; 30&#x60; </value>
    ...
    /// <summary>
    /// A Json converter for type <see cref="FromAddressV2Response" />
    /// </summary>
    public class FromAddressV2ResponseJsonConverter : JsonConverter<FromAddressV2Response>
    {
        /// <summary>
        /// Deserializes json to <see cref="FromAddressV2Response" />
        /// </summary>
        ...
        public override FromAddressV2Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class FromAddressV2Response.");

            if (addressLine1.IsSet && addressLine1.Value == null)
                throw new ArgumentNullException(nameof(addressLine1), "Property is not nullable for class FromAddressV2Response.");

            if (addressLine2.IsSet && addressLine2.Value == null)
                throw new ArgumentNullException(nameof(addressLine2), "Property is not nullable for class FromAddressV2Response.");

            if (addressLine3.IsSet && addressLine3.Value == null)
                throw new ArgumentNullException(nameof(addressLine3), "Property is not nullable for class FromAddressV2Response.");

            if (company.IsSet && company.Value == null)
                throw new ArgumentNullException(nameof(company), "Property is not nullable for class FromAddressV2Response.");

            if (email.IsSet && email.Value == null)
                throw new ArgumentNullException(nameof(email), "Property is not nullable for class FromAddressV2Response.");

            if (phone.IsSet && phone.Value == null)
                throw new ArgumentNullException(nameof(phone), "Property is not nullable for class FromAddressV2Response.");

            if (cityTown.IsSet && cityTown.Value == null)
                throw new ArgumentNullException(nameof(cityTown), "Property is not nullable for class FromAddressV2Response.");

            if (stateProvince.IsSet && stateProvince.Value == null)
                throw new ArgumentNullException(nameof(stateProvince), "Property is not nullable for class FromAddressV2Response.");

            if (postalCode.IsSet && postalCode.Value == null)
                throw new ArgumentNullException(nameof(postalCode), "Property is not nullable for class FromAddressV2Response.");

            if (inductionPostalCode.IsSet && inductionPostalCode.Value == null)
                throw new ArgumentNullException(nameof(inductionPostalCode), "Property is not nullable for class FromAddressV2Response.");

            if (countryCode.IsSet && countryCode.Value == null)
                throw new ArgumentNullException(nameof(countryCode), "Property is not nullable for class FromAddressV2Response.");

            if (residential.IsSet && residential.Value == null)
                throw new ArgumentNullException(nameof(residential), "Property is not nullable for class FromAddressV2Response.");

            return new FromAddressV2Response(name, addressLine1, addressLine2, addressLine3, company, email, phone, cityTown, stateProvince, postalCode, inductionPostalCode, countryCode, residential);
        }

        /// <summary>
        /// Serializes a <see cref="FromAddressV2Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="fromAddressV2Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, FromAddressV2Response fromAddressV2Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, fromAddressV2Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="FromAddressV2Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="fromAddressV2Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, FromAddressV2Response fromAddressV2Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (fromAddressV2Response.NameOption.IsSet && fromAddressV2Response.Name == null)
                throw new ArgumentNullException(nameof(fromAddressV2Response.Name), "Property is required for class FromAddressV2Response.");

            if (fromAddressV2Response.AddressLine1Option.IsSet && fromAddressV2Response.AddressLine1 == null)
                throw new ArgumentNullException(nameof(fromAddressV2Response.AddressLine1), "Property is required for class FromAddressV2Response.");

            if (fromAddressV2Response.AddressLine2Option.IsSet && fromAddressV2Response.AddressLine2 == null)
                throw new ArgumentNullException(nameof(fromAddressV2Response.AddressLine2), "Property is required for class FromAddressV2Response.");

            if (fromAddressV2Response.AddressLine3Option.IsSet && fromAddressV2Response.AddressLine3 == null)
                throw new ArgumentNullException(nameof(fromAddressV2Response.AddressLine3), "Property is required for class FromAddressV2Response.");

            if (fromAddressV2Response.CompanyOption.IsSet && fromAddressV2Response.Company == null)
                throw new ArgumentNullException(nameof(fromAddressV2Response.Company), "Property is required for class FromAddressV2Response.");

            if (fromAddressV2Response.EmailOption.IsSet && fromAddressV2Response.Email == null)
                throw new ArgumentNullException(nameof(fromAddressV2Response.Email), "Property is required for class FromAddressV2Response.");

            if (fromAddressV2Response.PhoneOption.IsSet && fromAddressV2Response.Phone == null)
                throw new ArgumentNullException(nameof(fromAddressV2Response.Phone), "Property is required for class FromAddressV2Response.");

            if (fromAddressV2Response.CityTownOption.IsSet && fromAddressV2Response.CityTown == null)
                throw new ArgumentNullException(nameof(fromAddressV2Response.CityTown), "Property is required for class FromAddressV2Response.");

            if (fromAddressV2Response.StateProvinceOption.IsSet && fromAddressV2Response.StateProvince == null)
                throw new ArgumentNullException(nameof(fromAddressV2Response.StateProvince), "Property is required for class FromAddressV2Response.");

            if (fromAddressV2Response.PostalCodeOption.IsSet && fromAddressV2Response.PostalCode == null)
                throw new ArgumentNullException(nameof(fromAddressV2Response.PostalCode), "Property is required for class FromAddressV2Response.");

            if (fromAddressV2Response.InductionPostalCodeOption.IsSet && fromAddressV2Response.InductionPostalCode == null)
                throw new ArgumentNullException(nameof(fromAddressV2Response.InductionPostalCode), "Property is required for class FromAddressV2Response.");

            if (fromAddressV2Response.CountryCodeOption.IsSet && fromAddressV2Response.CountryCode == null)
                throw new ArgumentNullException(nameof(fromAddressV2Response.CountryCode), "Property is required for class FromAddressV2Response.");

            if (fromAddressV2Response.NameOption.IsSet)
                writer.WriteString("name", fromAddressV2Response.Name);

            if (fromAddressV2Response.AddressLine1Option.IsSet)
                writer.WriteString("addressLine1", fromAddressV2Response.AddressLine1);

            if (fromAddressV2Response.AddressLine2Option.IsSet)
                writer.WriteString("addressLine2", fromAddressV2Response.AddressLine2);

            if (fromAddressV2Response.AddressLine3Option.IsSet)
                writer.WriteString("addressLine3", fromAddressV2Response.AddressLine3);

            if (fromAddressV2Response.CompanyOption.IsSet)
                writer.WriteString("company", fromAddressV2Response.Company);

            if (fromAddressV2Response.EmailOption.IsSet)
                writer.WriteString("email", fromAddressV2Response.Email);

            if (fromAddressV2Response.PhoneOption.IsSet)
                writer.WriteString("phone", fromAddressV2Response.Phone);

            if (fromAddressV2Response.CityTownOption.IsSet)
                writer.WriteString("cityTown", fromAddressV2Response.CityTown);

            if (fromAddressV2Response.StateProvinceOption.IsSet)
                writer.WriteString("stateProvince", fromAddressV2Response.StateProvince);

            if (fromAddressV2Response.PostalCodeOption.IsSet)
                writer.WriteString("postalCode", fromAddressV2Response.PostalCode);

            if (fromAddressV2Response.InductionPostalCodeOption.IsSet)
                writer.WriteString("inductionPostalCode", fromAddressV2Response.InductionPostalCode);

            if (fromAddressV2Response.CountryCodeOption.IsSet)
                writer.WriteString("countryCode", fromAddressV2Response.CountryCode);

            if (fromAddressV2Response.ResidentialOption.IsSet)
                writer.WriteBoolean("residential", fromAddressV2Response.ResidentialOption.Value.Value);
        }
    }
}
