...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    [DataContract(Name = "fromAddressV2Response")]
    public partial class FromAddressV2Response : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="name">The name of the Sender to which this address points.&lt;br /&gt;.</param>
        ...
        public FromAddressV2Response(string name = default(string), string addressLine1 = default(string), string cityTown = default(string), string stateProvince = default(string), string postalCode = default(string), string countryCode = default(string), string company = default(string), string phone = default(string), string email = default(string), bool residential = default(bool))
        {
            this.Name = name;
        ...
        /// </summary>
        /// <value>The name of the Sender to which this address points.&lt;br /&gt;</value>
