...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    public partial class DHLExpressCarrierPayment : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DHLExpressCarrierPayment" /> class.
        /// </summary>
        /// <param name="accountNumber">The DHL Express account number of the party to be billed.</param>
        ...
        /// <param name="party">Billing party for DHL Express. Account number is required for all scenarios.</param>
        /// <param name="typeOfCharge">The type of charge billed to the specified party.</param>
        [JsonConstructor]
        public DHLExpressCarrierPayment(Option<string> accountNumber = default, Option<string> countryCode = default, Option<string> postalCode = default, Option<PartyEnum?> party = default, Option<TypeOfChargeEnum?> typeOfCharge = default)
        {
        ...
        /// </summary>
        /// <value>Billing party for DHL Express. Account number is required for all scenarios.</value>
        ...
        /// </summary>
        /// <value>Billing party for DHL Express. Account number is required for all scenarios.</value>
        /* <example>BILL_THIRD_PARTY</example> */
        [JsonPropertyName("party")]
        public PartyEnum? Party { get { return this.PartyOption; } set { this.PartyOption = new Option<PartyEnum?>(value); } }

        /// <summary>
        /// The type of charge billed to the specified party.
        /// </summary>
        /// <value>The type of charge billed to the specified party.</value>
        ...
        /// </summary>
        /// <value>The type of charge billed to the specified party.</value>
        /* <example>DUTIES_AND_TAXES</example> */
        [JsonPropertyName("typeOfCharge")]
        public TypeOfChargeEnum? TypeOfCharge { get { return this.TypeOfChargeOption; } set { this.TypeOfChargeOption = new Option<TypeOfChargeEnum?>(value); } }
        ...
        /// </summary>
        /// <value>The DHL Express account number of the party to be billed.</value>
        /* <example>DHL123456</example> */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DHLExpressCarrierPayment {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="DHLExpressCarrierPayment" />
    /// </summary>
    public class DHLExpressCarrierPaymentJsonConverter : JsonConverter<DHLExpressCarrierPayment>
    {
        /// <summary>
        /// Deserializes json to <see cref="DHLExpressCarrierPayment" />
        /// </summary>
        ...
        public override DHLExpressCarrierPayment Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<DHLExpressCarrierPayment.PartyEnum?> party = default;
            Option<DHLExpressCarrierPayment.TypeOfChargeEnum?> typeOfCharge = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "party":
                            ...
                            if (partyRawValue != null)
                                party = new Option<DHLExpressCarrierPayment.PartyEnum?>(DHLExpressCarrierPayment.PartyEnumFromStringOrDefault(partyRawValue));
                            break;
                        case "typeOfCharge":
                            string typeOfChargeRawValue = utf8JsonReader.GetString();
                            if (typeOfChargeRawValue != null)
                                typeOfCharge = new Option<DHLExpressCarrierPayment.TypeOfChargeEnum?>(DHLExpressCarrierPayment.TypeOfChargeEnumFromStringOrDefault(typeOfChargeRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            if (accountNumber.IsSet && accountNumber.Value == null)
                throw new ArgumentNullException(nameof(accountNumber), "Property is not nullable for class DHLExpressCarrierPayment.");

            if (countryCode.IsSet && countryCode.Value == null)
                throw new ArgumentNullException(nameof(countryCode), "Property is not nullable for class DHLExpressCarrierPayment.");

            if (postalCode.IsSet && postalCode.Value == null)
                throw new ArgumentNullException(nameof(postalCode), "Property is not nullable for class DHLExpressCarrierPayment.");

            if (party.IsSet && party.Value == null)
                throw new ArgumentNullException(nameof(party), "Property is not nullable for class DHLExpressCarrierPayment.");

            if (typeOfCharge.IsSet && typeOfCharge.Value == null)
                throw new ArgumentNullException(nameof(typeOfCharge), "Property is not nullable for class DHLExpressCarrierPayment.");

            return new DHLExpressCarrierPayment(accountNumber, countryCode, postalCode, party, typeOfCharge);
        }

        /// <summary>
        /// Serializes a <see cref="DHLExpressCarrierPayment" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="dHLExpressCarrierPayment"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, DHLExpressCarrierPayment dHLExpressCarrierPayment, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, dHLExpressCarrierPayment, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="DHLExpressCarrierPayment" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="dHLExpressCarrierPayment"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, DHLExpressCarrierPayment dHLExpressCarrierPayment, JsonSerializerOptions jsonSerializerOptions)
        {
            if (dHLExpressCarrierPayment.AccountNumberOption.IsSet && dHLExpressCarrierPayment.AccountNumber == null)
                throw new ArgumentNullException(nameof(dHLExpressCarrierPayment.AccountNumber), "Property is required for class DHLExpressCarrierPayment.");

            if (dHLExpressCarrierPayment.CountryCodeOption.IsSet && dHLExpressCarrierPayment.CountryCode == null)
                throw new ArgumentNullException(nameof(dHLExpressCarrierPayment.CountryCode), "Property is required for class DHLExpressCarrierPayment.");

            if (dHLExpressCarrierPayment.PostalCodeOption.IsSet && dHLExpressCarrierPayment.PostalCode == null)
                throw new ArgumentNullException(nameof(dHLExpressCarrierPayment.PostalCode), "Property is required for class DHLExpressCarrierPayment.");

            if (dHLExpressCarrierPayment.AccountNumberOption.IsSet)
                writer.WriteString("accountNumber", dHLExpressCarrierPayment.AccountNumber);

            if (dHLExpressCarrierPayment.CountryCodeOption.IsSet)
                writer.WriteString("countryCode", dHLExpressCarrierPayment.CountryCode);

            if (dHLExpressCarrierPayment.PostalCodeOption.IsSet)
                writer.WriteString("postalCode", dHLExpressCarrierPayment.PostalCode);

            var partyRawValue = DHLExpressCarrierPayment.PartyEnumToJsonValue(dHLExpressCarrierPayment.PartyOption.Value.Value);
            writer.WriteString("party", partyRawValue);
            var typeOfChargeRawValue = DHLExpressCarrierPayment.TypeOfChargeEnumToJsonValue(dHLExpressCarrierPayment.TypeOfChargeOption.Value.Value);
