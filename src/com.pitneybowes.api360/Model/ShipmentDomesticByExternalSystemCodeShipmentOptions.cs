...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    public partial class ShipmentDomesticByExternalSystemCodeShipmentOptions : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShipmentDomesticByExternalSystemCodeShipmentOptions" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public ShipmentDomesticByExternalSystemCodeShipmentOptions(Option<bool?> addToManifest = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShipmentDomesticByExternalSystemCodeShipmentOptions {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="ShipmentDomesticByExternalSystemCodeShipmentOptions" />
    /// </summary>
    public class ShipmentDomesticByExternalSystemCodeShipmentOptionsJsonConverter : JsonConverter<ShipmentDomesticByExternalSystemCodeShipmentOptions>
    {
        /// <summary>
        /// Deserializes json to <see cref="ShipmentDomesticByExternalSystemCodeShipmentOptions" />
        /// </summary>
        ...
        public override ShipmentDomesticByExternalSystemCodeShipmentOptions Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (addToManifest.IsSet && addToManifest.Value == null)
                throw new ArgumentNullException(nameof(addToManifest), "Property is not nullable for class ShipmentDomesticByExternalSystemCodeShipmentOptions.");

            return new ShipmentDomesticByExternalSystemCodeShipmentOptions(addToManifest);
        }

        /// <summary>
        /// Serializes a <see cref="ShipmentDomesticByExternalSystemCodeShipmentOptions" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="shipmentDomesticByExternalSystemCodeShipmentOptions"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ShipmentDomesticByExternalSystemCodeShipmentOptions shipmentDomesticByExternalSystemCodeShipmentOptions, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, shipmentDomesticByExternalSystemCodeShipmentOptions, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ShipmentDomesticByExternalSystemCodeShipmentOptions" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="shipmentDomesticByExternalSystemCodeShipmentOptions"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ShipmentDomesticByExternalSystemCodeShipmentOptions shipmentDomesticByExternalSystemCodeShipmentOptions, JsonSerializerOptions jsonSerializerOptions)
        {
            if (shipmentDomesticByExternalSystemCodeShipmentOptions.AddToManifestOption.IsSet)
                writer.WriteBoolean("addToManifest", shipmentDomesticByExternalSystemCodeShipmentOptions.AddToManifestOption.Value.Value);
        }
    }
}
