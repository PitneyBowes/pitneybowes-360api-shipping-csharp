...
{
    /// <summary>
    /// MultipieceShipmentInternationalRequestCustomsCustomsInfo
    /// </summary>
    public partial class MultipieceShipmentInternationalRequestCustomsCustomsInfo : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MultipieceShipmentInternationalRequestCustomsCustomsInfo" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public MultipieceShipmentInternationalRequestCustomsCustomsInfo(string currencyCode, Option<string?> reasonForExport = default, Option<double?> customsDeclaredValue = default, Option<string?> eELPFC = default, Option<string?> certificateNumber = default, Option<string?> comments = default, Option<string?> fromCustomsReference = default, Option<string?> importerCustomsReference = default, Option<string?> invoiceNumber = default, Option<string?> licenseNumber = default, Option<double?> sdrValue = default, Option<TermsOfSaleEnum?> termsOfSale = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MultipieceShipmentInternationalRequestCustomsCustomsInfo {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="MultipieceShipmentInternationalRequestCustomsCustomsInfo" />
    /// </summary>
    public class MultipieceShipmentInternationalRequestCustomsCustomsInfoJsonConverter : JsonConverter<MultipieceShipmentInternationalRequestCustomsCustomsInfo>
    {
        /// <summary>
        /// Deserializes json to <see cref="MultipieceShipmentInternationalRequestCustomsCustomsInfo" />
        /// </summary>
        ...
        public override MultipieceShipmentInternationalRequestCustomsCustomsInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<MultipieceShipmentInternationalRequestCustomsCustomsInfo.TermsOfSaleEnum?> termsOfSale = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "termsOfSale":
                            ...
                            if (termsOfSaleRawValue != null)
                                termsOfSale = new Option<MultipieceShipmentInternationalRequestCustomsCustomsInfo.TermsOfSaleEnum?>(MultipieceShipmentInternationalRequestCustomsCustomsInfo.TermsOfSaleEnumFromStringOrDefault(termsOfSaleRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            if (!currencyCode.IsSet)
                throw new ArgumentException("Property is required for class MultipieceShipmentInternationalRequestCustomsCustomsInfo.", nameof(currencyCode));

            if (currencyCode.IsSet && currencyCode.Value == null)
                throw new ArgumentNullException(nameof(currencyCode), "Property is not nullable for class MultipieceShipmentInternationalRequestCustomsCustomsInfo.");

            if (reasonForExport.IsSet && reasonForExport.Value == null)
                throw new ArgumentNullException(nameof(reasonForExport), "Property is not nullable for class MultipieceShipmentInternationalRequestCustomsCustomsInfo.");

            if (customsDeclaredValue.IsSet && customsDeclaredValue.Value == null)
                throw new ArgumentNullException(nameof(customsDeclaredValue), "Property is not nullable for class MultipieceShipmentInternationalRequestCustomsCustomsInfo.");

            if (eELPFC.IsSet && eELPFC.Value == null)
                throw new ArgumentNullException(nameof(eELPFC), "Property is not nullable for class MultipieceShipmentInternationalRequestCustomsCustomsInfo.");

            if (certificateNumber.IsSet && certificateNumber.Value == null)
                throw new ArgumentNullException(nameof(certificateNumber), "Property is not nullable for class MultipieceShipmentInternationalRequestCustomsCustomsInfo.");

            if (comments.IsSet && comments.Value == null)
                throw new ArgumentNullException(nameof(comments), "Property is not nullable for class MultipieceShipmentInternationalRequestCustomsCustomsInfo.");

            if (fromCustomsReference.IsSet && fromCustomsReference.Value == null)
                throw new ArgumentNullException(nameof(fromCustomsReference), "Property is not nullable for class MultipieceShipmentInternationalRequestCustomsCustomsInfo.");

            if (importerCustomsReference.IsSet && importerCustomsReference.Value == null)
                throw new ArgumentNullException(nameof(importerCustomsReference), "Property is not nullable for class MultipieceShipmentInternationalRequestCustomsCustomsInfo.");

            if (invoiceNumber.IsSet && invoiceNumber.Value == null)
                throw new ArgumentNullException(nameof(invoiceNumber), "Property is not nullable for class MultipieceShipmentInternationalRequestCustomsCustomsInfo.");

            if (licenseNumber.IsSet && licenseNumber.Value == null)
                throw new ArgumentNullException(nameof(licenseNumber), "Property is not nullable for class MultipieceShipmentInternationalRequestCustomsCustomsInfo.");

            if (sdrValue.IsSet && sdrValue.Value == null)
                throw new ArgumentNullException(nameof(sdrValue), "Property is not nullable for class MultipieceShipmentInternationalRequestCustomsCustomsInfo.");

            if (termsOfSale.IsSet && termsOfSale.Value == null)
                throw new ArgumentNullException(nameof(termsOfSale), "Property is not nullable for class MultipieceShipmentInternationalRequestCustomsCustomsInfo.");

            return new MultipieceShipmentInternationalRequestCustomsCustomsInfo(currencyCode.Value!, reasonForExport, customsDeclaredValue, eELPFC, certificateNumber, comments, fromCustomsReference, importerCustomsReference, invoiceNumber, licenseNumber, sdrValue, termsOfSale);
        }

        /// <summary>
        /// Serializes a <see cref="MultipieceShipmentInternationalRequestCustomsCustomsInfo" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="multipieceShipmentInternationalRequestCustomsCustomsInfo"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, MultipieceShipmentInternationalRequestCustomsCustomsInfo multipieceShipmentInternationalRequestCustomsCustomsInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, multipieceShipmentInternationalRequestCustomsCustomsInfo, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="MultipieceShipmentInternationalRequestCustomsCustomsInfo" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="multipieceShipmentInternationalRequestCustomsCustomsInfo"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, MultipieceShipmentInternationalRequestCustomsCustomsInfo multipieceShipmentInternationalRequestCustomsCustomsInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            if (multipieceShipmentInternationalRequestCustomsCustomsInfo.CurrencyCode == null)
                throw new ArgumentNullException(nameof(multipieceShipmentInternationalRequestCustomsCustomsInfo.CurrencyCode), "Property is required for class MultipieceShipmentInternationalRequestCustomsCustomsInfo.");

            if (multipieceShipmentInternationalRequestCustomsCustomsInfo.ReasonForExportOption.IsSet && multipieceShipmentInternationalRequestCustomsCustomsInfo.ReasonForExport == null)
                throw new ArgumentNullException(nameof(multipieceShipmentInternationalRequestCustomsCustomsInfo.ReasonForExport), "Property is required for class MultipieceShipmentInternationalRequestCustomsCustomsInfo.");

            if (multipieceShipmentInternationalRequestCustomsCustomsInfo.EELPFCOption.IsSet && multipieceShipmentInternationalRequestCustomsCustomsInfo.EELPFC == null)
                throw new ArgumentNullException(nameof(multipieceShipmentInternationalRequestCustomsCustomsInfo.EELPFC), "Property is required for class MultipieceShipmentInternationalRequestCustomsCustomsInfo.");

            if (multipieceShipmentInternationalRequestCustomsCustomsInfo.CertificateNumberOption.IsSet && multipieceShipmentInternationalRequestCustomsCustomsInfo.CertificateNumber == null)
                throw new ArgumentNullException(nameof(multipieceShipmentInternationalRequestCustomsCustomsInfo.CertificateNumber), "Property is required for class MultipieceShipmentInternationalRequestCustomsCustomsInfo.");

            if (multipieceShipmentInternationalRequestCustomsCustomsInfo.CommentsOption.IsSet && multipieceShipmentInternationalRequestCustomsCustomsInfo.Comments == null)
                throw new ArgumentNullException(nameof(multipieceShipmentInternationalRequestCustomsCustomsInfo.Comments), "Property is required for class MultipieceShipmentInternationalRequestCustomsCustomsInfo.");

            if (multipieceShipmentInternationalRequestCustomsCustomsInfo.FromCustomsReferenceOption.IsSet && multipieceShipmentInternationalRequestCustomsCustomsInfo.FromCustomsReference == null)
                throw new ArgumentNullException(nameof(multipieceShipmentInternationalRequestCustomsCustomsInfo.FromCustomsReference), "Property is required for class MultipieceShipmentInternationalRequestCustomsCustomsInfo.");

            if (multipieceShipmentInternationalRequestCustomsCustomsInfo.ImporterCustomsReferenceOption.IsSet && multipieceShipmentInternationalRequestCustomsCustomsInfo.ImporterCustomsReference == null)
                throw new ArgumentNullException(nameof(multipieceShipmentInternationalRequestCustomsCustomsInfo.ImporterCustomsReference), "Property is required for class MultipieceShipmentInternationalRequestCustomsCustomsInfo.");

            if (multipieceShipmentInternationalRequestCustomsCustomsInfo.InvoiceNumberOption.IsSet && multipieceShipmentInternationalRequestCustomsCustomsInfo.InvoiceNumber == null)
                throw new ArgumentNullException(nameof(multipieceShipmentInternationalRequestCustomsCustomsInfo.InvoiceNumber), "Property is required for class MultipieceShipmentInternationalRequestCustomsCustomsInfo.");

            if (multipieceShipmentInternationalRequestCustomsCustomsInfo.LicenseNumberOption.IsSet && multipieceShipmentInternationalRequestCustomsCustomsInfo.LicenseNumber == null)
                throw new ArgumentNullException(nameof(multipieceShipmentInternationalRequestCustomsCustomsInfo.LicenseNumber), "Property is required for class MultipieceShipmentInternationalRequestCustomsCustomsInfo.");

            writer.WriteString("currencyCode", multipieceShipmentInternationalRequestCustomsCustomsInfo.CurrencyCode);

            if (multipieceShipmentInternationalRequestCustomsCustomsInfo.ReasonForExportOption.IsSet)
                writer.WriteString("reasonForExport", multipieceShipmentInternationalRequestCustomsCustomsInfo.ReasonForExport);

            if (multipieceShipmentInternationalRequestCustomsCustomsInfo.CustomsDeclaredValueOption.IsSet)
                writer.WriteNumber("customsDeclaredValue", multipieceShipmentInternationalRequestCustomsCustomsInfo.CustomsDeclaredValueOption.Value!.Value);

            if (multipieceShipmentInternationalRequestCustomsCustomsInfo.EELPFCOption.IsSet)
                writer.WriteString("EELPFC", multipieceShipmentInternationalRequestCustomsCustomsInfo.EELPFC);

            if (multipieceShipmentInternationalRequestCustomsCustomsInfo.CertificateNumberOption.IsSet)
                writer.WriteString("certificateNumber", multipieceShipmentInternationalRequestCustomsCustomsInfo.CertificateNumber);

            if (multipieceShipmentInternationalRequestCustomsCustomsInfo.CommentsOption.IsSet)
                writer.WriteString("comments", multipieceShipmentInternationalRequestCustomsCustomsInfo.Comments);

            if (multipieceShipmentInternationalRequestCustomsCustomsInfo.FromCustomsReferenceOption.IsSet)
                writer.WriteString("fromCustomsReference", multipieceShipmentInternationalRequestCustomsCustomsInfo.FromCustomsReference);

            if (multipieceShipmentInternationalRequestCustomsCustomsInfo.ImporterCustomsReferenceOption.IsSet)
                writer.WriteString("importerCustomsReference", multipieceShipmentInternationalRequestCustomsCustomsInfo.ImporterCustomsReference);

            if (multipieceShipmentInternationalRequestCustomsCustomsInfo.InvoiceNumberOption.IsSet)
                writer.WriteString("invoiceNumber", multipieceShipmentInternationalRequestCustomsCustomsInfo.InvoiceNumber);

            if (multipieceShipmentInternationalRequestCustomsCustomsInfo.LicenseNumberOption.IsSet)
                writer.WriteString("licenseNumber", multipieceShipmentInternationalRequestCustomsCustomsInfo.LicenseNumber);

            if (multipieceShipmentInternationalRequestCustomsCustomsInfo.SdrValueOption.IsSet)
                writer.WriteNumber("sdrValue", multipieceShipmentInternationalRequestCustomsCustomsInfo.SdrValueOption.Value!.Value);

            var termsOfSaleRawValue = MultipieceShipmentInternationalRequestCustomsCustomsInfo.TermsOfSaleEnumToJsonValue(multipieceShipmentInternationalRequestCustomsCustomsInfo.TermsOfSaleOption.Value!.Value);
