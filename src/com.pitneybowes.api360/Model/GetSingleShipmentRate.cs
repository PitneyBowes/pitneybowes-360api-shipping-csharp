...
namespace com.pitneybowes.api360.Model
{
    ...
    public partial class GetSingleShipmentRate : IValidatableObject
    {
        ...
        [JsonConstructor]
        public GetSingleShipmentRate(Option<decimal?> baseCharge = default, Option<string> carrier = default, Option<string> currencyCode = default, Option<string> inductionPostalCode = default, Option<string> parcelType = default, Option<string> rateTypeId = default, Option<string> serviceId = default, Option<List<GetSingleShipmentRateSpecialServicesInner>> specialServices = default, Option<decimal?> totalCarrierCharge = default)
        {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<GetSingleShipmentRateSpecialServicesInner>> SpecialServicesOption { get; private set; }
        ...
        public List<GetSingleShipmentRateSpecialServicesInner> SpecialServices { get { return this.SpecialServicesOption; } set { this.SpecialServicesOption = new Option<List<GetSingleShipmentRateSpecialServicesInner>>(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="GetSingleShipmentRate" />
    /// </summary>
    public class GetSingleShipmentRateJsonConverter : JsonConverter<GetSingleShipmentRate>
    {
        /// <summary>
        /// Deserializes json to <see cref="GetSingleShipmentRate" />
        /// </summary>
        ...
        public override GetSingleShipmentRate Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<GetSingleShipmentRateSpecialServicesInner>> specialServices = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "specialServices":
                            specialServices = new Option<List<GetSingleShipmentRateSpecialServicesInner>>(JsonSerializer.Deserialize<List<GetSingleShipmentRateSpecialServicesInner>>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
            ...
            if (baseCharge.IsSet && baseCharge.Value == null)
                throw new ArgumentNullException(nameof(baseCharge), "Property is not nullable for class GetSingleShipmentRate.");

            if (carrier.IsSet && carrier.Value == null)
                throw new ArgumentNullException(nameof(carrier), "Property is not nullable for class GetSingleShipmentRate.");

            if (currencyCode.IsSet && currencyCode.Value == null)
                throw new ArgumentNullException(nameof(currencyCode), "Property is not nullable for class GetSingleShipmentRate.");

            if (inductionPostalCode.IsSet && inductionPostalCode.Value == null)
                throw new ArgumentNullException(nameof(inductionPostalCode), "Property is not nullable for class GetSingleShipmentRate.");

            if (parcelType.IsSet && parcelType.Value == null)
                throw new ArgumentNullException(nameof(parcelType), "Property is not nullable for class GetSingleShipmentRate.");

            if (rateTypeId.IsSet && rateTypeId.Value == null)
                throw new ArgumentNullException(nameof(rateTypeId), "Property is not nullable for class GetSingleShipmentRate.");

            if (serviceId.IsSet && serviceId.Value == null)
                throw new ArgumentNullException(nameof(serviceId), "Property is not nullable for class GetSingleShipmentRate.");

            if (specialServices.IsSet && specialServices.Value == null)
                throw new ArgumentNullException(nameof(specialServices), "Property is not nullable for class GetSingleShipmentRate.");

            if (totalCarrierCharge.IsSet && totalCarrierCharge.Value == null)
                throw new ArgumentNullException(nameof(totalCarrierCharge), "Property is not nullable for class GetSingleShipmentRate.");

            return new GetSingleShipmentRate(baseCharge, carrier, currencyCode, inductionPostalCode, parcelType, rateTypeId, serviceId, specialServices, totalCarrierCharge);
        }

        /// <summary>
        /// Serializes a <see cref="GetSingleShipmentRate" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getSingleShipmentRate"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GetSingleShipmentRate getSingleShipmentRate, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, getSingleShipmentRate, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GetSingleShipmentRate" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getSingleShipmentRate"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, GetSingleShipmentRate getSingleShipmentRate, JsonSerializerOptions jsonSerializerOptions)
        {
            if (getSingleShipmentRate.CarrierOption.IsSet && getSingleShipmentRate.Carrier == null)
                throw new ArgumentNullException(nameof(getSingleShipmentRate.Carrier), "Property is required for class GetSingleShipmentRate.");

            if (getSingleShipmentRate.CurrencyCodeOption.IsSet && getSingleShipmentRate.CurrencyCode == null)
                throw new ArgumentNullException(nameof(getSingleShipmentRate.CurrencyCode), "Property is required for class GetSingleShipmentRate.");

            if (getSingleShipmentRate.InductionPostalCodeOption.IsSet && getSingleShipmentRate.InductionPostalCode == null)
                throw new ArgumentNullException(nameof(getSingleShipmentRate.InductionPostalCode), "Property is required for class GetSingleShipmentRate.");

            if (getSingleShipmentRate.ParcelTypeOption.IsSet && getSingleShipmentRate.ParcelType == null)
                throw new ArgumentNullException(nameof(getSingleShipmentRate.ParcelType), "Property is required for class GetSingleShipmentRate.");

            if (getSingleShipmentRate.RateTypeIdOption.IsSet && getSingleShipmentRate.RateTypeId == null)
                throw new ArgumentNullException(nameof(getSingleShipmentRate.RateTypeId), "Property is required for class GetSingleShipmentRate.");

            if (getSingleShipmentRate.ServiceIdOption.IsSet && getSingleShipmentRate.ServiceId == null)
                throw new ArgumentNullException(nameof(getSingleShipmentRate.ServiceId), "Property is required for class GetSingleShipmentRate.");

            if (getSingleShipmentRate.SpecialServicesOption.IsSet && getSingleShipmentRate.SpecialServices == null)
                throw new ArgumentNullException(nameof(getSingleShipmentRate.SpecialServices), "Property is required for class GetSingleShipmentRate.");

            if (getSingleShipmentRate.BaseChargeOption.IsSet)
                writer.WriteNumber("baseCharge", getSingleShipmentRate.BaseChargeOption.Value.Value);

            if (getSingleShipmentRate.CarrierOption.IsSet)
                writer.WriteString("carrier", getSingleShipmentRate.Carrier);

            if (getSingleShipmentRate.CurrencyCodeOption.IsSet)
                writer.WriteString("currencyCode", getSingleShipmentRate.CurrencyCode);

            if (getSingleShipmentRate.InductionPostalCodeOption.IsSet)
                writer.WriteString("inductionPostalCode", getSingleShipmentRate.InductionPostalCode);

            if (getSingleShipmentRate.ParcelTypeOption.IsSet)
                writer.WriteString("parcelType", getSingleShipmentRate.ParcelType);

            if (getSingleShipmentRate.RateTypeIdOption.IsSet)
                writer.WriteString("rateTypeId", getSingleShipmentRate.RateTypeId);

            if (getSingleShipmentRate.ServiceIdOption.IsSet)
                writer.WriteString("serviceId", getSingleShipmentRate.ServiceId);

            if (getSingleShipmentRate.SpecialServicesOption.IsSet)
            {
                writer.WritePropertyName("specialServices");
                JsonSerializer.Serialize(writer, getSingleShipmentRate.SpecialServices, jsonSerializerOptions);
            }
            if (getSingleShipmentRate.TotalCarrierChargeOption.IsSet)
                writer.WriteNumber("totalCarrierCharge", getSingleShipmentRate.TotalCarrierChargeOption.Value.Value);
        }
    }
}
