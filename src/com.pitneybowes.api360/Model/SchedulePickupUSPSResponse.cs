...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    [DataContract(Name = "schedulePickupUSPSResponse")]
    public partial class SchedulePickupUSPSResponse : IValidatableObject
    {
        ...
        /// <param name="pickupDateTime">It displays the scheduled pickup date.</param>
        ...
        public SchedulePickupUSPSResponse(string packageLocation = default(string), string pickupConfirmationNumber = default(string), string pickupId = default(string), string carrier = default(string), string carrierAccountId = default(string), SchedulePickupDHLEXPResponsePickupAddress pickupAddress = default(SchedulePickupDHLEXPResponsePickupAddress), List<string> shipmentIds = default(List<string>), List<SchedulePickupUSPSResponsePickupSummaryInner> pickupSummary = default(List<SchedulePickupUSPSResponsePickupSummaryInner>), string additionalnotes = default(string), string reference = default(string), string pickupDateTime = default(string), decimal pickupTotalWeight = default(decimal), string pickupTotalWeightUnit = default(string))
        {
        ...
        public List<SchedulePickupUSPSResponsePickupSummaryInner> PickupSummary { get; set; }
        ...
        /// </summary>
        /// <value>It displays the scheduled pickup date</value>
        /// <example>11/17/2023</example>
