...
namespace com.pitneybowes.api360.Model
{
    ...
    public partial class Errors : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="varErrors">varErrors.</param>
        public Errors(List<ErrorsErrorsInner> varErrors = default(List<ErrorsErrorsInner>))
        {
            this.VarErrors = varErrors;
        }

        /// <summary>
        /// Gets or Sets VarErrors
        /// </summary>
        [DataMember(Name = "errors", EmitDefaultValue = false)]
        public List<ErrorsErrorsInner> VarErrors { get; set; }
