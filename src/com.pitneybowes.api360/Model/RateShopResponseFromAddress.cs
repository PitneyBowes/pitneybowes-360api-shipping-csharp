...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    public partial class RateShopResponseFromAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RateShopResponseFromAddress" /> class.
        /// </summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="RateShopResponseFromAddress" />
    /// </summary>
    public class RateShopResponseFromAddressJsonConverter : JsonConverter<RateShopResponseFromAddress>
    {
        /// <summary>
        /// Deserializes json to <see cref="RateShopResponseFromAddress" />
        /// </summary>
        ...
        public override RateShopResponseFromAddress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (addressLine1.IsSet && addressLine1.Value == null)
                throw new ArgumentNullException(nameof(addressLine1), "Property is not nullable for class RateShopResponseFromAddress.");

            if (addressLine2.IsSet && addressLine2.Value == null)
                throw new ArgumentNullException(nameof(addressLine2), "Property is not nullable for class RateShopResponseFromAddress.");

            if (addressLine3.IsSet && addressLine3.Value == null)
                throw new ArgumentNullException(nameof(addressLine3), "Property is not nullable for class RateShopResponseFromAddress.");

            if (cityTown.IsSet && cityTown.Value == null)
                throw new ArgumentNullException(nameof(cityTown), "Property is not nullable for class RateShopResponseFromAddress.");

            if (company.IsSet && company.Value == null)
                throw new ArgumentNullException(nameof(company), "Property is not nullable for class RateShopResponseFromAddress.");

            if (countryCode.IsSet && countryCode.Value == null)
                throw new ArgumentNullException(nameof(countryCode), "Property is not nullable for class RateShopResponseFromAddress.");

            if (email.IsSet && email.Value == null)
                throw new ArgumentNullException(nameof(email), "Property is not nullable for class RateShopResponseFromAddress.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class RateShopResponseFromAddress.");

            if (phone.IsSet && phone.Value == null)
                throw new ArgumentNullException(nameof(phone), "Property is not nullable for class RateShopResponseFromAddress.");

            if (postalCode.IsSet && postalCode.Value == null)
                throw new ArgumentNullException(nameof(postalCode), "Property is not nullable for class RateShopResponseFromAddress.");

            if (residential.IsSet && residential.Value == null)
                throw new ArgumentNullException(nameof(residential), "Property is not nullable for class RateShopResponseFromAddress.");

            if (stateProvince.IsSet && stateProvince.Value == null)
                throw new ArgumentNullException(nameof(stateProvince), "Property is not nullable for class RateShopResponseFromAddress.");

            return new RateShopResponseFromAddress(addressLine1, addressLine2, addressLine3, cityTown, company, countryCode, email, name, phone, postalCode, residential, stateProvince);
        }

        /// <summary>
        /// Serializes a <see cref="RateShopResponseFromAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="rateShopResponseFromAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, RateShopResponseFromAddress rateShopResponseFromAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, rateShopResponseFromAddress, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="RateShopResponseFromAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="rateShopResponseFromAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, RateShopResponseFromAddress rateShopResponseFromAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            if (rateShopResponseFromAddress.AddressLine1Option.IsSet && rateShopResponseFromAddress.AddressLine1 == null)
                throw new ArgumentNullException(nameof(rateShopResponseFromAddress.AddressLine1), "Property is required for class RateShopResponseFromAddress.");

            if (rateShopResponseFromAddress.AddressLine2Option.IsSet && rateShopResponseFromAddress.AddressLine2 == null)
                throw new ArgumentNullException(nameof(rateShopResponseFromAddress.AddressLine2), "Property is required for class RateShopResponseFromAddress.");

            if (rateShopResponseFromAddress.AddressLine3Option.IsSet && rateShopResponseFromAddress.AddressLine3 == null)
                throw new ArgumentNullException(nameof(rateShopResponseFromAddress.AddressLine3), "Property is required for class RateShopResponseFromAddress.");

            if (rateShopResponseFromAddress.CityTownOption.IsSet && rateShopResponseFromAddress.CityTown == null)
                throw new ArgumentNullException(nameof(rateShopResponseFromAddress.CityTown), "Property is required for class RateShopResponseFromAddress.");

            if (rateShopResponseFromAddress.CompanyOption.IsSet && rateShopResponseFromAddress.Company == null)
                throw new ArgumentNullException(nameof(rateShopResponseFromAddress.Company), "Property is required for class RateShopResponseFromAddress.");

            if (rateShopResponseFromAddress.CountryCodeOption.IsSet && rateShopResponseFromAddress.CountryCode == null)
                throw new ArgumentNullException(nameof(rateShopResponseFromAddress.CountryCode), "Property is required for class RateShopResponseFromAddress.");

            if (rateShopResponseFromAddress.EmailOption.IsSet && rateShopResponseFromAddress.Email == null)
                throw new ArgumentNullException(nameof(rateShopResponseFromAddress.Email), "Property is required for class RateShopResponseFromAddress.");

            if (rateShopResponseFromAddress.NameOption.IsSet && rateShopResponseFromAddress.Name == null)
                throw new ArgumentNullException(nameof(rateShopResponseFromAddress.Name), "Property is required for class RateShopResponseFromAddress.");

            if (rateShopResponseFromAddress.PhoneOption.IsSet && rateShopResponseFromAddress.Phone == null)
                throw new ArgumentNullException(nameof(rateShopResponseFromAddress.Phone), "Property is required for class RateShopResponseFromAddress.");

            if (rateShopResponseFromAddress.PostalCodeOption.IsSet && rateShopResponseFromAddress.PostalCode == null)
                throw new ArgumentNullException(nameof(rateShopResponseFromAddress.PostalCode), "Property is required for class RateShopResponseFromAddress.");

            if (rateShopResponseFromAddress.StateProvinceOption.IsSet && rateShopResponseFromAddress.StateProvince == null)
                throw new ArgumentNullException(nameof(rateShopResponseFromAddress.StateProvince), "Property is required for class RateShopResponseFromAddress.");

            if (rateShopResponseFromAddress.AddressLine1Option.IsSet)
                writer.WriteString("addressLine1", rateShopResponseFromAddress.AddressLine1);

            if (rateShopResponseFromAddress.AddressLine2Option.IsSet)
                writer.WriteString("addressLine2", rateShopResponseFromAddress.AddressLine2);

            if (rateShopResponseFromAddress.AddressLine3Option.IsSet)
                writer.WriteString("addressLine3", rateShopResponseFromAddress.AddressLine3);

            if (rateShopResponseFromAddress.CityTownOption.IsSet)
                writer.WriteString("cityTown", rateShopResponseFromAddress.CityTown);

            if (rateShopResponseFromAddress.CompanyOption.IsSet)
                writer.WriteString("company", rateShopResponseFromAddress.Company);

            if (rateShopResponseFromAddress.CountryCodeOption.IsSet)
                writer.WriteString("countryCode", rateShopResponseFromAddress.CountryCode);

            if (rateShopResponseFromAddress.EmailOption.IsSet)
                writer.WriteString("email", rateShopResponseFromAddress.Email);

            if (rateShopResponseFromAddress.NameOption.IsSet)
                writer.WriteString("name", rateShopResponseFromAddress.Name);

            if (rateShopResponseFromAddress.PhoneOption.IsSet)
                writer.WriteString("phone", rateShopResponseFromAddress.Phone);

            if (rateShopResponseFromAddress.PostalCodeOption.IsSet)
                writer.WriteString("postalCode", rateShopResponseFromAddress.PostalCode);

            if (rateShopResponseFromAddress.ResidentialOption.IsSet)
                writer.WriteBoolean("residential", rateShopResponseFromAddress.ResidentialOption.Value.Value);

            if (rateShopResponseFromAddress.StateProvinceOption.IsSet)
                writer.WriteString("stateProvince", rateShopResponseFromAddress.StateProvince);
        }
    }
}
