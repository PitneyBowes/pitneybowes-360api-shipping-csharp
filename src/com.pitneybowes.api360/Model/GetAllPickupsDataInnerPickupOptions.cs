...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getAllPickups_data_inner_pickupOptions")]
    public partial class GetAllPickupsDataInnerPickupOptions : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAllPickupsDataInnerPickupOptions" /> class.
        /// </summary>
        ...
        public GetAllPickupsDataInnerPickupOptions(string pickupStartDateTime = default(string), string pickupEndDateTime = default(string), decimal overweight = default(decimal), string carrierType = default(string))
        {
