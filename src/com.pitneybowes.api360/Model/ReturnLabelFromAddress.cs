...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    [DataContract(Name = "returnLabel_fromAddress")]
    public partial class ReturnLabelFromAddress : IValidatableObject
    {
        ...
        protected ReturnLabelFromAddress() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ReturnLabelFromAddress" /> class.
        /// </summary>
        ...
        public ReturnLabelFromAddress(string addressLine1 = default(string), string email = default(string), string cityTown = default(string), string countryCode = default(string), string name = default(string), string phone = default(string), string postalCode = default(string), string stateProvince = default(string))
        {
            // to ensure "addressLine1" is required (not null)
            if (addressLine1 == null)
            {
                throw new ArgumentNullException("addressLine1 is a required property for ReturnLabelFromAddress and cannot be null");
            }
