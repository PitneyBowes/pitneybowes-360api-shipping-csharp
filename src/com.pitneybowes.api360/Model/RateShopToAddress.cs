...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    public partial class RateShopToAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RateShopToAddress" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public RateShopToAddress(string addressLine1, string countryCode, string postalCode, Option<string> addressLine2 = default, Option<string> addressLine3 = default, Option<string> cityTown = default, Option<string> company = default, Option<string> email = default, Option<string> name = default, Option<string> phone = default, Option<bool?> residential = default, Option<string> stateProvince = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RateShopToAddress {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="RateShopToAddress" />
    /// </summary>
    public class RateShopToAddressJsonConverter : JsonConverter<RateShopToAddress>
    {
        /// <summary>
        /// Deserializes json to <see cref="RateShopToAddress" />
        /// </summary>
        ...
        public override RateShopToAddress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!addressLine1.IsSet)
                throw new ArgumentException("Property is required for class RateShopToAddress.", nameof(addressLine1));

            if (!countryCode.IsSet)
                throw new ArgumentException("Property is required for class RateShopToAddress.", nameof(countryCode));

            if (!postalCode.IsSet)
                throw new ArgumentException("Property is required for class RateShopToAddress.", nameof(postalCode));

            if (addressLine1.IsSet && addressLine1.Value == null)
                throw new ArgumentNullException(nameof(addressLine1), "Property is not nullable for class RateShopToAddress.");

            if (countryCode.IsSet && countryCode.Value == null)
                throw new ArgumentNullException(nameof(countryCode), "Property is not nullable for class RateShopToAddress.");

            if (postalCode.IsSet && postalCode.Value == null)
                throw new ArgumentNullException(nameof(postalCode), "Property is not nullable for class RateShopToAddress.");

            if (addressLine2.IsSet && addressLine2.Value == null)
                throw new ArgumentNullException(nameof(addressLine2), "Property is not nullable for class RateShopToAddress.");

            if (addressLine3.IsSet && addressLine3.Value == null)
                throw new ArgumentNullException(nameof(addressLine3), "Property is not nullable for class RateShopToAddress.");

            if (cityTown.IsSet && cityTown.Value == null)
                throw new ArgumentNullException(nameof(cityTown), "Property is not nullable for class RateShopToAddress.");

            if (company.IsSet && company.Value == null)
                throw new ArgumentNullException(nameof(company), "Property is not nullable for class RateShopToAddress.");

            if (email.IsSet && email.Value == null)
                throw new ArgumentNullException(nameof(email), "Property is not nullable for class RateShopToAddress.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class RateShopToAddress.");

            if (phone.IsSet && phone.Value == null)
                throw new ArgumentNullException(nameof(phone), "Property is not nullable for class RateShopToAddress.");

            if (residential.IsSet && residential.Value == null)
                throw new ArgumentNullException(nameof(residential), "Property is not nullable for class RateShopToAddress.");

            if (stateProvince.IsSet && stateProvince.Value == null)
                throw new ArgumentNullException(nameof(stateProvince), "Property is not nullable for class RateShopToAddress.");

            return new RateShopToAddress(addressLine1.Value, countryCode.Value, postalCode.Value, addressLine2, addressLine3, cityTown, company, email, name, phone, residential, stateProvince);
        }

        /// <summary>
        /// Serializes a <see cref="RateShopToAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="rateShopToAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, RateShopToAddress rateShopToAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, rateShopToAddress, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="RateShopToAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="rateShopToAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, RateShopToAddress rateShopToAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            if (rateShopToAddress.AddressLine1 == null)
                throw new ArgumentNullException(nameof(rateShopToAddress.AddressLine1), "Property is required for class RateShopToAddress.");

            if (rateShopToAddress.CountryCode == null)
                throw new ArgumentNullException(nameof(rateShopToAddress.CountryCode), "Property is required for class RateShopToAddress.");

            if (rateShopToAddress.PostalCode == null)
                throw new ArgumentNullException(nameof(rateShopToAddress.PostalCode), "Property is required for class RateShopToAddress.");

            if (rateShopToAddress.AddressLine2Option.IsSet && rateShopToAddress.AddressLine2 == null)
                throw new ArgumentNullException(nameof(rateShopToAddress.AddressLine2), "Property is required for class RateShopToAddress.");

            if (rateShopToAddress.AddressLine3Option.IsSet && rateShopToAddress.AddressLine3 == null)
                throw new ArgumentNullException(nameof(rateShopToAddress.AddressLine3), "Property is required for class RateShopToAddress.");

            if (rateShopToAddress.CityTownOption.IsSet && rateShopToAddress.CityTown == null)
                throw new ArgumentNullException(nameof(rateShopToAddress.CityTown), "Property is required for class RateShopToAddress.");

            if (rateShopToAddress.CompanyOption.IsSet && rateShopToAddress.Company == null)
                throw new ArgumentNullException(nameof(rateShopToAddress.Company), "Property is required for class RateShopToAddress.");

            if (rateShopToAddress.EmailOption.IsSet && rateShopToAddress.Email == null)
                throw new ArgumentNullException(nameof(rateShopToAddress.Email), "Property is required for class RateShopToAddress.");

            if (rateShopToAddress.NameOption.IsSet && rateShopToAddress.Name == null)
                throw new ArgumentNullException(nameof(rateShopToAddress.Name), "Property is required for class RateShopToAddress.");

            if (rateShopToAddress.PhoneOption.IsSet && rateShopToAddress.Phone == null)
                throw new ArgumentNullException(nameof(rateShopToAddress.Phone), "Property is required for class RateShopToAddress.");

            if (rateShopToAddress.StateProvinceOption.IsSet && rateShopToAddress.StateProvince == null)
                throw new ArgumentNullException(nameof(rateShopToAddress.StateProvince), "Property is required for class RateShopToAddress.");

            writer.WriteString("addressLine1", rateShopToAddress.AddressLine1);

            writer.WriteString("countryCode", rateShopToAddress.CountryCode);

            writer.WriteString("postalCode", rateShopToAddress.PostalCode);

            if (rateShopToAddress.AddressLine2Option.IsSet)
                writer.WriteString("addressLine2", rateShopToAddress.AddressLine2);

            if (rateShopToAddress.AddressLine3Option.IsSet)
                writer.WriteString("addressLine3", rateShopToAddress.AddressLine3);

            if (rateShopToAddress.CityTownOption.IsSet)
                writer.WriteString("cityTown", rateShopToAddress.CityTown);

            if (rateShopToAddress.CompanyOption.IsSet)
                writer.WriteString("company", rateShopToAddress.Company);

            if (rateShopToAddress.EmailOption.IsSet)
                writer.WriteString("email", rateShopToAddress.Email);

            if (rateShopToAddress.NameOption.IsSet)
                writer.WriteString("name", rateShopToAddress.Name);

            if (rateShopToAddress.PhoneOption.IsSet)
                writer.WriteString("phone", rateShopToAddress.Phone);

            if (rateShopToAddress.ResidentialOption.IsSet)
                writer.WriteBoolean("residential", rateShopToAddress.ResidentialOption.Value.Value);

            if (rateShopToAddress.StateProvinceOption.IsSet)
                writer.WriteString("stateProvince", rateShopToAddress.StateProvince);
        }
    }
}
