...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    [DataContract(Name = "schedulePickupUSPSRequest_pickupSummary_inner")]
    public partial class SchedulePickupUSPSRequestPickupSummaryInner : IValidatableObject
    {
        ...
        protected SchedulePickupUSPSRequestPickupSummaryInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SchedulePickupUSPSRequestPickupSummaryInner" /> class.
        /// </summary>
        ...
        public SchedulePickupUSPSRequestPickupSummaryInner(string serviceId = default(string), decimal packageCount = default(decimal), decimal totalWeight = default(decimal), string weightUnit = default(string))
        {
            // to ensure "serviceId" is required (not null)
            if (serviceId == null)
            {
                throw new ArgumentNullException("serviceId is a required property for SchedulePickupUSPSRequestPickupSummaryInner and cannot be null");
            }
            ...
            if (weightUnit == null)
            {
                throw new ArgumentNullException("weightUnit is a required property for SchedulePickupUSPSRequestPickupSummaryInner and cannot be null");
            }
