...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MultipieceInternationalShipmentRequest_customs_customsInfo")]
    public partial class MultipieceInternationalShipmentRequestCustomsCustomsInfo : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MultipieceInternationalShipmentRequestCustomsCustomsInfo" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MultipieceInternationalShipmentRequestCustomsCustomsInfo() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MultipieceInternationalShipmentRequestCustomsCustomsInfo" /> class.
        /// </summary>
        /// <param name="reasonForExport">The reason the commodity is being exported. (required).</param>
        ...
        public MultipieceInternationalShipmentRequestCustomsCustomsInfo(ReasonForExportEnum reasonForExport = default(ReasonForExportEnum), decimal customsDeclaredValue = default(decimal), string currencyCode = default(string), string eELPFC = default(string), string certificateNumber = default(string), string comments = default(string), string fromCustomsReference = default(string), string importerCustomsReference = default(string), string invoiceNumber = default(string), string licenseNumber = default(string), decimal sdrValue = default(decimal))
        {
            ...
            {
                throw new ArgumentNullException("currencyCode is a required property for MultipieceInternationalShipmentRequestCustomsCustomsInfo and cannot be null");
            }
