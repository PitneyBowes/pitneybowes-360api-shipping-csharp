...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    [DataContract(Name = "parcelTypes_inner_dimensionRules_inner_minParcelDimensions")]
    public partial class ParcelTypesInnerDimensionRulesInnerMinParcelDimensions : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ParcelTypesInnerDimensionRulesInnerMinParcelDimensions" /> class.
        /// </summary>
        ...
        public ParcelTypesInnerDimensionRulesInnerMinParcelDimensions(decimal height = default(decimal), decimal length = default(decimal), string unitOfMeasurement = default(string), decimal width = default(decimal))
        {
            this.Height = height;
            this.Length = length;
