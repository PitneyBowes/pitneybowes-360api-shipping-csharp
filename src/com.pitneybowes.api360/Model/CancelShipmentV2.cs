...
namespace com.pitneybowes.api360.Model
{
    ...
    /// CancelShipmentV2
    /// </summary>
    [DataContract(Name = "cancelShipmentV2")]
    public partial class CancelShipmentV2 : IValidatableObject
    {
        ...
        public CancelShipmentV2(string carrier = default(string), decimal totalCarrierCharge = default(decimal), string parcelTrackingNumber = default(string), string status = default(string), CancelShipmentV2References references = default(CancelShipmentV2References))
        {
