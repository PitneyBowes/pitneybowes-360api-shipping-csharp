...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    [DataContract(Name = "domesticShipmentResponseV2_labelLayout_inner")]
    public partial class DomesticShipmentResponseV2LabelLayoutInner : IValidatableObject
    {
        ...
        public DomesticShipmentResponseV2LabelLayoutInner(string contents = default(string), FileFormatEnum? fileFormat = default(FileFormatEnum?), SizeEnum? size = default(SizeEnum?), TypeEnum? type = default(TypeEnum?))
        {
