...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    [DataContract(Name = "fromAddressV2")]
    public partial class FromAddressV2 : IValidatableObject
    {
        ...
        protected FromAddressV2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FromAddressV2" /> class.
        /// </summary>
        /// <param name="name">The name of the Sender to which this address points.&lt;br /&gt; &#x60;Max length &#x3D; 30&#x60;. (required).</param>
        /// <param name="addressLine1">The addressLine1 contains the Flat number, Building or Apartment Name/number (if any) or company name (if not residential) of the Sender. &lt;br /&gt; &#x60;Max length &#x3D; 35&#x60;. (required).</param>
        /// <param name="cityTown">The name of the city or town the Sender&#39;s address belongs to. &lt;br /&gt; &#x60;Max length &#x3D; 30&#x60;. (required).</param>
        ...
        /// <param name="phone">This is sender&#39;s phone number. Enter the digits with or without spaces or hyphens. &lt;br /&gt; &#x60;Max length &#x3D; 15&#x60;. (required).</param>
        ...
        public FromAddressV2(string name = default(string), string addressLine1 = default(string), string cityTown = default(string), string stateProvince = default(string), string postalCode = default(string), string countryCode = default(string), string company = default(string), string phone = default(string), string email = default(string), bool residential = default(bool))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for FromAddressV2 and cannot be null");
            }
            this.Name = name;
            // to ensure "addressLine1" is required (not null)
            if (addressLine1 == null)
            {
                throw new ArgumentNullException("addressLine1 is a required property for FromAddressV2 and cannot be null");
            }
            this.AddressLine1 = addressLine1;
            // to ensure "cityTown" is required (not null)
            if (cityTown == null)
            {
                throw new ArgumentNullException("cityTown is a required property for FromAddressV2 and cannot be null");
            }
            this.CityTown = cityTown;
            // to ensure "stateProvince" is required (not null)
            if (stateProvince == null)
            {
                throw new ArgumentNullException("stateProvince is a required property for FromAddressV2 and cannot be null");
            }
            this.StateProvince = stateProvince;
            // to ensure "postalCode" is required (not null)
            if (postalCode == null)
            {
                throw new ArgumentNullException("postalCode is a required property for FromAddressV2 and cannot be null");
            }
            this.PostalCode = postalCode;
            // to ensure "countryCode" is required (not null)
            if (countryCode == null)
            {
                throw new ArgumentNullException("countryCode is a required property for FromAddressV2 and cannot be null");
            }
            this.CountryCode = countryCode;
            // to ensure "phone" is required (not null)
            if (phone == null)
            {
                throw new ArgumentNullException("phone is a required property for FromAddressV2 and cannot be null");
            }
            this.Phone = phone;
        ...
        /// </summary>
        /// <value>The name of the Sender to which this address points.&lt;br /&gt; &#x60;Max length &#x3D; 30&#x60;.</value>
