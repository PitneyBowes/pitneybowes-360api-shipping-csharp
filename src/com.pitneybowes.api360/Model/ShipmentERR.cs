...
namespace com.pitneybowes.api360.Model
{
    ...
    /// ShipmentERR
    /// </summary>
    [DataContract(Name = "ShipmentERR")]
    public partial class ShipmentERR : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShipmentERR" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ShipmentERR() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ShipmentERR" /> class.
        /// </summary>
        ...
        /// <param name="parcelType">&gt;-Packaging type varies as per selected carrier and its services, e.g., PKG, LGENV..</param>
        /// <param name="serviceId">&gt;-The unique identifier given to the carrier-specific service. ERR supports two services: First Class Mail (FCM) and Priority Mail (PM)..</param>
        /// <param name="dateOfShipment">Indicates the date when shipment is created..</param>
        ...
        /// </summary>
        /// <value>&gt;-Packaging type varies as per selected carrier and its services, e.g., PKG, LGENV.</value>
        /// <example>PKG</example>
        ...
        /// </summary>
        /// <value>&gt;-The unique identifier given to the carrier-specific service. ERR supports two services: First Class Mail (FCM) and Priority Mail (PM).</value>
        /// <example>PM</example>
        ...
        /// </summary>
        /// <value>Indicates the date when shipment is created.</value>
        ...
        public List<ShipmentERRMetadataInner> Metadata { get; set; }
