...
namespace com.pitneybowes.api360.Model
{
    ...
    /// <summary>
    /// A Json converter for type <see cref="SingleRateResponseFromAddress" />
    /// </summary>
    public class SingleRateResponseFromAddressJsonConverter : JsonConverter<SingleRateResponseFromAddress>
    {
        /// <summary>
        /// Deserializes json to <see cref="SingleRateResponseFromAddress" />
        /// </summary>
        ...
        public override SingleRateResponseFromAddress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (addressLine1.IsSet && addressLine1.Value == null)
                throw new ArgumentNullException(nameof(addressLine1), "Property is not nullable for class SingleRateResponseFromAddress.");

            if (addressLine2.IsSet && addressLine2.Value == null)
                throw new ArgumentNullException(nameof(addressLine2), "Property is not nullable for class SingleRateResponseFromAddress.");

            if (addressLine3.IsSet && addressLine3.Value == null)
                throw new ArgumentNullException(nameof(addressLine3), "Property is not nullable for class SingleRateResponseFromAddress.");

            if (cityTown.IsSet && cityTown.Value == null)
                throw new ArgumentNullException(nameof(cityTown), "Property is not nullable for class SingleRateResponseFromAddress.");

            if (company.IsSet && company.Value == null)
                throw new ArgumentNullException(nameof(company), "Property is not nullable for class SingleRateResponseFromAddress.");

            if (email.IsSet && email.Value == null)
                throw new ArgumentNullException(nameof(email), "Property is not nullable for class SingleRateResponseFromAddress.");

            if (countryCode.IsSet && countryCode.Value == null)
                throw new ArgumentNullException(nameof(countryCode), "Property is not nullable for class SingleRateResponseFromAddress.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class SingleRateResponseFromAddress.");

            if (phone.IsSet && phone.Value == null)
                throw new ArgumentNullException(nameof(phone), "Property is not nullable for class SingleRateResponseFromAddress.");

            if (postalCode.IsSet && postalCode.Value == null)
                throw new ArgumentNullException(nameof(postalCode), "Property is not nullable for class SingleRateResponseFromAddress.");

            if (stateProvince.IsSet && stateProvince.Value == null)
                throw new ArgumentNullException(nameof(stateProvince), "Property is not nullable for class SingleRateResponseFromAddress.");

            if (residential.IsSet && residential.Value == null)
                throw new ArgumentNullException(nameof(residential), "Property is not nullable for class SingleRateResponseFromAddress.");

            return new SingleRateResponseFromAddress(addressLine1, addressLine2, addressLine3, cityTown, company, email, countryCode, name, phone, postalCode, stateProvince, residential);
        }

        /// <summary>
        /// Serializes a <see cref="SingleRateResponseFromAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="singleRateResponseFromAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, SingleRateResponseFromAddress singleRateResponseFromAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, singleRateResponseFromAddress, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="SingleRateResponseFromAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="singleRateResponseFromAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, SingleRateResponseFromAddress singleRateResponseFromAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            if (singleRateResponseFromAddress.AddressLine1Option.IsSet && singleRateResponseFromAddress.AddressLine1 == null)
                throw new ArgumentNullException(nameof(singleRateResponseFromAddress.AddressLine1), "Property is required for class SingleRateResponseFromAddress.");

            if (singleRateResponseFromAddress.AddressLine2Option.IsSet && singleRateResponseFromAddress.AddressLine2 == null)
                throw new ArgumentNullException(nameof(singleRateResponseFromAddress.AddressLine2), "Property is required for class SingleRateResponseFromAddress.");

            if (singleRateResponseFromAddress.AddressLine3Option.IsSet && singleRateResponseFromAddress.AddressLine3 == null)
                throw new ArgumentNullException(nameof(singleRateResponseFromAddress.AddressLine3), "Property is required for class SingleRateResponseFromAddress.");

            if (singleRateResponseFromAddress.CityTownOption.IsSet && singleRateResponseFromAddress.CityTown == null)
                throw new ArgumentNullException(nameof(singleRateResponseFromAddress.CityTown), "Property is required for class SingleRateResponseFromAddress.");

            if (singleRateResponseFromAddress.CompanyOption.IsSet && singleRateResponseFromAddress.Company == null)
                throw new ArgumentNullException(nameof(singleRateResponseFromAddress.Company), "Property is required for class SingleRateResponseFromAddress.");

            if (singleRateResponseFromAddress.EmailOption.IsSet && singleRateResponseFromAddress.Email == null)
                throw new ArgumentNullException(nameof(singleRateResponseFromAddress.Email), "Property is required for class SingleRateResponseFromAddress.");

            if (singleRateResponseFromAddress.CountryCodeOption.IsSet && singleRateResponseFromAddress.CountryCode == null)
                throw new ArgumentNullException(nameof(singleRateResponseFromAddress.CountryCode), "Property is required for class SingleRateResponseFromAddress.");

            if (singleRateResponseFromAddress.NameOption.IsSet && singleRateResponseFromAddress.Name == null)
                throw new ArgumentNullException(nameof(singleRateResponseFromAddress.Name), "Property is required for class SingleRateResponseFromAddress.");

            if (singleRateResponseFromAddress.PhoneOption.IsSet && singleRateResponseFromAddress.Phone == null)
                throw new ArgumentNullException(nameof(singleRateResponseFromAddress.Phone), "Property is required for class SingleRateResponseFromAddress.");

            if (singleRateResponseFromAddress.PostalCodeOption.IsSet && singleRateResponseFromAddress.PostalCode == null)
                throw new ArgumentNullException(nameof(singleRateResponseFromAddress.PostalCode), "Property is required for class SingleRateResponseFromAddress.");

            if (singleRateResponseFromAddress.StateProvinceOption.IsSet && singleRateResponseFromAddress.StateProvince == null)
                throw new ArgumentNullException(nameof(singleRateResponseFromAddress.StateProvince), "Property is required for class SingleRateResponseFromAddress.");

            if (singleRateResponseFromAddress.AddressLine1Option.IsSet)
                writer.WriteString("addressLine1", singleRateResponseFromAddress.AddressLine1);

            if (singleRateResponseFromAddress.AddressLine2Option.IsSet)
                writer.WriteString("addressLine2", singleRateResponseFromAddress.AddressLine2);

            if (singleRateResponseFromAddress.AddressLine3Option.IsSet)
                writer.WriteString("addressLine3", singleRateResponseFromAddress.AddressLine3);

            if (singleRateResponseFromAddress.CityTownOption.IsSet)
                writer.WriteString("cityTown", singleRateResponseFromAddress.CityTown);

            if (singleRateResponseFromAddress.CompanyOption.IsSet)
                writer.WriteString("company", singleRateResponseFromAddress.Company);

            if (singleRateResponseFromAddress.EmailOption.IsSet)
                writer.WriteString("email", singleRateResponseFromAddress.Email);

            if (singleRateResponseFromAddress.CountryCodeOption.IsSet)
                writer.WriteString("countryCode", singleRateResponseFromAddress.CountryCode);

            if (singleRateResponseFromAddress.NameOption.IsSet)
                writer.WriteString("name", singleRateResponseFromAddress.Name);

            if (singleRateResponseFromAddress.PhoneOption.IsSet)
                writer.WriteString("phone", singleRateResponseFromAddress.Phone);

            if (singleRateResponseFromAddress.PostalCodeOption.IsSet)
                writer.WriteString("postalCode", singleRateResponseFromAddress.PostalCode);

            if (singleRateResponseFromAddress.StateProvinceOption.IsSet)
                writer.WriteString("stateProvince", singleRateResponseFromAddress.StateProvince);

            if (singleRateResponseFromAddress.ResidentialOption.IsSet)
                writer.WriteBoolean("residential", singleRateResponseFromAddress.ResidentialOption.Value.Value);
        }
    }
}
