...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    public partial class ShipmentDomesticByCarrierHandling : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShipmentDomesticByCarrierHandling" /> class.
        /// </summary>
        /// <param name="type">The special handling type.</param>
        [JsonConstructor]
        public ShipmentDomesticByCarrierHandling(Option<TypeEnum?> type = default)
        {
            TypeOption = type;
            OnCreated();
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShipmentDomesticByCarrierHandling {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="ShipmentDomesticByCarrierHandling" />
    /// </summary>
    public class ShipmentDomesticByCarrierHandlingJsonConverter : JsonConverter<ShipmentDomesticByCarrierHandling>
    {
        /// <summary>
        /// Deserializes json to <see cref="ShipmentDomesticByCarrierHandling" />
        /// </summary>
        ...
        public override ShipmentDomesticByCarrierHandling Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<ShipmentDomesticByCarrierHandling.TypeEnum?> type = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "type":
                            ...
                            if (typeRawValue != null)
                                type = new Option<ShipmentDomesticByCarrierHandling.TypeEnum?>(ShipmentDomesticByCarrierHandling.TypeEnumFromStringOrDefault(typeRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class ShipmentDomesticByCarrierHandling.");

            return new ShipmentDomesticByCarrierHandling(type);
        }

        /// <summary>
        /// Serializes a <see cref="ShipmentDomesticByCarrierHandling" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="shipmentDomesticByCarrierHandling"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ShipmentDomesticByCarrierHandling shipmentDomesticByCarrierHandling, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, shipmentDomesticByCarrierHandling, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ShipmentDomesticByCarrierHandling" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="shipmentDomesticByCarrierHandling"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ShipmentDomesticByCarrierHandling shipmentDomesticByCarrierHandling, JsonSerializerOptions jsonSerializerOptions)
        {
            var typeRawValue = ShipmentDomesticByCarrierHandling.TypeEnumToJsonValue(shipmentDomesticByCarrierHandling.TypeOption.Value!.Value);
