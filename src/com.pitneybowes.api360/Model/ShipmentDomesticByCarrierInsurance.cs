...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    public partial class ShipmentDomesticByCarrierInsurance : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShipmentDomesticByCarrierInsurance" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public ShipmentDomesticByCarrierInsurance(Option<TypeEnum?> type = default, Option<decimal?> amount = default)
        {
            TypeOption = type;
            AmountOption = amount;
            OnCreated();
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShipmentDomesticByCarrierInsurance {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="ShipmentDomesticByCarrierInsurance" />
    /// </summary>
    public class ShipmentDomesticByCarrierInsuranceJsonConverter : JsonConverter<ShipmentDomesticByCarrierInsurance>
    {
        /// <summary>
        /// Deserializes json to <see cref="ShipmentDomesticByCarrierInsurance" />
        /// </summary>
        ...
        public override ShipmentDomesticByCarrierInsurance Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<ShipmentDomesticByCarrierInsurance.TypeEnum?> type = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "type":
                            ...
                            if (typeRawValue != null)
                                type = new Option<ShipmentDomesticByCarrierInsurance.TypeEnum?>(ShipmentDomesticByCarrierInsurance.TypeEnumFromStringOrDefault(typeRawValue));
                            break;
                        case "amount":
            ...
            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class ShipmentDomesticByCarrierInsurance.");

            if (amount.IsSet && amount.Value == null)
                throw new ArgumentNullException(nameof(amount), "Property is not nullable for class ShipmentDomesticByCarrierInsurance.");

            return new ShipmentDomesticByCarrierInsurance(type, amount);
        }

        /// <summary>
        /// Serializes a <see cref="ShipmentDomesticByCarrierInsurance" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="shipmentDomesticByCarrierInsurance"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ShipmentDomesticByCarrierInsurance shipmentDomesticByCarrierInsurance, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, shipmentDomesticByCarrierInsurance, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ShipmentDomesticByCarrierInsurance" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="shipmentDomesticByCarrierInsurance"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ShipmentDomesticByCarrierInsurance shipmentDomesticByCarrierInsurance, JsonSerializerOptions jsonSerializerOptions)
        {
            var typeRawValue = ShipmentDomesticByCarrierInsurance.TypeEnumToJsonValue(shipmentDomesticByCarrierInsurance.TypeOption.Value.Value);
            writer.WriteString("type", typeRawValue);
            if (shipmentDomesticByCarrierInsurance.AmountOption.IsSet)
                writer.WriteNumber("amount", shipmentDomesticByCarrierInsurance.AmountOption.Value.Value);
        }
    }
}
