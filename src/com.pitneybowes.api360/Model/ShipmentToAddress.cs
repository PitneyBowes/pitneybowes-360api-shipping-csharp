...
namespace com.pitneybowes.api360.Model
{
    ...
    /// ShipmentToAddress
    /// </summary>
    [DataContract(Name = "Shipment_toAddress")]
    public partial class ShipmentToAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShipmentToAddress" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ShipmentToAddress() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ShipmentToAddress" /> class.
        /// </summary>
        ...
        public ShipmentToAddress(string addressLine1 = default(string), string addressLine2 = default(string), string addressLine3 = default(string), string cityTown = default(string), string countryCode = default(string), string name = default(string), string phone = default(string), string postalCode = default(string), string stateProvince = default(string))
        {
            // to ensure "addressLine1" is required (not null)
            if (addressLine1 == null)
            {
                throw new ArgumentNullException("addressLine1 is a required property for ShipmentToAddress and cannot be null");
            }
            this.AddressLine1 = addressLine1;
            // to ensure "countryCode" is required (not null)
            if (countryCode == null)
            {
                throw new ArgumentNullException("countryCode is a required property for ShipmentToAddress and cannot be null");
            }
            this.CountryCode = countryCode;
            // to ensure "postalCode" is required (not null)
            if (postalCode == null)
            {
                throw new ArgumentNullException("postalCode is a required property for ShipmentToAddress and cannot be null");
            }
            this.PostalCode = postalCode;
            // to ensure "stateProvince" is required (not null)
            if (stateProvince == null)
            {
                throw new ArgumentNullException("stateProvince is a required property for ShipmentToAddress and cannot be null");
            }
