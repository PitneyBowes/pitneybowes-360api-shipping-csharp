...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getAllShipments_data_inner_rate")]
    public partial class GetAllShipmentsDataInnerRate : IValidatableObject
    {
        ...
        public GetAllShipmentsDataInnerRate(decimal baseCharge = default(decimal), string carrier = default(string), string currencyCode = default(string), string inductionPostalCode = default(string), string parcelType = default(string), string rateTypeId = default(string), string serviceId = default(string), List<GetAllShipmentsDataInnerRateSpecialServicesInner> specialServices = default(List<GetAllShipmentsDataInnerRateSpecialServicesInner>), decimal totalCarrierCharge = default(decimal))
        {
        ...
        public List<GetAllShipmentsDataInnerRateSpecialServicesInner> SpecialServices { get; set; }
