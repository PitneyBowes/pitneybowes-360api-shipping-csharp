...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    public partial class GetAllShipmentsDataInnerRate : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAllShipmentsDataInnerRate" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public GetAllShipmentsDataInnerRate(Option<decimal?> baseCharge = default, Option<string> carrier = default, Option<string> currencyCode = default, Option<string> inductionPostalCode = default, Option<string> parcelType = default, Option<string> rateTypeId = default, Option<string> serviceId = default, Option<List<GetAllShipmentsDataInnerRateSpecialServicesInner>> specialServices = default, Option<decimal?> totalCarrierCharge = default)
        {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<GetAllShipmentsDataInnerRateSpecialServicesInner>> SpecialServicesOption { get; private set; }
        ...
        /* <example>[{&quot;fee&quot;:0,&quot;inputParameters&quot;:[{&quot;name&quot;:&quot;INPUT_VALUE&quot;,&quot;value&quot;:&quot;10&quot;}],&quot;specialServiceId&quot;:&quot;Ins&quot;}]</example> */
        [JsonPropertyName("specialServices")]
        public List<GetAllShipmentsDataInnerRateSpecialServicesInner> SpecialServices { get { return this.SpecialServicesOption; } set { this.SpecialServicesOption = new Option<List<GetAllShipmentsDataInnerRateSpecialServicesInner>>(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="GetAllShipmentsDataInnerRate" />
    /// </summary>
    public class GetAllShipmentsDataInnerRateJsonConverter : JsonConverter<GetAllShipmentsDataInnerRate>
    {
        /// <summary>
        /// Deserializes json to <see cref="GetAllShipmentsDataInnerRate" />
        /// </summary>
        ...
        public override GetAllShipmentsDataInnerRate Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<GetAllShipmentsDataInnerRateSpecialServicesInner>> specialServices = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "specialServices":
                            specialServices = new Option<List<GetAllShipmentsDataInnerRateSpecialServicesInner>>(JsonSerializer.Deserialize<List<GetAllShipmentsDataInnerRateSpecialServicesInner>>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
            ...
            if (baseCharge.IsSet && baseCharge.Value == null)
                throw new ArgumentNullException(nameof(baseCharge), "Property is not nullable for class GetAllShipmentsDataInnerRate.");

            if (carrier.IsSet && carrier.Value == null)
                throw new ArgumentNullException(nameof(carrier), "Property is not nullable for class GetAllShipmentsDataInnerRate.");

            if (currencyCode.IsSet && currencyCode.Value == null)
                throw new ArgumentNullException(nameof(currencyCode), "Property is not nullable for class GetAllShipmentsDataInnerRate.");

            if (inductionPostalCode.IsSet && inductionPostalCode.Value == null)
                throw new ArgumentNullException(nameof(inductionPostalCode), "Property is not nullable for class GetAllShipmentsDataInnerRate.");

            if (parcelType.IsSet && parcelType.Value == null)
                throw new ArgumentNullException(nameof(parcelType), "Property is not nullable for class GetAllShipmentsDataInnerRate.");

            if (rateTypeId.IsSet && rateTypeId.Value == null)
                throw new ArgumentNullException(nameof(rateTypeId), "Property is not nullable for class GetAllShipmentsDataInnerRate.");

            if (serviceId.IsSet && serviceId.Value == null)
                throw new ArgumentNullException(nameof(serviceId), "Property is not nullable for class GetAllShipmentsDataInnerRate.");

            if (specialServices.IsSet && specialServices.Value == null)
                throw new ArgumentNullException(nameof(specialServices), "Property is not nullable for class GetAllShipmentsDataInnerRate.");

            if (totalCarrierCharge.IsSet && totalCarrierCharge.Value == null)
                throw new ArgumentNullException(nameof(totalCarrierCharge), "Property is not nullable for class GetAllShipmentsDataInnerRate.");

            return new GetAllShipmentsDataInnerRate(baseCharge, carrier, currencyCode, inductionPostalCode, parcelType, rateTypeId, serviceId, specialServices, totalCarrierCharge);
        }

        /// <summary>
        /// Serializes a <see cref="GetAllShipmentsDataInnerRate" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getAllShipmentsDataInnerRate"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GetAllShipmentsDataInnerRate getAllShipmentsDataInnerRate, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, getAllShipmentsDataInnerRate, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GetAllShipmentsDataInnerRate" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getAllShipmentsDataInnerRate"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, GetAllShipmentsDataInnerRate getAllShipmentsDataInnerRate, JsonSerializerOptions jsonSerializerOptions)
        {
            if (getAllShipmentsDataInnerRate.CarrierOption.IsSet && getAllShipmentsDataInnerRate.Carrier == null)
                throw new ArgumentNullException(nameof(getAllShipmentsDataInnerRate.Carrier), "Property is required for class GetAllShipmentsDataInnerRate.");

            if (getAllShipmentsDataInnerRate.CurrencyCodeOption.IsSet && getAllShipmentsDataInnerRate.CurrencyCode == null)
                throw new ArgumentNullException(nameof(getAllShipmentsDataInnerRate.CurrencyCode), "Property is required for class GetAllShipmentsDataInnerRate.");

            if (getAllShipmentsDataInnerRate.InductionPostalCodeOption.IsSet && getAllShipmentsDataInnerRate.InductionPostalCode == null)
                throw new ArgumentNullException(nameof(getAllShipmentsDataInnerRate.InductionPostalCode), "Property is required for class GetAllShipmentsDataInnerRate.");

            if (getAllShipmentsDataInnerRate.ParcelTypeOption.IsSet && getAllShipmentsDataInnerRate.ParcelType == null)
                throw new ArgumentNullException(nameof(getAllShipmentsDataInnerRate.ParcelType), "Property is required for class GetAllShipmentsDataInnerRate.");

            if (getAllShipmentsDataInnerRate.RateTypeIdOption.IsSet && getAllShipmentsDataInnerRate.RateTypeId == null)
                throw new ArgumentNullException(nameof(getAllShipmentsDataInnerRate.RateTypeId), "Property is required for class GetAllShipmentsDataInnerRate.");

            if (getAllShipmentsDataInnerRate.ServiceIdOption.IsSet && getAllShipmentsDataInnerRate.ServiceId == null)
                throw new ArgumentNullException(nameof(getAllShipmentsDataInnerRate.ServiceId), "Property is required for class GetAllShipmentsDataInnerRate.");

            if (getAllShipmentsDataInnerRate.SpecialServicesOption.IsSet && getAllShipmentsDataInnerRate.SpecialServices == null)
                throw new ArgumentNullException(nameof(getAllShipmentsDataInnerRate.SpecialServices), "Property is required for class GetAllShipmentsDataInnerRate.");

            if (getAllShipmentsDataInnerRate.BaseChargeOption.IsSet)
                writer.WriteNumber("baseCharge", getAllShipmentsDataInnerRate.BaseChargeOption.Value.Value);

            if (getAllShipmentsDataInnerRate.CarrierOption.IsSet)
                writer.WriteString("carrier", getAllShipmentsDataInnerRate.Carrier);

            if (getAllShipmentsDataInnerRate.CurrencyCodeOption.IsSet)
                writer.WriteString("currencyCode", getAllShipmentsDataInnerRate.CurrencyCode);

            if (getAllShipmentsDataInnerRate.InductionPostalCodeOption.IsSet)
                writer.WriteString("inductionPostalCode", getAllShipmentsDataInnerRate.InductionPostalCode);

            if (getAllShipmentsDataInnerRate.ParcelTypeOption.IsSet)
                writer.WriteString("parcelType", getAllShipmentsDataInnerRate.ParcelType);

            if (getAllShipmentsDataInnerRate.RateTypeIdOption.IsSet)
                writer.WriteString("rateTypeId", getAllShipmentsDataInnerRate.RateTypeId);

            if (getAllShipmentsDataInnerRate.ServiceIdOption.IsSet)
                writer.WriteString("serviceId", getAllShipmentsDataInnerRate.ServiceId);

            if (getAllShipmentsDataInnerRate.SpecialServicesOption.IsSet)
            {
                writer.WritePropertyName("specialServices");
                JsonSerializer.Serialize(writer, getAllShipmentsDataInnerRate.SpecialServices, jsonSerializerOptions);
            }
            if (getAllShipmentsDataInnerRate.TotalCarrierChargeOption.IsSet)
                writer.WriteNumber("totalCarrierCharge", getAllShipmentsDataInnerRate.TotalCarrierChargeOption.Value.Value);
        }
    }
}
