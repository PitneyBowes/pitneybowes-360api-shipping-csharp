...
namespace com.pitneybowes.api360.Model
{
    ...
    /// RateResponseV2
    /// </summary>
    [DataContract(Name = "rateResponseV2")]
    public partial class RateResponseV2 : IValidatableObject
    {
        ...
        public RateResponseV2(decimal baseCharge = default(decimal), string carrier = default(string), string currencyCode = default(string), string parcelType = default(string), string serviceId = default(string), List<RateResponseV2SurchargesInner> surcharges = default(List<RateResponseV2SurchargesInner>), decimal totalCarrierCharge = default(decimal), RateResponseV2DeliveryCommitment deliveryCommitment = default(RateResponseV2DeliveryCommitment))
        {
        ...
        public List<RateResponseV2SurchargesInner> Surcharges { get; set; }
        ...
        public RateResponseV2DeliveryCommitment DeliveryCommitment { get; set; }
