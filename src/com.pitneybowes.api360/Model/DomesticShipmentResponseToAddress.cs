...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    [DataContract(Name = "domesticShipmentResponse_toAddress")]
    public partial class DomesticShipmentResponseToAddress : IValidatableObject
    {
        ...
        /// <param name="countryCode">This indicates the two-character ISO code of the destination country from the ISO country list..</param>
