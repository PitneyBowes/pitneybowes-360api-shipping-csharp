...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    public partial class DomesticShipmentResponseToAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DomesticShipmentResponseToAddress" /> class.
        /// </summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="DomesticShipmentResponseToAddress" />
    /// </summary>
    public class DomesticShipmentResponseToAddressJsonConverter : JsonConverter<DomesticShipmentResponseToAddress>
    {
        /// <summary>
        /// Deserializes json to <see cref="DomesticShipmentResponseToAddress" />
        /// </summary>
        ...
        public override DomesticShipmentResponseToAddress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (addressLine1.IsSet && addressLine1.Value == null)
                throw new ArgumentNullException(nameof(addressLine1), "Property is not nullable for class DomesticShipmentResponseToAddress.");

            if (addressLine2.IsSet && addressLine2.Value == null)
                throw new ArgumentNullException(nameof(addressLine2), "Property is not nullable for class DomesticShipmentResponseToAddress.");

            if (addressLine3.IsSet && addressLine3.Value == null)
                throw new ArgumentNullException(nameof(addressLine3), "Property is not nullable for class DomesticShipmentResponseToAddress.");

            if (cityTown.IsSet && cityTown.Value == null)
                throw new ArgumentNullException(nameof(cityTown), "Property is not nullable for class DomesticShipmentResponseToAddress.");

            if (company.IsSet && company.Value == null)
                throw new ArgumentNullException(nameof(company), "Property is not nullable for class DomesticShipmentResponseToAddress.");

            if (countryCode.IsSet && countryCode.Value == null)
                throw new ArgumentNullException(nameof(countryCode), "Property is not nullable for class DomesticShipmentResponseToAddress.");

            if (email.IsSet && email.Value == null)
                throw new ArgumentNullException(nameof(email), "Property is not nullable for class DomesticShipmentResponseToAddress.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class DomesticShipmentResponseToAddress.");

            if (phone.IsSet && phone.Value == null)
                throw new ArgumentNullException(nameof(phone), "Property is not nullable for class DomesticShipmentResponseToAddress.");

            if (postalCode.IsSet && postalCode.Value == null)
                throw new ArgumentNullException(nameof(postalCode), "Property is not nullable for class DomesticShipmentResponseToAddress.");

            if (residential.IsSet && residential.Value == null)
                throw new ArgumentNullException(nameof(residential), "Property is not nullable for class DomesticShipmentResponseToAddress.");

            if (stateProvince.IsSet && stateProvince.Value == null)
                throw new ArgumentNullException(nameof(stateProvince), "Property is not nullable for class DomesticShipmentResponseToAddress.");

            return new DomesticShipmentResponseToAddress(addressLine1, addressLine2, addressLine3, cityTown, company, countryCode, email, name, phone, postalCode, residential, stateProvince);
        }

        /// <summary>
        /// Serializes a <see cref="DomesticShipmentResponseToAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="domesticShipmentResponseToAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, DomesticShipmentResponseToAddress domesticShipmentResponseToAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, domesticShipmentResponseToAddress, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="DomesticShipmentResponseToAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="domesticShipmentResponseToAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, DomesticShipmentResponseToAddress domesticShipmentResponseToAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            if (domesticShipmentResponseToAddress.AddressLine1Option.IsSet && domesticShipmentResponseToAddress.AddressLine1 == null)
                throw new ArgumentNullException(nameof(domesticShipmentResponseToAddress.AddressLine1), "Property is required for class DomesticShipmentResponseToAddress.");

            if (domesticShipmentResponseToAddress.AddressLine2Option.IsSet && domesticShipmentResponseToAddress.AddressLine2 == null)
                throw new ArgumentNullException(nameof(domesticShipmentResponseToAddress.AddressLine2), "Property is required for class DomesticShipmentResponseToAddress.");

            if (domesticShipmentResponseToAddress.AddressLine3Option.IsSet && domesticShipmentResponseToAddress.AddressLine3 == null)
                throw new ArgumentNullException(nameof(domesticShipmentResponseToAddress.AddressLine3), "Property is required for class DomesticShipmentResponseToAddress.");

            if (domesticShipmentResponseToAddress.CityTownOption.IsSet && domesticShipmentResponseToAddress.CityTown == null)
                throw new ArgumentNullException(nameof(domesticShipmentResponseToAddress.CityTown), "Property is required for class DomesticShipmentResponseToAddress.");

            if (domesticShipmentResponseToAddress.CompanyOption.IsSet && domesticShipmentResponseToAddress.Company == null)
                throw new ArgumentNullException(nameof(domesticShipmentResponseToAddress.Company), "Property is required for class DomesticShipmentResponseToAddress.");

            if (domesticShipmentResponseToAddress.CountryCodeOption.IsSet && domesticShipmentResponseToAddress.CountryCode == null)
                throw new ArgumentNullException(nameof(domesticShipmentResponseToAddress.CountryCode), "Property is required for class DomesticShipmentResponseToAddress.");

            if (domesticShipmentResponseToAddress.EmailOption.IsSet && domesticShipmentResponseToAddress.Email == null)
                throw new ArgumentNullException(nameof(domesticShipmentResponseToAddress.Email), "Property is required for class DomesticShipmentResponseToAddress.");

            if (domesticShipmentResponseToAddress.NameOption.IsSet && domesticShipmentResponseToAddress.Name == null)
                throw new ArgumentNullException(nameof(domesticShipmentResponseToAddress.Name), "Property is required for class DomesticShipmentResponseToAddress.");

            if (domesticShipmentResponseToAddress.PhoneOption.IsSet && domesticShipmentResponseToAddress.Phone == null)
                throw new ArgumentNullException(nameof(domesticShipmentResponseToAddress.Phone), "Property is required for class DomesticShipmentResponseToAddress.");

            if (domesticShipmentResponseToAddress.PostalCodeOption.IsSet && domesticShipmentResponseToAddress.PostalCode == null)
                throw new ArgumentNullException(nameof(domesticShipmentResponseToAddress.PostalCode), "Property is required for class DomesticShipmentResponseToAddress.");

            if (domesticShipmentResponseToAddress.StateProvinceOption.IsSet && domesticShipmentResponseToAddress.StateProvince == null)
                throw new ArgumentNullException(nameof(domesticShipmentResponseToAddress.StateProvince), "Property is required for class DomesticShipmentResponseToAddress.");

            if (domesticShipmentResponseToAddress.AddressLine1Option.IsSet)
                writer.WriteString("addressLine1", domesticShipmentResponseToAddress.AddressLine1);

            if (domesticShipmentResponseToAddress.AddressLine2Option.IsSet)
                writer.WriteString("addressLine2", domesticShipmentResponseToAddress.AddressLine2);

            if (domesticShipmentResponseToAddress.AddressLine3Option.IsSet)
                writer.WriteString("addressLine3", domesticShipmentResponseToAddress.AddressLine3);

            if (domesticShipmentResponseToAddress.CityTownOption.IsSet)
                writer.WriteString("cityTown", domesticShipmentResponseToAddress.CityTown);

            if (domesticShipmentResponseToAddress.CompanyOption.IsSet)
                writer.WriteString("company", domesticShipmentResponseToAddress.Company);

            if (domesticShipmentResponseToAddress.CountryCodeOption.IsSet)
                writer.WriteString("countryCode", domesticShipmentResponseToAddress.CountryCode);

            if (domesticShipmentResponseToAddress.EmailOption.IsSet)
                writer.WriteString("email", domesticShipmentResponseToAddress.Email);

            if (domesticShipmentResponseToAddress.NameOption.IsSet)
                writer.WriteString("name", domesticShipmentResponseToAddress.Name);

            if (domesticShipmentResponseToAddress.PhoneOption.IsSet)
                writer.WriteString("phone", domesticShipmentResponseToAddress.Phone);

            if (domesticShipmentResponseToAddress.PostalCodeOption.IsSet)
                writer.WriteString("postalCode", domesticShipmentResponseToAddress.PostalCode);

            if (domesticShipmentResponseToAddress.ResidentialOption.IsSet)
                writer.WriteBoolean("residential", domesticShipmentResponseToAddress.ResidentialOption.Value.Value);

            if (domesticShipmentResponseToAddress.StateProvinceOption.IsSet)
                writer.WriteString("stateProvince", domesticShipmentResponseToAddress.StateProvince);
        }
    }
}
