...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    public partial class DomesticShipmentResponseRate : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DomesticShipmentResponseRate" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public DomesticShipmentResponseRate(Option<decimal?> baseCharge = default, Option<List<RateShipment200ResponseRateInnerBaseChargeTaxesInner>> baseChargeTaxes = default, Option<string> carrier = default, Option<string> currencyCode = default, Option<MultipieceRateShopResponseRatesInnerDeliveryCommitment> deliveryCommitment = default, Option<string> parcelType = default, Option<string> rateTypeId = default, Option<string> serviceId = default, Option<List<DomesticShipmentResponseRateSpecialServicesInner>> specialServices = default, Option<decimal?> totalCarrierCharge = default, Option<string> inductionPostalCode = default, Option<float?> totalTaxAmount = default, Option<string> destinationZone = default)
        {
        ...
        public List<RateShipment200ResponseRateInnerBaseChargeTaxesInner> BaseChargeTaxes { get { return this.BaseChargeTaxesOption; } set { this.BaseChargeTaxesOption = new Option<List<RateShipment200ResponseRateInnerBaseChargeTaxesInner>>(value); } }
        ...
        public MultipieceRateShopResponseRatesInnerDeliveryCommitment DeliveryCommitment { get { return this.DeliveryCommitmentOption; } set { this.DeliveryCommitmentOption = new Option<MultipieceRateShopResponseRatesInnerDeliveryCommitment>(value); } }
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<DomesticShipmentResponseRateSpecialServicesInner>> SpecialServicesOption { get; private set; }
        ...
        public List<DomesticShipmentResponseRateSpecialServicesInner> SpecialServices { get { return this.SpecialServicesOption; } set { this.SpecialServicesOption = new Option<List<DomesticShipmentResponseRateSpecialServicesInner>>(value); } }
        ...
        public float? TotalTaxAmount { get { return this.TotalTaxAmountOption; } set { this.TotalTaxAmountOption = new Option<float?>(value); } }
        ...
        public string DestinationZone { get { return this.DestinationZoneOption; } set { this.DestinationZoneOption = new Option<string>(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="DomesticShipmentResponseRate" />
    /// </summary>
    public class DomesticShipmentResponseRateJsonConverter : JsonConverter<DomesticShipmentResponseRate>
    {
        /// <summary>
        /// Deserializes json to <see cref="DomesticShipmentResponseRate" />
        /// </summary>
        ...
        public override DomesticShipmentResponseRate Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<DomesticShipmentResponseRateSpecialServicesInner>> specialServices = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "specialServices":
                            specialServices = new Option<List<DomesticShipmentResponseRateSpecialServicesInner>>(JsonSerializer.Deserialize<List<DomesticShipmentResponseRateSpecialServicesInner>>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
            ...
            if (baseCharge.IsSet && baseCharge.Value == null)
                throw new ArgumentNullException(nameof(baseCharge), "Property is not nullable for class DomesticShipmentResponseRate.");

            if (baseChargeTaxes.IsSet && baseChargeTaxes.Value == null)
                throw new ArgumentNullException(nameof(baseChargeTaxes), "Property is not nullable for class DomesticShipmentResponseRate.");

            if (carrier.IsSet && carrier.Value == null)
                throw new ArgumentNullException(nameof(carrier), "Property is not nullable for class DomesticShipmentResponseRate.");

            if (currencyCode.IsSet && currencyCode.Value == null)
                throw new ArgumentNullException(nameof(currencyCode), "Property is not nullable for class DomesticShipmentResponseRate.");

            if (deliveryCommitment.IsSet && deliveryCommitment.Value == null)
                throw new ArgumentNullException(nameof(deliveryCommitment), "Property is not nullable for class DomesticShipmentResponseRate.");

            if (parcelType.IsSet && parcelType.Value == null)
                throw new ArgumentNullException(nameof(parcelType), "Property is not nullable for class DomesticShipmentResponseRate.");

            if (rateTypeId.IsSet && rateTypeId.Value == null)
                throw new ArgumentNullException(nameof(rateTypeId), "Property is not nullable for class DomesticShipmentResponseRate.");

            if (serviceId.IsSet && serviceId.Value == null)
                throw new ArgumentNullException(nameof(serviceId), "Property is not nullable for class DomesticShipmentResponseRate.");

            if (specialServices.IsSet && specialServices.Value == null)
                throw new ArgumentNullException(nameof(specialServices), "Property is not nullable for class DomesticShipmentResponseRate.");

            if (totalCarrierCharge.IsSet && totalCarrierCharge.Value == null)
                throw new ArgumentNullException(nameof(totalCarrierCharge), "Property is not nullable for class DomesticShipmentResponseRate.");

            if (inductionPostalCode.IsSet && inductionPostalCode.Value == null)
                throw new ArgumentNullException(nameof(inductionPostalCode), "Property is not nullable for class DomesticShipmentResponseRate.");

            if (totalTaxAmount.IsSet && totalTaxAmount.Value == null)
                throw new ArgumentNullException(nameof(totalTaxAmount), "Property is not nullable for class DomesticShipmentResponseRate.");

            if (destinationZone.IsSet && destinationZone.Value == null)
                throw new ArgumentNullException(nameof(destinationZone), "Property is not nullable for class DomesticShipmentResponseRate.");

            return new DomesticShipmentResponseRate(baseCharge, baseChargeTaxes, carrier, currencyCode, deliveryCommitment, parcelType, rateTypeId, serviceId, specialServices, totalCarrierCharge, inductionPostalCode, totalTaxAmount, destinationZone);
        }

        /// <summary>
        /// Serializes a <see cref="DomesticShipmentResponseRate" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="domesticShipmentResponseRate"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, DomesticShipmentResponseRate domesticShipmentResponseRate, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, domesticShipmentResponseRate, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="DomesticShipmentResponseRate" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="domesticShipmentResponseRate"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, DomesticShipmentResponseRate domesticShipmentResponseRate, JsonSerializerOptions jsonSerializerOptions)
        {
            if (domesticShipmentResponseRate.BaseChargeTaxesOption.IsSet && domesticShipmentResponseRate.BaseChargeTaxes == null)
                throw new ArgumentNullException(nameof(domesticShipmentResponseRate.BaseChargeTaxes), "Property is required for class DomesticShipmentResponseRate.");

            if (domesticShipmentResponseRate.CarrierOption.IsSet && domesticShipmentResponseRate.Carrier == null)
                throw new ArgumentNullException(nameof(domesticShipmentResponseRate.Carrier), "Property is required for class DomesticShipmentResponseRate.");

            if (domesticShipmentResponseRate.CurrencyCodeOption.IsSet && domesticShipmentResponseRate.CurrencyCode == null)
                throw new ArgumentNullException(nameof(domesticShipmentResponseRate.CurrencyCode), "Property is required for class DomesticShipmentResponseRate.");

            if (domesticShipmentResponseRate.DeliveryCommitmentOption.IsSet && domesticShipmentResponseRate.DeliveryCommitment == null)
                throw new ArgumentNullException(nameof(domesticShipmentResponseRate.DeliveryCommitment), "Property is required for class DomesticShipmentResponseRate.");

            if (domesticShipmentResponseRate.ParcelTypeOption.IsSet && domesticShipmentResponseRate.ParcelType == null)
                throw new ArgumentNullException(nameof(domesticShipmentResponseRate.ParcelType), "Property is required for class DomesticShipmentResponseRate.");

            if (domesticShipmentResponseRate.RateTypeIdOption.IsSet && domesticShipmentResponseRate.RateTypeId == null)
                throw new ArgumentNullException(nameof(domesticShipmentResponseRate.RateTypeId), "Property is required for class DomesticShipmentResponseRate.");

            if (domesticShipmentResponseRate.ServiceIdOption.IsSet && domesticShipmentResponseRate.ServiceId == null)
                throw new ArgumentNullException(nameof(domesticShipmentResponseRate.ServiceId), "Property is required for class DomesticShipmentResponseRate.");

            if (domesticShipmentResponseRate.SpecialServicesOption.IsSet && domesticShipmentResponseRate.SpecialServices == null)
                throw new ArgumentNullException(nameof(domesticShipmentResponseRate.SpecialServices), "Property is required for class DomesticShipmentResponseRate.");

            if (domesticShipmentResponseRate.InductionPostalCodeOption.IsSet && domesticShipmentResponseRate.InductionPostalCode == null)
                throw new ArgumentNullException(nameof(domesticShipmentResponseRate.InductionPostalCode), "Property is required for class DomesticShipmentResponseRate.");

            if (domesticShipmentResponseRate.DestinationZoneOption.IsSet && domesticShipmentResponseRate.DestinationZone == null)
                throw new ArgumentNullException(nameof(domesticShipmentResponseRate.DestinationZone), "Property is required for class DomesticShipmentResponseRate.");

            if (domesticShipmentResponseRate.BaseChargeOption.IsSet)
                writer.WriteNumber("baseCharge", domesticShipmentResponseRate.BaseChargeOption.Value.Value);

            if (domesticShipmentResponseRate.BaseChargeTaxesOption.IsSet)
            {
                writer.WritePropertyName("baseChargeTaxes");
                JsonSerializer.Serialize(writer, domesticShipmentResponseRate.BaseChargeTaxes, jsonSerializerOptions);
            }
            if (domesticShipmentResponseRate.CarrierOption.IsSet)
                writer.WriteString("carrier", domesticShipmentResponseRate.Carrier);

            if (domesticShipmentResponseRate.CurrencyCodeOption.IsSet)
                writer.WriteString("currencyCode", domesticShipmentResponseRate.CurrencyCode);

            if (domesticShipmentResponseRate.DeliveryCommitmentOption.IsSet)
            {
                writer.WritePropertyName("deliveryCommitment");
                JsonSerializer.Serialize(writer, domesticShipmentResponseRate.DeliveryCommitment, jsonSerializerOptions);
            }
            if (domesticShipmentResponseRate.ParcelTypeOption.IsSet)
                writer.WriteString("parcelType", domesticShipmentResponseRate.ParcelType);

            if (domesticShipmentResponseRate.RateTypeIdOption.IsSet)
                writer.WriteString("rateTypeId", domesticShipmentResponseRate.RateTypeId);

            if (domesticShipmentResponseRate.ServiceIdOption.IsSet)
                writer.WriteString("serviceId", domesticShipmentResponseRate.ServiceId);

            if (domesticShipmentResponseRate.SpecialServicesOption.IsSet)
            {
                writer.WritePropertyName("specialServices");
                JsonSerializer.Serialize(writer, domesticShipmentResponseRate.SpecialServices, jsonSerializerOptions);
            }
            if (domesticShipmentResponseRate.TotalCarrierChargeOption.IsSet)
                writer.WriteNumber("totalCarrierCharge", domesticShipmentResponseRate.TotalCarrierChargeOption.Value.Value);

            if (domesticShipmentResponseRate.InductionPostalCodeOption.IsSet)
                writer.WriteString("inductionPostalCode", domesticShipmentResponseRate.InductionPostalCode);

            if (domesticShipmentResponseRate.TotalTaxAmountOption.IsSet)
                writer.WriteNumber("totalTaxAmount", domesticShipmentResponseRate.TotalTaxAmountOption.Value.Value);

            if (domesticShipmentResponseRate.DestinationZoneOption.IsSet)
                writer.WriteString("destinationZone", domesticShipmentResponseRate.DestinationZone);
        }
    }
}
