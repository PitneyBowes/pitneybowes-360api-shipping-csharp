...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    [DataContract(Name = "domesticShipmentResponse_rate")]
    public partial class DomesticShipmentResponseRate : IValidatableObject
    {
        ...
        public DomesticShipmentResponseRate(decimal baseCharge = default(decimal), string carrier = default(string), string currencyCode = default(string), string parcelType = default(string), string rateTypeId = default(string), string serviceId = default(string), List<DomesticShipmentResponseRateSpecialServicesInner> specialServices = default(List<DomesticShipmentResponseRateSpecialServicesInner>), decimal totalCarrierCharge = default(decimal))
        {
        ...
        public List<DomesticShipmentResponseRateSpecialServicesInner> SpecialServices { get; set; }
