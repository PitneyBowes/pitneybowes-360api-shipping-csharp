...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    [DataContract(Name = "sendingOptionsResponse")]
    public partial class SendingOptionsResponse : IValidatableObject
    {
        ...
        public SendingOptionsResponse(string carrier = default(string), string service = default(string), SendingOptionsResponseCarrierAccounts carrierAccounts = default(SendingOptionsResponseCarrierAccounts), LabelSizeEnum? labelSize = default(LabelSizeEnum?), string labelType = default(string), string labelFormat = default(string), FromAddressV2Response fromAddress = default(FromAddressV2Response), ParcelV2Response parcel = default(ParcelV2Response))
        {
        ...
        public SendingOptionsResponseCarrierAccounts CarrierAccounts { get; set; }
        ...
        public ParcelV2Response Parcel { get; set; }
