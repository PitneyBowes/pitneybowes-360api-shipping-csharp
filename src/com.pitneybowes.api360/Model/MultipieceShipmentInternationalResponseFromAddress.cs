...
{
    /// <summary>
    /// MultipieceShipmentInternationalResponseFromAddress
    /// </summary>
    public partial class MultipieceShipmentInternationalResponseFromAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MultipieceShipmentInternationalResponseFromAddress" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public MultipieceShipmentInternationalResponseFromAddress(Option<string?> addressLine1 = default, Option<string?> addressLine2 = default, Option<string?> addressLine3 = default, Option<string?> cityTown = default, Option<string?> company = default, Option<string?> email = default, Option<string?> countryCode = default, Option<string?> name = default, Option<string?> phone = default, Option<string?> postalCode = default, Option<string?> stateProvince = default, Option<bool?> residential = default, Option<string?> taxId = default, Option<TaxIdTypeEnum?> taxIdType = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MultipieceShipmentInternationalResponseFromAddress {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="MultipieceShipmentInternationalResponseFromAddress" />
    /// </summary>
    public class MultipieceShipmentInternationalResponseFromAddressJsonConverter : JsonConverter<MultipieceShipmentInternationalResponseFromAddress>
    {
        /// <summary>
        /// Deserializes json to <see cref="MultipieceShipmentInternationalResponseFromAddress" />
        /// </summary>
        ...
        public override MultipieceShipmentInternationalResponseFromAddress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<MultipieceShipmentInternationalResponseFromAddress.TaxIdTypeEnum?> taxIdType = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "taxIdType":
                            ...
                            if (taxIdTypeRawValue != null)
                                taxIdType = new Option<MultipieceShipmentInternationalResponseFromAddress.TaxIdTypeEnum?>(MultipieceShipmentInternationalResponseFromAddress.TaxIdTypeEnumFromStringOrDefault(taxIdTypeRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            if (addressLine1.IsSet && addressLine1.Value == null)
                throw new ArgumentNullException(nameof(addressLine1), "Property is not nullable for class MultipieceShipmentInternationalResponseFromAddress.");

            if (addressLine2.IsSet && addressLine2.Value == null)
                throw new ArgumentNullException(nameof(addressLine2), "Property is not nullable for class MultipieceShipmentInternationalResponseFromAddress.");

            if (addressLine3.IsSet && addressLine3.Value == null)
                throw new ArgumentNullException(nameof(addressLine3), "Property is not nullable for class MultipieceShipmentInternationalResponseFromAddress.");

            if (cityTown.IsSet && cityTown.Value == null)
                throw new ArgumentNullException(nameof(cityTown), "Property is not nullable for class MultipieceShipmentInternationalResponseFromAddress.");

            if (company.IsSet && company.Value == null)
                throw new ArgumentNullException(nameof(company), "Property is not nullable for class MultipieceShipmentInternationalResponseFromAddress.");

            if (email.IsSet && email.Value == null)
                throw new ArgumentNullException(nameof(email), "Property is not nullable for class MultipieceShipmentInternationalResponseFromAddress.");

            if (countryCode.IsSet && countryCode.Value == null)
                throw new ArgumentNullException(nameof(countryCode), "Property is not nullable for class MultipieceShipmentInternationalResponseFromAddress.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class MultipieceShipmentInternationalResponseFromAddress.");

            if (phone.IsSet && phone.Value == null)
                throw new ArgumentNullException(nameof(phone), "Property is not nullable for class MultipieceShipmentInternationalResponseFromAddress.");

            if (postalCode.IsSet && postalCode.Value == null)
                throw new ArgumentNullException(nameof(postalCode), "Property is not nullable for class MultipieceShipmentInternationalResponseFromAddress.");

            if (stateProvince.IsSet && stateProvince.Value == null)
                throw new ArgumentNullException(nameof(stateProvince), "Property is not nullable for class MultipieceShipmentInternationalResponseFromAddress.");

            if (residential.IsSet && residential.Value == null)
                throw new ArgumentNullException(nameof(residential), "Property is not nullable for class MultipieceShipmentInternationalResponseFromAddress.");

            if (taxId.IsSet && taxId.Value == null)
                throw new ArgumentNullException(nameof(taxId), "Property is not nullable for class MultipieceShipmentInternationalResponseFromAddress.");

            if (taxIdType.IsSet && taxIdType.Value == null)
                throw new ArgumentNullException(nameof(taxIdType), "Property is not nullable for class MultipieceShipmentInternationalResponseFromAddress.");

            return new MultipieceShipmentInternationalResponseFromAddress(addressLine1, addressLine2, addressLine3, cityTown, company, email, countryCode, name, phone, postalCode, stateProvince, residential, taxId, taxIdType);
        }

        /// <summary>
        /// Serializes a <see cref="MultipieceShipmentInternationalResponseFromAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="multipieceShipmentInternationalResponseFromAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, MultipieceShipmentInternationalResponseFromAddress multipieceShipmentInternationalResponseFromAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, multipieceShipmentInternationalResponseFromAddress, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="MultipieceShipmentInternationalResponseFromAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="multipieceShipmentInternationalResponseFromAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, MultipieceShipmentInternationalResponseFromAddress multipieceShipmentInternationalResponseFromAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            if (multipieceShipmentInternationalResponseFromAddress.AddressLine1Option.IsSet && multipieceShipmentInternationalResponseFromAddress.AddressLine1 == null)
                throw new ArgumentNullException(nameof(multipieceShipmentInternationalResponseFromAddress.AddressLine1), "Property is required for class MultipieceShipmentInternationalResponseFromAddress.");

            if (multipieceShipmentInternationalResponseFromAddress.AddressLine2Option.IsSet && multipieceShipmentInternationalResponseFromAddress.AddressLine2 == null)
                throw new ArgumentNullException(nameof(multipieceShipmentInternationalResponseFromAddress.AddressLine2), "Property is required for class MultipieceShipmentInternationalResponseFromAddress.");

            if (multipieceShipmentInternationalResponseFromAddress.AddressLine3Option.IsSet && multipieceShipmentInternationalResponseFromAddress.AddressLine3 == null)
                throw new ArgumentNullException(nameof(multipieceShipmentInternationalResponseFromAddress.AddressLine3), "Property is required for class MultipieceShipmentInternationalResponseFromAddress.");

            if (multipieceShipmentInternationalResponseFromAddress.CityTownOption.IsSet && multipieceShipmentInternationalResponseFromAddress.CityTown == null)
                throw new ArgumentNullException(nameof(multipieceShipmentInternationalResponseFromAddress.CityTown), "Property is required for class MultipieceShipmentInternationalResponseFromAddress.");

            if (multipieceShipmentInternationalResponseFromAddress.CompanyOption.IsSet && multipieceShipmentInternationalResponseFromAddress.Company == null)
                throw new ArgumentNullException(nameof(multipieceShipmentInternationalResponseFromAddress.Company), "Property is required for class MultipieceShipmentInternationalResponseFromAddress.");

            if (multipieceShipmentInternationalResponseFromAddress.EmailOption.IsSet && multipieceShipmentInternationalResponseFromAddress.Email == null)
                throw new ArgumentNullException(nameof(multipieceShipmentInternationalResponseFromAddress.Email), "Property is required for class MultipieceShipmentInternationalResponseFromAddress.");

            if (multipieceShipmentInternationalResponseFromAddress.CountryCodeOption.IsSet && multipieceShipmentInternationalResponseFromAddress.CountryCode == null)
                throw new ArgumentNullException(nameof(multipieceShipmentInternationalResponseFromAddress.CountryCode), "Property is required for class MultipieceShipmentInternationalResponseFromAddress.");

            if (multipieceShipmentInternationalResponseFromAddress.NameOption.IsSet && multipieceShipmentInternationalResponseFromAddress.Name == null)
                throw new ArgumentNullException(nameof(multipieceShipmentInternationalResponseFromAddress.Name), "Property is required for class MultipieceShipmentInternationalResponseFromAddress.");

            if (multipieceShipmentInternationalResponseFromAddress.PhoneOption.IsSet && multipieceShipmentInternationalResponseFromAddress.Phone == null)
                throw new ArgumentNullException(nameof(multipieceShipmentInternationalResponseFromAddress.Phone), "Property is required for class MultipieceShipmentInternationalResponseFromAddress.");

            if (multipieceShipmentInternationalResponseFromAddress.PostalCodeOption.IsSet && multipieceShipmentInternationalResponseFromAddress.PostalCode == null)
                throw new ArgumentNullException(nameof(multipieceShipmentInternationalResponseFromAddress.PostalCode), "Property is required for class MultipieceShipmentInternationalResponseFromAddress.");

            if (multipieceShipmentInternationalResponseFromAddress.StateProvinceOption.IsSet && multipieceShipmentInternationalResponseFromAddress.StateProvince == null)
                throw new ArgumentNullException(nameof(multipieceShipmentInternationalResponseFromAddress.StateProvince), "Property is required for class MultipieceShipmentInternationalResponseFromAddress.");

            if (multipieceShipmentInternationalResponseFromAddress.TaxIdOption.IsSet && multipieceShipmentInternationalResponseFromAddress.TaxId == null)
                throw new ArgumentNullException(nameof(multipieceShipmentInternationalResponseFromAddress.TaxId), "Property is required for class MultipieceShipmentInternationalResponseFromAddress.");

            if (multipieceShipmentInternationalResponseFromAddress.AddressLine1Option.IsSet)
                writer.WriteString("addressLine1", multipieceShipmentInternationalResponseFromAddress.AddressLine1);

            if (multipieceShipmentInternationalResponseFromAddress.AddressLine2Option.IsSet)
                writer.WriteString("addressLine2", multipieceShipmentInternationalResponseFromAddress.AddressLine2);

            if (multipieceShipmentInternationalResponseFromAddress.AddressLine3Option.IsSet)
                writer.WriteString("addressLine3", multipieceShipmentInternationalResponseFromAddress.AddressLine3);

            if (multipieceShipmentInternationalResponseFromAddress.CityTownOption.IsSet)
                writer.WriteString("cityTown", multipieceShipmentInternationalResponseFromAddress.CityTown);

            if (multipieceShipmentInternationalResponseFromAddress.CompanyOption.IsSet)
                writer.WriteString("company", multipieceShipmentInternationalResponseFromAddress.Company);

            if (multipieceShipmentInternationalResponseFromAddress.EmailOption.IsSet)
                writer.WriteString("email", multipieceShipmentInternationalResponseFromAddress.Email);

            if (multipieceShipmentInternationalResponseFromAddress.CountryCodeOption.IsSet)
                writer.WriteString("countryCode", multipieceShipmentInternationalResponseFromAddress.CountryCode);

            if (multipieceShipmentInternationalResponseFromAddress.NameOption.IsSet)
                writer.WriteString("name", multipieceShipmentInternationalResponseFromAddress.Name);

            if (multipieceShipmentInternationalResponseFromAddress.PhoneOption.IsSet)
                writer.WriteString("phone", multipieceShipmentInternationalResponseFromAddress.Phone);

            if (multipieceShipmentInternationalResponseFromAddress.PostalCodeOption.IsSet)
                writer.WriteString("postalCode", multipieceShipmentInternationalResponseFromAddress.PostalCode);

            if (multipieceShipmentInternationalResponseFromAddress.StateProvinceOption.IsSet)
                writer.WriteString("stateProvince", multipieceShipmentInternationalResponseFromAddress.StateProvince);

            if (multipieceShipmentInternationalResponseFromAddress.ResidentialOption.IsSet)
                writer.WriteBoolean("residential", multipieceShipmentInternationalResponseFromAddress.ResidentialOption.Value!.Value);

            if (multipieceShipmentInternationalResponseFromAddress.TaxIdOption.IsSet)
                writer.WriteString("taxId", multipieceShipmentInternationalResponseFromAddress.TaxId);

            var taxIdTypeRawValue = MultipieceShipmentInternationalResponseFromAddress.TaxIdTypeEnumToJsonValue(multipieceShipmentInternationalResponseFromAddress.TaxIdTypeOption.Value!.Value);
