...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    [DataContract(Name = "addressSuggestRequest_address")]
    public partial class AddressSuggestRequestAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddressSuggestRequestAddress" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AddressSuggestRequestAddress() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AddressSuggestRequestAddress" /> class.
        /// </summary>
        ...
        /// <param name="cityTown">The name of the city or town to where the address belongs. (required).</param>
        /// <param name="countryCode">This indicates the two-character ISO code of the country from the ISO country list. (required).</param>
        /// <param name="name">Name of the person to which this address points..</param>
        ...
        public AddressSuggestRequestAddress(string addressLine1 = default(string), string addressLine2 = default(string), string addressLine3 = default(string), string cityTown = default(string), string countryCode = default(string), string name = default(string), string postalCode = default(string), string stateProvince = default(string))
        {
            // to ensure "addressLine1" is required (not null)
            if (addressLine1 == null)
            {
                throw new ArgumentNullException("addressLine1 is a required property for AddressSuggestRequestAddress and cannot be null");
            }
            this.AddressLine1 = addressLine1;
            // to ensure "cityTown" is required (not null)
            if (cityTown == null)
            {
                throw new ArgumentNullException("cityTown is a required property for AddressSuggestRequestAddress and cannot be null");
            }
            this.CityTown = cityTown;
            // to ensure "countryCode" is required (not null)
            if (countryCode == null)
            {
                throw new ArgumentNullException("countryCode is a required property for AddressSuggestRequestAddress and cannot be null");
            }
            this.CountryCode = countryCode;
            // to ensure "postalCode" is required (not null)
            if (postalCode == null)
            {
                throw new ArgumentNullException("postalCode is a required property for AddressSuggestRequestAddress and cannot be null");
            }
            this.PostalCode = postalCode;
            // to ensure "stateProvince" is required (not null)
            if (stateProvince == null)
            {
                throw new ArgumentNullException("stateProvince is a required property for AddressSuggestRequestAddress and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Name of the person to which this address points.</value>
