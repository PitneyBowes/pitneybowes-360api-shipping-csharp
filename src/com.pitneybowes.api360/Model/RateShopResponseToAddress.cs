...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    public partial class RateShopResponseToAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RateShopResponseToAddress" /> class.
        /// </summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="RateShopResponseToAddress" />
    /// </summary>
    public class RateShopResponseToAddressJsonConverter : JsonConverter<RateShopResponseToAddress>
    {
        /// <summary>
        /// Deserializes json to <see cref="RateShopResponseToAddress" />
        /// </summary>
        ...
        public override RateShopResponseToAddress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (addressLine1.IsSet && addressLine1.Value == null)
                throw new ArgumentNullException(nameof(addressLine1), "Property is not nullable for class RateShopResponseToAddress.");

            if (addressLine2.IsSet && addressLine2.Value == null)
                throw new ArgumentNullException(nameof(addressLine2), "Property is not nullable for class RateShopResponseToAddress.");

            if (addressLine3.IsSet && addressLine3.Value == null)
                throw new ArgumentNullException(nameof(addressLine3), "Property is not nullable for class RateShopResponseToAddress.");

            if (cityTown.IsSet && cityTown.Value == null)
                throw new ArgumentNullException(nameof(cityTown), "Property is not nullable for class RateShopResponseToAddress.");

            if (company.IsSet && company.Value == null)
                throw new ArgumentNullException(nameof(company), "Property is not nullable for class RateShopResponseToAddress.");

            if (countryCode.IsSet && countryCode.Value == null)
                throw new ArgumentNullException(nameof(countryCode), "Property is not nullable for class RateShopResponseToAddress.");

            if (email.IsSet && email.Value == null)
                throw new ArgumentNullException(nameof(email), "Property is not nullable for class RateShopResponseToAddress.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class RateShopResponseToAddress.");

            if (phone.IsSet && phone.Value == null)
                throw new ArgumentNullException(nameof(phone), "Property is not nullable for class RateShopResponseToAddress.");

            if (postalCode.IsSet && postalCode.Value == null)
                throw new ArgumentNullException(nameof(postalCode), "Property is not nullable for class RateShopResponseToAddress.");

            if (residential.IsSet && residential.Value == null)
                throw new ArgumentNullException(nameof(residential), "Property is not nullable for class RateShopResponseToAddress.");

            if (stateProvince.IsSet && stateProvince.Value == null)
                throw new ArgumentNullException(nameof(stateProvince), "Property is not nullable for class RateShopResponseToAddress.");

            return new RateShopResponseToAddress(addressLine1, addressLine2, addressLine3, cityTown, company, countryCode, email, name, phone, postalCode, residential, stateProvince);
        }

        /// <summary>
        /// Serializes a <see cref="RateShopResponseToAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="rateShopResponseToAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, RateShopResponseToAddress rateShopResponseToAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, rateShopResponseToAddress, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="RateShopResponseToAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="rateShopResponseToAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, RateShopResponseToAddress rateShopResponseToAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            if (rateShopResponseToAddress.AddressLine1Option.IsSet && rateShopResponseToAddress.AddressLine1 == null)
                throw new ArgumentNullException(nameof(rateShopResponseToAddress.AddressLine1), "Property is required for class RateShopResponseToAddress.");

            if (rateShopResponseToAddress.AddressLine2Option.IsSet && rateShopResponseToAddress.AddressLine2 == null)
                throw new ArgumentNullException(nameof(rateShopResponseToAddress.AddressLine2), "Property is required for class RateShopResponseToAddress.");

            if (rateShopResponseToAddress.AddressLine3Option.IsSet && rateShopResponseToAddress.AddressLine3 == null)
                throw new ArgumentNullException(nameof(rateShopResponseToAddress.AddressLine3), "Property is required for class RateShopResponseToAddress.");

            if (rateShopResponseToAddress.CityTownOption.IsSet && rateShopResponseToAddress.CityTown == null)
                throw new ArgumentNullException(nameof(rateShopResponseToAddress.CityTown), "Property is required for class RateShopResponseToAddress.");

            if (rateShopResponseToAddress.CompanyOption.IsSet && rateShopResponseToAddress.Company == null)
                throw new ArgumentNullException(nameof(rateShopResponseToAddress.Company), "Property is required for class RateShopResponseToAddress.");

            if (rateShopResponseToAddress.CountryCodeOption.IsSet && rateShopResponseToAddress.CountryCode == null)
                throw new ArgumentNullException(nameof(rateShopResponseToAddress.CountryCode), "Property is required for class RateShopResponseToAddress.");

            if (rateShopResponseToAddress.EmailOption.IsSet && rateShopResponseToAddress.Email == null)
                throw new ArgumentNullException(nameof(rateShopResponseToAddress.Email), "Property is required for class RateShopResponseToAddress.");

            if (rateShopResponseToAddress.NameOption.IsSet && rateShopResponseToAddress.Name == null)
                throw new ArgumentNullException(nameof(rateShopResponseToAddress.Name), "Property is required for class RateShopResponseToAddress.");

            if (rateShopResponseToAddress.PhoneOption.IsSet && rateShopResponseToAddress.Phone == null)
                throw new ArgumentNullException(nameof(rateShopResponseToAddress.Phone), "Property is required for class RateShopResponseToAddress.");

            if (rateShopResponseToAddress.PostalCodeOption.IsSet && rateShopResponseToAddress.PostalCode == null)
                throw new ArgumentNullException(nameof(rateShopResponseToAddress.PostalCode), "Property is required for class RateShopResponseToAddress.");

            if (rateShopResponseToAddress.StateProvinceOption.IsSet && rateShopResponseToAddress.StateProvince == null)
                throw new ArgumentNullException(nameof(rateShopResponseToAddress.StateProvince), "Property is required for class RateShopResponseToAddress.");

            if (rateShopResponseToAddress.AddressLine1Option.IsSet)
                writer.WriteString("addressLine1", rateShopResponseToAddress.AddressLine1);

            if (rateShopResponseToAddress.AddressLine2Option.IsSet)
                writer.WriteString("addressLine2", rateShopResponseToAddress.AddressLine2);

            if (rateShopResponseToAddress.AddressLine3Option.IsSet)
                writer.WriteString("addressLine3", rateShopResponseToAddress.AddressLine3);

            if (rateShopResponseToAddress.CityTownOption.IsSet)
                writer.WriteString("cityTown", rateShopResponseToAddress.CityTown);

            if (rateShopResponseToAddress.CompanyOption.IsSet)
                writer.WriteString("company", rateShopResponseToAddress.Company);

            if (rateShopResponseToAddress.CountryCodeOption.IsSet)
                writer.WriteString("countryCode", rateShopResponseToAddress.CountryCode);

            if (rateShopResponseToAddress.EmailOption.IsSet)
                writer.WriteString("email", rateShopResponseToAddress.Email);

            if (rateShopResponseToAddress.NameOption.IsSet)
                writer.WriteString("name", rateShopResponseToAddress.Name);

            if (rateShopResponseToAddress.PhoneOption.IsSet)
                writer.WriteString("phone", rateShopResponseToAddress.Phone);

            if (rateShopResponseToAddress.PostalCodeOption.IsSet)
                writer.WriteString("postalCode", rateShopResponseToAddress.PostalCode);

            if (rateShopResponseToAddress.ResidentialOption.IsSet)
                writer.WriteBoolean("residential", rateShopResponseToAddress.ResidentialOption.Value!.Value);

            if (rateShopResponseToAddress.StateProvinceOption.IsSet)
                writer.WriteString("stateProvince", rateShopResponseToAddress.StateProvince);
        }
    }
}
