...
namespace com.pitneybowes.api360.Model
{
    ...
    public partial class Parameter : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="name">The name of the parameter i.e. key.</param>
        /// <param name="value">&gt;- Parameter value is as per the carrier specifications. It provides blank value, when presence of parameter is sufficient, and no value is associated.</param>
        [JsonConstructor]
        ...
        /// </summary>
        /// <value>&gt;- Parameter value is as per the carrier specifications. It provides blank value, when presence of parameter is sufficient, and no value is associated.</value>
        /* <example>100</example> */
    ...
    /// <summary>
    /// A Json converter for type <see cref="Parameter" />
    /// </summary>
    public class ParameterJsonConverter : JsonConverter<Parameter>
    {
        /// <summary>
        /// Deserializes json to <see cref="Parameter" />
        /// </summary>
        ...
        public override Parameter Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!name.IsSet)
                throw new ArgumentException("Property is required for class Parameter.", nameof(name));

            if (!value.IsSet)
                throw new ArgumentException("Property is required for class Parameter.", nameof(value));

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class Parameter.");

            if (value.IsSet && value.Value == null)
                throw new ArgumentNullException(nameof(value), "Property is not nullable for class Parameter.");

            return new Parameter(name.Value, value.Value);
        }

        /// <summary>
        /// Serializes a <see cref="Parameter" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="varParameter"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, Parameter varParameter, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, varParameter, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="Parameter" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="varParameter"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, Parameter varParameter, JsonSerializerOptions jsonSerializerOptions)
        {
            if (varParameter.Name == null)
                throw new ArgumentNullException(nameof(varParameter.Name), "Property is required for class Parameter.");

            if (varParameter.Value == null)
                throw new ArgumentNullException(nameof(varParameter.Value), "Property is required for class Parameter.");

            writer.WriteString("name", varParameter.Name);

            writer.WriteString("value", varParameter.Value);
        }
    }
}
