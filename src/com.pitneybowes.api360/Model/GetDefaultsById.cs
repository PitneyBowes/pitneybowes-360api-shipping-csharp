...
namespace com.pitneybowes.api360.Model
{
    ...
    /// GetDefaultsById
    /// </summary>
    [DataContract(Name = "GetDefaultsById")]
    public partial class GetDefaultsById : IValidatableObject
    {
        ...
        public GetDefaultsById(string name = default(string), string defaultID = default(string), DateTime createdDate = default(DateTime), DateTime updatedDate = default(DateTime), SendingOptions sendingOptions = default(SendingOptions))
        {
            this.Name = name;
