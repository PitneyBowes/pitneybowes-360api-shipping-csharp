...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    [DataContract(Name = "shipmentDomestic_toAddress")]
    public partial class ShipmentDomesticToAddress : IValidatableObject
    {
        ...
        protected ShipmentDomesticToAddress() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ShipmentDomesticToAddress" /> class.
        /// </summary>
        ...
        /// <param name="company">This indicates the name of the company, in case if the recipient address is not residential..</param>
        ...
        public ShipmentDomesticToAddress(string addressLine1 = default(string), string addressLine2 = default(string), string addressLine3 = default(string), string cityTown = default(string), string countryCode = default(string), string name = default(string), string company = default(string), string phone = default(string), string postalCode = default(string), string stateProvince = default(string))
        {
            // to ensure "addressLine1" is required (not null)
            if (addressLine1 == null)
            {
                throw new ArgumentNullException("addressLine1 is a required property for ShipmentDomesticToAddress and cannot be null");
            }
            this.AddressLine1 = addressLine1;
            // to ensure "countryCode" is required (not null)
            if (countryCode == null)
            {
                throw new ArgumentNullException("countryCode is a required property for ShipmentDomesticToAddress and cannot be null");
            }
            this.CountryCode = countryCode;
            // to ensure "postalCode" is required (not null)
            if (postalCode == null)
            {
                throw new ArgumentNullException("postalCode is a required property for ShipmentDomesticToAddress and cannot be null");
            }
            this.PostalCode = postalCode;
            // to ensure "stateProvince" is required (not null)
            if (stateProvince == null)
            {
                throw new ArgumentNullException("stateProvince is a required property for ShipmentDomesticToAddress and cannot be null");
            }
        ...
        /// </summary>
        /// <value>This indicates the name of the company, in case if the recipient address is not residential.</value>
        /// <example>ABC</example>
