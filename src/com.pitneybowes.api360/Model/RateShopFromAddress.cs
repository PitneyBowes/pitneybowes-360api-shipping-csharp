...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    public partial class RateShopFromAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RateShopFromAddress" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public RateShopFromAddress(string addressLine1, string countryCode, string postalCode, Option<string> addressLine2 = default, Option<string> addressLine3 = default, Option<string> cityTown = default, Option<string> company = default, Option<string> email = default, Option<string> name = default, Option<string> phone = default, Option<string> inductionPostalCode = default, Option<string> stateProvince = default, Option<bool?> residential = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="RateShopFromAddress" />
    /// </summary>
    public class RateShopFromAddressJsonConverter : JsonConverter<RateShopFromAddress>
    {
        /// <summary>
        /// Deserializes json to <see cref="RateShopFromAddress" />
        /// </summary>
        ...
        public override RateShopFromAddress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!addressLine1.IsSet)
                throw new ArgumentException("Property is required for class RateShopFromAddress.", nameof(addressLine1));

            if (!countryCode.IsSet)
                throw new ArgumentException("Property is required for class RateShopFromAddress.", nameof(countryCode));

            if (!postalCode.IsSet)
                throw new ArgumentException("Property is required for class RateShopFromAddress.", nameof(postalCode));

            if (addressLine1.IsSet && addressLine1.Value == null)
                throw new ArgumentNullException(nameof(addressLine1), "Property is not nullable for class RateShopFromAddress.");

            if (countryCode.IsSet && countryCode.Value == null)
                throw new ArgumentNullException(nameof(countryCode), "Property is not nullable for class RateShopFromAddress.");

            if (postalCode.IsSet && postalCode.Value == null)
                throw new ArgumentNullException(nameof(postalCode), "Property is not nullable for class RateShopFromAddress.");

            if (addressLine2.IsSet && addressLine2.Value == null)
                throw new ArgumentNullException(nameof(addressLine2), "Property is not nullable for class RateShopFromAddress.");

            if (addressLine3.IsSet && addressLine3.Value == null)
                throw new ArgumentNullException(nameof(addressLine3), "Property is not nullable for class RateShopFromAddress.");

            if (cityTown.IsSet && cityTown.Value == null)
                throw new ArgumentNullException(nameof(cityTown), "Property is not nullable for class RateShopFromAddress.");

            if (company.IsSet && company.Value == null)
                throw new ArgumentNullException(nameof(company), "Property is not nullable for class RateShopFromAddress.");

            if (email.IsSet && email.Value == null)
                throw new ArgumentNullException(nameof(email), "Property is not nullable for class RateShopFromAddress.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class RateShopFromAddress.");

            if (phone.IsSet && phone.Value == null)
                throw new ArgumentNullException(nameof(phone), "Property is not nullable for class RateShopFromAddress.");

            if (inductionPostalCode.IsSet && inductionPostalCode.Value == null)
                throw new ArgumentNullException(nameof(inductionPostalCode), "Property is not nullable for class RateShopFromAddress.");

            if (stateProvince.IsSet && stateProvince.Value == null)
                throw new ArgumentNullException(nameof(stateProvince), "Property is not nullable for class RateShopFromAddress.");

            if (residential.IsSet && residential.Value == null)
                throw new ArgumentNullException(nameof(residential), "Property is not nullable for class RateShopFromAddress.");

            return new RateShopFromAddress(addressLine1.Value, countryCode.Value, postalCode.Value, addressLine2, addressLine3, cityTown, company, email, name, phone, inductionPostalCode, stateProvince, residential);
        }

        /// <summary>
        /// Serializes a <see cref="RateShopFromAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="rateShopFromAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, RateShopFromAddress rateShopFromAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, rateShopFromAddress, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="RateShopFromAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="rateShopFromAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, RateShopFromAddress rateShopFromAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            if (rateShopFromAddress.AddressLine1 == null)
                throw new ArgumentNullException(nameof(rateShopFromAddress.AddressLine1), "Property is required for class RateShopFromAddress.");

            if (rateShopFromAddress.CountryCode == null)
                throw new ArgumentNullException(nameof(rateShopFromAddress.CountryCode), "Property is required for class RateShopFromAddress.");

            if (rateShopFromAddress.PostalCode == null)
                throw new ArgumentNullException(nameof(rateShopFromAddress.PostalCode), "Property is required for class RateShopFromAddress.");

            if (rateShopFromAddress.AddressLine2Option.IsSet && rateShopFromAddress.AddressLine2 == null)
                throw new ArgumentNullException(nameof(rateShopFromAddress.AddressLine2), "Property is required for class RateShopFromAddress.");

            if (rateShopFromAddress.AddressLine3Option.IsSet && rateShopFromAddress.AddressLine3 == null)
                throw new ArgumentNullException(nameof(rateShopFromAddress.AddressLine3), "Property is required for class RateShopFromAddress.");

            if (rateShopFromAddress.CityTownOption.IsSet && rateShopFromAddress.CityTown == null)
                throw new ArgumentNullException(nameof(rateShopFromAddress.CityTown), "Property is required for class RateShopFromAddress.");

            if (rateShopFromAddress.CompanyOption.IsSet && rateShopFromAddress.Company == null)
                throw new ArgumentNullException(nameof(rateShopFromAddress.Company), "Property is required for class RateShopFromAddress.");

            if (rateShopFromAddress.EmailOption.IsSet && rateShopFromAddress.Email == null)
                throw new ArgumentNullException(nameof(rateShopFromAddress.Email), "Property is required for class RateShopFromAddress.");

            if (rateShopFromAddress.NameOption.IsSet && rateShopFromAddress.Name == null)
                throw new ArgumentNullException(nameof(rateShopFromAddress.Name), "Property is required for class RateShopFromAddress.");

            if (rateShopFromAddress.PhoneOption.IsSet && rateShopFromAddress.Phone == null)
                throw new ArgumentNullException(nameof(rateShopFromAddress.Phone), "Property is required for class RateShopFromAddress.");

            if (rateShopFromAddress.InductionPostalCodeOption.IsSet && rateShopFromAddress.InductionPostalCode == null)
                throw new ArgumentNullException(nameof(rateShopFromAddress.InductionPostalCode), "Property is required for class RateShopFromAddress.");

            if (rateShopFromAddress.StateProvinceOption.IsSet && rateShopFromAddress.StateProvince == null)
                throw new ArgumentNullException(nameof(rateShopFromAddress.StateProvince), "Property is required for class RateShopFromAddress.");

            writer.WriteString("addressLine1", rateShopFromAddress.AddressLine1);

            writer.WriteString("countryCode", rateShopFromAddress.CountryCode);

            writer.WriteString("postalCode", rateShopFromAddress.PostalCode);

            if (rateShopFromAddress.AddressLine2Option.IsSet)
                writer.WriteString("addressLine2", rateShopFromAddress.AddressLine2);

            if (rateShopFromAddress.AddressLine3Option.IsSet)
                writer.WriteString("addressLine3", rateShopFromAddress.AddressLine3);

            if (rateShopFromAddress.CityTownOption.IsSet)
                writer.WriteString("cityTown", rateShopFromAddress.CityTown);

            if (rateShopFromAddress.CompanyOption.IsSet)
                writer.WriteString("company", rateShopFromAddress.Company);

            if (rateShopFromAddress.EmailOption.IsSet)
                writer.WriteString("email", rateShopFromAddress.Email);

            if (rateShopFromAddress.NameOption.IsSet)
                writer.WriteString("name", rateShopFromAddress.Name);

            if (rateShopFromAddress.PhoneOption.IsSet)
                writer.WriteString("phone", rateShopFromAddress.Phone);

            if (rateShopFromAddress.InductionPostalCodeOption.IsSet)
                writer.WriteString("inductionPostalCode", rateShopFromAddress.InductionPostalCode);

            if (rateShopFromAddress.StateProvinceOption.IsSet)
                writer.WriteString("stateProvince", rateShopFromAddress.StateProvince);

            if (rateShopFromAddress.ResidentialOption.IsSet)
                writer.WriteBoolean("residential", rateShopFromAddress.ResidentialOption.Value.Value);
        }
    }
}
