...
namespace com.pitneybowes.api360.Model
{
    ...
    public partial class Error : IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="Error" /> class.
        /// </summary>
        /// <param name="message">This is HTTP 401 Unauthorized response status code, that indicates that the client request has not been completed because it lacks valid authentication credentials for the requested resource. (required).</param>
        ...
        /// </summary>
        /// <value>This is HTTP 401 Unauthorized response status code, that indicates that the client request has not been completed because it lacks valid authentication credentials for the requested resource.</value>
