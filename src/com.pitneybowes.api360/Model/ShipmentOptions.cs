...
namespace com.pitneybowes.api360.Model
{
    ...
    public partial class ShipmentOptions : IValidatableObject
    {
        ...
        [JsonConstructor]
        public ShipmentOptions(Option<bool?> addToManifest = default, Option<string?> printCustomMessage = default, Option<string?> receiptOption = default, Option<string?> printDepartment = default, Option<string?> printInvoiceNumber = default, Option<string?> printPONumber = default, Option<string?> shipperId = default, Option<bool?> minimalAddressValidation = default)
        {
    ...
    public class ShipmentOptionsJsonConverter : JsonConverter<ShipmentOptions>
    {
        ...
        public void WriteProperties(Utf8JsonWriter writer, ShipmentOptions shipmentOptions, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (shipmentOptions.ReceiptOptionOption.IsSet && shipmentOptions.ReceiptOption == null)
                throw new ArgumentNullException(nameof(shipmentOptions.ReceiptOption), "Property is required for class ShipmentOptions.");
            ...
            if (shipmentOptions.ReceiptOptionOption.IsSet)
                writer.WriteString("receiptOption", shipmentOptions.ReceiptOption);
