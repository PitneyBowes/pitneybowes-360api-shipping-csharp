...
namespace com.pitneybowes.api360.Model
{
    ...
    /// ShipmentOptions
    /// </summary>
    [DataContract(Name = "shipmentOptions")]
    public partial class ShipmentOptions : IValidatableObject
    {
        ...
        /// <param name="packageDescription">This is required for DHL Express shipment. It is used to provide description of package.</param>
        public ShipmentOptions(bool addToManifest = default(bool), string printCustomMessage = default(string), string receiptOption = default(string), string printDepartment = default(string), string printInvoiceNumber = default(string), string printPONumber = default(string), string packageDescription = default(string))
        {
        ...
        /// </summary>
        /// <value>This is required for DHL Express shipment. It is used to provide description of package</value>
        /// <example>packagedescription</example>
