...
{
    /// <summary>
    /// MilitaryMailShipmentsFromAddress
    /// </summary>
    public partial class MilitaryMailShipmentsFromAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MilitaryMailShipmentsFromAddress" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public MilitaryMailShipmentsFromAddress(string addressLine1, string countryCode, string postalCode, string stateProvince, Option<string> addressLine2 = default, Option<string> addressLine3 = default, Option<string> cityTown = default, Option<string> name = default, Option<string> company = default, Option<string> email = default, Option<string> phone = default, Option<string> inductionPostalCode = default, Option<bool?> residential = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MilitaryMailShipmentsFromAddress {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="MilitaryMailShipmentsFromAddress" />
    /// </summary>
    public class MilitaryMailShipmentsFromAddressJsonConverter : JsonConverter<MilitaryMailShipmentsFromAddress>
    {
        /// <summary>
        /// Deserializes json to <see cref="MilitaryMailShipmentsFromAddress" />
        /// </summary>
        ...
        public override MilitaryMailShipmentsFromAddress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!addressLine1.IsSet)
                throw new ArgumentException("Property is required for class MilitaryMailShipmentsFromAddress.", nameof(addressLine1));

            if (!countryCode.IsSet)
                throw new ArgumentException("Property is required for class MilitaryMailShipmentsFromAddress.", nameof(countryCode));

            if (!postalCode.IsSet)
                throw new ArgumentException("Property is required for class MilitaryMailShipmentsFromAddress.", nameof(postalCode));

            if (!stateProvince.IsSet)
                throw new ArgumentException("Property is required for class MilitaryMailShipmentsFromAddress.", nameof(stateProvince));

            if (addressLine1.IsSet && addressLine1.Value == null)
                throw new ArgumentNullException(nameof(addressLine1), "Property is not nullable for class MilitaryMailShipmentsFromAddress.");

            if (countryCode.IsSet && countryCode.Value == null)
                throw new ArgumentNullException(nameof(countryCode), "Property is not nullable for class MilitaryMailShipmentsFromAddress.");

            if (postalCode.IsSet && postalCode.Value == null)
                throw new ArgumentNullException(nameof(postalCode), "Property is not nullable for class MilitaryMailShipmentsFromAddress.");

            if (stateProvince.IsSet && stateProvince.Value == null)
                throw new ArgumentNullException(nameof(stateProvince), "Property is not nullable for class MilitaryMailShipmentsFromAddress.");

            if (addressLine2.IsSet && addressLine2.Value == null)
                throw new ArgumentNullException(nameof(addressLine2), "Property is not nullable for class MilitaryMailShipmentsFromAddress.");

            if (addressLine3.IsSet && addressLine3.Value == null)
                throw new ArgumentNullException(nameof(addressLine3), "Property is not nullable for class MilitaryMailShipmentsFromAddress.");

            if (cityTown.IsSet && cityTown.Value == null)
                throw new ArgumentNullException(nameof(cityTown), "Property is not nullable for class MilitaryMailShipmentsFromAddress.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class MilitaryMailShipmentsFromAddress.");

            if (company.IsSet && company.Value == null)
                throw new ArgumentNullException(nameof(company), "Property is not nullable for class MilitaryMailShipmentsFromAddress.");

            if (email.IsSet && email.Value == null)
                throw new ArgumentNullException(nameof(email), "Property is not nullable for class MilitaryMailShipmentsFromAddress.");

            if (phone.IsSet && phone.Value == null)
                throw new ArgumentNullException(nameof(phone), "Property is not nullable for class MilitaryMailShipmentsFromAddress.");

            if (inductionPostalCode.IsSet && inductionPostalCode.Value == null)
                throw new ArgumentNullException(nameof(inductionPostalCode), "Property is not nullable for class MilitaryMailShipmentsFromAddress.");

            if (residential.IsSet && residential.Value == null)
                throw new ArgumentNullException(nameof(residential), "Property is not nullable for class MilitaryMailShipmentsFromAddress.");

            return new MilitaryMailShipmentsFromAddress(addressLine1.Value, countryCode.Value, postalCode.Value, stateProvince.Value, addressLine2, addressLine3, cityTown, name, company, email, phone, inductionPostalCode, residential);
        }

        /// <summary>
        /// Serializes a <see cref="MilitaryMailShipmentsFromAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="militaryMailShipmentsFromAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, MilitaryMailShipmentsFromAddress militaryMailShipmentsFromAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, militaryMailShipmentsFromAddress, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="MilitaryMailShipmentsFromAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="militaryMailShipmentsFromAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, MilitaryMailShipmentsFromAddress militaryMailShipmentsFromAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            if (militaryMailShipmentsFromAddress.AddressLine1 == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentsFromAddress.AddressLine1), "Property is required for class MilitaryMailShipmentsFromAddress.");

            if (militaryMailShipmentsFromAddress.CountryCode == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentsFromAddress.CountryCode), "Property is required for class MilitaryMailShipmentsFromAddress.");

            if (militaryMailShipmentsFromAddress.PostalCode == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentsFromAddress.PostalCode), "Property is required for class MilitaryMailShipmentsFromAddress.");

            if (militaryMailShipmentsFromAddress.StateProvince == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentsFromAddress.StateProvince), "Property is required for class MilitaryMailShipmentsFromAddress.");

            if (militaryMailShipmentsFromAddress.AddressLine2Option.IsSet && militaryMailShipmentsFromAddress.AddressLine2 == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentsFromAddress.AddressLine2), "Property is required for class MilitaryMailShipmentsFromAddress.");

            if (militaryMailShipmentsFromAddress.AddressLine3Option.IsSet && militaryMailShipmentsFromAddress.AddressLine3 == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentsFromAddress.AddressLine3), "Property is required for class MilitaryMailShipmentsFromAddress.");

            if (militaryMailShipmentsFromAddress.CityTownOption.IsSet && militaryMailShipmentsFromAddress.CityTown == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentsFromAddress.CityTown), "Property is required for class MilitaryMailShipmentsFromAddress.");

            if (militaryMailShipmentsFromAddress.NameOption.IsSet && militaryMailShipmentsFromAddress.Name == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentsFromAddress.Name), "Property is required for class MilitaryMailShipmentsFromAddress.");

            if (militaryMailShipmentsFromAddress.CompanyOption.IsSet && militaryMailShipmentsFromAddress.Company == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentsFromAddress.Company), "Property is required for class MilitaryMailShipmentsFromAddress.");

            if (militaryMailShipmentsFromAddress.EmailOption.IsSet && militaryMailShipmentsFromAddress.Email == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentsFromAddress.Email), "Property is required for class MilitaryMailShipmentsFromAddress.");

            if (militaryMailShipmentsFromAddress.PhoneOption.IsSet && militaryMailShipmentsFromAddress.Phone == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentsFromAddress.Phone), "Property is required for class MilitaryMailShipmentsFromAddress.");

            if (militaryMailShipmentsFromAddress.InductionPostalCodeOption.IsSet && militaryMailShipmentsFromAddress.InductionPostalCode == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentsFromAddress.InductionPostalCode), "Property is required for class MilitaryMailShipmentsFromAddress.");

            writer.WriteString("addressLine1", militaryMailShipmentsFromAddress.AddressLine1);

            writer.WriteString("countryCode", militaryMailShipmentsFromAddress.CountryCode);

            writer.WriteString("postalCode", militaryMailShipmentsFromAddress.PostalCode);

            writer.WriteString("stateProvince", militaryMailShipmentsFromAddress.StateProvince);

            if (militaryMailShipmentsFromAddress.AddressLine2Option.IsSet)
                writer.WriteString("addressLine2", militaryMailShipmentsFromAddress.AddressLine2);

            if (militaryMailShipmentsFromAddress.AddressLine3Option.IsSet)
                writer.WriteString("addressLine3", militaryMailShipmentsFromAddress.AddressLine3);

            if (militaryMailShipmentsFromAddress.CityTownOption.IsSet)
                writer.WriteString("cityTown", militaryMailShipmentsFromAddress.CityTown);

            if (militaryMailShipmentsFromAddress.NameOption.IsSet)
                writer.WriteString("name", militaryMailShipmentsFromAddress.Name);

            if (militaryMailShipmentsFromAddress.CompanyOption.IsSet)
                writer.WriteString("company", militaryMailShipmentsFromAddress.Company);

            if (militaryMailShipmentsFromAddress.EmailOption.IsSet)
                writer.WriteString("email", militaryMailShipmentsFromAddress.Email);

            if (militaryMailShipmentsFromAddress.PhoneOption.IsSet)
                writer.WriteString("phone", militaryMailShipmentsFromAddress.Phone);

            if (militaryMailShipmentsFromAddress.InductionPostalCodeOption.IsSet)
                writer.WriteString("inductionPostalCode", militaryMailShipmentsFromAddress.InductionPostalCode);

            if (militaryMailShipmentsFromAddress.ResidentialOption.IsSet)
                writer.WriteBoolean("residential", militaryMailShipmentsFromAddress.ResidentialOption.Value.Value);
        }
    }
}
