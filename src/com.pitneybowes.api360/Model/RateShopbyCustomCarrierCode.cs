...
{
    /// <summary>
    /// RateShopbyCustomCarrierCode
    /// </summary>
    public partial class RateShopbyCustomCarrierCode : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RateShopbyCustomCarrierCode" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public RateShopbyCustomCarrierCode(FromAddressV2 fromAddress, ToAddressV2 toAddress, RateShopbyCarrierParcel parcel, RateShopByEnum rateShopBy, Option<string> parcelType = default, Option<RateShopbyCustomCarrierCodeByCustomCarrierCode> byCustomCarrierCode = default, Option<RateShopbyCarrierDeliveryOption> deliveryOption = default)
        {
        ...
        /// </summary>
        /// <value>RateShop, which is attached to an Enterprise or Location, is done through four approaches: by Carrier, by RateGroup, by RuleSet and by CustomCarrierCode.  &lt;br /&gt;  Through Carrier, customers can choose the carriers as per requirement, based on which services, parcel types, and special services can be selected, and RateShop is done. &lt;br /&gt; Through RateGroup, customers can select the RateGroup, which has been divided into two categories: Cheapest (w.r.t. price) and Fastest (w.r.t. delivery hours).  &lt;br /&gt; Through RuleSet, customers can define the Condition/rule for selecting carriers and their services, so they do not need to worry for Rate Shopping every time they create Shipment. For example, For a particular location, they can set one definite carrier, or apply RateGroup - Cheapest/Fastest.   Similarly, for a particular amount like below $1000 Dollars, they can select a definite carrier service, based on RateGroup.</value>
        /* <example>customCarrierCode</example> */
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<RateShopbyCustomCarrierCodeByCustomCarrierCode> ByCustomCarrierCodeOption { get; private set; }

        /// <summary>
        /// Gets or Sets ByCustomCarrierCode
        /// </summary>
        [JsonPropertyName("byCustomCarrierCode")]
        public RateShopbyCustomCarrierCodeByCustomCarrierCode ByCustomCarrierCode { get { return this.ByCustomCarrierCodeOption; } set { this.ByCustomCarrierCodeOption = new Option<RateShopbyCustomCarrierCodeByCustomCarrierCode>(value); } }
        ...
        public RateShopbyCarrierDeliveryOption DeliveryOption { get { return this.DeliveryOptionOption; } set { this.DeliveryOptionOption = new Option<RateShopbyCarrierDeliveryOption>(value); } }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RateShopbyCustomCarrierCode {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="RateShopbyCustomCarrierCode" />
    /// </summary>
    public class RateShopbyCustomCarrierCodeJsonConverter : JsonConverter<RateShopbyCustomCarrierCode>
    {
        /// <summary>
        /// Deserializes json to <see cref="RateShopbyCustomCarrierCode" />
        /// </summary>
        ...
        public override RateShopbyCustomCarrierCode Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<RateShopbyCustomCarrierCode.RateShopByEnum?> rateShopBy = default;
            Option<string> parcelType = default;
            Option<RateShopbyCustomCarrierCodeByCustomCarrierCode> byCustomCarrierCode = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "rateShopBy":
                            ...
                            if (rateShopByRawValue != null)
                                rateShopBy = new Option<RateShopbyCustomCarrierCode.RateShopByEnum?>(RateShopbyCustomCarrierCode.RateShopByEnumFromStringOrDefault(rateShopByRawValue));
                            break;
                        case "parcelType":
                            parcelType = new Option<string>(utf8JsonReader.GetString());
                            break;
                        case "byCustomCarrierCode":
                            byCustomCarrierCode = new Option<RateShopbyCustomCarrierCodeByCustomCarrierCode>(JsonSerializer.Deserialize<RateShopbyCustomCarrierCodeByCustomCarrierCode>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "deliveryOption":
            ...
            if (!fromAddress.IsSet)
                throw new ArgumentException("Property is required for class RateShopbyCustomCarrierCode.", nameof(fromAddress));

            if (!toAddress.IsSet)
                throw new ArgumentException("Property is required for class RateShopbyCustomCarrierCode.", nameof(toAddress));

            if (!parcel.IsSet)
                throw new ArgumentException("Property is required for class RateShopbyCustomCarrierCode.", nameof(parcel));

            if (!rateShopBy.IsSet)
                throw new ArgumentException("Property is required for class RateShopbyCustomCarrierCode.", nameof(rateShopBy));

            if (fromAddress.IsSet && fromAddress.Value == null)
                throw new ArgumentNullException(nameof(fromAddress), "Property is not nullable for class RateShopbyCustomCarrierCode.");

            if (toAddress.IsSet && toAddress.Value == null)
                throw new ArgumentNullException(nameof(toAddress), "Property is not nullable for class RateShopbyCustomCarrierCode.");

            if (parcel.IsSet && parcel.Value == null)
                throw new ArgumentNullException(nameof(parcel), "Property is not nullable for class RateShopbyCustomCarrierCode.");

            if (rateShopBy.IsSet && rateShopBy.Value == null)
                throw new ArgumentNullException(nameof(rateShopBy), "Property is not nullable for class RateShopbyCustomCarrierCode.");

            if (parcelType.IsSet && parcelType.Value == null)
                throw new ArgumentNullException(nameof(parcelType), "Property is not nullable for class RateShopbyCustomCarrierCode.");

            if (byCustomCarrierCode.IsSet && byCustomCarrierCode.Value == null)
                throw new ArgumentNullException(nameof(byCustomCarrierCode), "Property is not nullable for class RateShopbyCustomCarrierCode.");

            if (deliveryOption.IsSet && deliveryOption.Value == null)
                throw new ArgumentNullException(nameof(deliveryOption), "Property is not nullable for class RateShopbyCustomCarrierCode.");

            return new RateShopbyCustomCarrierCode(fromAddress.Value, toAddress.Value, parcel.Value, rateShopBy.Value.Value, parcelType, byCustomCarrierCode, deliveryOption);
        }

        /// <summary>
        /// Serializes a <see cref="RateShopbyCustomCarrierCode" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="rateShopbyCustomCarrierCode"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, RateShopbyCustomCarrierCode rateShopbyCustomCarrierCode, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, rateShopbyCustomCarrierCode, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="RateShopbyCustomCarrierCode" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="rateShopbyCustomCarrierCode"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, RateShopbyCustomCarrierCode rateShopbyCustomCarrierCode, JsonSerializerOptions jsonSerializerOptions)
        {
            if (rateShopbyCustomCarrierCode.FromAddress == null)
                throw new ArgumentNullException(nameof(rateShopbyCustomCarrierCode.FromAddress), "Property is required for class RateShopbyCustomCarrierCode.");

            if (rateShopbyCustomCarrierCode.ToAddress == null)
                throw new ArgumentNullException(nameof(rateShopbyCustomCarrierCode.ToAddress), "Property is required for class RateShopbyCustomCarrierCode.");

            if (rateShopbyCustomCarrierCode.Parcel == null)
                throw new ArgumentNullException(nameof(rateShopbyCustomCarrierCode.Parcel), "Property is required for class RateShopbyCustomCarrierCode.");

            if (rateShopbyCustomCarrierCode.ParcelTypeOption.IsSet && rateShopbyCustomCarrierCode.ParcelType == null)
                throw new ArgumentNullException(nameof(rateShopbyCustomCarrierCode.ParcelType), "Property is required for class RateShopbyCustomCarrierCode.");

            if (rateShopbyCustomCarrierCode.ByCustomCarrierCodeOption.IsSet && rateShopbyCustomCarrierCode.ByCustomCarrierCode == null)
                throw new ArgumentNullException(nameof(rateShopbyCustomCarrierCode.ByCustomCarrierCode), "Property is required for class RateShopbyCustomCarrierCode.");

            if (rateShopbyCustomCarrierCode.DeliveryOptionOption.IsSet && rateShopbyCustomCarrierCode.DeliveryOption == null)
                throw new ArgumentNullException(nameof(rateShopbyCustomCarrierCode.DeliveryOption), "Property is required for class RateShopbyCustomCarrierCode.");

            writer.WritePropertyName("fromAddress");
            JsonSerializer.Serialize(writer, rateShopbyCustomCarrierCode.FromAddress, jsonSerializerOptions);
            writer.WritePropertyName("toAddress");
            JsonSerializer.Serialize(writer, rateShopbyCustomCarrierCode.ToAddress, jsonSerializerOptions);
            writer.WritePropertyName("parcel");
            JsonSerializer.Serialize(writer, rateShopbyCustomCarrierCode.Parcel, jsonSerializerOptions);
            var rateShopByRawValue = RateShopbyCustomCarrierCode.RateShopByEnumToJsonValue(rateShopbyCustomCarrierCode.RateShopBy);
            writer.WriteString("rateShopBy", rateShopByRawValue);
            if (rateShopbyCustomCarrierCode.ParcelTypeOption.IsSet)
                writer.WriteString("parcelType", rateShopbyCustomCarrierCode.ParcelType);

            if (rateShopbyCustomCarrierCode.ByCustomCarrierCodeOption.IsSet)
            {
                writer.WritePropertyName("byCustomCarrierCode");
                JsonSerializer.Serialize(writer, rateShopbyCustomCarrierCode.ByCustomCarrierCode, jsonSerializerOptions);
            }
            if (rateShopbyCustomCarrierCode.DeliveryOptionOption.IsSet)
            {
                writer.WritePropertyName("deliveryOption");
                JsonSerializer.Serialize(writer, rateShopbyCustomCarrierCode.DeliveryOption, jsonSerializerOptions);
            }
        }
    }
}
