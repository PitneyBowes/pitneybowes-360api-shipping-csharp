...
namespace com.pitneybowes.api360.Model
{
    ...
    public partial class GetAllShipmentsDataInnerShipmentOptions : IValidatableObject
    {
        ...
        [JsonConstructor]
        public GetAllShipmentsDataInnerShipmentOptions(Option<bool?> addToManifest = default, Option<string?> printCustomMessage = default, Option<string?> receiptOption = default, Option<string?> printDepartment = default, Option<string?> printInvoiceNumber = default, Option<string?> printPONumber = default, Option<string?> shipperId = default, Option<bool?> minimalAddressValidation = default, Option<string?> bookingConfirmationNumber = default, Option<string?> billingWeight = default)
        {
    ...
    public class GetAllShipmentsDataInnerShipmentOptionsJsonConverter : JsonConverter<GetAllShipmentsDataInnerShipmentOptions>
    {
        ...
        public void WriteProperties(Utf8JsonWriter writer, GetAllShipmentsDataInnerShipmentOptions getAllShipmentsDataInnerShipmentOptions, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (getAllShipmentsDataInnerShipmentOptions.ReceiptOptionOption.IsSet && getAllShipmentsDataInnerShipmentOptions.ReceiptOption == null)
                throw new ArgumentNullException(nameof(getAllShipmentsDataInnerShipmentOptions.ReceiptOption), "Property is required for class GetAllShipmentsDataInnerShipmentOptions.");
            ...
            if (getAllShipmentsDataInnerShipmentOptions.ReceiptOptionOption.IsSet)
                writer.WriteString("receiptOption", getAllShipmentsDataInnerShipmentOptions.ReceiptOption);
