...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    [DataContract(Name = "rateShop_parcel")]
    public partial class RateShopParcel : IValidatableObject
    {
        ...
        public RateShopParcel(decimal height = default(decimal), decimal length = default(decimal), decimal width = default(decimal), DimUnitEnum dimUnit = default(DimUnitEnum), WeightUnitEnum weightUnit = default(WeightUnitEnum), decimal weight = default(decimal))
        {
            this.Height = height;
            this.Length = length;
            this.Width = width;
