...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    public partial class RateShopParcel : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RateShopParcel" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public RateShopParcel(int length, int width, int height, DimUnitEnum dimUnit, WeightUnitEnum weightUnit, decimal weight)
        {
            Length = length;
            Width = width;
            Height = height;
    ...
    /// <summary>
    /// A Json converter for type <see cref="RateShopParcel" />
    /// </summary>
    public class RateShopParcelJsonConverter : JsonConverter<RateShopParcel>
    {
        /// <summary>
        /// Deserializes json to <see cref="RateShopParcel" />
        /// </summary>
        ...
        public override RateShopParcel Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<RateShopParcel.DimUnitEnum?> dimUnit = default;
            Option<RateShopParcel.WeightUnitEnum?> weightUnit = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "dimUnit":
                            ...
                            if (dimUnitRawValue != null)
                                dimUnit = new Option<RateShopParcel.DimUnitEnum?>(RateShopParcel.DimUnitEnumFromStringOrDefault(dimUnitRawValue));
                            break;
                        case "weightUnit":
                            string? weightUnitRawValue = utf8JsonReader.GetString();
                            if (weightUnitRawValue != null)
                                weightUnit = new Option<RateShopParcel.WeightUnitEnum?>(RateShopParcel.WeightUnitEnumFromStringOrDefault(weightUnitRawValue));
                            break;
                        case "weight":
            ...
            if (!length.IsSet)
                throw new ArgumentException("Property is required for class RateShopParcel.", nameof(length));

            if (!width.IsSet)
                throw new ArgumentException("Property is required for class RateShopParcel.", nameof(width));

            if (!height.IsSet)
                throw new ArgumentException("Property is required for class RateShopParcel.", nameof(height));

            if (!dimUnit.IsSet)
                throw new ArgumentException("Property is required for class RateShopParcel.", nameof(dimUnit));

            if (!weightUnit.IsSet)
                throw new ArgumentException("Property is required for class RateShopParcel.", nameof(weightUnit));

            if (!weight.IsSet)
                throw new ArgumentException("Property is required for class RateShopParcel.", nameof(weight));

            if (length.IsSet && length.Value == null)
                throw new ArgumentNullException(nameof(length), "Property is not nullable for class RateShopParcel.");

            if (width.IsSet && width.Value == null)
                throw new ArgumentNullException(nameof(width), "Property is not nullable for class RateShopParcel.");

            if (height.IsSet && height.Value == null)
                throw new ArgumentNullException(nameof(height), "Property is not nullable for class RateShopParcel.");

            if (dimUnit.IsSet && dimUnit.Value == null)
                throw new ArgumentNullException(nameof(dimUnit), "Property is not nullable for class RateShopParcel.");

            if (weightUnit.IsSet && weightUnit.Value == null)
                throw new ArgumentNullException(nameof(weightUnit), "Property is not nullable for class RateShopParcel.");

            if (weight.IsSet && weight.Value == null)
                throw new ArgumentNullException(nameof(weight), "Property is not nullable for class RateShopParcel.");

            return new RateShopParcel(length.Value!.Value!, width.Value!.Value!, height.Value!.Value!, dimUnit.Value!.Value!, weightUnit.Value!.Value!, weight.Value!.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="RateShopParcel" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="rateShopParcel"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, RateShopParcel rateShopParcel, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, rateShopParcel, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="RateShopParcel" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="rateShopParcel"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, RateShopParcel rateShopParcel, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteNumber("length", rateShopParcel.Length);

            writer.WriteNumber("width", rateShopParcel.Width);

            writer.WriteNumber("height", rateShopParcel.Height);

            var dimUnitRawValue = RateShopParcel.DimUnitEnumToJsonValue(rateShopParcel.DimUnit);
            writer.WriteString("dimUnit", dimUnitRawValue);
            var weightUnitRawValue = RateShopParcel.WeightUnitEnumToJsonValue(rateShopParcel.WeightUnit);
            writer.WriteString("weightUnit", weightUnitRawValue);
            writer.WriteNumber("weight", rateShopParcel.Weight);
        }
    }
}
