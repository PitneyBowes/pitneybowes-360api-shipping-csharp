...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    [DataContract(Name = "internationalShipmentResponse_customs_customsItems_inner")]
    public partial class InternationalShipmentResponseCustomsCustomsItemsInner : IValidatableObject
    {
        ...
        public InternationalShipmentResponseCustomsCustomsItemsInner(string description = default(string), string hSTariffCode = default(string), string originCountryCode = default(string), decimal quantity = default(decimal), decimal unitPrice = default(decimal), string weightUnit = default(string), decimal weight = default(decimal))
        {
