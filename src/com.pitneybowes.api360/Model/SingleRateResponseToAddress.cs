...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    public partial class SingleRateResponseToAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SingleRateResponseToAddress" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public SingleRateResponseToAddress(Option<string> addressLine1 = default, Option<string> addressLine2 = default, Option<string> addressLine3 = default, Option<string> name = default, Option<string> cityTown = default, Option<string> company = default, Option<string> email = default, Option<string> phone = default, Option<string> countryCode = default, Option<string> postalCode = default, Option<string> stateProvince = default, Option<bool?> residential = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="SingleRateResponseToAddress" />
    /// </summary>
    public class SingleRateResponseToAddressJsonConverter : JsonConverter<SingleRateResponseToAddress>
    {
        /// <summary>
        /// Deserializes json to <see cref="SingleRateResponseToAddress" />
        /// </summary>
        ...
        public override SingleRateResponseToAddress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (addressLine1.IsSet && addressLine1.Value == null)
                throw new ArgumentNullException(nameof(addressLine1), "Property is not nullable for class SingleRateResponseToAddress.");

            if (addressLine2.IsSet && addressLine2.Value == null)
                throw new ArgumentNullException(nameof(addressLine2), "Property is not nullable for class SingleRateResponseToAddress.");

            if (addressLine3.IsSet && addressLine3.Value == null)
                throw new ArgumentNullException(nameof(addressLine3), "Property is not nullable for class SingleRateResponseToAddress.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class SingleRateResponseToAddress.");

            if (cityTown.IsSet && cityTown.Value == null)
                throw new ArgumentNullException(nameof(cityTown), "Property is not nullable for class SingleRateResponseToAddress.");

            if (company.IsSet && company.Value == null)
                throw new ArgumentNullException(nameof(company), "Property is not nullable for class SingleRateResponseToAddress.");

            if (email.IsSet && email.Value == null)
                throw new ArgumentNullException(nameof(email), "Property is not nullable for class SingleRateResponseToAddress.");

            if (phone.IsSet && phone.Value == null)
                throw new ArgumentNullException(nameof(phone), "Property is not nullable for class SingleRateResponseToAddress.");

            if (countryCode.IsSet && countryCode.Value == null)
                throw new ArgumentNullException(nameof(countryCode), "Property is not nullable for class SingleRateResponseToAddress.");

            if (postalCode.IsSet && postalCode.Value == null)
                throw new ArgumentNullException(nameof(postalCode), "Property is not nullable for class SingleRateResponseToAddress.");

            if (stateProvince.IsSet && stateProvince.Value == null)
                throw new ArgumentNullException(nameof(stateProvince), "Property is not nullable for class SingleRateResponseToAddress.");

            if (residential.IsSet && residential.Value == null)
                throw new ArgumentNullException(nameof(residential), "Property is not nullable for class SingleRateResponseToAddress.");

            return new SingleRateResponseToAddress(addressLine1, addressLine2, addressLine3, name, cityTown, company, email, phone, countryCode, postalCode, stateProvince, residential);
        }

        /// <summary>
        /// Serializes a <see cref="SingleRateResponseToAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="singleRateResponseToAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, SingleRateResponseToAddress singleRateResponseToAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, singleRateResponseToAddress, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="SingleRateResponseToAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="singleRateResponseToAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, SingleRateResponseToAddress singleRateResponseToAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            if (singleRateResponseToAddress.AddressLine1Option.IsSet && singleRateResponseToAddress.AddressLine1 == null)
                throw new ArgumentNullException(nameof(singleRateResponseToAddress.AddressLine1), "Property is required for class SingleRateResponseToAddress.");

            if (singleRateResponseToAddress.AddressLine2Option.IsSet && singleRateResponseToAddress.AddressLine2 == null)
                throw new ArgumentNullException(nameof(singleRateResponseToAddress.AddressLine2), "Property is required for class SingleRateResponseToAddress.");

            if (singleRateResponseToAddress.AddressLine3Option.IsSet && singleRateResponseToAddress.AddressLine3 == null)
                throw new ArgumentNullException(nameof(singleRateResponseToAddress.AddressLine3), "Property is required for class SingleRateResponseToAddress.");

            if (singleRateResponseToAddress.NameOption.IsSet && singleRateResponseToAddress.Name == null)
                throw new ArgumentNullException(nameof(singleRateResponseToAddress.Name), "Property is required for class SingleRateResponseToAddress.");

            if (singleRateResponseToAddress.CityTownOption.IsSet && singleRateResponseToAddress.CityTown == null)
                throw new ArgumentNullException(nameof(singleRateResponseToAddress.CityTown), "Property is required for class SingleRateResponseToAddress.");

            if (singleRateResponseToAddress.CompanyOption.IsSet && singleRateResponseToAddress.Company == null)
                throw new ArgumentNullException(nameof(singleRateResponseToAddress.Company), "Property is required for class SingleRateResponseToAddress.");

            if (singleRateResponseToAddress.EmailOption.IsSet && singleRateResponseToAddress.Email == null)
                throw new ArgumentNullException(nameof(singleRateResponseToAddress.Email), "Property is required for class SingleRateResponseToAddress.");

            if (singleRateResponseToAddress.PhoneOption.IsSet && singleRateResponseToAddress.Phone == null)
                throw new ArgumentNullException(nameof(singleRateResponseToAddress.Phone), "Property is required for class SingleRateResponseToAddress.");

            if (singleRateResponseToAddress.CountryCodeOption.IsSet && singleRateResponseToAddress.CountryCode == null)
                throw new ArgumentNullException(nameof(singleRateResponseToAddress.CountryCode), "Property is required for class SingleRateResponseToAddress.");

            if (singleRateResponseToAddress.PostalCodeOption.IsSet && singleRateResponseToAddress.PostalCode == null)
                throw new ArgumentNullException(nameof(singleRateResponseToAddress.PostalCode), "Property is required for class SingleRateResponseToAddress.");

            if (singleRateResponseToAddress.StateProvinceOption.IsSet && singleRateResponseToAddress.StateProvince == null)
                throw new ArgumentNullException(nameof(singleRateResponseToAddress.StateProvince), "Property is required for class SingleRateResponseToAddress.");

            if (singleRateResponseToAddress.AddressLine1Option.IsSet)
                writer.WriteString("addressLine1", singleRateResponseToAddress.AddressLine1);

            if (singleRateResponseToAddress.AddressLine2Option.IsSet)
                writer.WriteString("addressLine2", singleRateResponseToAddress.AddressLine2);

            if (singleRateResponseToAddress.AddressLine3Option.IsSet)
                writer.WriteString("addressLine3", singleRateResponseToAddress.AddressLine3);

            if (singleRateResponseToAddress.NameOption.IsSet)
                writer.WriteString("name", singleRateResponseToAddress.Name);

            if (singleRateResponseToAddress.CityTownOption.IsSet)
                writer.WriteString("cityTown", singleRateResponseToAddress.CityTown);

            if (singleRateResponseToAddress.CompanyOption.IsSet)
                writer.WriteString("company", singleRateResponseToAddress.Company);

            if (singleRateResponseToAddress.EmailOption.IsSet)
                writer.WriteString("email", singleRateResponseToAddress.Email);

            if (singleRateResponseToAddress.PhoneOption.IsSet)
                writer.WriteString("phone", singleRateResponseToAddress.Phone);

            if (singleRateResponseToAddress.CountryCodeOption.IsSet)
                writer.WriteString("countryCode", singleRateResponseToAddress.CountryCode);

            if (singleRateResponseToAddress.PostalCodeOption.IsSet)
                writer.WriteString("postalCode", singleRateResponseToAddress.PostalCode);

            if (singleRateResponseToAddress.StateProvinceOption.IsSet)
                writer.WriteString("stateProvince", singleRateResponseToAddress.StateProvince);

            if (singleRateResponseToAddress.ResidentialOption.IsSet)
                writer.WriteBoolean("residential", singleRateResponseToAddress.ResidentialOption.Value.Value);
        }
    }
}
