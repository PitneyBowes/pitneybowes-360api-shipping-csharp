...
{
    /// <summary>
    /// MilitaryMailShipmentsResponseToAddress
    /// </summary>
    public partial class MilitaryMailShipmentsResponseToAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MilitaryMailShipmentsResponseToAddress" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MilitaryMailShipmentsResponseToAddress {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="MilitaryMailShipmentsResponseToAddress" />
    /// </summary>
    public class MilitaryMailShipmentsResponseToAddressJsonConverter : JsonConverter<MilitaryMailShipmentsResponseToAddress>
    {
        /// <summary>
        /// Deserializes json to <see cref="MilitaryMailShipmentsResponseToAddress" />
        /// </summary>
        ...
        public override MilitaryMailShipmentsResponseToAddress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (addressLine1.IsSet && addressLine1.Value == null)
                throw new ArgumentNullException(nameof(addressLine1), "Property is not nullable for class MilitaryMailShipmentsResponseToAddress.");

            if (addressLine2.IsSet && addressLine2.Value == null)
                throw new ArgumentNullException(nameof(addressLine2), "Property is not nullable for class MilitaryMailShipmentsResponseToAddress.");

            if (addressLine3.IsSet && addressLine3.Value == null)
                throw new ArgumentNullException(nameof(addressLine3), "Property is not nullable for class MilitaryMailShipmentsResponseToAddress.");

            if (cityTown.IsSet && cityTown.Value == null)
                throw new ArgumentNullException(nameof(cityTown), "Property is not nullable for class MilitaryMailShipmentsResponseToAddress.");

            if (company.IsSet && company.Value == null)
                throw new ArgumentNullException(nameof(company), "Property is not nullable for class MilitaryMailShipmentsResponseToAddress.");

            if (countryCode.IsSet && countryCode.Value == null)
                throw new ArgumentNullException(nameof(countryCode), "Property is not nullable for class MilitaryMailShipmentsResponseToAddress.");

            if (email.IsSet && email.Value == null)
                throw new ArgumentNullException(nameof(email), "Property is not nullable for class MilitaryMailShipmentsResponseToAddress.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class MilitaryMailShipmentsResponseToAddress.");

            if (phone.IsSet && phone.Value == null)
                throw new ArgumentNullException(nameof(phone), "Property is not nullable for class MilitaryMailShipmentsResponseToAddress.");

            if (postalCode.IsSet && postalCode.Value == null)
                throw new ArgumentNullException(nameof(postalCode), "Property is not nullable for class MilitaryMailShipmentsResponseToAddress.");

            if (residential.IsSet && residential.Value == null)
                throw new ArgumentNullException(nameof(residential), "Property is not nullable for class MilitaryMailShipmentsResponseToAddress.");

            if (stateProvince.IsSet && stateProvince.Value == null)
                throw new ArgumentNullException(nameof(stateProvince), "Property is not nullable for class MilitaryMailShipmentsResponseToAddress.");

            return new MilitaryMailShipmentsResponseToAddress(addressLine1, addressLine2, addressLine3, cityTown, company, countryCode, email, name, phone, postalCode, residential, stateProvince);
        }

        /// <summary>
        /// Serializes a <see cref="MilitaryMailShipmentsResponseToAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="militaryMailShipmentsResponseToAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, MilitaryMailShipmentsResponseToAddress militaryMailShipmentsResponseToAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, militaryMailShipmentsResponseToAddress, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="MilitaryMailShipmentsResponseToAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="militaryMailShipmentsResponseToAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, MilitaryMailShipmentsResponseToAddress militaryMailShipmentsResponseToAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            if (militaryMailShipmentsResponseToAddress.AddressLine1Option.IsSet && militaryMailShipmentsResponseToAddress.AddressLine1 == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentsResponseToAddress.AddressLine1), "Property is required for class MilitaryMailShipmentsResponseToAddress.");

            if (militaryMailShipmentsResponseToAddress.AddressLine2Option.IsSet && militaryMailShipmentsResponseToAddress.AddressLine2 == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentsResponseToAddress.AddressLine2), "Property is required for class MilitaryMailShipmentsResponseToAddress.");

            if (militaryMailShipmentsResponseToAddress.AddressLine3Option.IsSet && militaryMailShipmentsResponseToAddress.AddressLine3 == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentsResponseToAddress.AddressLine3), "Property is required for class MilitaryMailShipmentsResponseToAddress.");

            if (militaryMailShipmentsResponseToAddress.CityTownOption.IsSet && militaryMailShipmentsResponseToAddress.CityTown == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentsResponseToAddress.CityTown), "Property is required for class MilitaryMailShipmentsResponseToAddress.");

            if (militaryMailShipmentsResponseToAddress.CompanyOption.IsSet && militaryMailShipmentsResponseToAddress.Company == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentsResponseToAddress.Company), "Property is required for class MilitaryMailShipmentsResponseToAddress.");

            if (militaryMailShipmentsResponseToAddress.CountryCodeOption.IsSet && militaryMailShipmentsResponseToAddress.CountryCode == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentsResponseToAddress.CountryCode), "Property is required for class MilitaryMailShipmentsResponseToAddress.");

            if (militaryMailShipmentsResponseToAddress.EmailOption.IsSet && militaryMailShipmentsResponseToAddress.Email == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentsResponseToAddress.Email), "Property is required for class MilitaryMailShipmentsResponseToAddress.");

            if (militaryMailShipmentsResponseToAddress.NameOption.IsSet && militaryMailShipmentsResponseToAddress.Name == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentsResponseToAddress.Name), "Property is required for class MilitaryMailShipmentsResponseToAddress.");

            if (militaryMailShipmentsResponseToAddress.PhoneOption.IsSet && militaryMailShipmentsResponseToAddress.Phone == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentsResponseToAddress.Phone), "Property is required for class MilitaryMailShipmentsResponseToAddress.");

            if (militaryMailShipmentsResponseToAddress.PostalCodeOption.IsSet && militaryMailShipmentsResponseToAddress.PostalCode == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentsResponseToAddress.PostalCode), "Property is required for class MilitaryMailShipmentsResponseToAddress.");

            if (militaryMailShipmentsResponseToAddress.StateProvinceOption.IsSet && militaryMailShipmentsResponseToAddress.StateProvince == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentsResponseToAddress.StateProvince), "Property is required for class MilitaryMailShipmentsResponseToAddress.");

            if (militaryMailShipmentsResponseToAddress.AddressLine1Option.IsSet)
                writer.WriteString("addressLine1", militaryMailShipmentsResponseToAddress.AddressLine1);

            if (militaryMailShipmentsResponseToAddress.AddressLine2Option.IsSet)
                writer.WriteString("addressLine2", militaryMailShipmentsResponseToAddress.AddressLine2);

            if (militaryMailShipmentsResponseToAddress.AddressLine3Option.IsSet)
                writer.WriteString("addressLine3", militaryMailShipmentsResponseToAddress.AddressLine3);

            if (militaryMailShipmentsResponseToAddress.CityTownOption.IsSet)
                writer.WriteString("cityTown", militaryMailShipmentsResponseToAddress.CityTown);

            if (militaryMailShipmentsResponseToAddress.CompanyOption.IsSet)
                writer.WriteString("company", militaryMailShipmentsResponseToAddress.Company);

            if (militaryMailShipmentsResponseToAddress.CountryCodeOption.IsSet)
                writer.WriteString("countryCode", militaryMailShipmentsResponseToAddress.CountryCode);

            if (militaryMailShipmentsResponseToAddress.EmailOption.IsSet)
                writer.WriteString("email", militaryMailShipmentsResponseToAddress.Email);

            if (militaryMailShipmentsResponseToAddress.NameOption.IsSet)
                writer.WriteString("name", militaryMailShipmentsResponseToAddress.Name);

            if (militaryMailShipmentsResponseToAddress.PhoneOption.IsSet)
                writer.WriteString("phone", militaryMailShipmentsResponseToAddress.Phone);

            if (militaryMailShipmentsResponseToAddress.PostalCodeOption.IsSet)
                writer.WriteString("postalCode", militaryMailShipmentsResponseToAddress.PostalCode);

            if (militaryMailShipmentsResponseToAddress.ResidentialOption.IsSet)
                writer.WriteBoolean("residential", militaryMailShipmentsResponseToAddress.ResidentialOption.Value!.Value);

            if (militaryMailShipmentsResponseToAddress.StateProvinceOption.IsSet)
                writer.WriteString("stateProvince", militaryMailShipmentsResponseToAddress.StateProvince);
        }
    }
}
