...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    public partial class SchedulePickupFedexRequestPickupOptions : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SchedulePickupFedexRequestPickupOptions" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public SchedulePickupFedexRequestPickupOptions(DateTime pickupStartDateTime, DateTime pickupEndDateTime, string carrierType, Option<int?> overweight = default)
        {
            PickupStartDateTime = pickupStartDateTime;
            PickupEndDateTime = pickupEndDateTime;
    ...
    /// <summary>
    /// A Json converter for type <see cref="SchedulePickupFedexRequestPickupOptions" />
    /// </summary>
    public class SchedulePickupFedexRequestPickupOptionsJsonConverter : JsonConverter<SchedulePickupFedexRequestPickupOptions>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="SchedulePickupFedexRequestPickupOptions" />
        /// </summary>
        ...
        public override SchedulePickupFedexRequestPickupOptions Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!pickupStartDateTime.IsSet)
                throw new ArgumentException("Property is required for class SchedulePickupFedexRequestPickupOptions.", nameof(pickupStartDateTime));

            if (!pickupEndDateTime.IsSet)
                throw new ArgumentException("Property is required for class SchedulePickupFedexRequestPickupOptions.", nameof(pickupEndDateTime));

            if (!carrierType.IsSet)
                throw new ArgumentException("Property is required for class SchedulePickupFedexRequestPickupOptions.", nameof(carrierType));

            if (pickupStartDateTime.IsSet && pickupStartDateTime.Value == null)
                throw new ArgumentNullException(nameof(pickupStartDateTime), "Property is not nullable for class SchedulePickupFedexRequestPickupOptions.");

            if (pickupEndDateTime.IsSet && pickupEndDateTime.Value == null)
                throw new ArgumentNullException(nameof(pickupEndDateTime), "Property is not nullable for class SchedulePickupFedexRequestPickupOptions.");

            if (carrierType.IsSet && carrierType.Value == null)
                throw new ArgumentNullException(nameof(carrierType), "Property is not nullable for class SchedulePickupFedexRequestPickupOptions.");

            if (overweight.IsSet && overweight.Value == null)
                throw new ArgumentNullException(nameof(overweight), "Property is not nullable for class SchedulePickupFedexRequestPickupOptions.");

            return new SchedulePickupFedexRequestPickupOptions(pickupStartDateTime.Value.Value, pickupEndDateTime.Value.Value, carrierType.Value, overweight);
        }

        /// <summary>
        /// Serializes a <see cref="SchedulePickupFedexRequestPickupOptions" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="schedulePickupFedexRequestPickupOptions"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, SchedulePickupFedexRequestPickupOptions schedulePickupFedexRequestPickupOptions, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, schedulePickupFedexRequestPickupOptions, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="SchedulePickupFedexRequestPickupOptions" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="schedulePickupFedexRequestPickupOptions"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, SchedulePickupFedexRequestPickupOptions schedulePickupFedexRequestPickupOptions, JsonSerializerOptions jsonSerializerOptions)
        {
            if (schedulePickupFedexRequestPickupOptions.CarrierType == null)
                throw new ArgumentNullException(nameof(schedulePickupFedexRequestPickupOptions.CarrierType), "Property is required for class SchedulePickupFedexRequestPickupOptions.");

            writer.WriteString("pickupStartDateTime", schedulePickupFedexRequestPickupOptions.PickupStartDateTime.ToString(PickupStartDateTimeFormat));

            writer.WriteString("pickupEndDateTime", schedulePickupFedexRequestPickupOptions.PickupEndDateTime.ToString(PickupEndDateTimeFormat));

            writer.WriteString("carrierType", schedulePickupFedexRequestPickupOptions.CarrierType);

            if (schedulePickupFedexRequestPickupOptions.OverweightOption.IsSet)
                writer.WriteNumber("overweight", schedulePickupFedexRequestPickupOptions.OverweightOption.Value.Value);
        }
    }
}
