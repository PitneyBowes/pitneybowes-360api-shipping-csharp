...
{
    /// <summary>
    /// MilitaryMailShipmentsResponseRate
    /// </summary>
    public partial class MilitaryMailShipmentsResponseRate : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MilitaryMailShipmentsResponseRate" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public MilitaryMailShipmentsResponseRate(Option<decimal?> baseCharge = default, Option<string> carrier = default, Option<string> currencyCode = default, Option<MultipieceRateShopResponseRatesInnerDeliveryCommitment> deliveryCommitment = default, Option<string> parcelType = default, Option<string> rateTypeId = default, Option<string> serviceId = default, Option<List<DomesticShipmentResponseRateSpecialServicesInner>> specialServices = default, Option<decimal?> totalCarrierCharge = default, Option<string> inductionPostalCode = default, Option<string> destinationZone = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MilitaryMailShipmentsResponseRate {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="MilitaryMailShipmentsResponseRate" />
    /// </summary>
    public class MilitaryMailShipmentsResponseRateJsonConverter : JsonConverter<MilitaryMailShipmentsResponseRate>
    {
        /// <summary>
        /// Deserializes json to <see cref="MilitaryMailShipmentsResponseRate" />
        /// </summary>
        ...
        public override MilitaryMailShipmentsResponseRate Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (baseCharge.IsSet && baseCharge.Value == null)
                throw new ArgumentNullException(nameof(baseCharge), "Property is not nullable for class MilitaryMailShipmentsResponseRate.");

            if (carrier.IsSet && carrier.Value == null)
                throw new ArgumentNullException(nameof(carrier), "Property is not nullable for class MilitaryMailShipmentsResponseRate.");

            if (currencyCode.IsSet && currencyCode.Value == null)
                throw new ArgumentNullException(nameof(currencyCode), "Property is not nullable for class MilitaryMailShipmentsResponseRate.");

            if (deliveryCommitment.IsSet && deliveryCommitment.Value == null)
                throw new ArgumentNullException(nameof(deliveryCommitment), "Property is not nullable for class MilitaryMailShipmentsResponseRate.");

            if (parcelType.IsSet && parcelType.Value == null)
                throw new ArgumentNullException(nameof(parcelType), "Property is not nullable for class MilitaryMailShipmentsResponseRate.");

            if (rateTypeId.IsSet && rateTypeId.Value == null)
                throw new ArgumentNullException(nameof(rateTypeId), "Property is not nullable for class MilitaryMailShipmentsResponseRate.");

            if (serviceId.IsSet && serviceId.Value == null)
                throw new ArgumentNullException(nameof(serviceId), "Property is not nullable for class MilitaryMailShipmentsResponseRate.");

            if (specialServices.IsSet && specialServices.Value == null)
                throw new ArgumentNullException(nameof(specialServices), "Property is not nullable for class MilitaryMailShipmentsResponseRate.");

            if (totalCarrierCharge.IsSet && totalCarrierCharge.Value == null)
                throw new ArgumentNullException(nameof(totalCarrierCharge), "Property is not nullable for class MilitaryMailShipmentsResponseRate.");

            if (inductionPostalCode.IsSet && inductionPostalCode.Value == null)
                throw new ArgumentNullException(nameof(inductionPostalCode), "Property is not nullable for class MilitaryMailShipmentsResponseRate.");

            if (destinationZone.IsSet && destinationZone.Value == null)
                throw new ArgumentNullException(nameof(destinationZone), "Property is not nullable for class MilitaryMailShipmentsResponseRate.");

            return new MilitaryMailShipmentsResponseRate(baseCharge, carrier, currencyCode, deliveryCommitment, parcelType, rateTypeId, serviceId, specialServices, totalCarrierCharge, inductionPostalCode, destinationZone);
        }

        /// <summary>
        /// Serializes a <see cref="MilitaryMailShipmentsResponseRate" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="militaryMailShipmentsResponseRate"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, MilitaryMailShipmentsResponseRate militaryMailShipmentsResponseRate, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, militaryMailShipmentsResponseRate, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="MilitaryMailShipmentsResponseRate" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="militaryMailShipmentsResponseRate"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, MilitaryMailShipmentsResponseRate militaryMailShipmentsResponseRate, JsonSerializerOptions jsonSerializerOptions)
        {
            if (militaryMailShipmentsResponseRate.CarrierOption.IsSet && militaryMailShipmentsResponseRate.Carrier == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentsResponseRate.Carrier), "Property is required for class MilitaryMailShipmentsResponseRate.");

            if (militaryMailShipmentsResponseRate.CurrencyCodeOption.IsSet && militaryMailShipmentsResponseRate.CurrencyCode == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentsResponseRate.CurrencyCode), "Property is required for class MilitaryMailShipmentsResponseRate.");

            if (militaryMailShipmentsResponseRate.DeliveryCommitmentOption.IsSet && militaryMailShipmentsResponseRate.DeliveryCommitment == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentsResponseRate.DeliveryCommitment), "Property is required for class MilitaryMailShipmentsResponseRate.");

            if (militaryMailShipmentsResponseRate.ParcelTypeOption.IsSet && militaryMailShipmentsResponseRate.ParcelType == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentsResponseRate.ParcelType), "Property is required for class MilitaryMailShipmentsResponseRate.");

            if (militaryMailShipmentsResponseRate.RateTypeIdOption.IsSet && militaryMailShipmentsResponseRate.RateTypeId == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentsResponseRate.RateTypeId), "Property is required for class MilitaryMailShipmentsResponseRate.");

            if (militaryMailShipmentsResponseRate.ServiceIdOption.IsSet && militaryMailShipmentsResponseRate.ServiceId == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentsResponseRate.ServiceId), "Property is required for class MilitaryMailShipmentsResponseRate.");

            if (militaryMailShipmentsResponseRate.SpecialServicesOption.IsSet && militaryMailShipmentsResponseRate.SpecialServices == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentsResponseRate.SpecialServices), "Property is required for class MilitaryMailShipmentsResponseRate.");

            if (militaryMailShipmentsResponseRate.InductionPostalCodeOption.IsSet && militaryMailShipmentsResponseRate.InductionPostalCode == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentsResponseRate.InductionPostalCode), "Property is required for class MilitaryMailShipmentsResponseRate.");

            if (militaryMailShipmentsResponseRate.DestinationZoneOption.IsSet && militaryMailShipmentsResponseRate.DestinationZone == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentsResponseRate.DestinationZone), "Property is required for class MilitaryMailShipmentsResponseRate.");

            if (militaryMailShipmentsResponseRate.BaseChargeOption.IsSet)
                writer.WriteNumber("baseCharge", militaryMailShipmentsResponseRate.BaseChargeOption.Value.Value);

            if (militaryMailShipmentsResponseRate.CarrierOption.IsSet)
                writer.WriteString("carrier", militaryMailShipmentsResponseRate.Carrier);

            if (militaryMailShipmentsResponseRate.CurrencyCodeOption.IsSet)
                writer.WriteString("currencyCode", militaryMailShipmentsResponseRate.CurrencyCode);

            if (militaryMailShipmentsResponseRate.DeliveryCommitmentOption.IsSet)
            {
                writer.WritePropertyName("deliveryCommitment");
                JsonSerializer.Serialize(writer, militaryMailShipmentsResponseRate.DeliveryCommitment, jsonSerializerOptions);
            }
            if (militaryMailShipmentsResponseRate.ParcelTypeOption.IsSet)
                writer.WriteString("parcelType", militaryMailShipmentsResponseRate.ParcelType);

            if (militaryMailShipmentsResponseRate.RateTypeIdOption.IsSet)
                writer.WriteString("rateTypeId", militaryMailShipmentsResponseRate.RateTypeId);

            if (militaryMailShipmentsResponseRate.ServiceIdOption.IsSet)
                writer.WriteString("serviceId", militaryMailShipmentsResponseRate.ServiceId);

            if (militaryMailShipmentsResponseRate.SpecialServicesOption.IsSet)
            {
                writer.WritePropertyName("specialServices");
                JsonSerializer.Serialize(writer, militaryMailShipmentsResponseRate.SpecialServices, jsonSerializerOptions);
            }
            if (militaryMailShipmentsResponseRate.TotalCarrierChargeOption.IsSet)
                writer.WriteNumber("totalCarrierCharge", militaryMailShipmentsResponseRate.TotalCarrierChargeOption.Value.Value);

            if (militaryMailShipmentsResponseRate.InductionPostalCodeOption.IsSet)
                writer.WriteString("inductionPostalCode", militaryMailShipmentsResponseRate.InductionPostalCode);

            if (militaryMailShipmentsResponseRate.DestinationZoneOption.IsSet)
                writer.WriteString("destinationZone", militaryMailShipmentsResponseRate.DestinationZone);
        }
    }
}
