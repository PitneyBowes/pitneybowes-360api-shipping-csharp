...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    public partial class MilitaryMailShipmentResponseV2AllOfCustomsCustomsInfo : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MilitaryMailShipmentResponseV2AllOfCustomsCustomsInfo" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public MilitaryMailShipmentResponseV2AllOfCustomsCustomsInfo(Option<ReasonForExportEnum?> reasonForExport = default, Option<decimal?> customsDeclaredValue = default, Option<string> currencyCode = default, Option<string> eELPFC = default, Option<string> certificateNumber = default, Option<string> comments = default, Option<string> fromCustomsReference = default, Option<string> importerCustomsReference = default, Option<string> invoiceNumber = default, Option<string> licenseNumber = default, Option<decimal?> sdrValue = default, Option<TermsOfSaleEnum?> termsOfSale = default)
        {
        ...
        public Option<ReasonForExportEnum?> ReasonForExportOption { get; private set; }
        ...
        public ReasonForExportEnum? ReasonForExport { get { return this.ReasonForExportOption; } set { this.ReasonForExportOption = new Option<ReasonForExportEnum?>(value); } }
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<decimal?> CustomsDeclaredValueOption { get; private set; }
        ...
        public decimal? CustomsDeclaredValue { get { return this.CustomsDeclaredValueOption; } set { this.CustomsDeclaredValueOption = new Option<decimal?>(value); } }
        ...
        public decimal? SdrValue { get { return this.SdrValueOption; } set { this.SdrValueOption = new Option<decimal?>(value); } }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MilitaryMailShipmentResponseV2AllOfCustomsCustomsInfo {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="MilitaryMailShipmentResponseV2AllOfCustomsCustomsInfo" />
    /// </summary>
    public class MilitaryMailShipmentResponseV2AllOfCustomsCustomsInfoJsonConverter : JsonConverter<MilitaryMailShipmentResponseV2AllOfCustomsCustomsInfo>
    {
        /// <summary>
        /// Deserializes json to <see cref="MilitaryMailShipmentResponseV2AllOfCustomsCustomsInfo" />
        /// </summary>
        ...
        public override MilitaryMailShipmentResponseV2AllOfCustomsCustomsInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<MilitaryMailShipmentResponseV2AllOfCustomsCustomsInfo.ReasonForExportEnum?> reasonForExport = default;
            ...
            Option<MilitaryMailShipmentResponseV2AllOfCustomsCustomsInfo.TermsOfSaleEnum?> termsOfSale = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "reasonForExport":
                            ...
                            if (reasonForExportRawValue != null)
                                reasonForExport = new Option<MilitaryMailShipmentResponseV2AllOfCustomsCustomsInfo.ReasonForExportEnum?>(MilitaryMailShipmentResponseV2AllOfCustomsCustomsInfo.ReasonForExportEnumFromStringOrDefault(reasonForExportRawValue));
                            break;
                        ...
                        case "termsOfSale":
                            ...
                            if (termsOfSaleRawValue != null)
                                termsOfSale = new Option<MilitaryMailShipmentResponseV2AllOfCustomsCustomsInfo.TermsOfSaleEnum?>(MilitaryMailShipmentResponseV2AllOfCustomsCustomsInfo.TermsOfSaleEnumFromStringOrDefault(termsOfSaleRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            if (reasonForExport.IsSet && reasonForExport.Value == null)
                throw new ArgumentNullException(nameof(reasonForExport), "Property is not nullable for class MilitaryMailShipmentResponseV2AllOfCustomsCustomsInfo.");

            if (customsDeclaredValue.IsSet && customsDeclaredValue.Value == null)
                throw new ArgumentNullException(nameof(customsDeclaredValue), "Property is not nullable for class MilitaryMailShipmentResponseV2AllOfCustomsCustomsInfo.");

            if (currencyCode.IsSet && currencyCode.Value == null)
                throw new ArgumentNullException(nameof(currencyCode), "Property is not nullable for class MilitaryMailShipmentResponseV2AllOfCustomsCustomsInfo.");

            if (eELPFC.IsSet && eELPFC.Value == null)
                throw new ArgumentNullException(nameof(eELPFC), "Property is not nullable for class MilitaryMailShipmentResponseV2AllOfCustomsCustomsInfo.");

            if (certificateNumber.IsSet && certificateNumber.Value == null)
                throw new ArgumentNullException(nameof(certificateNumber), "Property is not nullable for class MilitaryMailShipmentResponseV2AllOfCustomsCustomsInfo.");

            if (comments.IsSet && comments.Value == null)
                throw new ArgumentNullException(nameof(comments), "Property is not nullable for class MilitaryMailShipmentResponseV2AllOfCustomsCustomsInfo.");

            if (fromCustomsReference.IsSet && fromCustomsReference.Value == null)
                throw new ArgumentNullException(nameof(fromCustomsReference), "Property is not nullable for class MilitaryMailShipmentResponseV2AllOfCustomsCustomsInfo.");

            if (importerCustomsReference.IsSet && importerCustomsReference.Value == null)
                throw new ArgumentNullException(nameof(importerCustomsReference), "Property is not nullable for class MilitaryMailShipmentResponseV2AllOfCustomsCustomsInfo.");

            if (invoiceNumber.IsSet && invoiceNumber.Value == null)
                throw new ArgumentNullException(nameof(invoiceNumber), "Property is not nullable for class MilitaryMailShipmentResponseV2AllOfCustomsCustomsInfo.");

            if (licenseNumber.IsSet && licenseNumber.Value == null)
                throw new ArgumentNullException(nameof(licenseNumber), "Property is not nullable for class MilitaryMailShipmentResponseV2AllOfCustomsCustomsInfo.");

            if (sdrValue.IsSet && sdrValue.Value == null)
                throw new ArgumentNullException(nameof(sdrValue), "Property is not nullable for class MilitaryMailShipmentResponseV2AllOfCustomsCustomsInfo.");

            if (termsOfSale.IsSet && termsOfSale.Value == null)
                throw new ArgumentNullException(nameof(termsOfSale), "Property is not nullable for class MilitaryMailShipmentResponseV2AllOfCustomsCustomsInfo.");

            return new MilitaryMailShipmentResponseV2AllOfCustomsCustomsInfo(reasonForExport, customsDeclaredValue, currencyCode, eELPFC, certificateNumber, comments, fromCustomsReference, importerCustomsReference, invoiceNumber, licenseNumber, sdrValue, termsOfSale);
        }

        /// <summary>
        /// Serializes a <see cref="MilitaryMailShipmentResponseV2AllOfCustomsCustomsInfo" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="militaryMailShipmentResponseV2AllOfCustomsCustomsInfo"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, MilitaryMailShipmentResponseV2AllOfCustomsCustomsInfo militaryMailShipmentResponseV2AllOfCustomsCustomsInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, militaryMailShipmentResponseV2AllOfCustomsCustomsInfo, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="MilitaryMailShipmentResponseV2AllOfCustomsCustomsInfo" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="militaryMailShipmentResponseV2AllOfCustomsCustomsInfo"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, MilitaryMailShipmentResponseV2AllOfCustomsCustomsInfo militaryMailShipmentResponseV2AllOfCustomsCustomsInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            if (militaryMailShipmentResponseV2AllOfCustomsCustomsInfo.CurrencyCodeOption.IsSet && militaryMailShipmentResponseV2AllOfCustomsCustomsInfo.CurrencyCode == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentResponseV2AllOfCustomsCustomsInfo.CurrencyCode), "Property is required for class MilitaryMailShipmentResponseV2AllOfCustomsCustomsInfo.");

            if (militaryMailShipmentResponseV2AllOfCustomsCustomsInfo.EELPFCOption.IsSet && militaryMailShipmentResponseV2AllOfCustomsCustomsInfo.EELPFC == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentResponseV2AllOfCustomsCustomsInfo.EELPFC), "Property is required for class MilitaryMailShipmentResponseV2AllOfCustomsCustomsInfo.");

            if (militaryMailShipmentResponseV2AllOfCustomsCustomsInfo.CertificateNumberOption.IsSet && militaryMailShipmentResponseV2AllOfCustomsCustomsInfo.CertificateNumber == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentResponseV2AllOfCustomsCustomsInfo.CertificateNumber), "Property is required for class MilitaryMailShipmentResponseV2AllOfCustomsCustomsInfo.");

            if (militaryMailShipmentResponseV2AllOfCustomsCustomsInfo.CommentsOption.IsSet && militaryMailShipmentResponseV2AllOfCustomsCustomsInfo.Comments == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentResponseV2AllOfCustomsCustomsInfo.Comments), "Property is required for class MilitaryMailShipmentResponseV2AllOfCustomsCustomsInfo.");

            if (militaryMailShipmentResponseV2AllOfCustomsCustomsInfo.FromCustomsReferenceOption.IsSet && militaryMailShipmentResponseV2AllOfCustomsCustomsInfo.FromCustomsReference == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentResponseV2AllOfCustomsCustomsInfo.FromCustomsReference), "Property is required for class MilitaryMailShipmentResponseV2AllOfCustomsCustomsInfo.");

            if (militaryMailShipmentResponseV2AllOfCustomsCustomsInfo.ImporterCustomsReferenceOption.IsSet && militaryMailShipmentResponseV2AllOfCustomsCustomsInfo.ImporterCustomsReference == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentResponseV2AllOfCustomsCustomsInfo.ImporterCustomsReference), "Property is required for class MilitaryMailShipmentResponseV2AllOfCustomsCustomsInfo.");

            if (militaryMailShipmentResponseV2AllOfCustomsCustomsInfo.InvoiceNumberOption.IsSet && militaryMailShipmentResponseV2AllOfCustomsCustomsInfo.InvoiceNumber == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentResponseV2AllOfCustomsCustomsInfo.InvoiceNumber), "Property is required for class MilitaryMailShipmentResponseV2AllOfCustomsCustomsInfo.");

            if (militaryMailShipmentResponseV2AllOfCustomsCustomsInfo.LicenseNumberOption.IsSet && militaryMailShipmentResponseV2AllOfCustomsCustomsInfo.LicenseNumber == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentResponseV2AllOfCustomsCustomsInfo.LicenseNumber), "Property is required for class MilitaryMailShipmentResponseV2AllOfCustomsCustomsInfo.");

            var reasonForExportRawValue = MilitaryMailShipmentResponseV2AllOfCustomsCustomsInfo.ReasonForExportEnumToJsonValue(militaryMailShipmentResponseV2AllOfCustomsCustomsInfo.ReasonForExportOption.Value.Value);
            writer.WriteString("reasonForExport", reasonForExportRawValue);
            if (militaryMailShipmentResponseV2AllOfCustomsCustomsInfo.CustomsDeclaredValueOption.IsSet)
                writer.WriteNumber("customsDeclaredValue", militaryMailShipmentResponseV2AllOfCustomsCustomsInfo.CustomsDeclaredValueOption.Value.Value);

            if (militaryMailShipmentResponseV2AllOfCustomsCustomsInfo.CurrencyCodeOption.IsSet)
                writer.WriteString("currencyCode", militaryMailShipmentResponseV2AllOfCustomsCustomsInfo.CurrencyCode);

            if (militaryMailShipmentResponseV2AllOfCustomsCustomsInfo.EELPFCOption.IsSet)
                writer.WriteString("EELPFC", militaryMailShipmentResponseV2AllOfCustomsCustomsInfo.EELPFC);

            if (militaryMailShipmentResponseV2AllOfCustomsCustomsInfo.CertificateNumberOption.IsSet)
                writer.WriteString("certificateNumber", militaryMailShipmentResponseV2AllOfCustomsCustomsInfo.CertificateNumber);

            if (militaryMailShipmentResponseV2AllOfCustomsCustomsInfo.CommentsOption.IsSet)
                writer.WriteString("comments", militaryMailShipmentResponseV2AllOfCustomsCustomsInfo.Comments);

            if (militaryMailShipmentResponseV2AllOfCustomsCustomsInfo.FromCustomsReferenceOption.IsSet)
                writer.WriteString("fromCustomsReference", militaryMailShipmentResponseV2AllOfCustomsCustomsInfo.FromCustomsReference);

            if (militaryMailShipmentResponseV2AllOfCustomsCustomsInfo.ImporterCustomsReferenceOption.IsSet)
                writer.WriteString("importerCustomsReference", militaryMailShipmentResponseV2AllOfCustomsCustomsInfo.ImporterCustomsReference);

            if (militaryMailShipmentResponseV2AllOfCustomsCustomsInfo.InvoiceNumberOption.IsSet)
                writer.WriteString("invoiceNumber", militaryMailShipmentResponseV2AllOfCustomsCustomsInfo.InvoiceNumber);

            if (militaryMailShipmentResponseV2AllOfCustomsCustomsInfo.LicenseNumberOption.IsSet)
                writer.WriteString("licenseNumber", militaryMailShipmentResponseV2AllOfCustomsCustomsInfo.LicenseNumber);

            if (militaryMailShipmentResponseV2AllOfCustomsCustomsInfo.SdrValueOption.IsSet)
                writer.WriteNumber("sdrValue", militaryMailShipmentResponseV2AllOfCustomsCustomsInfo.SdrValueOption.Value.Value);

            var termsOfSaleRawValue = MilitaryMailShipmentResponseV2AllOfCustomsCustomsInfo.TermsOfSaleEnumToJsonValue(militaryMailShipmentResponseV2AllOfCustomsCustomsInfo.TermsOfSaleOption.Value.Value);
