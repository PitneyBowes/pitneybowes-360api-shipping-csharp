...
namespace com.pitneybowes.api360.Model
{
    ...
    public partial class Parcel : IValidatableObject
    {
        ...
        public Parcel(float length = default(float), float width = default(float), float height = default(float), DimUnitEnum? dimUnit = default(DimUnitEnum?), WeightUnitEnum weightUnit = default(WeightUnitEnum), float weight = default(float))
        {
