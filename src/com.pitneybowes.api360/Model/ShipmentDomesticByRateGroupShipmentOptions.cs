...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    public partial class ShipmentDomesticByRateGroupShipmentOptions : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShipmentDomesticByRateGroupShipmentOptions" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public ShipmentDomesticByRateGroupShipmentOptions(Option<bool?> addToManifest = default, Option<bool?> minimalAddressValidation = default, Option<string?> bookingConfirmationNumber = default, Option<string?> shipperID = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="ShipmentDomesticByRateGroupShipmentOptions" />
    /// </summary>
    public class ShipmentDomesticByRateGroupShipmentOptionsJsonConverter : JsonConverter<ShipmentDomesticByRateGroupShipmentOptions>
    {
        /// <summary>
        /// Deserializes json to <see cref="ShipmentDomesticByRateGroupShipmentOptions" />
        /// </summary>
        ...
        public override ShipmentDomesticByRateGroupShipmentOptions Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (addToManifest.IsSet && addToManifest.Value == null)
                throw new ArgumentNullException(nameof(addToManifest), "Property is not nullable for class ShipmentDomesticByRateGroupShipmentOptions.");

            if (minimalAddressValidation.IsSet && minimalAddressValidation.Value == null)
                throw new ArgumentNullException(nameof(minimalAddressValidation), "Property is not nullable for class ShipmentDomesticByRateGroupShipmentOptions.");

            if (bookingConfirmationNumber.IsSet && bookingConfirmationNumber.Value == null)
                throw new ArgumentNullException(nameof(bookingConfirmationNumber), "Property is not nullable for class ShipmentDomesticByRateGroupShipmentOptions.");

            if (shipperID.IsSet && shipperID.Value == null)
                throw new ArgumentNullException(nameof(shipperID), "Property is not nullable for class ShipmentDomesticByRateGroupShipmentOptions.");

            return new ShipmentDomesticByRateGroupShipmentOptions(addToManifest, minimalAddressValidation, bookingConfirmationNumber, shipperID);
        }

        /// <summary>
        /// Serializes a <see cref="ShipmentDomesticByRateGroupShipmentOptions" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="shipmentDomesticByRateGroupShipmentOptions"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ShipmentDomesticByRateGroupShipmentOptions shipmentDomesticByRateGroupShipmentOptions, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, shipmentDomesticByRateGroupShipmentOptions, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ShipmentDomesticByRateGroupShipmentOptions" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="shipmentDomesticByRateGroupShipmentOptions"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ShipmentDomesticByRateGroupShipmentOptions shipmentDomesticByRateGroupShipmentOptions, JsonSerializerOptions jsonSerializerOptions)
        {
            if (shipmentDomesticByRateGroupShipmentOptions.BookingConfirmationNumberOption.IsSet && shipmentDomesticByRateGroupShipmentOptions.BookingConfirmationNumber == null)
                throw new ArgumentNullException(nameof(shipmentDomesticByRateGroupShipmentOptions.BookingConfirmationNumber), "Property is required for class ShipmentDomesticByRateGroupShipmentOptions.");

            if (shipmentDomesticByRateGroupShipmentOptions.ShipperIDOption.IsSet && shipmentDomesticByRateGroupShipmentOptions.ShipperID == null)
                throw new ArgumentNullException(nameof(shipmentDomesticByRateGroupShipmentOptions.ShipperID), "Property is required for class ShipmentDomesticByRateGroupShipmentOptions.");

            if (shipmentDomesticByRateGroupShipmentOptions.AddToManifestOption.IsSet)
                writer.WriteBoolean("addToManifest", shipmentDomesticByRateGroupShipmentOptions.AddToManifestOption.Value!.Value);

            if (shipmentDomesticByRateGroupShipmentOptions.MinimalAddressValidationOption.IsSet)
                writer.WriteBoolean("minimalAddressValidation", shipmentDomesticByRateGroupShipmentOptions.MinimalAddressValidationOption.Value!.Value);

            if (shipmentDomesticByRateGroupShipmentOptions.BookingConfirmationNumberOption.IsSet)
                writer.WriteString("bookingConfirmationNumber", shipmentDomesticByRateGroupShipmentOptions.BookingConfirmationNumber);

            if (shipmentDomesticByRateGroupShipmentOptions.ShipperIDOption.IsSet)
                writer.WriteString("shipperID", shipmentDomesticByRateGroupShipmentOptions.ShipperID);
        }
    }
}
