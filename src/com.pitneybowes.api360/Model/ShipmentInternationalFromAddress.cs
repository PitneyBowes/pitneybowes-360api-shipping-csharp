...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    public partial class ShipmentInternationalFromAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShipmentInternationalFromAddress" /> class.
        /// </summary>
        ...
        /// <param name="email">This must be sender&#39;s valid email. Email is required if the customer is using GoFor Carrier. This field is required for RMG b2b shipment.</param>
        ...
        [JsonConstructor]
        public ShipmentInternationalFromAddress(string addressLine1, string countryCode, string postalCode, string stateProvince, Option<string> addressLine2 = default, Option<string> addressLine3 = default, Option<string> cityTown = default, Option<string> name = default, Option<string> company = default, Option<string> email = default, Option<string> phone = default, Option<string> inductionPostalCode = default, Option<bool?> residential = default, Option<string> taxId = default, Option<TaxIdTypeEnum?> taxIdType = default)
        {
        ...
        /// <summary>
        /// This must be sender&#39;s valid email. Email is required if the customer is using GoFor Carrier. This field is required for RMG b2b shipment.
        /// </summary>
        /// <value>This must be sender&#39;s valid email. Email is required if the customer is using GoFor Carrier. This field is required for RMG b2b shipment.</value>
        ...
        /// <summary>
        /// The postal code where the shipment is tendered to the carrier. If an induction postal code is specified in the \&quot;fromAddress\&quot;, it will be used for rate calculations and determining manifest eligibility instead of the standard postal code. If not specified, the postal code from the \&quot;fromAddress\&quot; will be used. IPC supported only for carrier USPS.
        /// </summary>
        /// <value>The postal code where the shipment is tendered to the carrier. If an induction postal code is specified in the \&quot;fromAddress\&quot;, it will be used for rate calculations and determining manifest eligibility instead of the standard postal code. If not specified, the postal code from the \&quot;fromAddress\&quot; will be used. IPC supported only for carrier USPS.</value>
        /* <example>06905</example> */
    ...
    /// <summary>
    /// A Json converter for type <see cref="ShipmentInternationalFromAddress" />
    /// </summary>
    public class ShipmentInternationalFromAddressJsonConverter : JsonConverter<ShipmentInternationalFromAddress>
    {
        /// <summary>
        /// Deserializes json to <see cref="ShipmentInternationalFromAddress" />
        /// </summary>
        ...
        public override ShipmentInternationalFromAddress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<ShipmentInternationalFromAddress.TaxIdTypeEnum?> taxIdType = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "taxIdType":
                            ...
                            if (taxIdTypeRawValue != null)
                                taxIdType = new Option<ShipmentInternationalFromAddress.TaxIdTypeEnum?>(ShipmentInternationalFromAddress.TaxIdTypeEnumFromStringOrDefault(taxIdTypeRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            if (!addressLine1.IsSet)
                throw new ArgumentException("Property is required for class ShipmentInternationalFromAddress.", nameof(addressLine1));

            if (!countryCode.IsSet)
                throw new ArgumentException("Property is required for class ShipmentInternationalFromAddress.", nameof(countryCode));

            if (!postalCode.IsSet)
                throw new ArgumentException("Property is required for class ShipmentInternationalFromAddress.", nameof(postalCode));

            if (!stateProvince.IsSet)
                throw new ArgumentException("Property is required for class ShipmentInternationalFromAddress.", nameof(stateProvince));

            if (addressLine1.IsSet && addressLine1.Value == null)
                throw new ArgumentNullException(nameof(addressLine1), "Property is not nullable for class ShipmentInternationalFromAddress.");

            if (countryCode.IsSet && countryCode.Value == null)
                throw new ArgumentNullException(nameof(countryCode), "Property is not nullable for class ShipmentInternationalFromAddress.");

            if (postalCode.IsSet && postalCode.Value == null)
                throw new ArgumentNullException(nameof(postalCode), "Property is not nullable for class ShipmentInternationalFromAddress.");

            if (stateProvince.IsSet && stateProvince.Value == null)
                throw new ArgumentNullException(nameof(stateProvince), "Property is not nullable for class ShipmentInternationalFromAddress.");

            if (addressLine2.IsSet && addressLine2.Value == null)
                throw new ArgumentNullException(nameof(addressLine2), "Property is not nullable for class ShipmentInternationalFromAddress.");

            if (addressLine3.IsSet && addressLine3.Value == null)
                throw new ArgumentNullException(nameof(addressLine3), "Property is not nullable for class ShipmentInternationalFromAddress.");

            if (cityTown.IsSet && cityTown.Value == null)
                throw new ArgumentNullException(nameof(cityTown), "Property is not nullable for class ShipmentInternationalFromAddress.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class ShipmentInternationalFromAddress.");

            if (company.IsSet && company.Value == null)
                throw new ArgumentNullException(nameof(company), "Property is not nullable for class ShipmentInternationalFromAddress.");

            if (email.IsSet && email.Value == null)
                throw new ArgumentNullException(nameof(email), "Property is not nullable for class ShipmentInternationalFromAddress.");

            if (phone.IsSet && phone.Value == null)
                throw new ArgumentNullException(nameof(phone), "Property is not nullable for class ShipmentInternationalFromAddress.");

            if (inductionPostalCode.IsSet && inductionPostalCode.Value == null)
                throw new ArgumentNullException(nameof(inductionPostalCode), "Property is not nullable for class ShipmentInternationalFromAddress.");

            if (residential.IsSet && residential.Value == null)
                throw new ArgumentNullException(nameof(residential), "Property is not nullable for class ShipmentInternationalFromAddress.");

            if (taxId.IsSet && taxId.Value == null)
                throw new ArgumentNullException(nameof(taxId), "Property is not nullable for class ShipmentInternationalFromAddress.");

            if (taxIdType.IsSet && taxIdType.Value == null)
                throw new ArgumentNullException(nameof(taxIdType), "Property is not nullable for class ShipmentInternationalFromAddress.");

            return new ShipmentInternationalFromAddress(addressLine1.Value, countryCode.Value, postalCode.Value, stateProvince.Value, addressLine2, addressLine3, cityTown, name, company, email, phone, inductionPostalCode, residential, taxId, taxIdType);
        }

        /// <summary>
        /// Serializes a <see cref="ShipmentInternationalFromAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="shipmentInternationalFromAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ShipmentInternationalFromAddress shipmentInternationalFromAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, shipmentInternationalFromAddress, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ShipmentInternationalFromAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="shipmentInternationalFromAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ShipmentInternationalFromAddress shipmentInternationalFromAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            if (shipmentInternationalFromAddress.AddressLine1 == null)
                throw new ArgumentNullException(nameof(shipmentInternationalFromAddress.AddressLine1), "Property is required for class ShipmentInternationalFromAddress.");

            if (shipmentInternationalFromAddress.CountryCode == null)
                throw new ArgumentNullException(nameof(shipmentInternationalFromAddress.CountryCode), "Property is required for class ShipmentInternationalFromAddress.");

            if (shipmentInternationalFromAddress.PostalCode == null)
                throw new ArgumentNullException(nameof(shipmentInternationalFromAddress.PostalCode), "Property is required for class ShipmentInternationalFromAddress.");

            if (shipmentInternationalFromAddress.StateProvince == null)
                throw new ArgumentNullException(nameof(shipmentInternationalFromAddress.StateProvince), "Property is required for class ShipmentInternationalFromAddress.");

            if (shipmentInternationalFromAddress.AddressLine2Option.IsSet && shipmentInternationalFromAddress.AddressLine2 == null)
                throw new ArgumentNullException(nameof(shipmentInternationalFromAddress.AddressLine2), "Property is required for class ShipmentInternationalFromAddress.");

            if (shipmentInternationalFromAddress.AddressLine3Option.IsSet && shipmentInternationalFromAddress.AddressLine3 == null)
                throw new ArgumentNullException(nameof(shipmentInternationalFromAddress.AddressLine3), "Property is required for class ShipmentInternationalFromAddress.");

            if (shipmentInternationalFromAddress.CityTownOption.IsSet && shipmentInternationalFromAddress.CityTown == null)
                throw new ArgumentNullException(nameof(shipmentInternationalFromAddress.CityTown), "Property is required for class ShipmentInternationalFromAddress.");

            if (shipmentInternationalFromAddress.NameOption.IsSet && shipmentInternationalFromAddress.Name == null)
                throw new ArgumentNullException(nameof(shipmentInternationalFromAddress.Name), "Property is required for class ShipmentInternationalFromAddress.");

            if (shipmentInternationalFromAddress.CompanyOption.IsSet && shipmentInternationalFromAddress.Company == null)
                throw new ArgumentNullException(nameof(shipmentInternationalFromAddress.Company), "Property is required for class ShipmentInternationalFromAddress.");

            if (shipmentInternationalFromAddress.EmailOption.IsSet && shipmentInternationalFromAddress.Email == null)
                throw new ArgumentNullException(nameof(shipmentInternationalFromAddress.Email), "Property is required for class ShipmentInternationalFromAddress.");

            if (shipmentInternationalFromAddress.PhoneOption.IsSet && shipmentInternationalFromAddress.Phone == null)
                throw new ArgumentNullException(nameof(shipmentInternationalFromAddress.Phone), "Property is required for class ShipmentInternationalFromAddress.");

            if (shipmentInternationalFromAddress.InductionPostalCodeOption.IsSet && shipmentInternationalFromAddress.InductionPostalCode == null)
                throw new ArgumentNullException(nameof(shipmentInternationalFromAddress.InductionPostalCode), "Property is required for class ShipmentInternationalFromAddress.");

            if (shipmentInternationalFromAddress.TaxIdOption.IsSet && shipmentInternationalFromAddress.TaxId == null)
                throw new ArgumentNullException(nameof(shipmentInternationalFromAddress.TaxId), "Property is required for class ShipmentInternationalFromAddress.");

            writer.WriteString("addressLine1", shipmentInternationalFromAddress.AddressLine1);

            writer.WriteString("countryCode", shipmentInternationalFromAddress.CountryCode);

            writer.WriteString("postalCode", shipmentInternationalFromAddress.PostalCode);

            writer.WriteString("stateProvince", shipmentInternationalFromAddress.StateProvince);

            if (shipmentInternationalFromAddress.AddressLine2Option.IsSet)
                writer.WriteString("addressLine2", shipmentInternationalFromAddress.AddressLine2);

            if (shipmentInternationalFromAddress.AddressLine3Option.IsSet)
                writer.WriteString("addressLine3", shipmentInternationalFromAddress.AddressLine3);

            if (shipmentInternationalFromAddress.CityTownOption.IsSet)
                writer.WriteString("cityTown", shipmentInternationalFromAddress.CityTown);

            if (shipmentInternationalFromAddress.NameOption.IsSet)
                writer.WriteString("name", shipmentInternationalFromAddress.Name);

            if (shipmentInternationalFromAddress.CompanyOption.IsSet)
                writer.WriteString("company", shipmentInternationalFromAddress.Company);

            if (shipmentInternationalFromAddress.EmailOption.IsSet)
                writer.WriteString("email", shipmentInternationalFromAddress.Email);

            if (shipmentInternationalFromAddress.PhoneOption.IsSet)
                writer.WriteString("phone", shipmentInternationalFromAddress.Phone);

            if (shipmentInternationalFromAddress.InductionPostalCodeOption.IsSet)
                writer.WriteString("inductionPostalCode", shipmentInternationalFromAddress.InductionPostalCode);

            if (shipmentInternationalFromAddress.ResidentialOption.IsSet)
                writer.WriteBoolean("residential", shipmentInternationalFromAddress.ResidentialOption.Value.Value);

            if (shipmentInternationalFromAddress.TaxIdOption.IsSet)
                writer.WriteString("taxId", shipmentInternationalFromAddress.TaxId);

            var taxIdTypeRawValue = ShipmentInternationalFromAddress.TaxIdTypeEnumToJsonValue(shipmentInternationalFromAddress.TaxIdTypeOption.Value.Value);
