...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    [DataContract(Name = "domesticShipmentResponse")]
    public partial class DomesticShipmentResponse : IValidatableObject
    {
        ...
        public DomesticShipmentResponse(string correlationId = default(string), List<DomesticShipmentResponseLabelLayoutInner> labelLayout = default(List<DomesticShipmentResponseLabelLayoutInner>), DomesticShipmentResponseFromAddress fromAddress = default(DomesticShipmentResponseFromAddress), ShipmentDomesticParcel parcel = default(ShipmentDomesticParcel), string parcelId = default(string), string parcelTrackingNumber = default(string), DomesticShipmentResponseRate rate = default(DomesticShipmentResponseRate), string shipmentId = default(string), ShipmentOptionsV2 shipmentOptions = default(ShipmentOptionsV2), DomesticShipmentResponseToAddress toAddress = default(DomesticShipmentResponseToAddress))
        {
        ...
        public DomesticShipmentResponseFromAddress FromAddress { get; set; }
        ...
        public DomesticShipmentResponseRate Rate { get; set; }
        ...
        public DomesticShipmentResponseToAddress ToAddress { get; set; }
