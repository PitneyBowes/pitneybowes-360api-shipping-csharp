...
{
    /// <summary>
    /// MultipieceShipmentInternationalRequestFromAddress
    /// </summary>
    public partial class MultipieceShipmentInternationalRequestFromAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MultipieceShipmentInternationalRequestFromAddress" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public MultipieceShipmentInternationalRequestFromAddress(string addressLine1, string countryCode, string postalCode, string stateProvince, Option<string> addressLine2 = default, Option<string> addressLine3 = default, Option<string> cityTown = default, Option<string> company = default, Option<string> email = default, Option<string> name = default, Option<string> phone = default, Option<bool?> residential = default, Option<string> taxId = default, Option<TaxIdTypeEnum?> taxIdType = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MultipieceShipmentInternationalRequestFromAddress {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="MultipieceShipmentInternationalRequestFromAddress" />
    /// </summary>
    public class MultipieceShipmentInternationalRequestFromAddressJsonConverter : JsonConverter<MultipieceShipmentInternationalRequestFromAddress>
    {
        /// <summary>
        /// Deserializes json to <see cref="MultipieceShipmentInternationalRequestFromAddress" />
        /// </summary>
        ...
        public override MultipieceShipmentInternationalRequestFromAddress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<MultipieceShipmentInternationalRequestFromAddress.TaxIdTypeEnum?> taxIdType = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "taxIdType":
                            ...
                            if (taxIdTypeRawValue != null)
                                taxIdType = new Option<MultipieceShipmentInternationalRequestFromAddress.TaxIdTypeEnum?>(MultipieceShipmentInternationalRequestFromAddress.TaxIdTypeEnumFromStringOrDefault(taxIdTypeRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            if (!addressLine1.IsSet)
                throw new ArgumentException("Property is required for class MultipieceShipmentInternationalRequestFromAddress.", nameof(addressLine1));

            if (!countryCode.IsSet)
                throw new ArgumentException("Property is required for class MultipieceShipmentInternationalRequestFromAddress.", nameof(countryCode));

            if (!postalCode.IsSet)
                throw new ArgumentException("Property is required for class MultipieceShipmentInternationalRequestFromAddress.", nameof(postalCode));

            if (!stateProvince.IsSet)
                throw new ArgumentException("Property is required for class MultipieceShipmentInternationalRequestFromAddress.", nameof(stateProvince));

            if (addressLine1.IsSet && addressLine1.Value == null)
                throw new ArgumentNullException(nameof(addressLine1), "Property is not nullable for class MultipieceShipmentInternationalRequestFromAddress.");

            if (countryCode.IsSet && countryCode.Value == null)
                throw new ArgumentNullException(nameof(countryCode), "Property is not nullable for class MultipieceShipmentInternationalRequestFromAddress.");

            if (postalCode.IsSet && postalCode.Value == null)
                throw new ArgumentNullException(nameof(postalCode), "Property is not nullable for class MultipieceShipmentInternationalRequestFromAddress.");

            if (stateProvince.IsSet && stateProvince.Value == null)
                throw new ArgumentNullException(nameof(stateProvince), "Property is not nullable for class MultipieceShipmentInternationalRequestFromAddress.");

            if (addressLine2.IsSet && addressLine2.Value == null)
                throw new ArgumentNullException(nameof(addressLine2), "Property is not nullable for class MultipieceShipmentInternationalRequestFromAddress.");

            if (addressLine3.IsSet && addressLine3.Value == null)
                throw new ArgumentNullException(nameof(addressLine3), "Property is not nullable for class MultipieceShipmentInternationalRequestFromAddress.");

            if (cityTown.IsSet && cityTown.Value == null)
                throw new ArgumentNullException(nameof(cityTown), "Property is not nullable for class MultipieceShipmentInternationalRequestFromAddress.");

            if (company.IsSet && company.Value == null)
                throw new ArgumentNullException(nameof(company), "Property is not nullable for class MultipieceShipmentInternationalRequestFromAddress.");

            if (email.IsSet && email.Value == null)
                throw new ArgumentNullException(nameof(email), "Property is not nullable for class MultipieceShipmentInternationalRequestFromAddress.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class MultipieceShipmentInternationalRequestFromAddress.");

            if (phone.IsSet && phone.Value == null)
                throw new ArgumentNullException(nameof(phone), "Property is not nullable for class MultipieceShipmentInternationalRequestFromAddress.");

            if (residential.IsSet && residential.Value == null)
                throw new ArgumentNullException(nameof(residential), "Property is not nullable for class MultipieceShipmentInternationalRequestFromAddress.");

            if (taxId.IsSet && taxId.Value == null)
                throw new ArgumentNullException(nameof(taxId), "Property is not nullable for class MultipieceShipmentInternationalRequestFromAddress.");

            if (taxIdType.IsSet && taxIdType.Value == null)
                throw new ArgumentNullException(nameof(taxIdType), "Property is not nullable for class MultipieceShipmentInternationalRequestFromAddress.");

            return new MultipieceShipmentInternationalRequestFromAddress(addressLine1.Value, countryCode.Value, postalCode.Value, stateProvince.Value, addressLine2, addressLine3, cityTown, company, email, name, phone, residential, taxId, taxIdType);
        }

        /// <summary>
        /// Serializes a <see cref="MultipieceShipmentInternationalRequestFromAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="multipieceShipmentInternationalRequestFromAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, MultipieceShipmentInternationalRequestFromAddress multipieceShipmentInternationalRequestFromAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, multipieceShipmentInternationalRequestFromAddress, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="MultipieceShipmentInternationalRequestFromAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="multipieceShipmentInternationalRequestFromAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, MultipieceShipmentInternationalRequestFromAddress multipieceShipmentInternationalRequestFromAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            if (multipieceShipmentInternationalRequestFromAddress.AddressLine1 == null)
                throw new ArgumentNullException(nameof(multipieceShipmentInternationalRequestFromAddress.AddressLine1), "Property is required for class MultipieceShipmentInternationalRequestFromAddress.");

            if (multipieceShipmentInternationalRequestFromAddress.CountryCode == null)
                throw new ArgumentNullException(nameof(multipieceShipmentInternationalRequestFromAddress.CountryCode), "Property is required for class MultipieceShipmentInternationalRequestFromAddress.");

            if (multipieceShipmentInternationalRequestFromAddress.PostalCode == null)
                throw new ArgumentNullException(nameof(multipieceShipmentInternationalRequestFromAddress.PostalCode), "Property is required for class MultipieceShipmentInternationalRequestFromAddress.");

            if (multipieceShipmentInternationalRequestFromAddress.StateProvince == null)
                throw new ArgumentNullException(nameof(multipieceShipmentInternationalRequestFromAddress.StateProvince), "Property is required for class MultipieceShipmentInternationalRequestFromAddress.");

            if (multipieceShipmentInternationalRequestFromAddress.AddressLine2Option.IsSet && multipieceShipmentInternationalRequestFromAddress.AddressLine2 == null)
                throw new ArgumentNullException(nameof(multipieceShipmentInternationalRequestFromAddress.AddressLine2), "Property is required for class MultipieceShipmentInternationalRequestFromAddress.");

            if (multipieceShipmentInternationalRequestFromAddress.AddressLine3Option.IsSet && multipieceShipmentInternationalRequestFromAddress.AddressLine3 == null)
                throw new ArgumentNullException(nameof(multipieceShipmentInternationalRequestFromAddress.AddressLine3), "Property is required for class MultipieceShipmentInternationalRequestFromAddress.");

            if (multipieceShipmentInternationalRequestFromAddress.CityTownOption.IsSet && multipieceShipmentInternationalRequestFromAddress.CityTown == null)
                throw new ArgumentNullException(nameof(multipieceShipmentInternationalRequestFromAddress.CityTown), "Property is required for class MultipieceShipmentInternationalRequestFromAddress.");

            if (multipieceShipmentInternationalRequestFromAddress.CompanyOption.IsSet && multipieceShipmentInternationalRequestFromAddress.Company == null)
                throw new ArgumentNullException(nameof(multipieceShipmentInternationalRequestFromAddress.Company), "Property is required for class MultipieceShipmentInternationalRequestFromAddress.");

            if (multipieceShipmentInternationalRequestFromAddress.EmailOption.IsSet && multipieceShipmentInternationalRequestFromAddress.Email == null)
                throw new ArgumentNullException(nameof(multipieceShipmentInternationalRequestFromAddress.Email), "Property is required for class MultipieceShipmentInternationalRequestFromAddress.");

            if (multipieceShipmentInternationalRequestFromAddress.NameOption.IsSet && multipieceShipmentInternationalRequestFromAddress.Name == null)
                throw new ArgumentNullException(nameof(multipieceShipmentInternationalRequestFromAddress.Name), "Property is required for class MultipieceShipmentInternationalRequestFromAddress.");

            if (multipieceShipmentInternationalRequestFromAddress.PhoneOption.IsSet && multipieceShipmentInternationalRequestFromAddress.Phone == null)
                throw new ArgumentNullException(nameof(multipieceShipmentInternationalRequestFromAddress.Phone), "Property is required for class MultipieceShipmentInternationalRequestFromAddress.");

            if (multipieceShipmentInternationalRequestFromAddress.TaxIdOption.IsSet && multipieceShipmentInternationalRequestFromAddress.TaxId == null)
                throw new ArgumentNullException(nameof(multipieceShipmentInternationalRequestFromAddress.TaxId), "Property is required for class MultipieceShipmentInternationalRequestFromAddress.");

            writer.WriteString("addressLine1", multipieceShipmentInternationalRequestFromAddress.AddressLine1);

            writer.WriteString("countryCode", multipieceShipmentInternationalRequestFromAddress.CountryCode);

            writer.WriteString("postalCode", multipieceShipmentInternationalRequestFromAddress.PostalCode);

            writer.WriteString("stateProvince", multipieceShipmentInternationalRequestFromAddress.StateProvince);

            if (multipieceShipmentInternationalRequestFromAddress.AddressLine2Option.IsSet)
                writer.WriteString("addressLine2", multipieceShipmentInternationalRequestFromAddress.AddressLine2);

            if (multipieceShipmentInternationalRequestFromAddress.AddressLine3Option.IsSet)
                writer.WriteString("addressLine3", multipieceShipmentInternationalRequestFromAddress.AddressLine3);

            if (multipieceShipmentInternationalRequestFromAddress.CityTownOption.IsSet)
                writer.WriteString("cityTown", multipieceShipmentInternationalRequestFromAddress.CityTown);

            if (multipieceShipmentInternationalRequestFromAddress.CompanyOption.IsSet)
                writer.WriteString("company", multipieceShipmentInternationalRequestFromAddress.Company);

            if (multipieceShipmentInternationalRequestFromAddress.EmailOption.IsSet)
                writer.WriteString("email", multipieceShipmentInternationalRequestFromAddress.Email);

            if (multipieceShipmentInternationalRequestFromAddress.NameOption.IsSet)
                writer.WriteString("name", multipieceShipmentInternationalRequestFromAddress.Name);

            if (multipieceShipmentInternationalRequestFromAddress.PhoneOption.IsSet)
                writer.WriteString("phone", multipieceShipmentInternationalRequestFromAddress.Phone);

            if (multipieceShipmentInternationalRequestFromAddress.ResidentialOption.IsSet)
                writer.WriteBoolean("residential", multipieceShipmentInternationalRequestFromAddress.ResidentialOption.Value.Value);

            if (multipieceShipmentInternationalRequestFromAddress.TaxIdOption.IsSet)
                writer.WriteString("taxId", multipieceShipmentInternationalRequestFromAddress.TaxId);

            var taxIdTypeRawValue = MultipieceShipmentInternationalRequestFromAddress.TaxIdTypeEnumToJsonValue(multipieceShipmentInternationalRequestFromAddress.TaxIdTypeOption.Value.Value);
