...
namespace com.pitneybowes.api360.Model
{
    ...
    public partial class ShipmentDomestic : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="size">Defines the label size of the Shipment, e.g., Shipping Label having Doc Size (4&#39; X 6&#39; or 8.5&#39; X 11&#39;). RMG b2b shipment support only 4x6 and 8x11 label sizes.</param>
        ...
        [JsonConstructor]
        public ShipmentDomestic(SizeEnum size, TypeEnum type, ShipmentDomesticFromAddress fromAddress, ShipmentDomesticParcel parcel, string carrierAccountId, string parcelType, string serviceId, ShipmentDomesticToAddress toAddress, Option<FormatEnum?> format = default, Option<ContentTypeEnum?> contentType = default, Option<DateTime?> dateOfShipment = default, Option<ShipmentDomesticAltReturnAddress> altReturnAddress = default, Option<List<SpecialService>> specialServices = default, Option<ShipmentDomesticShipmentOptions> shipmentOptions = default, Option<ShipmentDomesticDocTab> docTab = default, Option<List<CarrierPaymentsInner>> carrierPayments = default, Option<List<ShipmentDomesticMetadataInner>> metadata = default, Option<SoldToAddress> soldToAddress = default, Option<List<AdditionalAddressesInner>> additionalAddresses = default, Option<ShipmentDomesticCustoms> customs = default)
        {
            Size = size;
            Type = type;
        ...
        /// <summary>
        /// Defines the label size of the Shipment, e.g., Shipping Label having Doc Size (4&#39; X 6&#39; or 8.5&#39; X 11&#39;). RMG b2b shipment support only 4x6 and 8x11 label sizes.
        /// </summary>
        /// <value>Defines the label size of the Shipment, e.g., Shipping Label having Doc Size (4&#39; X 6&#39; or 8.5&#39; X 11&#39;). RMG b2b shipment support only 4x6 and 8x11 label sizes.</value>
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<ShipmentDomesticAltReturnAddress> AltReturnAddressOption { get; private set; }

        /// <summary>
        /// Gets or Sets AltReturnAddress
        /// </summary>
        [JsonPropertyName("altReturnAddress")]
        public ShipmentDomesticAltReturnAddress AltReturnAddress { get { return this.AltReturnAddressOption; } set { this.AltReturnAddressOption = new Option<ShipmentDomesticAltReturnAddress>(value); } }
        ...
        public ShipmentDomesticShipmentOptions ShipmentOptions { get { return this.ShipmentOptionsOption; } set { this.ShipmentOptionsOption = new Option<ShipmentDomesticShipmentOptions>(value); } }
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<ShipmentDomesticDocTab> DocTabOption { get; private set; }

        /// <summary>
        /// Gets or Sets DocTab
        /// </summary>
        [JsonPropertyName("docTab")]
        public ShipmentDomesticDocTab DocTab { get { return this.DocTabOption; } set { this.DocTabOption = new Option<ShipmentDomesticDocTab>(value); } }
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<ShipmentDomesticCustoms> CustomsOption { get; private set; }

        /// <summary>
        /// Gets or Sets Customs
        /// </summary>
        [JsonPropertyName("customs")]
        public ShipmentDomesticCustoms Customs { get { return this.CustomsOption; } set { this.CustomsOption = new Option<ShipmentDomesticCustoms>(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="ShipmentDomestic" />
    /// </summary>
    public class ShipmentDomesticJsonConverter : JsonConverter<ShipmentDomestic>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="ShipmentDomestic" />
        /// </summary>
        ...
        public override ShipmentDomestic Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<ShipmentDomestic.SizeEnum?> size = default;
            Option<ShipmentDomestic.TypeEnum?> type = default;
            Option<ShipmentDomesticFromAddress> fromAddress = default;
            ...
            Option<ShipmentDomesticToAddress> toAddress = default;
            Option<ShipmentDomestic.FormatEnum?> format = default;
            Option<ShipmentDomestic.ContentTypeEnum?> contentType = default;
            Option<DateTime?> dateOfShipment = default;
            Option<ShipmentDomesticAltReturnAddress> altReturnAddress = default;
            Option<List<SpecialService>> specialServices = default;
            Option<ShipmentDomesticShipmentOptions> shipmentOptions = default;
            Option<ShipmentDomesticDocTab> docTab = default;
            ...
            Option<ShipmentDomesticCustoms> customs = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "size":
                            ...
                            if (sizeRawValue != null)
                                size = new Option<ShipmentDomestic.SizeEnum?>(ShipmentDomestic.SizeEnumFromStringOrDefault(sizeRawValue));
                            break;
                        case "type":
                            string typeRawValue = utf8JsonReader.GetString();
                            if (typeRawValue != null)
                                type = new Option<ShipmentDomestic.TypeEnum?>(ShipmentDomestic.TypeEnumFromStringOrDefault(typeRawValue));
                            break;
                        case "fromAddress":
                            fromAddress = new Option<ShipmentDomesticFromAddress>(JsonSerializer.Deserialize<ShipmentDomesticFromAddress>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "parcel":
                        ...
                        case "serviceId":
                            ...
                            break;
                        case "toAddress":
                            toAddress = new Option<ShipmentDomesticToAddress>(JsonSerializer.Deserialize<ShipmentDomesticToAddress>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "format":
                            string formatRawValue = utf8JsonReader.GetString();
                            if (formatRawValue != null)
                                format = new Option<ShipmentDomestic.FormatEnum?>(ShipmentDomestic.FormatEnumFromStringOrDefault(formatRawValue));
                            break;
                        case "contentType":
                            string contentTypeRawValue = utf8JsonReader.GetString();
                            if (contentTypeRawValue != null)
                                contentType = new Option<ShipmentDomestic.ContentTypeEnum?>(ShipmentDomestic.ContentTypeEnumFromStringOrDefault(contentTypeRawValue));
                            break;
                        case "dateOfShipment":
                        ...
                        case "altReturnAddress":
                            altReturnAddress = new Option<ShipmentDomesticAltReturnAddress>(JsonSerializer.Deserialize<ShipmentDomesticAltReturnAddress>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        ...
                        case "shipmentOptions":
                            ...
                            break;
                        case "docTab":
                            docTab = new Option<ShipmentDomesticDocTab>(JsonSerializer.Deserialize<ShipmentDomesticDocTab>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        ...
                        case "additionalAddresses":
                            ...
                            break;
                        case "customs":
                            customs = new Option<ShipmentDomesticCustoms>(JsonSerializer.Deserialize<ShipmentDomesticCustoms>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        default:
                            break;
                    }
            ...
            if (!size.IsSet)
                throw new ArgumentException("Property is required for class ShipmentDomestic.", nameof(size));

            if (!type.IsSet)
                throw new ArgumentException("Property is required for class ShipmentDomestic.", nameof(type));

            if (!fromAddress.IsSet)
                throw new ArgumentException("Property is required for class ShipmentDomestic.", nameof(fromAddress));

            if (!parcel.IsSet)
                throw new ArgumentException("Property is required for class ShipmentDomestic.", nameof(parcel));

            if (!carrierAccountId.IsSet)
                throw new ArgumentException("Property is required for class ShipmentDomestic.", nameof(carrierAccountId));

            if (!parcelType.IsSet)
                throw new ArgumentException("Property is required for class ShipmentDomestic.", nameof(parcelType));

            if (!serviceId.IsSet)
                throw new ArgumentException("Property is required for class ShipmentDomestic.", nameof(serviceId));

            if (!toAddress.IsSet)
                throw new ArgumentException("Property is required for class ShipmentDomestic.", nameof(toAddress));

            if (size.IsSet && size.Value == null)
                throw new ArgumentNullException(nameof(size), "Property is not nullable for class ShipmentDomestic.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class ShipmentDomestic.");

            if (fromAddress.IsSet && fromAddress.Value == null)
                throw new ArgumentNullException(nameof(fromAddress), "Property is not nullable for class ShipmentDomestic.");

            if (parcel.IsSet && parcel.Value == null)
                throw new ArgumentNullException(nameof(parcel), "Property is not nullable for class ShipmentDomestic.");

            if (carrierAccountId.IsSet && carrierAccountId.Value == null)
                throw new ArgumentNullException(nameof(carrierAccountId), "Property is not nullable for class ShipmentDomestic.");

            if (parcelType.IsSet && parcelType.Value == null)
                throw new ArgumentNullException(nameof(parcelType), "Property is not nullable for class ShipmentDomestic.");

            if (serviceId.IsSet && serviceId.Value == null)
                throw new ArgumentNullException(nameof(serviceId), "Property is not nullable for class ShipmentDomestic.");

            if (toAddress.IsSet && toAddress.Value == null)
                throw new ArgumentNullException(nameof(toAddress), "Property is not nullable for class ShipmentDomestic.");

            if (format.IsSet && format.Value == null)
                throw new ArgumentNullException(nameof(format), "Property is not nullable for class ShipmentDomestic.");

            if (contentType.IsSet && contentType.Value == null)
                throw new ArgumentNullException(nameof(contentType), "Property is not nullable for class ShipmentDomestic.");

            if (dateOfShipment.IsSet && dateOfShipment.Value == null)
                throw new ArgumentNullException(nameof(dateOfShipment), "Property is not nullable for class ShipmentDomestic.");

            if (altReturnAddress.IsSet && altReturnAddress.Value == null)
                throw new ArgumentNullException(nameof(altReturnAddress), "Property is not nullable for class ShipmentDomestic.");

            if (specialServices.IsSet && specialServices.Value == null)
                throw new ArgumentNullException(nameof(specialServices), "Property is not nullable for class ShipmentDomestic.");

            if (shipmentOptions.IsSet && shipmentOptions.Value == null)
                throw new ArgumentNullException(nameof(shipmentOptions), "Property is not nullable for class ShipmentDomestic.");

            if (docTab.IsSet && docTab.Value == null)
                throw new ArgumentNullException(nameof(docTab), "Property is not nullable for class ShipmentDomestic.");

            if (carrierPayments.IsSet && carrierPayments.Value == null)
                throw new ArgumentNullException(nameof(carrierPayments), "Property is not nullable for class ShipmentDomestic.");

            if (metadata.IsSet && metadata.Value == null)
                throw new ArgumentNullException(nameof(metadata), "Property is not nullable for class ShipmentDomestic.");

            if (soldToAddress.IsSet && soldToAddress.Value == null)
                throw new ArgumentNullException(nameof(soldToAddress), "Property is not nullable for class ShipmentDomestic.");

            if (additionalAddresses.IsSet && additionalAddresses.Value == null)
                throw new ArgumentNullException(nameof(additionalAddresses), "Property is not nullable for class ShipmentDomestic.");

            if (customs.IsSet && customs.Value == null)
                throw new ArgumentNullException(nameof(customs), "Property is not nullable for class ShipmentDomestic.");

            return new ShipmentDomestic(size.Value.Value, type.Value.Value, fromAddress.Value, parcel.Value, carrierAccountId.Value, parcelType.Value, serviceId.Value, toAddress.Value, format, contentType, dateOfShipment, altReturnAddress, specialServices, shipmentOptions, docTab, carrierPayments, metadata, soldToAddress, additionalAddresses, customs);
        }

        /// <summary>
        /// Serializes a <see cref="ShipmentDomestic" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="shipmentDomestic"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ShipmentDomestic shipmentDomestic, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, shipmentDomestic, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ShipmentDomestic" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="shipmentDomestic"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ShipmentDomestic shipmentDomestic, JsonSerializerOptions jsonSerializerOptions)
        {
            if (shipmentDomestic.FromAddress == null)
                throw new ArgumentNullException(nameof(shipmentDomestic.FromAddress), "Property is required for class ShipmentDomestic.");

            if (shipmentDomestic.Parcel == null)
                throw new ArgumentNullException(nameof(shipmentDomestic.Parcel), "Property is required for class ShipmentDomestic.");

            if (shipmentDomestic.CarrierAccountId == null)
                throw new ArgumentNullException(nameof(shipmentDomestic.CarrierAccountId), "Property is required for class ShipmentDomestic.");

            if (shipmentDomestic.ParcelType == null)
                throw new ArgumentNullException(nameof(shipmentDomestic.ParcelType), "Property is required for class ShipmentDomestic.");

            if (shipmentDomestic.ServiceId == null)
                throw new ArgumentNullException(nameof(shipmentDomestic.ServiceId), "Property is required for class ShipmentDomestic.");

            if (shipmentDomestic.ToAddress == null)
                throw new ArgumentNullException(nameof(shipmentDomestic.ToAddress), "Property is required for class ShipmentDomestic.");

            if (shipmentDomestic.AltReturnAddressOption.IsSet && shipmentDomestic.AltReturnAddress == null)
                throw new ArgumentNullException(nameof(shipmentDomestic.AltReturnAddress), "Property is required for class ShipmentDomestic.");

            if (shipmentDomestic.SpecialServicesOption.IsSet && shipmentDomestic.SpecialServices == null)
                throw new ArgumentNullException(nameof(shipmentDomestic.SpecialServices), "Property is required for class ShipmentDomestic.");

            if (shipmentDomestic.ShipmentOptionsOption.IsSet && shipmentDomestic.ShipmentOptions == null)
                throw new ArgumentNullException(nameof(shipmentDomestic.ShipmentOptions), "Property is required for class ShipmentDomestic.");

            if (shipmentDomestic.DocTabOption.IsSet && shipmentDomestic.DocTab == null)
                throw new ArgumentNullException(nameof(shipmentDomestic.DocTab), "Property is required for class ShipmentDomestic.");

            if (shipmentDomestic.CarrierPaymentsOption.IsSet && shipmentDomestic.CarrierPayments == null)
                throw new ArgumentNullException(nameof(shipmentDomestic.CarrierPayments), "Property is required for class ShipmentDomestic.");

            if (shipmentDomestic.MetadataOption.IsSet && shipmentDomestic.Metadata == null)
                throw new ArgumentNullException(nameof(shipmentDomestic.Metadata), "Property is required for class ShipmentDomestic.");

            if (shipmentDomestic.SoldToAddressOption.IsSet && shipmentDomestic.SoldToAddress == null)
                throw new ArgumentNullException(nameof(shipmentDomestic.SoldToAddress), "Property is required for class ShipmentDomestic.");

            if (shipmentDomestic.AdditionalAddressesOption.IsSet && shipmentDomestic.AdditionalAddresses == null)
                throw new ArgumentNullException(nameof(shipmentDomestic.AdditionalAddresses), "Property is required for class ShipmentDomestic.");

            if (shipmentDomestic.CustomsOption.IsSet && shipmentDomestic.Customs == null)
                throw new ArgumentNullException(nameof(shipmentDomestic.Customs), "Property is required for class ShipmentDomestic.");

            var sizeRawValue = ShipmentDomestic.SizeEnumToJsonValue(shipmentDomestic.Size);
            writer.WriteString("size", sizeRawValue);
            var typeRawValue = ShipmentDomestic.TypeEnumToJsonValue(shipmentDomestic.Type);
            writer.WriteString("type", typeRawValue);
            writer.WritePropertyName("fromAddress");
            JsonSerializer.Serialize(writer, shipmentDomestic.FromAddress, jsonSerializerOptions);
            writer.WritePropertyName("parcel");
            JsonSerializer.Serialize(writer, shipmentDomestic.Parcel, jsonSerializerOptions);
            writer.WriteString("carrierAccountId", shipmentDomestic.CarrierAccountId);

            writer.WriteString("parcelType", shipmentDomestic.ParcelType);

            writer.WriteString("serviceId", shipmentDomestic.ServiceId);

            writer.WritePropertyName("toAddress");
            JsonSerializer.Serialize(writer, shipmentDomestic.ToAddress, jsonSerializerOptions);
            var formatRawValue = ShipmentDomestic.FormatEnumToJsonValue(shipmentDomestic.FormatOption.Value.Value);
            writer.WriteString("format", formatRawValue);
            var contentTypeRawValue = ShipmentDomestic.ContentTypeEnumToJsonValue(shipmentDomestic.ContentTypeOption.Value.Value);
            writer.WriteString("contentType", contentTypeRawValue);
            if (shipmentDomestic.DateOfShipmentOption.IsSet)
                writer.WriteString("dateOfShipment", shipmentDomestic.DateOfShipmentOption.Value.Value.ToString(DateOfShipmentFormat));

            if (shipmentDomestic.AltReturnAddressOption.IsSet)
            {
                writer.WritePropertyName("altReturnAddress");
                JsonSerializer.Serialize(writer, shipmentDomestic.AltReturnAddress, jsonSerializerOptions);
            }
            if (shipmentDomestic.SpecialServicesOption.IsSet)
            {
                writer.WritePropertyName("specialServices");
                JsonSerializer.Serialize(writer, shipmentDomestic.SpecialServices, jsonSerializerOptions);
            }
            if (shipmentDomestic.ShipmentOptionsOption.IsSet)
            {
                writer.WritePropertyName("shipmentOptions");
                JsonSerializer.Serialize(writer, shipmentDomestic.ShipmentOptions, jsonSerializerOptions);
            }
            if (shipmentDomestic.DocTabOption.IsSet)
            {
                writer.WritePropertyName("docTab");
                JsonSerializer.Serialize(writer, shipmentDomestic.DocTab, jsonSerializerOptions);
            }
            if (shipmentDomestic.CarrierPaymentsOption.IsSet)
            {
                writer.WritePropertyName("carrierPayments");
                JsonSerializer.Serialize(writer, shipmentDomestic.CarrierPayments, jsonSerializerOptions);
            }
            if (shipmentDomestic.MetadataOption.IsSet)
            {
                writer.WritePropertyName("metadata");
                JsonSerializer.Serialize(writer, shipmentDomestic.Metadata, jsonSerializerOptions);
            }
            if (shipmentDomestic.SoldToAddressOption.IsSet)
            {
                writer.WritePropertyName("soldToAddress");
                JsonSerializer.Serialize(writer, shipmentDomestic.SoldToAddress, jsonSerializerOptions);
            }
            if (shipmentDomestic.AdditionalAddressesOption.IsSet)
            {
                writer.WritePropertyName("additionalAddresses");
                JsonSerializer.Serialize(writer, shipmentDomestic.AdditionalAddresses, jsonSerializerOptions);
            }
            if (shipmentDomestic.CustomsOption.IsSet)
            {
                writer.WritePropertyName("customs");
                JsonSerializer.Serialize(writer, shipmentDomestic.Customs, jsonSerializerOptions);
            }
        }
    }
}
