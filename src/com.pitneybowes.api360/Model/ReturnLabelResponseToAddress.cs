...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    public partial class ReturnLabelResponseToAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReturnLabelResponseToAddress" /> class.
        /// </summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="ReturnLabelResponseToAddress" />
    /// </summary>
    public class ReturnLabelResponseToAddressJsonConverter : JsonConverter<ReturnLabelResponseToAddress>
    {
        /// <summary>
        /// Deserializes json to <see cref="ReturnLabelResponseToAddress" />
        /// </summary>
        ...
        public override ReturnLabelResponseToAddress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!addressLine1.IsSet)
                throw new ArgumentException("Property is required for class ReturnLabelResponseToAddress.", nameof(addressLine1));

            if (addressLine1.IsSet && addressLine1.Value == null)
                throw new ArgumentNullException(nameof(addressLine1), "Property is not nullable for class ReturnLabelResponseToAddress.");

            if (addressLine2.IsSet && addressLine2.Value == null)
                throw new ArgumentNullException(nameof(addressLine2), "Property is not nullable for class ReturnLabelResponseToAddress.");

            if (addressLine3.IsSet && addressLine3.Value == null)
                throw new ArgumentNullException(nameof(addressLine3), "Property is not nullable for class ReturnLabelResponseToAddress.");

            if (company.IsSet && company.Value == null)
                throw new ArgumentNullException(nameof(company), "Property is not nullable for class ReturnLabelResponseToAddress.");

            if (email.IsSet && email.Value == null)
                throw new ArgumentNullException(nameof(email), "Property is not nullable for class ReturnLabelResponseToAddress.");

            if (cityTown.IsSet && cityTown.Value == null)
                throw new ArgumentNullException(nameof(cityTown), "Property is not nullable for class ReturnLabelResponseToAddress.");

            if (countryCode.IsSet && countryCode.Value == null)
                throw new ArgumentNullException(nameof(countryCode), "Property is not nullable for class ReturnLabelResponseToAddress.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class ReturnLabelResponseToAddress.");

            if (phone.IsSet && phone.Value == null)
                throw new ArgumentNullException(nameof(phone), "Property is not nullable for class ReturnLabelResponseToAddress.");

            if (postalCode.IsSet && postalCode.Value == null)
                throw new ArgumentNullException(nameof(postalCode), "Property is not nullable for class ReturnLabelResponseToAddress.");

            if (stateProvince.IsSet && stateProvince.Value == null)
                throw new ArgumentNullException(nameof(stateProvince), "Property is not nullable for class ReturnLabelResponseToAddress.");

            if (residential.IsSet && residential.Value == null)
                throw new ArgumentNullException(nameof(residential), "Property is not nullable for class ReturnLabelResponseToAddress.");

            return new ReturnLabelResponseToAddress(addressLine1.Value, addressLine2, addressLine3, company, email, cityTown, countryCode, name, phone, postalCode, stateProvince, residential);
        }

        /// <summary>
        /// Serializes a <see cref="ReturnLabelResponseToAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="returnLabelResponseToAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ReturnLabelResponseToAddress returnLabelResponseToAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, returnLabelResponseToAddress, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ReturnLabelResponseToAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="returnLabelResponseToAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ReturnLabelResponseToAddress returnLabelResponseToAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            if (returnLabelResponseToAddress.AddressLine1 == null)
                throw new ArgumentNullException(nameof(returnLabelResponseToAddress.AddressLine1), "Property is required for class ReturnLabelResponseToAddress.");

            if (returnLabelResponseToAddress.AddressLine2Option.IsSet && returnLabelResponseToAddress.AddressLine2 == null)
                throw new ArgumentNullException(nameof(returnLabelResponseToAddress.AddressLine2), "Property is required for class ReturnLabelResponseToAddress.");

            if (returnLabelResponseToAddress.AddressLine3Option.IsSet && returnLabelResponseToAddress.AddressLine3 == null)
                throw new ArgumentNullException(nameof(returnLabelResponseToAddress.AddressLine3), "Property is required for class ReturnLabelResponseToAddress.");

            if (returnLabelResponseToAddress.CompanyOption.IsSet && returnLabelResponseToAddress.Company == null)
                throw new ArgumentNullException(nameof(returnLabelResponseToAddress.Company), "Property is required for class ReturnLabelResponseToAddress.");

            if (returnLabelResponseToAddress.EmailOption.IsSet && returnLabelResponseToAddress.Email == null)
                throw new ArgumentNullException(nameof(returnLabelResponseToAddress.Email), "Property is required for class ReturnLabelResponseToAddress.");

            if (returnLabelResponseToAddress.CityTownOption.IsSet && returnLabelResponseToAddress.CityTown == null)
                throw new ArgumentNullException(nameof(returnLabelResponseToAddress.CityTown), "Property is required for class ReturnLabelResponseToAddress.");

            if (returnLabelResponseToAddress.CountryCodeOption.IsSet && returnLabelResponseToAddress.CountryCode == null)
                throw new ArgumentNullException(nameof(returnLabelResponseToAddress.CountryCode), "Property is required for class ReturnLabelResponseToAddress.");

            if (returnLabelResponseToAddress.NameOption.IsSet && returnLabelResponseToAddress.Name == null)
                throw new ArgumentNullException(nameof(returnLabelResponseToAddress.Name), "Property is required for class ReturnLabelResponseToAddress.");

            if (returnLabelResponseToAddress.PhoneOption.IsSet && returnLabelResponseToAddress.Phone == null)
                throw new ArgumentNullException(nameof(returnLabelResponseToAddress.Phone), "Property is required for class ReturnLabelResponseToAddress.");

            if (returnLabelResponseToAddress.PostalCodeOption.IsSet && returnLabelResponseToAddress.PostalCode == null)
                throw new ArgumentNullException(nameof(returnLabelResponseToAddress.PostalCode), "Property is required for class ReturnLabelResponseToAddress.");

            if (returnLabelResponseToAddress.StateProvinceOption.IsSet && returnLabelResponseToAddress.StateProvince == null)
                throw new ArgumentNullException(nameof(returnLabelResponseToAddress.StateProvince), "Property is required for class ReturnLabelResponseToAddress.");

            writer.WriteString("addressLine1", returnLabelResponseToAddress.AddressLine1);

            if (returnLabelResponseToAddress.AddressLine2Option.IsSet)
                writer.WriteString("addressLine2", returnLabelResponseToAddress.AddressLine2);

            if (returnLabelResponseToAddress.AddressLine3Option.IsSet)
                writer.WriteString("addressLine3", returnLabelResponseToAddress.AddressLine3);

            if (returnLabelResponseToAddress.CompanyOption.IsSet)
                writer.WriteString("company", returnLabelResponseToAddress.Company);

            if (returnLabelResponseToAddress.EmailOption.IsSet)
                writer.WriteString("email", returnLabelResponseToAddress.Email);

            if (returnLabelResponseToAddress.CityTownOption.IsSet)
                writer.WriteString("cityTown", returnLabelResponseToAddress.CityTown);

            if (returnLabelResponseToAddress.CountryCodeOption.IsSet)
                writer.WriteString("countryCode", returnLabelResponseToAddress.CountryCode);

            if (returnLabelResponseToAddress.NameOption.IsSet)
                writer.WriteString("name", returnLabelResponseToAddress.Name);

            if (returnLabelResponseToAddress.PhoneOption.IsSet)
                writer.WriteString("phone", returnLabelResponseToAddress.Phone);

            if (returnLabelResponseToAddress.PostalCodeOption.IsSet)
                writer.WriteString("postalCode", returnLabelResponseToAddress.PostalCode);

            if (returnLabelResponseToAddress.StateProvinceOption.IsSet)
                writer.WriteString("stateProvince", returnLabelResponseToAddress.StateProvince);

            if (returnLabelResponseToAddress.ResidentialOption.IsSet)
                writer.WriteBoolean("residential", returnLabelResponseToAddress.ResidentialOption.Value.Value);
        }
    }
}
