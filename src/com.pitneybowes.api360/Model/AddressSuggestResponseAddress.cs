...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    [DataContract(Name = "addressSuggestResponse_address")]
    public partial class AddressSuggestResponseAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddressSuggestResponseAddress" /> class.
        /// </summary>
        ...
        public AddressSuggestResponseAddress(string addressLine1 = default(string), string addressLine2 = default(string), string addressLine3 = default(string), string cityTown = default(string), string countryCode = default(string), string name = default(string), string postalCode = default(string), bool residential = default(bool), string stateProvince = default(string), string status = default(string))
        {
        ...
        /// Gets or Sets Status
        /// </summary>
        /// <example>VALIDATED_CHANGE</example>
