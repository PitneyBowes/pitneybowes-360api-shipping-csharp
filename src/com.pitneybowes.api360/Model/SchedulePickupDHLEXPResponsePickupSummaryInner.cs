...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    [DataContract(Name = "schedulePickupDHLEXPResponse_pickupSummary_inner")]
    public partial class SchedulePickupDHLEXPResponsePickupSummaryInner : IValidatableObject
    {
        ...
        public SchedulePickupDHLEXPResponsePickupSummaryInner(string serviceId = default(string), decimal packageCount = default(decimal), decimal totalWeight = default(decimal), string weightUnit = default(string), string currencyCode = default(string), string totalCustomsDeclaredValue = default(string))
        {
        ...
        public string TotalCustomsDeclaredValue { get; set; }
