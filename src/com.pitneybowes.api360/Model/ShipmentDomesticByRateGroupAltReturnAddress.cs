...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    public partial class ShipmentDomesticByRateGroupAltReturnAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShipmentDomesticByRateGroupAltReturnAddress" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShipmentDomesticByRateGroupAltReturnAddress {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="ShipmentDomesticByRateGroupAltReturnAddress" />
    /// </summary>
    public class ShipmentDomesticByRateGroupAltReturnAddressJsonConverter : JsonConverter<ShipmentDomesticByRateGroupAltReturnAddress>
    {
        /// <summary>
        /// Deserializes json to <see cref="ShipmentDomesticByRateGroupAltReturnAddress" />
        /// </summary>
        ...
        public override ShipmentDomesticByRateGroupAltReturnAddress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (addressLine1.IsSet && addressLine1.Value == null)
                throw new ArgumentNullException(nameof(addressLine1), "Property is not nullable for class ShipmentDomesticByRateGroupAltReturnAddress.");

            if (addressLine2.IsSet && addressLine2.Value == null)
                throw new ArgumentNullException(nameof(addressLine2), "Property is not nullable for class ShipmentDomesticByRateGroupAltReturnAddress.");

            if (addressLine3.IsSet && addressLine3.Value == null)
                throw new ArgumentNullException(nameof(addressLine3), "Property is not nullable for class ShipmentDomesticByRateGroupAltReturnAddress.");

            if (company.IsSet && company.Value == null)
                throw new ArgumentNullException(nameof(company), "Property is not nullable for class ShipmentDomesticByRateGroupAltReturnAddress.");

            if (email.IsSet && email.Value == null)
                throw new ArgumentNullException(nameof(email), "Property is not nullable for class ShipmentDomesticByRateGroupAltReturnAddress.");

            if (residential.IsSet && residential.Value == null)
                throw new ArgumentNullException(nameof(residential), "Property is not nullable for class ShipmentDomesticByRateGroupAltReturnAddress.");

            if (cityTown.IsSet && cityTown.Value == null)
                throw new ArgumentNullException(nameof(cityTown), "Property is not nullable for class ShipmentDomesticByRateGroupAltReturnAddress.");

            if (countryCode.IsSet && countryCode.Value == null)
                throw new ArgumentNullException(nameof(countryCode), "Property is not nullable for class ShipmentDomesticByRateGroupAltReturnAddress.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class ShipmentDomesticByRateGroupAltReturnAddress.");

            if (phone.IsSet && phone.Value == null)
                throw new ArgumentNullException(nameof(phone), "Property is not nullable for class ShipmentDomesticByRateGroupAltReturnAddress.");

            if (postalCode.IsSet && postalCode.Value == null)
                throw new ArgumentNullException(nameof(postalCode), "Property is not nullable for class ShipmentDomesticByRateGroupAltReturnAddress.");

            if (stateProvince.IsSet && stateProvince.Value == null)
                throw new ArgumentNullException(nameof(stateProvince), "Property is not nullable for class ShipmentDomesticByRateGroupAltReturnAddress.");

            return new ShipmentDomesticByRateGroupAltReturnAddress(addressLine1, addressLine2, addressLine3, company, email, residential, cityTown, countryCode, name, phone, postalCode, stateProvince);
        }

        /// <summary>
        /// Serializes a <see cref="ShipmentDomesticByRateGroupAltReturnAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="shipmentDomesticByRateGroupAltReturnAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ShipmentDomesticByRateGroupAltReturnAddress shipmentDomesticByRateGroupAltReturnAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, shipmentDomesticByRateGroupAltReturnAddress, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ShipmentDomesticByRateGroupAltReturnAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="shipmentDomesticByRateGroupAltReturnAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ShipmentDomesticByRateGroupAltReturnAddress shipmentDomesticByRateGroupAltReturnAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            if (shipmentDomesticByRateGroupAltReturnAddress.AddressLine1Option.IsSet && shipmentDomesticByRateGroupAltReturnAddress.AddressLine1 == null)
                throw new ArgumentNullException(nameof(shipmentDomesticByRateGroupAltReturnAddress.AddressLine1), "Property is required for class ShipmentDomesticByRateGroupAltReturnAddress.");

            if (shipmentDomesticByRateGroupAltReturnAddress.AddressLine2Option.IsSet && shipmentDomesticByRateGroupAltReturnAddress.AddressLine2 == null)
                throw new ArgumentNullException(nameof(shipmentDomesticByRateGroupAltReturnAddress.AddressLine2), "Property is required for class ShipmentDomesticByRateGroupAltReturnAddress.");

            if (shipmentDomesticByRateGroupAltReturnAddress.AddressLine3Option.IsSet && shipmentDomesticByRateGroupAltReturnAddress.AddressLine3 == null)
                throw new ArgumentNullException(nameof(shipmentDomesticByRateGroupAltReturnAddress.AddressLine3), "Property is required for class ShipmentDomesticByRateGroupAltReturnAddress.");

            if (shipmentDomesticByRateGroupAltReturnAddress.CompanyOption.IsSet && shipmentDomesticByRateGroupAltReturnAddress.Company == null)
                throw new ArgumentNullException(nameof(shipmentDomesticByRateGroupAltReturnAddress.Company), "Property is required for class ShipmentDomesticByRateGroupAltReturnAddress.");

            if (shipmentDomesticByRateGroupAltReturnAddress.EmailOption.IsSet && shipmentDomesticByRateGroupAltReturnAddress.Email == null)
                throw new ArgumentNullException(nameof(shipmentDomesticByRateGroupAltReturnAddress.Email), "Property is required for class ShipmentDomesticByRateGroupAltReturnAddress.");

            if (shipmentDomesticByRateGroupAltReturnAddress.CityTownOption.IsSet && shipmentDomesticByRateGroupAltReturnAddress.CityTown == null)
                throw new ArgumentNullException(nameof(shipmentDomesticByRateGroupAltReturnAddress.CityTown), "Property is required for class ShipmentDomesticByRateGroupAltReturnAddress.");

            if (shipmentDomesticByRateGroupAltReturnAddress.CountryCodeOption.IsSet && shipmentDomesticByRateGroupAltReturnAddress.CountryCode == null)
                throw new ArgumentNullException(nameof(shipmentDomesticByRateGroupAltReturnAddress.CountryCode), "Property is required for class ShipmentDomesticByRateGroupAltReturnAddress.");

            if (shipmentDomesticByRateGroupAltReturnAddress.NameOption.IsSet && shipmentDomesticByRateGroupAltReturnAddress.Name == null)
                throw new ArgumentNullException(nameof(shipmentDomesticByRateGroupAltReturnAddress.Name), "Property is required for class ShipmentDomesticByRateGroupAltReturnAddress.");

            if (shipmentDomesticByRateGroupAltReturnAddress.PhoneOption.IsSet && shipmentDomesticByRateGroupAltReturnAddress.Phone == null)
                throw new ArgumentNullException(nameof(shipmentDomesticByRateGroupAltReturnAddress.Phone), "Property is required for class ShipmentDomesticByRateGroupAltReturnAddress.");

            if (shipmentDomesticByRateGroupAltReturnAddress.PostalCodeOption.IsSet && shipmentDomesticByRateGroupAltReturnAddress.PostalCode == null)
                throw new ArgumentNullException(nameof(shipmentDomesticByRateGroupAltReturnAddress.PostalCode), "Property is required for class ShipmentDomesticByRateGroupAltReturnAddress.");

            if (shipmentDomesticByRateGroupAltReturnAddress.StateProvinceOption.IsSet && shipmentDomesticByRateGroupAltReturnAddress.StateProvince == null)
                throw new ArgumentNullException(nameof(shipmentDomesticByRateGroupAltReturnAddress.StateProvince), "Property is required for class ShipmentDomesticByRateGroupAltReturnAddress.");

            if (shipmentDomesticByRateGroupAltReturnAddress.AddressLine1Option.IsSet)
                writer.WriteString("addressLine1", shipmentDomesticByRateGroupAltReturnAddress.AddressLine1);

            if (shipmentDomesticByRateGroupAltReturnAddress.AddressLine2Option.IsSet)
                writer.WriteString("addressLine2", shipmentDomesticByRateGroupAltReturnAddress.AddressLine2);

            if (shipmentDomesticByRateGroupAltReturnAddress.AddressLine3Option.IsSet)
                writer.WriteString("addressLine3", shipmentDomesticByRateGroupAltReturnAddress.AddressLine3);

            if (shipmentDomesticByRateGroupAltReturnAddress.CompanyOption.IsSet)
                writer.WriteString("company", shipmentDomesticByRateGroupAltReturnAddress.Company);

            if (shipmentDomesticByRateGroupAltReturnAddress.EmailOption.IsSet)
                writer.WriteString("email", shipmentDomesticByRateGroupAltReturnAddress.Email);

            if (shipmentDomesticByRateGroupAltReturnAddress.ResidentialOption.IsSet)
                writer.WriteBoolean("residential", shipmentDomesticByRateGroupAltReturnAddress.ResidentialOption.Value!.Value);

            if (shipmentDomesticByRateGroupAltReturnAddress.CityTownOption.IsSet)
                writer.WriteString("cityTown", shipmentDomesticByRateGroupAltReturnAddress.CityTown);

            if (shipmentDomesticByRateGroupAltReturnAddress.CountryCodeOption.IsSet)
                writer.WriteString("countryCode", shipmentDomesticByRateGroupAltReturnAddress.CountryCode);

            if (shipmentDomesticByRateGroupAltReturnAddress.NameOption.IsSet)
                writer.WriteString("name", shipmentDomesticByRateGroupAltReturnAddress.Name);

            if (shipmentDomesticByRateGroupAltReturnAddress.PhoneOption.IsSet)
                writer.WriteString("phone", shipmentDomesticByRateGroupAltReturnAddress.Phone);

            if (shipmentDomesticByRateGroupAltReturnAddress.PostalCodeOption.IsSet)
                writer.WriteString("postalCode", shipmentDomesticByRateGroupAltReturnAddress.PostalCode);

            if (shipmentDomesticByRateGroupAltReturnAddress.StateProvinceOption.IsSet)
                writer.WriteString("stateProvince", shipmentDomesticByRateGroupAltReturnAddress.StateProvince);
        }
    }
}
