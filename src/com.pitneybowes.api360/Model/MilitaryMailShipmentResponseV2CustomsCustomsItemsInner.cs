...
{
    /// <summary>
    /// MilitaryMailShipmentResponseV2CustomsCustomsItemsInner
    /// </summary>
    public partial class MilitaryMailShipmentResponseV2CustomsCustomsItemsInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MilitaryMailShipmentResponseV2CustomsCustomsItemsInner" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MilitaryMailShipmentResponseV2CustomsCustomsItemsInner {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="MilitaryMailShipmentResponseV2CustomsCustomsItemsInner" />
    /// </summary>
    public class MilitaryMailShipmentResponseV2CustomsCustomsItemsInnerJsonConverter : JsonConverter<MilitaryMailShipmentResponseV2CustomsCustomsItemsInner>
    {
        /// <summary>
        /// Deserializes json to <see cref="MilitaryMailShipmentResponseV2CustomsCustomsItemsInner" />
        /// </summary>
        ...
        public override MilitaryMailShipmentResponseV2CustomsCustomsItemsInner Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<MilitaryMailShipmentResponseV2CustomsCustomsItemsInner.WeightUnitEnum?> weightUnit = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "weightUnit":
                            ...
                            if (weightUnitRawValue != null)
                                weightUnit = new Option<MilitaryMailShipmentResponseV2CustomsCustomsItemsInner.WeightUnitEnum?>(MilitaryMailShipmentResponseV2CustomsCustomsItemsInner.WeightUnitEnumFromStringOrDefault(weightUnitRawValue));
                            break;
                        case "weight":
            ...
            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class MilitaryMailShipmentResponseV2CustomsCustomsItemsInner.");

            if (hSTariffCode.IsSet && hSTariffCode.Value == null)
                throw new ArgumentNullException(nameof(hSTariffCode), "Property is not nullable for class MilitaryMailShipmentResponseV2CustomsCustomsItemsInner.");

            if (originCountryCode.IsSet && originCountryCode.Value == null)
                throw new ArgumentNullException(nameof(originCountryCode), "Property is not nullable for class MilitaryMailShipmentResponseV2CustomsCustomsItemsInner.");

            if (quantity.IsSet && quantity.Value == null)
                throw new ArgumentNullException(nameof(quantity), "Property is not nullable for class MilitaryMailShipmentResponseV2CustomsCustomsItemsInner.");

            if (unitPrice.IsSet && unitPrice.Value == null)
                throw new ArgumentNullException(nameof(unitPrice), "Property is not nullable for class MilitaryMailShipmentResponseV2CustomsCustomsItemsInner.");

            if (weightUnit.IsSet && weightUnit.Value == null)
                throw new ArgumentNullException(nameof(weightUnit), "Property is not nullable for class MilitaryMailShipmentResponseV2CustomsCustomsItemsInner.");

            if (weight.IsSet && weight.Value == null)
                throw new ArgumentNullException(nameof(weight), "Property is not nullable for class MilitaryMailShipmentResponseV2CustomsCustomsItemsInner.");

            return new MilitaryMailShipmentResponseV2CustomsCustomsItemsInner(description, hSTariffCode, originCountryCode, quantity, unitPrice, weightUnit, weight);
        }

        /// <summary>
        /// Serializes a <see cref="MilitaryMailShipmentResponseV2CustomsCustomsItemsInner" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="militaryMailShipmentResponseV2CustomsCustomsItemsInner"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, MilitaryMailShipmentResponseV2CustomsCustomsItemsInner militaryMailShipmentResponseV2CustomsCustomsItemsInner, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, militaryMailShipmentResponseV2CustomsCustomsItemsInner, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="MilitaryMailShipmentResponseV2CustomsCustomsItemsInner" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="militaryMailShipmentResponseV2CustomsCustomsItemsInner"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, MilitaryMailShipmentResponseV2CustomsCustomsItemsInner militaryMailShipmentResponseV2CustomsCustomsItemsInner, JsonSerializerOptions jsonSerializerOptions)
        {
            if (militaryMailShipmentResponseV2CustomsCustomsItemsInner.DescriptionOption.IsSet && militaryMailShipmentResponseV2CustomsCustomsItemsInner.Description == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentResponseV2CustomsCustomsItemsInner.Description), "Property is required for class MilitaryMailShipmentResponseV2CustomsCustomsItemsInner.");

            if (militaryMailShipmentResponseV2CustomsCustomsItemsInner.HSTariffCodeOption.IsSet && militaryMailShipmentResponseV2CustomsCustomsItemsInner.HSTariffCode == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentResponseV2CustomsCustomsItemsInner.HSTariffCode), "Property is required for class MilitaryMailShipmentResponseV2CustomsCustomsItemsInner.");

            if (militaryMailShipmentResponseV2CustomsCustomsItemsInner.OriginCountryCodeOption.IsSet && militaryMailShipmentResponseV2CustomsCustomsItemsInner.OriginCountryCode == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentResponseV2CustomsCustomsItemsInner.OriginCountryCode), "Property is required for class MilitaryMailShipmentResponseV2CustomsCustomsItemsInner.");

            if (militaryMailShipmentResponseV2CustomsCustomsItemsInner.DescriptionOption.IsSet)
                writer.WriteString("description", militaryMailShipmentResponseV2CustomsCustomsItemsInner.Description);

            if (militaryMailShipmentResponseV2CustomsCustomsItemsInner.HSTariffCodeOption.IsSet)
            {
                writer.WritePropertyName("hSTariffCode");
                JsonSerializer.Serialize(writer, militaryMailShipmentResponseV2CustomsCustomsItemsInner.HSTariffCode, jsonSerializerOptions);
            }
            if (militaryMailShipmentResponseV2CustomsCustomsItemsInner.OriginCountryCodeOption.IsSet)
                writer.WriteString("originCountryCode", militaryMailShipmentResponseV2CustomsCustomsItemsInner.OriginCountryCode);

            if (militaryMailShipmentResponseV2CustomsCustomsItemsInner.QuantityOption.IsSet)
                writer.WriteNumber("quantity", militaryMailShipmentResponseV2CustomsCustomsItemsInner.QuantityOption.Value.Value);

            if (militaryMailShipmentResponseV2CustomsCustomsItemsInner.UnitPriceOption.IsSet)
                writer.WriteNumber("unitPrice", militaryMailShipmentResponseV2CustomsCustomsItemsInner.UnitPriceOption.Value.Value);

            var weightUnitRawValue = MilitaryMailShipmentResponseV2CustomsCustomsItemsInner.WeightUnitEnumToJsonValue(militaryMailShipmentResponseV2CustomsCustomsItemsInner.WeightUnitOption.Value.Value);
            writer.WriteString("weightUnit", weightUnitRawValue);
            if (militaryMailShipmentResponseV2CustomsCustomsItemsInner.WeightOption.IsSet)
                writer.WriteNumber("weight", militaryMailShipmentResponseV2CustomsCustomsItemsInner.WeightOption.Value.Value);
        }
    }
}
