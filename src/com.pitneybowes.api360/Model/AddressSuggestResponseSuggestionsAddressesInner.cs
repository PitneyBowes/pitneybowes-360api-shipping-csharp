...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    [DataContract(Name = "addressSuggestResponse_suggestions_addresses_inner")]
    public partial class AddressSuggestResponseSuggestionsAddressesInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddressSuggestResponseSuggestionsAddressesInner" /> class.
        /// </summary>
        ...
        public AddressSuggestResponseSuggestionsAddressesInner(string addressLine1 = default(string), string addressLine2 = default(string), string addressLine3 = default(string), string cityTown = default(string), string name = default(string), string postalCode = default(string), bool residential = default(bool), string stateProvince = default(string))
        {
