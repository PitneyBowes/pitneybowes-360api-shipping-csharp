...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    [DataContract(Name = "fromAddress")]
    public partial class FromAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FromAddress" /> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="FromAddress" /> class.
        /// </summary>
        /// <param name="name">The name of the Sender to which this address points.&lt;br /&gt; &#x60;Max length &#x3D; 40&#x60; (required).</param>
        /// <param name="addressLine1">The addressLine1 contains the Flat number, Building or Apartment Name/number (if any) or company name (if not residential) of the Sender. &lt;br /&gt; &#x60;Max length &#x3D; 40&#x60; (required).</param>
        ...
        /// <param name="phone">This is sender&#39;s phone number. Enter the digits with or without spaces or hyphens. &lt;br /&gt; &#x60;Max length &#x3D; 15&#x60;..</param>
        /// <param name="email">This must be sender&#39;s valid email. &lt;br /&gt; &#x60;Max length &#x3D; 50&#x60; .</param>
        ...
        public FromAddress(string name = default(string), string addressLine1 = default(string), string addressLine2 = default(string), string addressLine3 = default(string), string cityTown = default(string), string stateProvince = default(string), string postalCode = default(string), string countryCode = default(string), string company = default(string), string phone = default(string), string email = default(string), bool residential = default(bool))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for FromAddress and cannot be null");
            }
            this.Name = name;
            // to ensure "addressLine1" is required (not null)
            if (addressLine1 == null)
            {
                throw new ArgumentNullException("addressLine1 is a required property for FromAddress and cannot be null");
            }
            this.AddressLine1 = addressLine1;
            // to ensure "cityTown" is required (not null)
            if (cityTown == null)
            {
                throw new ArgumentNullException("cityTown is a required property for FromAddress and cannot be null");
            }
            this.CityTown = cityTown;
            // to ensure "stateProvince" is required (not null)
            if (stateProvince == null)
            {
                throw new ArgumentNullException("stateProvince is a required property for FromAddress and cannot be null");
            }
            this.StateProvince = stateProvince;
            // to ensure "postalCode" is required (not null)
            if (postalCode == null)
            {
                throw new ArgumentNullException("postalCode is a required property for FromAddress and cannot be null");
            }
            this.PostalCode = postalCode;
            // to ensure "countryCode" is required (not null)
            if (countryCode == null)
            {
                throw new ArgumentNullException("countryCode is a required property for FromAddress and cannot be null");
            }
        ...
        /// </summary>
        /// <value>The name of the Sender to which this address points.&lt;br /&gt; &#x60;Max length &#x3D; 40&#x60;</value>
        /// <example>Anupama</example>
        ...
        /// </summary>
        /// <value>The addressLine1 contains the Flat number, Building or Apartment Name/number (if any) or company name (if not residential) of the Sender. &lt;br /&gt; &#x60;Max length &#x3D; 40&#x60;</value>
        ...
        /// </summary>
        /// <value>This is sender&#39;s phone number. Enter the digits with or without spaces or hyphens. &lt;br /&gt; &#x60;Max length &#x3D; 15&#x60;.</value>
        ...
        /// </summary>
        /// <value>This must be sender&#39;s valid email. &lt;br /&gt; &#x60;Max length &#x3D; 50&#x60; </value>
