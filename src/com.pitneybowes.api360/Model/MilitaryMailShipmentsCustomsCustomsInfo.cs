...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    public partial class MilitaryMailShipmentsCustomsCustomsInfo : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MilitaryMailShipmentsCustomsCustomsInfo" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MilitaryMailShipmentsCustomsCustomsInfo {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="MilitaryMailShipmentsCustomsCustomsInfo" />
    /// </summary>
    public class MilitaryMailShipmentsCustomsCustomsInfoJsonConverter : JsonConverter<MilitaryMailShipmentsCustomsCustomsInfo>
    {
        /// <summary>
        /// Deserializes json to <see cref="MilitaryMailShipmentsCustomsCustomsInfo" />
        /// </summary>
        ...
        public override MilitaryMailShipmentsCustomsCustomsInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<MilitaryMailShipmentsCustomsCustomsInfo.ReasonForExportEnum?> reasonForExport = default;
            ...
            Option<MilitaryMailShipmentsCustomsCustomsInfo.TermsOfSaleEnum?> termsOfSale = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "reasonForExport":
                            ...
                            if (reasonForExportRawValue != null)
                                reasonForExport = new Option<MilitaryMailShipmentsCustomsCustomsInfo.ReasonForExportEnum?>(MilitaryMailShipmentsCustomsCustomsInfo.ReasonForExportEnumFromStringOrDefault(reasonForExportRawValue));
                            break;
                        ...
                        case "termsOfSale":
                            ...
                            if (termsOfSaleRawValue != null)
                                termsOfSale = new Option<MilitaryMailShipmentsCustomsCustomsInfo.TermsOfSaleEnum?>(MilitaryMailShipmentsCustomsCustomsInfo.TermsOfSaleEnumFromStringOrDefault(termsOfSaleRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            if (!reasonForExport.IsSet)
                throw new ArgumentException("Property is required for class MilitaryMailShipmentsCustomsCustomsInfo.", nameof(reasonForExport));

            if (!customsDeclaredValue.IsSet)
                throw new ArgumentException("Property is required for class MilitaryMailShipmentsCustomsCustomsInfo.", nameof(customsDeclaredValue));

            if (!currencyCode.IsSet)
                throw new ArgumentException("Property is required for class MilitaryMailShipmentsCustomsCustomsInfo.", nameof(currencyCode));

            if (reasonForExport.IsSet && reasonForExport.Value == null)
                throw new ArgumentNullException(nameof(reasonForExport), "Property is not nullable for class MilitaryMailShipmentsCustomsCustomsInfo.");

            if (customsDeclaredValue.IsSet && customsDeclaredValue.Value == null)
                throw new ArgumentNullException(nameof(customsDeclaredValue), "Property is not nullable for class MilitaryMailShipmentsCustomsCustomsInfo.");

            if (currencyCode.IsSet && currencyCode.Value == null)
                throw new ArgumentNullException(nameof(currencyCode), "Property is not nullable for class MilitaryMailShipmentsCustomsCustomsInfo.");

            if (eELPFC.IsSet && eELPFC.Value == null)
                throw new ArgumentNullException(nameof(eELPFC), "Property is not nullable for class MilitaryMailShipmentsCustomsCustomsInfo.");

            if (certificateNumber.IsSet && certificateNumber.Value == null)
                throw new ArgumentNullException(nameof(certificateNumber), "Property is not nullable for class MilitaryMailShipmentsCustomsCustomsInfo.");

            if (comments.IsSet && comments.Value == null)
                throw new ArgumentNullException(nameof(comments), "Property is not nullable for class MilitaryMailShipmentsCustomsCustomsInfo.");

            if (fromCustomsReference.IsSet && fromCustomsReference.Value == null)
                throw new ArgumentNullException(nameof(fromCustomsReference), "Property is not nullable for class MilitaryMailShipmentsCustomsCustomsInfo.");

            if (importerCustomsReference.IsSet && importerCustomsReference.Value == null)
                throw new ArgumentNullException(nameof(importerCustomsReference), "Property is not nullable for class MilitaryMailShipmentsCustomsCustomsInfo.");

            if (invoiceNumber.IsSet && invoiceNumber.Value == null)
                throw new ArgumentNullException(nameof(invoiceNumber), "Property is not nullable for class MilitaryMailShipmentsCustomsCustomsInfo.");

            if (licenseNumber.IsSet && licenseNumber.Value == null)
                throw new ArgumentNullException(nameof(licenseNumber), "Property is not nullable for class MilitaryMailShipmentsCustomsCustomsInfo.");

            if (sdrValue.IsSet && sdrValue.Value == null)
                throw new ArgumentNullException(nameof(sdrValue), "Property is not nullable for class MilitaryMailShipmentsCustomsCustomsInfo.");

            if (termsOfSale.IsSet && termsOfSale.Value == null)
                throw new ArgumentNullException(nameof(termsOfSale), "Property is not nullable for class MilitaryMailShipmentsCustomsCustomsInfo.");

            return new MilitaryMailShipmentsCustomsCustomsInfo(reasonForExport.Value.Value, customsDeclaredValue.Value.Value, currencyCode.Value, eELPFC, certificateNumber, comments, fromCustomsReference, importerCustomsReference, invoiceNumber, licenseNumber, sdrValue, termsOfSale);
        }

        /// <summary>
        /// Serializes a <see cref="MilitaryMailShipmentsCustomsCustomsInfo" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="militaryMailShipmentsCustomsCustomsInfo"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, MilitaryMailShipmentsCustomsCustomsInfo militaryMailShipmentsCustomsCustomsInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, militaryMailShipmentsCustomsCustomsInfo, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="MilitaryMailShipmentsCustomsCustomsInfo" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="militaryMailShipmentsCustomsCustomsInfo"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, MilitaryMailShipmentsCustomsCustomsInfo militaryMailShipmentsCustomsCustomsInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            if (militaryMailShipmentsCustomsCustomsInfo.CurrencyCode == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentsCustomsCustomsInfo.CurrencyCode), "Property is required for class MilitaryMailShipmentsCustomsCustomsInfo.");

            if (militaryMailShipmentsCustomsCustomsInfo.EELPFCOption.IsSet && militaryMailShipmentsCustomsCustomsInfo.EELPFC == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentsCustomsCustomsInfo.EELPFC), "Property is required for class MilitaryMailShipmentsCustomsCustomsInfo.");

            if (militaryMailShipmentsCustomsCustomsInfo.CertificateNumberOption.IsSet && militaryMailShipmentsCustomsCustomsInfo.CertificateNumber == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentsCustomsCustomsInfo.CertificateNumber), "Property is required for class MilitaryMailShipmentsCustomsCustomsInfo.");

            if (militaryMailShipmentsCustomsCustomsInfo.CommentsOption.IsSet && militaryMailShipmentsCustomsCustomsInfo.Comments == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentsCustomsCustomsInfo.Comments), "Property is required for class MilitaryMailShipmentsCustomsCustomsInfo.");

            if (militaryMailShipmentsCustomsCustomsInfo.FromCustomsReferenceOption.IsSet && militaryMailShipmentsCustomsCustomsInfo.FromCustomsReference == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentsCustomsCustomsInfo.FromCustomsReference), "Property is required for class MilitaryMailShipmentsCustomsCustomsInfo.");

            if (militaryMailShipmentsCustomsCustomsInfo.ImporterCustomsReferenceOption.IsSet && militaryMailShipmentsCustomsCustomsInfo.ImporterCustomsReference == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentsCustomsCustomsInfo.ImporterCustomsReference), "Property is required for class MilitaryMailShipmentsCustomsCustomsInfo.");

            if (militaryMailShipmentsCustomsCustomsInfo.InvoiceNumberOption.IsSet && militaryMailShipmentsCustomsCustomsInfo.InvoiceNumber == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentsCustomsCustomsInfo.InvoiceNumber), "Property is required for class MilitaryMailShipmentsCustomsCustomsInfo.");

            if (militaryMailShipmentsCustomsCustomsInfo.LicenseNumberOption.IsSet && militaryMailShipmentsCustomsCustomsInfo.LicenseNumber == null)
                throw new ArgumentNullException(nameof(militaryMailShipmentsCustomsCustomsInfo.LicenseNumber), "Property is required for class MilitaryMailShipmentsCustomsCustomsInfo.");

            var reasonForExportRawValue = MilitaryMailShipmentsCustomsCustomsInfo.ReasonForExportEnumToJsonValue(militaryMailShipmentsCustomsCustomsInfo.ReasonForExport);
            writer.WriteString("reasonForExport", reasonForExportRawValue);
            writer.WriteNumber("customsDeclaredValue", militaryMailShipmentsCustomsCustomsInfo.CustomsDeclaredValue);

            writer.WriteString("currencyCode", militaryMailShipmentsCustomsCustomsInfo.CurrencyCode);

            if (militaryMailShipmentsCustomsCustomsInfo.EELPFCOption.IsSet)
                writer.WriteString("EELPFC", militaryMailShipmentsCustomsCustomsInfo.EELPFC);

            if (militaryMailShipmentsCustomsCustomsInfo.CertificateNumberOption.IsSet)
                writer.WriteString("certificateNumber", militaryMailShipmentsCustomsCustomsInfo.CertificateNumber);

            if (militaryMailShipmentsCustomsCustomsInfo.CommentsOption.IsSet)
                writer.WriteString("comments", militaryMailShipmentsCustomsCustomsInfo.Comments);

            if (militaryMailShipmentsCustomsCustomsInfo.FromCustomsReferenceOption.IsSet)
                writer.WriteString("fromCustomsReference", militaryMailShipmentsCustomsCustomsInfo.FromCustomsReference);

            if (militaryMailShipmentsCustomsCustomsInfo.ImporterCustomsReferenceOption.IsSet)
                writer.WriteString("importerCustomsReference", militaryMailShipmentsCustomsCustomsInfo.ImporterCustomsReference);

            if (militaryMailShipmentsCustomsCustomsInfo.InvoiceNumberOption.IsSet)
                writer.WriteString("invoiceNumber", militaryMailShipmentsCustomsCustomsInfo.InvoiceNumber);

            if (militaryMailShipmentsCustomsCustomsInfo.LicenseNumberOption.IsSet)
                writer.WriteString("licenseNumber", militaryMailShipmentsCustomsCustomsInfo.LicenseNumber);

            if (militaryMailShipmentsCustomsCustomsInfo.SdrValueOption.IsSet)
                writer.WriteNumber("sdrValue", militaryMailShipmentsCustomsCustomsInfo.SdrValueOption.Value.Value);

            var termsOfSaleRawValue = MilitaryMailShipmentsCustomsCustomsInfo.TermsOfSaleEnumToJsonValue(militaryMailShipmentsCustomsCustomsInfo.TermsOfSaleOption.Value.Value);
