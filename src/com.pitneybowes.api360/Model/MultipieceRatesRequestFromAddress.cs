...
namespace com.pitneybowes.api360.Model
{
    ...
    public partial class MultipieceRatesRequestFromAddress : IValidatableObject
    {
        ...
        [JsonConstructor]
        public MultipieceRatesRequestFromAddress(Option<string> addressLine1 = default, Option<string> addressLine2 = default, Option<string> addressLine3 = default, Option<string> cityTown = default, Option<string> stateProvince = default, Option<string> postalCode = default, Option<string> countryCode = default, Option<string> company = default, Option<string> name = default, Option<string> phone = default, Option<string> email = default, Option<bool?> residential = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="MultipieceRatesRequestFromAddress" />
    /// </summary>
    public class MultipieceRatesRequestFromAddressJsonConverter : JsonConverter<MultipieceRatesRequestFromAddress>
    {
        /// <summary>
        /// Deserializes json to <see cref="MultipieceRatesRequestFromAddress" />
        /// </summary>
        ...
        public override MultipieceRatesRequestFromAddress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (addressLine1.IsSet && addressLine1.Value == null)
                throw new ArgumentNullException(nameof(addressLine1), "Property is not nullable for class MultipieceRatesRequestFromAddress.");

            if (addressLine2.IsSet && addressLine2.Value == null)
                throw new ArgumentNullException(nameof(addressLine2), "Property is not nullable for class MultipieceRatesRequestFromAddress.");

            if (addressLine3.IsSet && addressLine3.Value == null)
                throw new ArgumentNullException(nameof(addressLine3), "Property is not nullable for class MultipieceRatesRequestFromAddress.");

            if (cityTown.IsSet && cityTown.Value == null)
                throw new ArgumentNullException(nameof(cityTown), "Property is not nullable for class MultipieceRatesRequestFromAddress.");

            if (stateProvince.IsSet && stateProvince.Value == null)
                throw new ArgumentNullException(nameof(stateProvince), "Property is not nullable for class MultipieceRatesRequestFromAddress.");

            if (postalCode.IsSet && postalCode.Value == null)
                throw new ArgumentNullException(nameof(postalCode), "Property is not nullable for class MultipieceRatesRequestFromAddress.");

            if (countryCode.IsSet && countryCode.Value == null)
                throw new ArgumentNullException(nameof(countryCode), "Property is not nullable for class MultipieceRatesRequestFromAddress.");

            if (company.IsSet && company.Value == null)
                throw new ArgumentNullException(nameof(company), "Property is not nullable for class MultipieceRatesRequestFromAddress.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class MultipieceRatesRequestFromAddress.");

            if (phone.IsSet && phone.Value == null)
                throw new ArgumentNullException(nameof(phone), "Property is not nullable for class MultipieceRatesRequestFromAddress.");

            if (email.IsSet && email.Value == null)
                throw new ArgumentNullException(nameof(email), "Property is not nullable for class MultipieceRatesRequestFromAddress.");

            if (residential.IsSet && residential.Value == null)
                throw new ArgumentNullException(nameof(residential), "Property is not nullable for class MultipieceRatesRequestFromAddress.");

            return new MultipieceRatesRequestFromAddress(addressLine1, addressLine2, addressLine3, cityTown, stateProvince, postalCode, countryCode, company, name, phone, email, residential);
        }

        /// <summary>
        /// Serializes a <see cref="MultipieceRatesRequestFromAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="multipieceRatesRequestFromAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, MultipieceRatesRequestFromAddress multipieceRatesRequestFromAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, multipieceRatesRequestFromAddress, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="MultipieceRatesRequestFromAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="multipieceRatesRequestFromAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, MultipieceRatesRequestFromAddress multipieceRatesRequestFromAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            if (multipieceRatesRequestFromAddress.AddressLine1Option.IsSet && multipieceRatesRequestFromAddress.AddressLine1 == null)
                throw new ArgumentNullException(nameof(multipieceRatesRequestFromAddress.AddressLine1), "Property is required for class MultipieceRatesRequestFromAddress.");

            if (multipieceRatesRequestFromAddress.AddressLine2Option.IsSet && multipieceRatesRequestFromAddress.AddressLine2 == null)
                throw new ArgumentNullException(nameof(multipieceRatesRequestFromAddress.AddressLine2), "Property is required for class MultipieceRatesRequestFromAddress.");

            if (multipieceRatesRequestFromAddress.AddressLine3Option.IsSet && multipieceRatesRequestFromAddress.AddressLine3 == null)
                throw new ArgumentNullException(nameof(multipieceRatesRequestFromAddress.AddressLine3), "Property is required for class MultipieceRatesRequestFromAddress.");

            if (multipieceRatesRequestFromAddress.CityTownOption.IsSet && multipieceRatesRequestFromAddress.CityTown == null)
                throw new ArgumentNullException(nameof(multipieceRatesRequestFromAddress.CityTown), "Property is required for class MultipieceRatesRequestFromAddress.");

            if (multipieceRatesRequestFromAddress.StateProvinceOption.IsSet && multipieceRatesRequestFromAddress.StateProvince == null)
                throw new ArgumentNullException(nameof(multipieceRatesRequestFromAddress.StateProvince), "Property is required for class MultipieceRatesRequestFromAddress.");

            if (multipieceRatesRequestFromAddress.PostalCodeOption.IsSet && multipieceRatesRequestFromAddress.PostalCode == null)
                throw new ArgumentNullException(nameof(multipieceRatesRequestFromAddress.PostalCode), "Property is required for class MultipieceRatesRequestFromAddress.");

            if (multipieceRatesRequestFromAddress.CountryCodeOption.IsSet && multipieceRatesRequestFromAddress.CountryCode == null)
                throw new ArgumentNullException(nameof(multipieceRatesRequestFromAddress.CountryCode), "Property is required for class MultipieceRatesRequestFromAddress.");

            if (multipieceRatesRequestFromAddress.CompanyOption.IsSet && multipieceRatesRequestFromAddress.Company == null)
                throw new ArgumentNullException(nameof(multipieceRatesRequestFromAddress.Company), "Property is required for class MultipieceRatesRequestFromAddress.");

            if (multipieceRatesRequestFromAddress.NameOption.IsSet && multipieceRatesRequestFromAddress.Name == null)
                throw new ArgumentNullException(nameof(multipieceRatesRequestFromAddress.Name), "Property is required for class MultipieceRatesRequestFromAddress.");

            if (multipieceRatesRequestFromAddress.PhoneOption.IsSet && multipieceRatesRequestFromAddress.Phone == null)
                throw new ArgumentNullException(nameof(multipieceRatesRequestFromAddress.Phone), "Property is required for class MultipieceRatesRequestFromAddress.");

            if (multipieceRatesRequestFromAddress.EmailOption.IsSet && multipieceRatesRequestFromAddress.Email == null)
                throw new ArgumentNullException(nameof(multipieceRatesRequestFromAddress.Email), "Property is required for class MultipieceRatesRequestFromAddress.");

            if (multipieceRatesRequestFromAddress.AddressLine1Option.IsSet)
                writer.WriteString("addressLine1", multipieceRatesRequestFromAddress.AddressLine1);

            if (multipieceRatesRequestFromAddress.AddressLine2Option.IsSet)
                writer.WriteString("addressLine2", multipieceRatesRequestFromAddress.AddressLine2);

            if (multipieceRatesRequestFromAddress.AddressLine3Option.IsSet)
                writer.WriteString("addressLine3", multipieceRatesRequestFromAddress.AddressLine3);

            if (multipieceRatesRequestFromAddress.CityTownOption.IsSet)
                writer.WriteString("cityTown", multipieceRatesRequestFromAddress.CityTown);

            if (multipieceRatesRequestFromAddress.StateProvinceOption.IsSet)
                writer.WriteString("stateProvince", multipieceRatesRequestFromAddress.StateProvince);

            if (multipieceRatesRequestFromAddress.PostalCodeOption.IsSet)
                writer.WriteString("postalCode", multipieceRatesRequestFromAddress.PostalCode);

            if (multipieceRatesRequestFromAddress.CountryCodeOption.IsSet)
                writer.WriteString("countryCode", multipieceRatesRequestFromAddress.CountryCode);

            if (multipieceRatesRequestFromAddress.CompanyOption.IsSet)
                writer.WriteString("company", multipieceRatesRequestFromAddress.Company);

            if (multipieceRatesRequestFromAddress.NameOption.IsSet)
                writer.WriteString("name", multipieceRatesRequestFromAddress.Name);

            if (multipieceRatesRequestFromAddress.PhoneOption.IsSet)
                writer.WriteString("phone", multipieceRatesRequestFromAddress.Phone);

            if (multipieceRatesRequestFromAddress.EmailOption.IsSet)
                writer.WriteString("email", multipieceRatesRequestFromAddress.Email);

            if (multipieceRatesRequestFromAddress.ResidentialOption.IsSet)
                writer.WriteBoolean("residential", multipieceRatesRequestFromAddress.ResidentialOption.Value.Value);
        }
    }
}
