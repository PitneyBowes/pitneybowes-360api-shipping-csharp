...
namespace com.pitneybowes.api360.Model
{
    ...
    /// ReprintShipmentV2
    /// </summary>
    [DataContract(Name = "reprintShipmentV2")]
    public partial class ReprintShipmentV2 : IValidatableObject
    {
        ...
        public ReprintShipmentV2(string shipmentId = default(string), string parcelTrackingNumber = default(string), List<ReprintShipmentV2LabelLayoutInner> labelLayout = default(List<ReprintShipmentV2LabelLayoutInner>), ParcelV2 parcel = default(ParcelV2), RateResponseV2 rate = default(RateResponseV2), CancelShipmentV2References references = default(CancelShipmentV2References), string printStatus = default(string))
        {
        ...
        public List<ReprintShipmentV2LabelLayoutInner> LabelLayout { get; set; }
        ...
        public CancelShipmentV2References References { get; set; }
