...
namespace com.pitneybowes.api360.Model
{
    ...
    /// </summary>
    public partial class GetAllShipmentsDataInnerParcel : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAllShipmentsDataInnerParcel" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public GetAllShipmentsDataInnerParcel(decimal length, decimal width, decimal height, DimUnitEnum dimUnit, WeightUnitEnum weightUnit, decimal weight)
        {
            Length = length;
            Width = width;
            Height = height;
    ...
    /// <summary>
    /// A Json converter for type <see cref="GetAllShipmentsDataInnerParcel" />
    /// </summary>
    public class GetAllShipmentsDataInnerParcelJsonConverter : JsonConverter<GetAllShipmentsDataInnerParcel>
    {
        /// <summary>
        /// Deserializes json to <see cref="GetAllShipmentsDataInnerParcel" />
        /// </summary>
        ...
        public override GetAllShipmentsDataInnerParcel Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<GetAllShipmentsDataInnerParcel.DimUnitEnum?> dimUnit = default;
            Option<GetAllShipmentsDataInnerParcel.WeightUnitEnum?> weightUnit = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "dimUnit":
                            ...
                            if (dimUnitRawValue != null)
                                dimUnit = new Option<GetAllShipmentsDataInnerParcel.DimUnitEnum?>(GetAllShipmentsDataInnerParcel.DimUnitEnumFromStringOrDefault(dimUnitRawValue));
                            break;
                        case "weightUnit":
                            string weightUnitRawValue = utf8JsonReader.GetString();
                            if (weightUnitRawValue != null)
                                weightUnit = new Option<GetAllShipmentsDataInnerParcel.WeightUnitEnum?>(GetAllShipmentsDataInnerParcel.WeightUnitEnumFromStringOrDefault(weightUnitRawValue));
                            break;
                        case "weight":
            ...
            if (!length.IsSet)
                throw new ArgumentException("Property is required for class GetAllShipmentsDataInnerParcel.", nameof(length));

            if (!width.IsSet)
                throw new ArgumentException("Property is required for class GetAllShipmentsDataInnerParcel.", nameof(width));

            if (!height.IsSet)
                throw new ArgumentException("Property is required for class GetAllShipmentsDataInnerParcel.", nameof(height));

            if (!dimUnit.IsSet)
                throw new ArgumentException("Property is required for class GetAllShipmentsDataInnerParcel.", nameof(dimUnit));

            if (!weightUnit.IsSet)
                throw new ArgumentException("Property is required for class GetAllShipmentsDataInnerParcel.", nameof(weightUnit));

            if (!weight.IsSet)
                throw new ArgumentException("Property is required for class GetAllShipmentsDataInnerParcel.", nameof(weight));

            if (length.IsSet && length.Value == null)
                throw new ArgumentNullException(nameof(length), "Property is not nullable for class GetAllShipmentsDataInnerParcel.");

            if (width.IsSet && width.Value == null)
                throw new ArgumentNullException(nameof(width), "Property is not nullable for class GetAllShipmentsDataInnerParcel.");

            if (height.IsSet && height.Value == null)
                throw new ArgumentNullException(nameof(height), "Property is not nullable for class GetAllShipmentsDataInnerParcel.");

            if (dimUnit.IsSet && dimUnit.Value == null)
                throw new ArgumentNullException(nameof(dimUnit), "Property is not nullable for class GetAllShipmentsDataInnerParcel.");

            if (weightUnit.IsSet && weightUnit.Value == null)
                throw new ArgumentNullException(nameof(weightUnit), "Property is not nullable for class GetAllShipmentsDataInnerParcel.");

            if (weight.IsSet && weight.Value == null)
                throw new ArgumentNullException(nameof(weight), "Property is not nullable for class GetAllShipmentsDataInnerParcel.");

            return new GetAllShipmentsDataInnerParcel(length.Value.Value, width.Value.Value, height.Value.Value, dimUnit.Value.Value, weightUnit.Value.Value, weight.Value.Value);
        }

        /// <summary>
        /// Serializes a <see cref="GetAllShipmentsDataInnerParcel" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getAllShipmentsDataInnerParcel"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GetAllShipmentsDataInnerParcel getAllShipmentsDataInnerParcel, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, getAllShipmentsDataInnerParcel, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GetAllShipmentsDataInnerParcel" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getAllShipmentsDataInnerParcel"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, GetAllShipmentsDataInnerParcel getAllShipmentsDataInnerParcel, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteNumber("length", getAllShipmentsDataInnerParcel.Length);

            writer.WriteNumber("width", getAllShipmentsDataInnerParcel.Width);

            writer.WriteNumber("height", getAllShipmentsDataInnerParcel.Height);

            var dimUnitRawValue = GetAllShipmentsDataInnerParcel.DimUnitEnumToJsonValue(getAllShipmentsDataInnerParcel.DimUnit);
            writer.WriteString("dimUnit", dimUnitRawValue);
            var weightUnitRawValue = GetAllShipmentsDataInnerParcel.WeightUnitEnumToJsonValue(getAllShipmentsDataInnerParcel.WeightUnit);
            writer.WriteString("weightUnit", weightUnitRawValue);
            writer.WriteNumber("weight", getAllShipmentsDataInnerParcel.Weight);
        }
    }
}
