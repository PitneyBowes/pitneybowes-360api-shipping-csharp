...
namespace com.pitneybowes.api360.Model
{
    ...
    public partial class ShipmentInternationalToAddress : IValidatableObject
    {
        ...
        /// <param name="company">The name of the company, in case if the receiver address is not residential. This field is required for RMG b2b shipment.</param>
        /// <param name="email">This must be receivers&#39;s valid email. Email is required if the customer is using GoFor Carrier.</param>
        ...
        [JsonConstructor]
        public ShipmentInternationalToAddress(string addressLine1, string countryCode, string postalCode, string stateProvince, Option<string?> addressLine2 = default, Option<string?> addressLine3 = default, Option<string?> cityTown = default, Option<string?> name = default, Option<string?> phone = default, Option<string?> company = default, Option<string?> email = default, Option<bool?> residential = default, Option<string?> taxId = default, Option<TaxIdTypeEnum?> taxIdType = default)
        {
        ...
        /// <summary>
        /// The name of the company, in case if the receiver address is not residential. This field is required for RMG b2b shipment.
        /// </summary>
        /// <value>The name of the company, in case if the receiver address is not residential. This field is required for RMG b2b shipment.</value>
        /* <example>PB</example> */
        ...
        /// <summary>
        /// This must be receivers&#39;s valid email. Email is required if the customer is using GoFor Carrier.
        /// </summary>
        /// <value>This must be receivers&#39;s valid email. Email is required if the customer is using GoFor Carrier.</value>
    ...
    /// <summary>
    /// A Json converter for type <see cref="ShipmentInternationalToAddress" />
    /// </summary>
    public class ShipmentInternationalToAddressJsonConverter : JsonConverter<ShipmentInternationalToAddress>
    {
        /// <summary>
        /// Deserializes json to <see cref="ShipmentInternationalToAddress" />
        /// </summary>
        ...
        public override ShipmentInternationalToAddress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<ShipmentInternationalToAddress.TaxIdTypeEnum?> taxIdType = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "taxIdType":
                            ...
                            if (taxIdTypeRawValue != null)
                                taxIdType = new Option<ShipmentInternationalToAddress.TaxIdTypeEnum?>(ShipmentInternationalToAddress.TaxIdTypeEnumFromStringOrDefault(taxIdTypeRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            if (!addressLine1.IsSet)
                throw new ArgumentException("Property is required for class ShipmentInternationalToAddress.", nameof(addressLine1));

            if (!countryCode.IsSet)
                throw new ArgumentException("Property is required for class ShipmentInternationalToAddress.", nameof(countryCode));

            if (!postalCode.IsSet)
                throw new ArgumentException("Property is required for class ShipmentInternationalToAddress.", nameof(postalCode));

            if (!stateProvince.IsSet)
                throw new ArgumentException("Property is required for class ShipmentInternationalToAddress.", nameof(stateProvince));

            if (addressLine1.IsSet && addressLine1.Value == null)
                throw new ArgumentNullException(nameof(addressLine1), "Property is not nullable for class ShipmentInternationalToAddress.");

            if (countryCode.IsSet && countryCode.Value == null)
                throw new ArgumentNullException(nameof(countryCode), "Property is not nullable for class ShipmentInternationalToAddress.");

            if (postalCode.IsSet && postalCode.Value == null)
                throw new ArgumentNullException(nameof(postalCode), "Property is not nullable for class ShipmentInternationalToAddress.");

            if (stateProvince.IsSet && stateProvince.Value == null)
                throw new ArgumentNullException(nameof(stateProvince), "Property is not nullable for class ShipmentInternationalToAddress.");

            if (addressLine2.IsSet && addressLine2.Value == null)
                throw new ArgumentNullException(nameof(addressLine2), "Property is not nullable for class ShipmentInternationalToAddress.");

            if (addressLine3.IsSet && addressLine3.Value == null)
                throw new ArgumentNullException(nameof(addressLine3), "Property is not nullable for class ShipmentInternationalToAddress.");

            if (cityTown.IsSet && cityTown.Value == null)
                throw new ArgumentNullException(nameof(cityTown), "Property is not nullable for class ShipmentInternationalToAddress.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class ShipmentInternationalToAddress.");

            if (phone.IsSet && phone.Value == null)
                throw new ArgumentNullException(nameof(phone), "Property is not nullable for class ShipmentInternationalToAddress.");

            if (company.IsSet && company.Value == null)
                throw new ArgumentNullException(nameof(company), "Property is not nullable for class ShipmentInternationalToAddress.");

            if (email.IsSet && email.Value == null)
                throw new ArgumentNullException(nameof(email), "Property is not nullable for class ShipmentInternationalToAddress.");

            if (residential.IsSet && residential.Value == null)
                throw new ArgumentNullException(nameof(residential), "Property is not nullable for class ShipmentInternationalToAddress.");

            if (taxId.IsSet && taxId.Value == null)
                throw new ArgumentNullException(nameof(taxId), "Property is not nullable for class ShipmentInternationalToAddress.");

            if (taxIdType.IsSet && taxIdType.Value == null)
                throw new ArgumentNullException(nameof(taxIdType), "Property is not nullable for class ShipmentInternationalToAddress.");

            return new ShipmentInternationalToAddress(addressLine1.Value!, countryCode.Value!, postalCode.Value!, stateProvince.Value!, addressLine2, addressLine3, cityTown, name, phone, company, email, residential, taxId, taxIdType);
        }

        /// <summary>
        /// Serializes a <see cref="ShipmentInternationalToAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="shipmentInternationalToAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ShipmentInternationalToAddress shipmentInternationalToAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, shipmentInternationalToAddress, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ShipmentInternationalToAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="shipmentInternationalToAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ShipmentInternationalToAddress shipmentInternationalToAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            if (shipmentInternationalToAddress.AddressLine1 == null)
                throw new ArgumentNullException(nameof(shipmentInternationalToAddress.AddressLine1), "Property is required for class ShipmentInternationalToAddress.");

            if (shipmentInternationalToAddress.CountryCode == null)
                throw new ArgumentNullException(nameof(shipmentInternationalToAddress.CountryCode), "Property is required for class ShipmentInternationalToAddress.");

            if (shipmentInternationalToAddress.PostalCode == null)
                throw new ArgumentNullException(nameof(shipmentInternationalToAddress.PostalCode), "Property is required for class ShipmentInternationalToAddress.");

            if (shipmentInternationalToAddress.StateProvince == null)
                throw new ArgumentNullException(nameof(shipmentInternationalToAddress.StateProvince), "Property is required for class ShipmentInternationalToAddress.");

            if (shipmentInternationalToAddress.AddressLine2Option.IsSet && shipmentInternationalToAddress.AddressLine2 == null)
                throw new ArgumentNullException(nameof(shipmentInternationalToAddress.AddressLine2), "Property is required for class ShipmentInternationalToAddress.");

            if (shipmentInternationalToAddress.AddressLine3Option.IsSet && shipmentInternationalToAddress.AddressLine3 == null)
                throw new ArgumentNullException(nameof(shipmentInternationalToAddress.AddressLine3), "Property is required for class ShipmentInternationalToAddress.");

            if (shipmentInternationalToAddress.CityTownOption.IsSet && shipmentInternationalToAddress.CityTown == null)
                throw new ArgumentNullException(nameof(shipmentInternationalToAddress.CityTown), "Property is required for class ShipmentInternationalToAddress.");

            if (shipmentInternationalToAddress.NameOption.IsSet && shipmentInternationalToAddress.Name == null)
                throw new ArgumentNullException(nameof(shipmentInternationalToAddress.Name), "Property is required for class ShipmentInternationalToAddress.");

            if (shipmentInternationalToAddress.PhoneOption.IsSet && shipmentInternationalToAddress.Phone == null)
                throw new ArgumentNullException(nameof(shipmentInternationalToAddress.Phone), "Property is required for class ShipmentInternationalToAddress.");

            if (shipmentInternationalToAddress.CompanyOption.IsSet && shipmentInternationalToAddress.Company == null)
                throw new ArgumentNullException(nameof(shipmentInternationalToAddress.Company), "Property is required for class ShipmentInternationalToAddress.");

            if (shipmentInternationalToAddress.EmailOption.IsSet && shipmentInternationalToAddress.Email == null)
                throw new ArgumentNullException(nameof(shipmentInternationalToAddress.Email), "Property is required for class ShipmentInternationalToAddress.");

            if (shipmentInternationalToAddress.TaxIdOption.IsSet && shipmentInternationalToAddress.TaxId == null)
                throw new ArgumentNullException(nameof(shipmentInternationalToAddress.TaxId), "Property is required for class ShipmentInternationalToAddress.");

            writer.WriteString("addressLine1", shipmentInternationalToAddress.AddressLine1);

            writer.WriteString("countryCode", shipmentInternationalToAddress.CountryCode);

            writer.WriteString("postalCode", shipmentInternationalToAddress.PostalCode);

            writer.WriteString("stateProvince", shipmentInternationalToAddress.StateProvince);

            if (shipmentInternationalToAddress.AddressLine2Option.IsSet)
                writer.WriteString("addressLine2", shipmentInternationalToAddress.AddressLine2);

            if (shipmentInternationalToAddress.AddressLine3Option.IsSet)
                writer.WriteString("addressLine3", shipmentInternationalToAddress.AddressLine3);

            if (shipmentInternationalToAddress.CityTownOption.IsSet)
                writer.WriteString("cityTown", shipmentInternationalToAddress.CityTown);

            if (shipmentInternationalToAddress.NameOption.IsSet)
                writer.WriteString("name", shipmentInternationalToAddress.Name);

            if (shipmentInternationalToAddress.PhoneOption.IsSet)
                writer.WriteString("phone", shipmentInternationalToAddress.Phone);

            if (shipmentInternationalToAddress.CompanyOption.IsSet)
                writer.WriteString("company", shipmentInternationalToAddress.Company);

            if (shipmentInternationalToAddress.EmailOption.IsSet)
                writer.WriteString("email", shipmentInternationalToAddress.Email);

            if (shipmentInternationalToAddress.ResidentialOption.IsSet)
                writer.WriteBoolean("residential", shipmentInternationalToAddress.ResidentialOption.Value!.Value);

            if (shipmentInternationalToAddress.TaxIdOption.IsSet)
                writer.WriteString("taxId", shipmentInternationalToAddress.TaxId);

            var taxIdTypeRawValue = ShipmentInternationalToAddress.TaxIdTypeEnumToJsonValue(shipmentInternationalToAddress.TaxIdTypeOption.Value!.Value);
