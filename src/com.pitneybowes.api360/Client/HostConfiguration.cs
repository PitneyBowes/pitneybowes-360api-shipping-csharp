...
namespace com.pitneybowes.api360.Client
{
    ...
    public class HostConfiguration
    {
        ...
        public HostConfiguration(IServiceCollection services)
        {
            ...
            _jsonOptions.Converters.Add(new ByCustomCarrierCodeV2JsonConverter());
            _jsonOptions.Converters.Add(new ByExternalSystemCodeV2JsonConverter());
            ...
            _jsonOptions.Converters.Add(new CarrierFacilityOptionsJsonConverter());
            _jsonOptions.Converters.Add(new CarrierFacilityRequestJsonConverter());
            _jsonOptions.Converters.Add(new CarrierFacilityResponseJsonConverter());
            _jsonOptions.Converters.Add(new CarrierFacilitySuggestionJsonConverter());
            _jsonOptions.Converters.Add(new CarrierFacilitySuggestionCarrierFacilityAttributesInnerJsonConverter());
            ...
            _jsonOptions.Converters.Add(new FacilityAddressJsonConverter());
            _jsonOptions.Converters.Add(new FacilityHoursJsonConverter());
            ...
            _jsonOptions.Converters.Add(new MilitaryMailShipmentResponseV2CustomsJsonConverter());
            _jsonOptions.Converters.Add(new MilitaryMailShipmentResponseV2CustomsCustomsInfoJsonConverter());
            _jsonOptions.Converters.Add(new MilitaryMailShipmentResponseV2CustomsCustomsItemsInnerJsonConverter());
            _jsonOptions.Converters.Add(new MilitaryMailShipmentResponseV2LabelLayoutInnerJsonConverter());
            _jsonOptions.Converters.Add(new MilitaryMailShipmentResponseV2PrintErrorJsonConverter());
            _jsonOptions.Converters.Add(new MilitaryMailShipmentResponseV2ShipmentOptionsJsonConverter());
            ...
            _jsonOptions.Converters.Add(new MilitaryMailShipmentsRequestV2CustomsJsonConverter());
            _jsonOptions.Converters.Add(new MilitaryMailShipmentsRequestV2CustomsCustomsInfoJsonConverter());
            ...
            _jsonOptions.Converters.Add(new PickupAvailabilityRequestJsonConverter());
            _jsonOptions.Converters.Add(new PickupAvailabilityRequestPickupAddressJsonConverter());
            _jsonOptions.Converters.Add(new PickupAvailabilityRequestPickupOptionsJsonConverter());
            _jsonOptions.Converters.Add(new PickupAvailabilityRequestPickupSummaryInnerJsonConverter());
            _jsonOptions.Converters.Add(new PickupAvailabilityRequestPickupSummaryInnerPackageDetailsInnerJsonConverter());
            _jsonOptions.Converters.Add(new PickupAvailabilityResponseJsonConverter());
            _jsonOptions.Converters.Add(new PickupAvailabilityResponsePickupAddressJsonConverter());
            _jsonOptions.Converters.Add(new PickupAvailabilityResponsePickupInformationJsonConverter());
            _jsonOptions.Converters.Add(new PickupAvailabilityResponsePickupInformationStartCloseTimeOptionsJsonConverter());
            ...
            _jsonOptions.Converters.Add(new RateShopbyCarrierDeliveryOptionJsonConverter());
            _jsonOptions.Converters.Add(new RateShopbyCarrierParcelJsonConverter());
            _jsonOptions.Converters.Add(new RateShopbyCustomCarrierCodeJsonConverter());
            _jsonOptions.Converters.Add(new RateShopbyCustomCarrierCodeByCustomCarrierCodeJsonConverter());
            _jsonOptions.Converters.Add(new RateShopbyExternalSystemCodeJsonConverter());
            ...
            _jsonOptions.Converters.Add(new SchedulePickupFedexRequestPickupOptionsJsonConverter());
            ...
            _jsonOptions.Converters.Add(new SchedulePickupFedexResponsePickupOptionsJsonConverter());
            ...
            _jsonOptions.Converters.Add(new SchedulePickupUSPSRequestPickupOptionsJsonConverter());
            ...
            _jsonOptions.Converters.Add(new ShipmentDomesticByCarrierReturnOptionsInputParametersInnerJsonConverter());
            _jsonOptions.Converters.Add(new ShipmentDomesticByCarrierShipmentOptionsJsonConverter());
            _jsonOptions.Converters.Add(new ShipmentDomesticByCustomCarrierCodeJsonConverter());
            _jsonOptions.Converters.Add(new ShipmentDomesticByCustomCarrierCodeMetadataInnerJsonConverter());
            _jsonOptions.Converters.Add(new ShipmentDomesticByExternalSystemCodeJsonConverter());
            _jsonOptions.Converters.Add(new ShipmentDomesticByExternalSystemCodeShipmentOptionsJsonConverter());
            _jsonOptions.Converters.Add(new ShipmentDomesticByRateGroupJsonConverter());
            _jsonOptions.Converters.Add(new ShipmentDomesticByRateGroupAltReturnAddressJsonConverter());
            ...
            _jsonOptions.Converters.Add(new SubscriptionCapabilitiesRequestJsonConverter());
            _jsonOptions.Converters.Add(new SubscriptionCapabilitiesRequestCapabilitiesJsonConverter());
