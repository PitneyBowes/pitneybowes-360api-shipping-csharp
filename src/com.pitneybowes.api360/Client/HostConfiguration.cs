...
namespace com.pitneybowes.api360.Client
{
    ...
    public class HostConfiguration
    {
        ...
        public HostConfiguration(IServiceCollection services)
        {
            ...
            _jsonOptions.Converters.Add(new PickupAvailabilityRequestPickupSummaryInnerSpecialServicesInnerJsonConverter());
            ...
            _jsonOptions.Converters.Add(new PickupAvailabilityResponsePickupInformationTimeRangeOptionsJsonConverter());
            _jsonOptions.Converters.Add(new PickupAvailabilityResponsePickupInformationTimeRangeOptionsDefaultRangeJsonConverter());
            _jsonOptions.Converters.Add(new PickupAvailabilityResponsePickupInformationTimeRangeOptionsTimeRangesInnerJsonConverter());
            _jsonOptions.Converters.Add(new PickupAvailabilityResponsePickupOptionsJsonConverter());
            _jsonOptions.Converters.Add(new PickupAvailabilityResponsePickupSummaryInnerJsonConverter());
