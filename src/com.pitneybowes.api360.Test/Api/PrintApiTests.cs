...
namespace com.pitneybowes.api360.Test.Api
{
    ...
    /// </summary>
    public sealed class PrintApiTests : ApiTestsBase
    {
        private readonly IPrintApi _instance;

        public PrintApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IPrintApi>();
        }
