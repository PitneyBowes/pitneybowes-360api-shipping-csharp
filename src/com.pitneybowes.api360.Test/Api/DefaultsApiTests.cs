...
namespace com.pitneybowes.api360.Test.Api
{
    ...
    /// </summary>
    public sealed class DefaultsApiTests : ApiTestsBase
    {
        private readonly IDefaultsApi _instance;

        public DefaultsApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IDefaultsApi>();
        }
