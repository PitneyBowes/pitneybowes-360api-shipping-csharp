...
{
    /// <summary>
    ///  Class for testing ElectronicTradeDocumentApi
    /// </summary>
    public sealed class ElectronicTradeDocumentApiTests : ApiTestsBase
    {
        private readonly IElectronicTradeDocumentApi _instance;

        public ElectronicTradeDocumentApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IElectronicTradeDocumentApi>();
        }
